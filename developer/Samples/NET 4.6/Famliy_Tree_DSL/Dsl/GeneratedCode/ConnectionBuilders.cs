...
namespace Fabrikam.Dsl.TestValidation
{
	...
	/// </summary>
	public static partial class ConnectParentRelation
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Fabrikam.Dsl.TestValidation.Person)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Fabrikam.Dsl.TestValidation.Person)
				{
					if (candidateTarget is global::Fabrikam.Dsl.TestValidation.Person)
					{
						global::Fabrikam.Dsl.TestValidation.Person sourcePerson = (global::Fabrikam.Dsl.TestValidation.Person)candidateSource;
						global::Fabrikam.Dsl.TestValidation.Person targetPerson = (global::Fabrikam.Dsl.TestValidation.Person)candidateTarget;
						if(targetPerson == null || sourcePerson == null || global::Fabrikam.Dsl.TestValidation.ParentRelation.GetLinks(sourcePerson, targetPerson).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Fabrikam.Dsl.TestValidation.Person)
				{
					if (target is global::Fabrikam.Dsl.TestValidation.Person)
					{
						global::Fabrikam.Dsl.TestValidation.Person sourceAccepted = (global::Fabrikam.Dsl.TestValidation.Person)source;
						global::Fabrikam.Dsl.TestValidation.Person targetAccepted = (global::Fabrikam.Dsl.TestValidation.Person)target;
						DslModeling::ElementLink result = new global::Fabrikam.Dsl.TestValidation.ParentRelation(sourceAccepted, targetAccepted);
	...
	/// </summary>
	internal partial class ParentRelationConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new ParentRelationConnectAction for the given Diagram.
		/// </summary>
		public ParentRelationConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the ParentRelationConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new ParentRelationConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class ParentRelationConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the ParentRelationConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected ParentRelationConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder ConnectParentRelation.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return ConnectParentRelation.CanAcceptSource(sourceElement);
					}
					else
					{				
						return ConnectParentRelation.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				ConnectParentRelation.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class ParentRelationConnectionType : ParentRelationConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the ParentRelationConnectionType with the given ConnectionBuilder.
			/// </summary>
			public ParentRelationConnectionType() : base() {}
		}
	}
}
