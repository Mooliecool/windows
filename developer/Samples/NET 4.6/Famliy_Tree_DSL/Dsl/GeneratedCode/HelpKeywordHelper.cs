...
namespace Fabrikam.Dsl.TestValidation
{
	...
	/// </remarks>
	public partial class TestValidationHelpKeywordHelper : TestValidationHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new TestValidationHelpKeywordHelper.
		/// </summary>
		protected TestValidationHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the TestValidationHelpKeywordHelper.
		/// </summary>
		public static TestValidationHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class TestValidationHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new TestValidationHelpKeywordHelperBase.
		/// </summary>
		protected TestValidationHelpKeywordHelperBase()
			: base() { }
