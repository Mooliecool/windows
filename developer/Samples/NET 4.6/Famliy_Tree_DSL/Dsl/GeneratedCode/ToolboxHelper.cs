...
namespace Fabrikam.Dsl.TestValidation
{
	...
	/// </remarks>
	public partial class TestValidationToolboxHelper : TestValidationToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new TestValidationToolboxHelper.
		/// </summary>
		public TestValidationToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class TestValidationToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify TestValidation toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "TestValidation.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify ParentRelation connector tool.
		/// </summary>
		public const string ParentRelationFilterString = "ParentRelation.1.0";
		...
		/// <summary>
		/// Constructs a new TestValidationToolboxHelperBase.
		/// </summary>
		protected TestValidationToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Fabrikam.Dsl.TestValidation.TestValidationDomainModel.SingletonResourceManager.GetString("TestValidationToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Fabrikam.Dsl.TestValidation.TestValidationDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Fabrikam.Dsl.TestValidation.PersonToolboxItem":
					// Add Person shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Fabrikam.Dsl.TestValidation.PersonToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						1, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("PersonToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("PersonToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Fabrikam.Dsl.TestValidation.TestValidationToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("TestValidationToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"ConnectPersonF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("PersonToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Fabrikam.Dsl.TestValidation.Person.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Fabrikam.Dsl.TestValidation.ParentRelationToolboxItem":

					// Add ParentRelation connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Fabrikam.Dsl.TestValidation.ParentRelationToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("ParentRelationToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("ParentRelationToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.				
						"Fabrikam.Dsl.TestValidation.TestValidationToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("TestValidationToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"ConnectParentRelationF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("ParentRelationToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						null, // Connector toolbox items do not have an underlying data object.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require), 
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ParentRelationFilterString)
						});
					break;
				default:
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Fabrikam.Dsl.TestValidation.TestValidationDomainModel));
