...
namespace Fabrikam.Dsl.TestValidation
{
	...
	/// </summary>
	internal partial class TestValidationDocData : TestValidationDocDataBase
	{
		/// <summary>
		/// Constructs a new TestValidationDocData.
		/// </summary>
		public TestValidationDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a TestValidation document in memory.
	/// </summary>
	internal abstract partial class TestValidationDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new TestValidationDocDataBase.
		/// </summary>
		protected TestValidationDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Fabrikam.Dsl.TestValidation.TestValidationDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Fabrikam.Dsl.TestValidation.TestValidationDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(TestValidationExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Fabrikam.Dsl.TestValidation.TestValidationDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Fabrikam.Dsl.TestValidation.TestValidationDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Fabrikam.Dsl.TestValidation.Family modelRoot = null;
			...
			global::Fabrikam.Dsl.TestValidation.TestValidationDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Fabrikam.Dsl.TestValidation.TestValidationSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Fabrikam.Dsl.TestValidation.TestValidationDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Fabrikam.Dsl.TestValidation.TestValidationDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected override bool CanSave(bool allowUserInterface)
		{
			...
			if (allowUserInterface)
			{
				...
				if (vc.ErrorMessages.Count != 0)
				{
					...
					global::System.Windows.Forms.DialogResult result = DslShell::PackageUtility.ShowMessageBox(this.ServiceProvider, global::Fabrikam.Dsl.TestValidation.TestValidationDomainModel.SingletonResourceManager.GetString(errorMsg), VSShellInterop::OLEMSGBUTTON.OLEMSGBUTTON_YESNO, VSShellInterop::OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_SECOND, VSShellInterop::OLEMSGICON.OLEMSGICON_WARNING);
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Fabrikam.Dsl.TestValidation.Family modelRoot = (global::Fabrikam.Dsl.TestValidation.Family)this.RootElement;
			...
			{
				global::Fabrikam.Dsl.TestValidation.TestValidationDiagram diagram = diagrams[0] as global::Fabrikam.Dsl.TestValidation.TestValidationDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Fabrikam.Dsl.TestValidation.TestValidationSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Fabrikam.Dsl.TestValidation.TestValidationSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Fabrikam.Dsl.TestValidation.TestValidationDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Fabrikam.Dsl.TestValidation.TestValidationSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Fabrikam.Dsl.TestValidation.Family modelRoot = this.RootElement as global::Fabrikam.Dsl.TestValidation.Family;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Fabrikam.Dsl.TestValidation.TestValidationSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
