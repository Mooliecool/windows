...
namespace Fabrikam.Dsl.TestValidation
{
	...
	/// </summary>
	internal partial class TestValidationDocView : TestValidationDocViewBase
	{
		/// <summary>
		/// Constructs a new TestValidationDocView.
		/// </summary>
		public TestValidationDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class TestValidationDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new TestValidationDocView.
		/// </summary>
		protected TestValidationDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			TestValidationDocDataBase docData = this.DocData as TestValidationDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for TestValidationDocViewBase should be an TestValidationDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Fabrikam.Dsl.TestValidation.TestValidationDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Fabrikam.Dsl.TestValidation.TestValidationDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Fabrikam.Dsl.TestValidation.TestValidationToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Fabrikam.Dsl.TestValidation.TestValidationToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.TestValidationDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Fabrikam.Dsl.TestValidation.TestValidationHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Fabrikam.Dsl.TestValidation.TestValidationHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Fabrikam.Dsl.TestValidation.TestValidationHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
