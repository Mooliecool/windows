...
namespace Fabrikam.Dsl.TestValidation
{
	...
	/// </summary>
	internal partial class TestValidationExplorer : TestValidationExplorerBase
	{
		/// <summary>
		/// Constructs a new TestValidationExplorer.
		/// </summary>
		public TestValidationExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the TestValidationExplorerToolWindow.
	/// </summary>
	internal abstract class TestValidationExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new TestValidationExplorerBase.
		/// </summary>
		protected TestValidationExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.TestValidationExplorerMenu;
			}
		}
		...
		{
			get { return global::Fabrikam.Dsl.TestValidation.Family.DomainClassId; }
		}
