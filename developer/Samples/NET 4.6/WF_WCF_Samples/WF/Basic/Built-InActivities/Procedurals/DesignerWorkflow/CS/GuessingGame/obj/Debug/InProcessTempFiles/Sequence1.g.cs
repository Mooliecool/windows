...
namespace Microsoft.Samples.GuessingGame {
    ...
    public partial class GuessingGameWF : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(GuessingGameWF).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(GuessingGameWF));
        ...
        private string FindResource() {
            string[] resources = typeof(GuessingGameWF).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Sequence1.g.xaml") || resource.Equals("Sequence1.g.xaml"))) {
                    return resource;
                }
            }
