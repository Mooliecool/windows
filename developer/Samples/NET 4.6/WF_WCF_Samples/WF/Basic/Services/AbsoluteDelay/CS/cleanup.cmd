...
echo --------------------------------------------------------------------------
echo   Cleaning up changes made by the Absolute Delay sample setup
echo --------------------------------------------------------------------------
echo.

echo Removing Sample Database ...
sqlcmd -S localhost\SQLExpress -E -i "cleanup.sql" -o cleanup-sqlcmd.log
...
echo -------------------------
echo A sqlcmd command in the cleanup script failed to execute.  This is most likely
