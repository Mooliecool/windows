...
namespace Microsoft.Samples.NestedTransactionScopeSample
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            WorkflowInvoker.Invoke(new ScenarioOne());
            ...
            application = new WorkflowApplication(new ScenarioTwo());
            ...
            application = new WorkflowApplication(new ScenarioThree());
            application.Aborted = Program.OnAborted;
            application.Completed = Program.OnCompleted;
            application.OnUnhandledException = Program.OnUnhandledException;
            syncEvent.Reset();
            ...
            application = new WorkflowApplication(new ScenarioFour());
            application.Aborted = Program.OnAborted;
            application.Completed = Program.OnCompleted;
            application.OnUnhandledException = Program.OnUnhandledException;
            syncEvent.Reset();
