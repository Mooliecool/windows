...
namespace Microsoft.Samples.StopWatchClient {
    ...
    public partial class StopWatchClientWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public StopWatchClientWorkflow() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(StopWatchClientWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(StopWatchClientWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(StopWatchClientWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".StopWatchClientWorkflow.g.xaml") || resource.Equals("StopWatchClientWorkflow.g.xaml"))) {
                    return resource;
                }
            }
