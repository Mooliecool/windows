...
namespace Microsoft.Samples.StopWatchService {
    ...
    public partial class StopWatchWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(StopWatchWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(StopWatchWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(StopWatchWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".StopWatchWorkflow.g.xaml") || resource.Equals("StopWatchWorkflow.g.xaml"))) {
                    return resource;
                }
            }
