...
namespace Microsoft.SDK.Samples.VistaBridge.Library
{
    ...
    public abstract class DialogControl
    {
        ...
        protected DialogControl() 
        {
            ...
            // To support wrapping of control IDs - 
            // JUST in case you create a lot of custom controls.
        ...
        protected void CheckPropertyChangeAllowed(string propName)
        {
            Debug.Assert(!String.IsNullOrEmpty(propName), 
                "Property changing was not specified");
        ...
        {
            Debug.Assert(!String.IsNullOrEmpty(propName), 
                "Property changed was not specified");
            if (hostingDialog != null)
