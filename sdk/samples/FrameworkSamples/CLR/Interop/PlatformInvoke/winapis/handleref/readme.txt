...
=============================================
     1. Open the Command Prompt window and navigate to the Technologies\Interop\PlatformInvoke\WinAPIs\HandleRef directory.
     2. Type msbuild [Solution Filename].


To build the sample using Visual Studio:
=======================================
     1. Open Windows Explorer and navigate to the Technologies\Interop\PlatformInvoke\WinAPIs\HandleRef directory.
