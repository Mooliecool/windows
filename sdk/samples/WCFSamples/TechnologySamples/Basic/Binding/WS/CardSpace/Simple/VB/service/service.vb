...
Namespace Microsoft.ServiceModel.Samples
    ...
    Public Class CalculatorService
        ...
        Const ppidClaimType As String = "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/privatepersonalidentifier"
        Public Function GetIdentity() As String Implements ISecureCalculator.GetIdentity
            ...
            For Each claimSet As ClaimSet In ctx.ClaimSets
                ...
                For Each claim As Claim In claimSet.FindClaims(ppidClaimType, Nothing)

                    identity += TryCast(claim.Resource, String)
                Next
