...
Namespace Microsoft.ServiceModel.Samples
    ...
    Public Class RequestSecurityToken
        ...
        Private m_requestType As String ' Tracks the request type (for example, Issue, Renew, Cancel).        		
        ...
        Public Sub New()
            ...
            Me.New([String].Empty, [String].Empty, [String].Empty, 0, Constants.Trust.KeyTypes.Symmetric, Nothing, _
             Nothing, Nothing)
        ...
        Public Function IsProofKeyAsymmetric() As Boolean
            ...
            Return Constants.Trust.KeyTypes.[Public] = m_keyType
        ...
        Private Shared Function ProcessRequestSecurityTokenElement(ByVal xr As XmlReader) As RequestSecurityToken
            ...
            Dim keyType As String = Constants.Trust.KeyTypes.Symmetric
            ...
            While xr.Read()
                ...
                If XmlNodeType.Element = xr.NodeType Then
                    ...
                    If Constants.Trust.NamespaceUri = xr.NamespaceURI Then
                        ...
                        If Constants.Trust.Elements.RequestType = xr.LocalName AndAlso Not xr.IsEmptyElement Then

                            xr.Read()
                            requestType = xr.ReadContentAsString()

                        ElseIf Constants.Trust.Elements.TokenType = xr.LocalName AndAlso Not xr.IsEmptyElement Then
                        ...
                        ElseIf Constants.Trust.Elements.KeyType = xr.LocalName AndAlso Not xr.IsEmptyElement Then
            ...
            Return New RequestSecurityToken(context, tokenType, requestType, keySize, keyType, proofKey, _
             entropy, appliesTo)
