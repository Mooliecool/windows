...
Namespace Microsoft.ServiceModel.Samples
    ...
    Class Client
        ...
        Private Shared Sub DemonstrateProblemUsingCanThrow()
            ...
            Try
                ...
                ' Create a new client.
                Using client As New CalculatorClient()
        ...
        Private Shared Sub DemonstrateProblemUsingCanThrowAndMask()
            ...
            Try
                ...
                Using client As New CalculatorClient()
                    ...
                    ' "using" block sees it.
                    Throw New ObjectDisposedException("Hope this Exception wasn't important, because " + "it might be masked by the Close Exception.")
        ...
        Private Shared Sub DemonstrateCleanupWithExceptions()
            ...
            Try
                ...
                Dim addValue As Double = client.Add(0, 0)
                ...
                Dim divideValue As Double = client.Divide(0, 0)
