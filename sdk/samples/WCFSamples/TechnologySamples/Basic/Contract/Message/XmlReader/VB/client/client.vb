    ...
    Class Client
        ...
        Public Shared Sub Main()
            ...
            Using New OperationContextScope(client.InnerChannel)
                Dim request As Message = Message.CreateMessage(OperationContext.Current.OutgoingMessageHeaders.MessageVersion, _
                    "http://Microsoft.ServiceModel.Samples/ICalculator/Sum", values)

                Dim reply As Message = client.Sum(request)

                Dim sum As Integer = reply.GetBody(Of Integer)()
