...
Set typedServiceMoniker = GetObject("service:address=http://localhost/ServiceModelSamples/service.svc, binding=wsHttpBinding, contract={9213C6D2-5A6F-3D26-839B-3BA9B82228D3}")
...
wsdlMonikerString = "service:address='http://localhost/ServiceModelSamples/service.svc'"
...
mexMonikerString = "service:mexAddress='http://localhost/servicemodelsamples/service.svc/mex'"
