...
echo granting permissions for non-administrative user to the database
Osql -S %COMPUTERNAME%\SQLExpress -E -d Tracking -Q "sp_grantlogin 'XMLAB\oleuser'"
Osql -S %COMPUTERNAME%\SQLExpress -E -d Tracking -Q "sp_grantdbaccess 'XMLAB\oleuser'"
Osql -S %COMPUTERNAME%\SQLExpress -E -d Tracking -Q "sp_addrolemember 'db_owner', 'XMLAB\oleuser'"
