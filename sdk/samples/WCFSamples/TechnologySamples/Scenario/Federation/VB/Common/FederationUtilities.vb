...
Namespace Microsoft.ServiceModel.Samples.Federation
    ...
    Public NotInheritable Class FederationUtilities
        ...
        Private Shared Function LookupCertificate(ByVal storeName As StoreName, ByVal storeLocation As StoreLocation, ByVal subjectDistinguishedName As String) As X509Certificate2
