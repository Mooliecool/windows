...
#Region "CreateSamlToken()"
        ...
        Public Shared Function CreateSamlToken(ByVal stsName As String, ByVal proofToken As BinarySecretSecurityToken, ByVal issuerToken As SecurityToken, ByVal proofKeyEncryptionToken As SecurityToken, ByVal samlConditions As SamlConditions, ByVal samlAttributes As IEnumerable(Of SamlAttribute)) As SamlSecurityToken
