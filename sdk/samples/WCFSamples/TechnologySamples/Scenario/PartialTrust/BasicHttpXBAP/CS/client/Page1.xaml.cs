...
namespace Microsoft.PartialTrust.Samples
{
    public partial class Page1 : Page
    {
        ...
        protected override void OnInitialized(EventArgs e)
        {
            ...
            proxy = new CalcPlusClient(new BasicHttpBinding(), serviceAddress);
        ...
        // (the only place they are allowed to call by default). For example, if this applicaion was launched
        // from "http://deploymentMachine/app.application" and the URL baked into the proxy is for localhost,
        // then "http://localhost/foo.svc" becomes "http://deploymentMachine/foo.svc"
        static string GetUpdateLocationUrl()
        {
            ...
            // Update the service URL to use the update location host.
