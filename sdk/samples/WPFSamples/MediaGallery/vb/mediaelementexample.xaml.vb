...
Namespace SDKSample
    ...
    Partial Class MediaElementExample
        ...
        Public Sub ChangeMediaSpeedRatio(ByVal sender As Object, ByVal args As RoutedPropertyChangedEventArgs(Of Double))
            'myMediaElement.SpeedRatio = System.Convert.ToDouble(speedRatioSlider.Value)
        End Sub

        ' When the media opens, initialize the "Seek To" slider maximum value
        ' to the total number of miliseconds in the length of the media clip.
        Public Sub Element_MediaOpened(ByVal sender As Object, ByVal args As RoutedEventArgs)
