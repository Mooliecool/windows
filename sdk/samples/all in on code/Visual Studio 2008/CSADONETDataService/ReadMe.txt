========================================================================
     WEB APPLICATION : CSADONETDataService Project Overview
========================================================================

/////////////////////////////////////////////////////////////////////////////
Summary:

The CSADONETDataService example demonstrates the ADO.NET Data Services for 
...
according to the SQL Server database instancea and accout information in your 
system.
...
A. Creating an ordinary ASP.NET Web Application
   ...
   1. In Visual Studio 2008, add a new Visual C#/ Web / ASP.NET Web 
      Application project named CSADONETDataService.
   ...
   3. Creating the ADO.NET Data Service entity class for non-relational 
    ...
    4. Implementing the IUpdatable methods to enable the insert 
       ...
       6) Other IUpdatable methods can throw the NotImplementedException if 
          ...
          references in the source code of CSADONETDataService and 
