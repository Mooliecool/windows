========================================================================
    WIN32 APPLICATION : CppCreateLowIntegrityProcess Project Overview
========================================================================
...
you will get the application: CppCreateLowIntegrityProcess.exe. 
...
instance of the CppCreateLowIntegrityProcess application is launched, but 
...
get the integrity level of the current process. 
  ...
  1) Open the primary access token of the process with TOKEN_QUERY.
  
  2) Use GetTokenInformation to query the TokenIntegrityLevel information 
     from the primary access token.
