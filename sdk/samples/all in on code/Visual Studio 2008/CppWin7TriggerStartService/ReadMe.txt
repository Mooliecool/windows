========================================================================
    SERVICE APPLICATION : CppWin7TriggerStartService Project Overview
========================================================================
...
To build the CppWin7TriggerStartService project, you must have Microsoft 
Windows SDK for Windows 7 and the .NET Framework 3.5 Service Pack 1 installed.
...
you will get a service application: CppWin7TriggerStartService.exe. 
...
The service is successfully installed if the process outputs:
  ...
  CppWin7TriggerStartService Sample Service installed.
...
find "CppWin7TriggerStartService Sample Service" in the service list. You can 
verify the configuration of the service by entering the command below in a 
command prompt.

  CppWin7TriggerStartService.exe -query

It should output:

  CppWin7TriggerStartService Sample Service was installed.
...
CppWin7TriggerStartService Sample Service is trigger-started. Open Event 
Viewer, and navigate to Windows Logs / Application. You should be able to see 
two events from CppWin7TriggerStartService with event messages: "Enter 
...
command prompt running as administrator.
  ...
  CppWin7TriggerStartService.exe -remove

If the service is successfully stopped and removed, you would see this output:

  Stopping CppWin7TriggerStartService Sample Service.
  CppWin7TriggerStartService Sample Service stopped.
  CppWin7TriggerStartService Sample Service removed.
...
CppWin7TriggerStartService service is stopped at the moment. Plug in your 
...
Application project named CppWin7TriggerStartService. Unselect the 
