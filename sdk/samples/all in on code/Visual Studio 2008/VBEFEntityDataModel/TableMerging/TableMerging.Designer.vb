...
<Assembly: Global.System.Data.Objects.DataClasses.EdmSchemaAttribute("f917ce59-d128-4683-9996-8cdbc92c1a74")> 
Namespace VBEFEntityDataModel.TableMerging
    'Original file name:
    'Generation date: 2009-10-22 6:57:44
    '''<summary>
    '''There are no comments for EFTblMergeEntities in the schema.
    '''</summary>
    Partial Public Class EFTblMergeEntities
        ...
        '''</summary>
        Public Sub New()
            MyBase.New("name=EFTblMergeEntities", "EFTblMergeEntities")
            Me.OnContextCreated()
        End Sub
        '''<summary>
        ...
        Public Sub New(ByVal connectionString As String)
            MyBase.New(connectionString, "EFTblMergeEntities")
            Me.OnContextCreated()
        End Sub
        '''<summary>
        '''Initialize a new EFTblMergeEntities object.
        ...
        Public Sub New(ByVal connection As Global.System.Data.EntityClient.EntityConnection)
            MyBase.New(connection, "EFTblMergeEntities")
            Me.OnContextCreated()
        End Sub
    ...
    '''PersonID
    '''</KeyProperties>
    <Global.System.Data.Objects.DataClasses.EdmEntityTypeAttribute(NamespaceName:="EFTblMergeModel", Name:="Person"), _
