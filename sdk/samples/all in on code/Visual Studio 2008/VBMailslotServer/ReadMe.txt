=============================================================================
          CONSOLE APPLICATION : VBMailslotServer Project Overview
=============================================================================
...
Step1. After you successfully build the VBMailslotClient and VBMailslotServer 
sample projects in Visual Studio 2008, you will get the applications: 
VBMailslotClient.exe and VBMailslotServer.exe. 

Step2. Run VBMailslotServer.exe in a command prompt to start up the server 
...
Step3. Run VBMailslotClient.exe in another command prompt to start up the 
...
VBMailslotClient -> VBMailslotServer
VBMailslotServer creates the mailslot. VBMailslotClient opens the mailslot 
