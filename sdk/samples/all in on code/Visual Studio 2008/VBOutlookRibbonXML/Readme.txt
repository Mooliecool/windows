========================================================================
    OFFICE ADD-IN : VBOutlookRibbonXml Project Overview
========================================================================

/////////////////////////////////////////////////////////////////////////////
Use:

The VBOutlookRibbonXml provides the examples on how to customize Office UI 
...
2. Create a class that implements the 
   Microsoft.Office.Core.IRibbonExtensibility class. (See Ribbon.vb)
3. In Ribbon.vb implement the GetCustomUI (memeber of IRibbonExtensibility)
