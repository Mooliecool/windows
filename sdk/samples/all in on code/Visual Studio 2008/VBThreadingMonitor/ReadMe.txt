============================================================================
    Console Application : VBThreadingMonitor Project Overview
============================================================================
...
VB SyncLock keyword and the Pulse method of the Monitor object. The Pulse 
method notifies a thread in the waiting queue of a change in the object's 
state (for more details on pulses, see the Monitor.Pulse Method). 
