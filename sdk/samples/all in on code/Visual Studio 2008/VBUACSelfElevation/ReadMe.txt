=============================================================================
          APPLICATION : VBUACSelfElevation Project Overview
=============================================================================
...
you will get an application: VBUACSelfElevation.exe. 
...
Step1. Create a new Visual Basic Windows Forms project named 
VBUACSelfElevation.
...
signatures are defined in NativeMethod.vb.

In the Load event of the main form, check and display the "run as 
...
To configure the elevation level in this Visual Basic Windows Forms project, 
open the project's properties, turn to the Application tab, and click the 
"View UAC Settings" button. This creates an app.manifest file and configures 
the project to embed the manifest. You can find the "app.manifest" file in 
the "My Project" folder of the VB.NET project. The file has the following 
content by default.
