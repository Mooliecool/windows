========================================================================
  ASP.NET APPLICATION :  CSASPNETSerializeJsonString Project Overview
========================================================================
...
Open the CSASPNETSerializeJsonString.sln directly, expand the web application 
...
Step 1.  Create a C# ASP.NET Empty Web Application in Visual Studio 2010.

Step 2.  Add a C# class file which named 'Book' in Visual Studio 2010, declare
