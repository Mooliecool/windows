================================================================================
				Windows APPLICATION: CSCustomCodeAnalysisRule                        
===============================================================================
/////////////////////////////////////////////////////////////////////////////
Summary:
...
1. Copy CSCustomCodeAnalysisRule.dll to
...
2. Copy CSCustomCodeAnalysisRule.ruleset to 
C:\Program Files (x86)\Microsoft Visual Studio 10.0\Team Tools\Static Analysis Tools\
...
Uninstall CSCustomCodeAnalysisRuleSetup.msi, the output of the CSCustomCodeAnalysisRuleSetup
setup project. 
...
Step4. Open another VS2010 instance, create a C# class library project TestCA.csproj, 
       add following class.
	       ...
	       public class ClassA
           {
               ...
               public int wrongPropertyName { get; set; }
               public int RightPropertyName { get; set; }
	       
               public void wrongMethodName() { }
               public void RightMethodName() { }
           }
...
named "CSCustomCodeAnalysisRule". 
...
public ProblemCollection Check(Member member) to check the members.
    ...
    sealed class PropertyNamingRule : BaseIntrospectionRule
    {
        public PropertyNamingRule()
            : base( "PropertyNamingRule", "CSCustomCodeAnalysisRule.Rules",
...
<RuleSet Name="CSCustomCodeAnalysisRule" Description=" " ToolsVersion="10.0">
...
E. Deploying the Rule with a setup project.
  ...
  4 Create folder "Microsoft Visual Studio 10.0\Team Tools\Static Analysis Tools\FxCop\Rules"
    under Program Files Folder. Add CSCustomCodeAnalysisRule.ruleset to the folder.
