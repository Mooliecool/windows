...
[assembly: EdmRelationshipAttribute("FKAssociationModel", "FK_Course_Department", "Department", System.Data.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, typeof(CSEFForeignKeyAssociation.FKAssociation.Department), "Course", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(CSEFForeignKeyAssociation.FKAssociation.Course), true)]
...
namespace CSEFForeignKeyAssociation.FKAssociation
{
    ...
    /// </summary>
    public partial class FKAssociationEntities : ObjectContext
    {
        #region Constructors
        ...
        /// </summary>
        public FKAssociationEntities() : base("name=FKAssociationEntities", "FKAssociationEntities")
        {
        ...
        /// </summary>
        public FKAssociationEntities(string connectionString) : base(connectionString, "FKAssociationEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new FKAssociationEntities object.
        /// </summary>
        public FKAssociationEntities(EntityConnection connection) : base(connection, "FKAssociationEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    public partial class Course : EntityObject
    {
        ...
        public Department Department
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Department>("FKAssociationModel.FK_Course_Department", "Department").Value;
            }
            set
            {
                ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Department>("FKAssociationModel.FK_Course_Department", "Department").Value = value;
            }
        }
        /// <summary>
        /// No Metadata Documentation available.
        ...
        public EntityReference<Department> DepartmentReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Department>("FKAssociationModel.FK_Course_Department", "Department");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<Department>("FKAssociationModel.FK_Course_Department", "Department", value);
                }
            }
        }
    ...
    public partial class Department : EntityObject
    {
        ...
        public EntityCollection<Course> Courses
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Course>("FKAssociationModel.FK_Course_Department", "Course");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Course>("FKAssociationModel.FK_Course_Department", "Course", value);
                }
            }
        }
