...
[assembly: EdmRelationshipAttribute("IndependentAssociationModel", "FK_Course_Department", "Department", System.Data.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, typeof(CSEFForeignKeyAssociation.IndependentAssociation.Department), "Course", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(CSEFForeignKeyAssociation.IndependentAssociation.Course))]
...
namespace CSEFForeignKeyAssociation.IndependentAssociation
{
    ...
    /// </summary>
    public partial class IndependentAssociationEntities : ObjectContext
    {
        #region Constructors
        ...
        /// </summary>
        public IndependentAssociationEntities() : base("name=IndependentAssociationEntities", "IndependentAssociationEntities")
        {
        ...
        /// </summary>
        public IndependentAssociationEntities(string connectionString) : base(connectionString, "IndependentAssociationEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new IndependentAssociationEntities object.
        /// </summary>
        public IndependentAssociationEntities(EntityConnection connection) : base(connection, "IndependentAssociationEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    public partial class Course : EntityObject
    {
        ...
        public Department Department
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Department>("IndependentAssociationModel.FK_Course_Department", "Department").Value;
            }
            set
            {
                ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Department>("IndependentAssociationModel.FK_Course_Department", "Department").Value = value;
            }
        }
        /// <summary>
        /// No Metadata Documentation available.
        ...
        public EntityReference<Department> DepartmentReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Department>("IndependentAssociationModel.FK_Course_Department", "Department");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<Department>("IndependentAssociationModel.FK_Course_Department", "Department", value);
                }
            }
        }
    ...
    public partial class Department : EntityObject
    {
        ...
        public EntityCollection<Course> Courses
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Course>("IndependentAssociationModel.FK_Course_Department", "Course");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Course>("IndependentAssociationModel.FK_Course_Department", "Course", value);
                }
            }
        }
