========================================================================
                 VBASPNETHTMLEditorExtender Overview
========================================================================
...
Step 1: Open the VBASPNETHTMLEditorExtender.sln.
...
Step 2.  Create a VB.NET "Class Library" project in Visual Studio 2010 or
...
Step 10.  Create a new class file, I call it H1.vb, in the  ToolBar_buttons folder.

Step 11. Write the codes to register server side class for the button. Refer to 
         sample file H1.vb.

Step 12. Create a new class in the root of the project, I call it MyEditor.vb.
...
Step 14. Create a new VB.NET ASP.NET Web Application, change the name to TestWebSite.
