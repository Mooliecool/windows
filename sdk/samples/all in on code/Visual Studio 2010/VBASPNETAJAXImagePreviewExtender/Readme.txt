========================================================================
              VBASPNETImagePreviewExtender Overview
========================================================================
...
Open the VBASPNETImagePreviewExtender.sln directly and open the 
...
Step 2: When the page load, the pictures are all in thumbnail mode, it looks
small. Click on each image.

Step 3: When click on one image which using the extender, you will see a big
...
Step 2. We can see three files created. one .JS file, one .VB and 
	one .RESX file. Delete the .RESX file, we don't need that here.
	Rename the js file to ImagePreviewBehavior.js.
	Rename the vb file to ImagePreviewControl.vb.

Step 3.  Open the ImagePreviewControl.vb.
	...
	[Code]
	Dim descriptor As New ScriptBehaviorDescriptor(
