<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ShowMe.aspx.vb" Inherits="VBASPNETEmbedLanguageInUrl._Default" %>
...
<body>
    ...
    <br />
    <br />
    <asp:Literal ID="litComment" runat="server" Text='<%$ Resources:Resource,Comment %>'></asp:Literal>
