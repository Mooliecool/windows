========================================================================
                 VBASPNETFileUploadStatus Overview
========================================================================
...
Step 1.  Create a Visual Basic Code Project in Visual Studio 2010 or Visual Web
Developer 2010. Name it as UploadStatus.

Step 2.  Add the two references into the project, System.Web.Extension and 
System.Web.

Step 3.  Copy the code from the UploadStatus.vb from the sample folder, 
"FileUploadStatus".
...
Step 6.  Also create the files: BinaryHelper.vb, UploadFile.vb, 
UploadFileCollection.vb and FileUploadDataManager.vb, and copy the codes.
