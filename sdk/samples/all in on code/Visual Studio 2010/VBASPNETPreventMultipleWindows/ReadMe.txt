========================================================================
            VBASPNETPreventMultipleWindows Overview
========================================================================
...
Step 1: Open the VBASPNETPreventMultipleWindows.sln.

Step 2: Expand the VBASPNETPreventMultipleWindows web application and press 
...
Step 1. Create a VB "ASP.NET Empty Web Application" in Visual Studio 2010 or
        Visual Web Developer 2010. Name it as "VBASPNETPreventMultipleWindows".
...
Step 4. Move DefaultPage.ascx user control on Default.aspx file and move
		...
		In Defalut.aspx.vb page, we have a method generate unique random number:
		[code]
