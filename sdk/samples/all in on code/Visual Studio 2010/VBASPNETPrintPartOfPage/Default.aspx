<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Default.aspx.vb" Inherits="VBASPNETPrintPartOfPage._Default" %>
...
<%= PrintImageBegin%>
    <asp:Image ID="Image1" runat="server" ImageUrl="~/image/microsoft.jpg" />
<%= PrintImageEnd%>
<%= PrintListBegin%>
<table border="0" width="90%">
<tr>
