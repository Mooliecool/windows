...
' if Session value has been change by Web Site 1 or not.
' 
...
Public Class _Default
    ...
    Protected Sub btnSetSession_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSetSession.Click
        ' Set Session in Web Site 2.
        Session("MySession") = "The Session content from Site2."
    End Sub
End Class