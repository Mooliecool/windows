    ...
    internal class SafeNativeMethods {
        ...
        internal class Gdip {
            ...
            private static void Initialize() {
                ...
                Debug.Assert(initToken == IntPtr.Zero, "GdiplusInitialization: Initialize should not be called more than once in the same domain!");
...
//        TA_TOP        = 0,
        ...
        */
        ...
        // Code that uses this function has IntSecurity.DemandReadFileIO(filename) applied.
...
*/
        ...
        */
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public static IntPtr LoadIcon(HandleRef hInst, int iconId) { // we only use the case were the low word of the IntPtr is used a resource id but it still has to be an intptr
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public static int LoadIconWithScaleDown(HandleRef hInst, int iconId, int cx, int cy, ref IntPtr phico) { // we only use the case were the low word of the IntPtr is used a resource id but it still has to be an intptr
