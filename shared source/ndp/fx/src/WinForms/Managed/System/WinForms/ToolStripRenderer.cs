...
namespace System.Windows.Forms {
    ...
    public abstract class ToolStripRenderer {
        ...
        private static int Offset3X = 3;
        private static int Offset1Y = 1;
        private static int Offset2Y = 2;
        private static int Offset4Y = 4;
...
#region EventHandlerSecurity
      ...
      /// -----------------------------------------------------------------------------
       ...
       public static Image CreateDisabledImage(Image normalImage) {
        ...
        private static void ScaleArrowOffsetsIfNeeded() {
            ...
            if (DpiHelper.IsScalingRequired) {
                ...
                Offset3X = DpiHelper.LogicalToDeviceUnitsX(3);
                Offset1Y = DpiHelper.LogicalToDeviceUnitsY(1);
                Offset2Y = DpiHelper.LogicalToDeviceUnitsY(2);
                Offset4Y = DpiHelper.LogicalToDeviceUnitsY(4);
            }
