...
namespace System.Management
{
    ...
    public class EnumerationOptions : ManagementOptions
    {
        ...
        /// <param name=' returnImmediatley'><see langword='true'/> to specify whether the operation should return immediately (semi-[....]) or block until all results are available; otherwise, <see langword='false'/> .</param>
