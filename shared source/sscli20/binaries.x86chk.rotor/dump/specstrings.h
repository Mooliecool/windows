...
#define __deref_out_z_opt                                       __post __deref __valid __refparam __exceptthat __maybenull __post __deref __nullterminated
...
#define __out_awcount(expr,size)            __pre __notnull \
                                            ...
                                            __precond(!(expr)) __elem_writableTo(size) \
