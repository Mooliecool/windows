...
#define IA64_FIRST_ARG(x)
#define IA64_ARG(x)
#define IA64_ONLY(x)
#define NOT_IA64(x)         x
#define NOT_IA64_ARG(x)     , x
...
// PREFAST macros BEGIN
//
//
// Use the following macro to suppress a prefast warning message. 
// Usage:
//       #ifndef FEATURE_PAL
//       #pragma PREFAST_SUPPRESS(6321, "blah")
//       #endif  
//       hMscoree = LoadLibraryA("mscoree.dll");
    #define PREFAST_SUPPRESS(_wrnNum_, _wrnMsg_)  comment(user, "dummy message for prefast suppress")
