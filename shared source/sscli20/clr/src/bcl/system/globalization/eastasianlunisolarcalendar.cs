        ...
        public int GetCelestialStem(int sexagenaryYear) {
            if ((sexagenaryYear < 1) || (sexagenaryYear > 60)) {
                throw new ArgumentOutOfRangeException(
                                "sexagenaryYear",
                                String.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("ArgumentOutOfRange_Range"), 1, 60));
            }
        ...
        internal int CheckYearRange(int year, int era) {
         ...
         year = GetGregorianYear(year, era);
            ...
            if ((year < MinCalendarYear) || (year > MaxCalendarYear)) {
                throw new ArgumentOutOfRangeException(
                                "year",
                                String.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("ArgumentOutOfRange_Range"), MinEraCalendarYear(era), MaxEraCalendarYear(era)));
            }
            return year;
        }
        ...
        public override int TwoDigitYearMax {
            ...
            set {
                ...
                if (value < 99 || value > MaxCalendarYear) {
                    throw new ArgumentOutOfRangeException(
                                "value",
                                String.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("ArgumentOutOfRange_Range"), 99, MaxCalendarYear));
                }
