...
[System.Runtime.InteropServices.ComVisible(true)]
    public sealed class SoapNormalizedString : ISoapXsd
    {
        ...
        private String Validate(String value)
        {
            ...
            if (index > -1)
                throw new RemotingException(String.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Remoting_SOAPInteropxsdInvalid"), "xsd:normalizedString", value));
...
[System.Runtime.InteropServices.ComVisible(true)]
    public sealed class SoapToken : ISoapXsd
    {
        ...
        private String Validate(String value)
        {
            ...
            if (index > -1)
                throw new RemotingException(String.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Remoting_SOAPInteropxsdInvalid"), "xsd:token", value));
