    ...
    internal sealed class ObjectReader
    {
        ...
        {       
            ...
            else if (pr.PRarrayTypeEnum == InternalArrayTypeE.Rectangular)
            {
                ...
                throw new SerializationException(String.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Serialization_ArrayType"),((Enum)pr.PRarrayTypeEnum)));                               
        ...
        private void ParseArrayMember(ParseRecord pr)
        {
            ...
            else if (pr.PRmemberValueEnum == InternalMemberValueE.Nested)
            {
                ...
                if (objectPr.PRarrayElementType != null) {
                ...
                if (bSimpleAssembly)
                {
                    try {
                          ...
                          try {
                              ...
                              assm = Assembly.LoadWithPartialNameInternal(assemblyName, null, ref stackMark);
                              if (assm == null && assemblyName != null)
                                  assm = Assembly.LoadWithPartialNameInternal(new AssemblyName(assemblyName).Name, null, ref stackMark);
                          }
                          finally {
