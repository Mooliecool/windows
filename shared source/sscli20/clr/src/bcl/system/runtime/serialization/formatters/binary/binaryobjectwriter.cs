...
{    
    ...
    internal sealed  class ObjectWriter
    {
                                 ...
                                 )
        {
            ...
            if (memberType == Converter.typeofObject || Nullable.GetUnderlyingType(memberType) != null)
            {
        ...
        private void WriteArray(WriteObjectInfo objectInfo, NameInfo memberNameInfo, WriteObjectInfo memberObjectInfo)          
        {
            ...
            if (arrayElemType == Converter.typeofObject || Nullable.GetUnderlyingType(arrayElemType) != null)
            {
                memberNameInfo.NItransmitTypeOnMember = true;
        ...
        private Object GetNext(out long objID)
        {
            ...
            if (isNew)
            {
                ...
                throw new SerializationException(String.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Serialization_ObjNoID"),realObj));                                                    
            }
