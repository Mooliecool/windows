    ...
    public class ObjectManager {
        ...
        **            not null.
        ...
        private bool GetCompletionInfo(FixupHolder fixup, out ObjectHolder holder, out Object member, bool bThrowIfMissing) {
            ...
            if (holder==null || holder.IsIncompleteObjectReference || holder.HasSurrogate || holder.ObjectValue==null) {
                if (bThrowIfMissing) {
        ...
        **Exceptions: None.
        ...
        private void DoNewlyRegisteredObjectFixups(ObjectHolder holder) {
            ...
            if (holder.IsIncompleteObjectReference || holder.HasSurrogate) {
        ...
        public virtual Object GetObject(long objectID) {
            ...
            if (holder==null || (holder.IsIncompleteObjectReference || holder.HasSurrogate)) { 
