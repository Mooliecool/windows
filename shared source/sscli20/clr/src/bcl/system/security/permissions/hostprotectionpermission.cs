...
namespace System.Security.Permissions
{
    ...
    [System.Runtime.InteropServices.ComVisible(true)]
    [Serializable()] sealed public class HostProtectionAttribute : CodeAccessSecurityAttribute
    {
...
[System.Runtime.InteropServices.ComVisible(true)]
    ...
    sealed internal class HostProtectionPermission : CodeAccessPermission, IUnrestrictedPermission, IBuiltInPermission
    {
        ...
        internal static HostProtectionResource protectedResources = HostProtectionResource.None;
        ...
        public HostProtectionResource Resources
        {
            set
            {
                if(value < HostProtectionResource.None || value > HostProtectionResource.All)
                    throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Arg_EnumIllegalVal"), (int)value));
                m_resources = value;
            }
