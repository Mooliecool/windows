    ...
    **
    ...
    internal sealed class GB18030Encoding : DBCSCodePageEncoding, ISerializable
    {
                                          ...
                                          base(GB18030, 936)
        {
            ...
            BCLDebug.Assert(info!=null, "[GB18030Encoding(Serialization...)] Expected null info to throw");
        ...
        void ISerializable.GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            BCLDebug.Assert(info!=null, "[GB18030.GetObjectData] Expected null info to throw");
        ...
        protected override unsafe void LoadManagedCodePage()
        {
            ...
            for (int index = 0; index < tableUnicodeToGBDiffs.Length; index++)
            {
                ...
                else
                {
                    ...
                    while (data > 0)
                    {
                        BCLDebug.Assert(count4Byte <= GBLast4ByteCode,
            ...
            BCLDebug.Assert(unicodeCount == 0,
            ...
            BCLDebug.Assert(count4Byte == GBLast4ByteCode + 1,
