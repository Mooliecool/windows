...
namespace System.Text
{
    ...
    internal class ISCIIEncoding : EncodingNLS, ISerializable
    {
        ...
        public ISCIIEncoding(int codePage) : base(codePage)
        {
            ...
            BCLDebug.Assert(defaultCodePage >= CodeDevanagari && defaultCodePage <= CodePunjabi,
        ...
        {
            BCLDebug.Assert(false, "Didn't expect to make it to ISCIIEncoding serialization constructor");
        ...
        void ISerializable.GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            BCLDebug.Assert(info!=null, "[ISCIIEncoding.GetObjectData] Expected null info to throw");
