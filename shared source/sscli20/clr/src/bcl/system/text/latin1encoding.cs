...
namespace System.Text
{
    ...
    //
    [Serializable()] internal class Latin1Encoding : EncodingNLS, ISerializable
    {
        ...
        void ISerializable.GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            BCLDebug.Assert(info!=null, "[Latin1Encoding.GetObjectData] Expected null info to throw");

            info.AddValue("CodePageEncoding+maxCharSize", 1);

            info.AddValue("CodePageEncoding+m_codePage", this.CodePage);
            info.AddValue("CodePageEncoding+dataItem", (CodePageDataItem)null);
        }
