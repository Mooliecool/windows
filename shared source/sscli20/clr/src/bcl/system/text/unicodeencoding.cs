...
#region Serialization 
        ...
        internal override void SetDefaultFallbacks()
        {
            ...
            else
            {
                ...
                this.decoderFallback = new DecoderReplacementFallback(String.Empty);
            }
        }
        ...
        {
            BCLDebug.Assert(chars!=null, "[UnicodeEncoding.GetByteCount]chars!=null");
            BCLDebug.Assert(count >= 0, "[UnicodeEncoding.GetByteCount]count >=0");
            ...
            while (((ch = (fallbackBuffer == null) ? (char)0 :fallbackBuffer.InternalGetNextChar()) != 0) || chars < charEnd)
            {
                ...
                if (ch == 0)
                {
                          ...
                          charLeftOver == 0 && (unchecked((int)chars) & 3) == 0)
                    {
                        ...
                        {
                            if (((ulong)(0x8000800080008000) & *longChars) != 0)
                            {
                                ...
                                ulong uTemp = (0xd800d800d800d800 & *longChars) ^ 0xd800d800d800d800;
...
#if BIGENDIAN
                                    if (((0xdc00dc00dc00dc00 & *longChars) ^ 0xd800dc00d800dc00) != 0)
#else
                                    if (((0xdc00dc00dc00dc00 & *longChars) ^ 0xdc00d800dc00d800) != 0)
#endif
                                    {
        ...
        {
            BCLDebug.Assert(chars!=null, "[UnicodeEncoding.GetBytes]chars!=null");
            BCLDebug.Assert(byteCount >=0, "[UnicodeEncoding.GetBytes]byteCount >=0");
            BCLDebug.Assert(charCount >=0, "[UnicodeEncoding.GetBytes]charCount >=0");
            BCLDebug.Assert(bytes!=null, "[UnicodeEncoding.GetBytes]bytes!=null");
            ...
            BCLDebug.Assert((encoder != null && !encoder.MustFlush) || charLeftOver == (char)0,
        ...
        {
            BCLDebug.Assert(bytes!=null, "[UnicodeEncoding.GetCharCount]bytes!=null");
            BCLDebug.Assert(count >= 0, "[UnicodeEncoding.GetCharCount]count >=0");
            ...
            if (decoder != null)
            {
                ...
                // (don't have to check m_throwOnOverflow for count)
                BCLDebug.Assert(!decoder.InternalHasFallbackBuffer || decoder.FallbackBuffer.Remaining == 0,
            ...
            while (bytes < byteEnd)
            {
                    ...
                    lastByte == -1 && lastChar == 0)
                {
                    ...
                    {
                        if (((ulong)(0x8000800080008000) & *longBytes) != 0)
                        {
                            // See if all 4 of those are bad...
                            // Surrogate pairs are "backwards" for little endian machines read in as one
                            // Mask off surrogate bits
                            ulong uTemp = (0xd800d800d800d800 & *longBytes) ^ 0xd800d800d800d800;
                                ...
                                (uTemp & 0x000000000000FFFF) == 0)
                            {
                                // Does it happen to have 4 good surrogates?
#if BIGENDIAN
                                if (((0xdc00dc00dc00dc00 & *longBytes) ^ 0xd800dc00d800dc00) != 0)
#else
                                if (((0xdc00dc00dc00dc00 & *longBytes) ^ 0xdc00d800dc00d800) != 0)
#endif // BIGENDIAN
                                {
                                    // If it wasn't 4 good surrogates then fall through to slow loop
                                    break;
        ...
        {
            BCLDebug.Assert(chars!=null, "[UnicodeEncoding.GetChars]chars!=null");
            BCLDebug.Assert(byteCount >=0, "[UnicodeEncoding.GetChars]byteCount >=0");
            BCLDebug.Assert(charCount >=0, "[UnicodeEncoding.GetChars]charCount >=0");
            BCLDebug.Assert(bytes!=null, "[UnicodeEncoding.GetChars]bytes!=null");
                    ...
                    if (ch <= 0xdbff)
                    {
                        ...
                        if (lastChar > 0)
                        {
                            ...
                            if (!fallbackBuffer.InternalFallback(byteBuffer, bytes, ref chars))
                            {
                                ...
                                BCLDebug.Assert(bytes >= byteStart + 2 || chars == charStart,
            ...
            if (decoder != null)
            {
                BCLDebug.Assert((decoder.MustFlush == false) || ((lastChar == (char)0) && (lastByte == -1)),
