...
{L"unicodeFFFE", 1201},             // Big Endian, BOM seems backwards, think of the BOM in little endian order.
{L"us", 20127}, 
{L"us-ascii", 20127}, 
{L"utf-16", 1200}, 
{L"UTF-16BE", 1201}, 
...
// People get confused about the FFFE here.  We can't change this because it'd break existing apps.
// This has been this way for a long time, including in Mlang.
{  1201,  1200, L"unicodeFFFE", L"unicodeFFFE", L"unicodeFFFE", 0}, // Big Endian, BOM seems backwards, think of the BOM in little endian order.
...
{ 12000,  1200, L"utf-32", L"utf-32", L"utf-32", 0}, // "Unicode (UTF-32)"
{ 12001,  1200, L"utf-32BE", L"utf-32BE", L"utf-32BE", 0}, // "Unicode (UTF-32 Big Endian)"
...
{ 28603,  1257, L"iso-8859-13", L"iso-8859-13", L"iso-8859-13", MIMECONTF_MAILNEWS | MIMECONTF_SAVABLE_MAILNEWS}, // "Estonian (ISO)"
