    ...
    PJAMO_SORT_INFOEX pSortResult)     // new sort sequence information    
{
    CONTRACTL {
        ...
        GC_NOTRIGGER;
        MODE_COOPERATIVE;
        PRECONDITION(CheckPointer(pSort));
        PRECONDITION(CheckPointer(pSortResult));
    } CONTRACTL_END;
    //
    ...
    )
{
    CONTRACTL {
        ...
        GC_NOTRIGGER;
        MODE_COOPERATIVE;
        PRECONDITION(CheckPointer(ppString));
        PRECONDITION(CheckPointer(pCount));
        PRECONDITION(CheckPointer(JamoSortInfo));
    } CONTRACTL_END;
    ...
    PJAMO_COMPOSE_STATE pSearchEnd = NULL;
    ...
    )
{
    CONTRACTL {
        ...
        PRECONDITION(CheckPointer(pUW));
        PRECONDITION(CheckPointer(pXW));
    } CONTRACTL_END;
    ...
    ZeroMemory(&JamoSortInfo, sizeof(JamoSortInfo));
