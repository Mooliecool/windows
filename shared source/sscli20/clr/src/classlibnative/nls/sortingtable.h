...
//            Most of the locales use the default sortkey table.
//
//            However, there are many locales which have different sortkey tables.
//            For these cutlures, we store the 'delta' information to the default sortkey
//            table.  We call this 'delta' information 'exceptions'.
//   
...
class NativeCompareInfo {
    public:    
        ...
        BOOL IsSortable(LPCWSTR pString, int nStringLen);
    ...
    private:
        ...
        LPCWSTR SkipUnsortable(LPCWSTR pStr, LPCWSTR pStrEnd, BOOL fIgnoreNonSpace, BOOL fIgnoreSymbols);
...
#define UNICODE_WT(pwt)           ( (((PSORTKEY)(pwt))->UW.Unicode) )

#define GET_DIACRITIC(pwt)        ( (((PSORTKEY)(pwt))->Diacritic) )

#define GET_CASE(pwt)             ( (BYTE)((((PSORTKEY)(pwt))->Case) & CASE_MASK) )

#define CASE_WT(pwt)              ( (((PSORTKEY)(pwt))->Case) )

#define GET_COMPRESSION(pwt)      ( (BYTE)((((PSORTKEY)(pwt))->Case) & COMPRESS_3_MASK) )

#define GET_EXPAND_INDEX(pwt)     ( (((PSORTKEY)(pwt))->UW.SM_AW.Alpha) )

#define GET_SPECIAL_WEIGHT(pwt)   ( (((PSORTKEY)(pwt))->UW.Unicode) )

//  position returned is backwards - byte reversal
#define GET_POSITION_SW(pos)      ( (WORD)(((pos) << 2) | SW_POSITION_MASK) )


#define GET_WT_FOUR(pwt)          ( (((PEXTRA_WT)(pwt))->Four) )
#define GET_WT_FIVE(pwt)          ( (((PEXTRA_WT)(pwt))->Five) )
#define GET_WT_SIX(pwt)           ( (((PEXTRA_WT)(pwt))->Six) )
#define GET_WT_SEVEN(pwt)         ( (((PEXTRA_WT)(pwt))->Seven) )
...
*/
    ...
    private:
        static const BYTE       pXWDrop[];        
        static const BYTE       pXWSeparator[];        

		SortingTable*	  m_pSortingFile;    
};

#endif  // _SORTING_TABLE_H
