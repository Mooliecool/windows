...
// this needs to match maxAlign in blobfetcher.h to really mean anything, 
// otherwise ngen can't really guarentee alignments up to maxAlign
//#define TEXT6_ALIGN 32
#define TEXT6_ALIGN 16
...
private:
    ...
    PEWriterSection **PEWriter::getSectStart() {
        return (PEWriterSection**)sectStart;
    }

    PEWriterSection **PEWriter::getSectCur() {
        return (PEWriterSection**)sectCur;
    }

    COUNT_T PEWriter::getSectCount() {
