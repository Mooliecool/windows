...
//*****************************************************************************
static const BYTE ExeMainX86Template[] =
{
...
static const BYTE DllMainX86Template[] = 
{
...
// fixed up by the loader when the image is paged in.
//*****************************************************************************
static const BYTE ExeMainAMD64Template[] =
{
	// Jump through IAT to _CorExeMain
...
static const BYTE DllMainAMD64Template[] = 
{
	// Jump through IAT to CorDllMain 
	0x48, 0xA1,				// rex.w rex.b mov rax,[following address]
...
//*****************************************************************************
static const BYTE ExeMainIA64Template[] =
{
    // ld8    r9  = [gp]    ;;
    // ld8    r10 = [r9],8
    // nop.i                ;;
...
static const BYTE DllMainIA64Template[] = 
{
    // ld8    r9  = [gp]    ;;
    // ld8    r10 = [r9],8
    // nop.i                ;;
