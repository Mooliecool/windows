...
#define emit_callinterface_new(interface_offset, vt_offset, hasReturnBuff) x86_callinterface_new(interface_offset, vt_offset)
#define emit_calli(hasReturnBuff) x86_calli
#define emit_call_stub(c) x86_call_stub(c)
#define emit_compute_interface_new(interface_offset, vt_offset, hasReturnBuff) x86_compute_interface_new(interface_offset, vt_offset)
#define emit_callnonvirt(ftnptr, hasReturnBuff, indirect) x86_callnonvirt(ftnptr, indirect)
#define emit_ldvtable_address(hint,offset) x86_emit_ldvtable_address(hint,offset)
#define emit_ldvtable_address_new(interface_offset, vt_offset) x86_emit_ldvtable_address_new(interface_offset, vt_offset)

/* stack operations */
#define emit_testTOS() x86_testTOS

/* moves between memory */
#define emit_LDIND_I8(unaligned)                  x86_load_indirect_qword()
...
#define x86_call_stub(c)				  	    \
{                                                                   \
    x86_mov_reg(x86DirTo, x86Big, x86_mod_ind(X86_EAX, X86_ECX));   \
    x86_call_memory_indirect(c);			            \
}
...
#define x86_emit_ldvtable_address_new(interface_offset, vt_offset) \
    _ASSERTE(inRegTOS); \
    x86_mov_reg(x86DirTo,x86Big, x86_mod_ind(X86_EAX, X86_EAX));                       \
    x86_mov_reg(x86DirTo,x86Big, x86_mod_ind_disp(X86_EAX, X86_EAX,offsetOfEEClass));                       \
    x86_mov_reg(x86DirTo,x86Big, x86_mod_ind_disp(X86_EAX, X86_EAX,offsetOfInterfaceTable));                \
...
#define x86_callinterface_new(interface_offset, vt_offset)                          \
    x86_mov_reg(x86DirTo,x86Big, x86_mod_ind(X86_EAX, X86_ECX));                       \
    x86_mov_reg(x86DirTo,x86Big, x86_mod_ind_disp(X86_EAX, X86_EAX,offsetOfEEClass));                       \
    x86_mov_reg(x86DirTo,x86Big, x86_mod_ind_disp(X86_EAX, X86_EAX,offsetOfInterfaceTable));                \
    x86_mov_reg(x86DirTo,x86Big, x86_mod_ind_disp(X86_EAX, X86_EAX,interface_offset));                       \
...
#define x86_compute_interface_new(interface_offset, vt_offset)                          \
    x86_mov_reg(x86DirTo,x86Big, x86_mod_ind(X86_EAX, X86_ECX));                        \
    x86_mov_reg(x86DirTo,x86Big, x86_mod_ind_disp(X86_EAX, X86_EAX,offsetOfEEClass));                       \
    x86_mov_reg(x86DirTo,x86Big, x86_mod_ind_disp(X86_EAX, X86_EAX,offsetOfInterfaceTable));                \
    x86_mov_reg(x86DirTo,x86Big, x86_mod_ind_disp(X86_EAX, X86_EAX,interface_offset));                       \
...
#define x86_callnonvirt(ftnptr, indirect)           \
...
#define emit_LDIND_R8(unaligned) \
...
#define emit_STIND_R8(unaligned)     \
    x86_FLT80(x86_mod_base_scale(x86_FPLoad80, X86_ESP, X86_NO_IDX_REG ,0)); \
    x86_mov_reg(x86DirTo, x86Big, \
...
#define emit_STIND_REV_R8(unaligned)     \
