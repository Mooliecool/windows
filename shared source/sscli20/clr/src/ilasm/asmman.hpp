...
class AsmMan
{
    ...
    AsmManComType*      GetComTypeByName(__in __nullterminated char* szComTypeName);
    mdToken             GetComTypeTokByName(__in __nullterminated char* szComTypeName);
