...
public:
    ...
    virtual unsigned getAll(char** ppch) = 0;
...
public:
    ...
    unsigned getAll(__in char **ppbuff)
    {
        *ppbuff = m_pStart;
        return m_pBS->length();
    };
...
public:
    ...
    unsigned getAll(__in char** pbuff)
    {
        *pbuff = m_pStart;
        return m_FileSize;
    }
...
public:
    ...
    unsigned getAll(__in char** pbuff) { return penv->in->getAll(pbuff); };
