...
public:
    ...
    CeeGenTokenMapper() : m_pIImport(0), m_cRefs(1), m_pIMapToken(NULL)  { LEAF_CONTRACT; }

//*****************************************************************************
// IUnknown implementation.  
//*****************************************************************************
    virtual ULONG __stdcall AddRef()
    {LEAF_CONTRACT;  return ++m_cRefs; }
...
//*****************************************************************************
    ...
    { LEAF_CONTRACT; return (MAX_TOKENMAP); }

    IUnknown *GetMapTokenIface() const
    { LEAF_CONTRACT; return ((IUnknown *) this); }
