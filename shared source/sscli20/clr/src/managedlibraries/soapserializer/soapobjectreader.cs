    ...
    internal sealed class ObjectReader
    {
        ...
        private void CheckSerializable(Type t)
        {
            if (!t.IsSerializable && !HasSurrogate(t))
                throw new SerializationException(String.Format(CultureInfo.CurrentCulture, SoapUtil.GetResourceString("Serialization_NonSerType"), 
                                                         t.FullName, t.Module.Assembly.FullName));
        }
        ...
        private void ParseArray(ParseRecord pr)
        {
            ...
            else if (pr.PRarrayTypeEnum == InternalArrayTypeE.Rectangular)
            {
                ...
                throw new SerializationException(String.Format(CultureInfo.CurrentCulture, SoapUtil.GetResourceString("Serialization_ArrayType"),((Enum)pr.PRarrayTypeEnum).ToString()));                               
        ...
        private void ParseMember(ParseRecord pr)
        {
            ...
            if ((pr.PRdtType == null) && objectPr.PRobjectInfo.isTyped)         
            {
                ...
                if (pr.PRdtType == null)
                    throw new SerializationException(String.Format(CultureInfo.CurrentCulture, SoapUtil.GetResourceString("Serialization_TypeResolved"), objectPr.PRnewObj+" "+pr.PRname));
...
#pragma warning disable 618
                          assm  = Assembly.LoadWithPartialName(assemblyString, null);
#pragma warning restore 618
                    ...
                    InternalST.Soap( this, "Error loading ",assemblyString, "Non-CLS Compliant Exception");
                }
            }
            else {
                try
        ...
        internal Type FastBindToType(String assemblyName, String typeName)
        {
            ...
            TypeNAssembly entry = typeCache.GetCachedValue(typeName) as TypeNAssembly;
