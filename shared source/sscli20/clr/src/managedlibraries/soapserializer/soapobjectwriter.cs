    ...
    internal sealed  class ObjectWriter
    {
            ...
            for (int i=0; i<headers.Length; i++)
            {
                ...
                else if (headers[i].Name.Equals("__MethodSignature"))
                {
                    ...
                    if (!(headers[i].Value is Type[]))
                        throw new SerializationException(String.Format(CultureInfo.CurrentCulture, SoapUtil.GetResourceString("Serialization_MethodSignature"), headerValueType));
                ...
                else
                {
                    ...
                    if ((headerValueType != null) && (code == InternalPrimitiveTypeE.Invalid))
                    {
                        ...
                        if (valueId == -1)
                        {
                            WriteObjectInfo objectInfo = WriteObjectInfo.Serialize(headers[i].Value, m_surrogates, m_context, serObjectInfoInit, m_formatterConverter, null, this);
        ...
        {       
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if (Nullable.GetUnderlyingType(memberTypes[i]) != null)
                            throw new SerializationException(String.Format(CultureInfo.CurrentCulture, SoapUtil.GetResourceString("Serialization_SoapNoGenericsSupport"), memberTypes[i]));
                        Type type = null;
        ...
        private void WriteArrayMember(WriteObjectInfo objectInfo, NameInfo arrayElemTypeNameInfo, Object data)
        {
            ...
            if (!WriteKnownValueClass(arrayElemTypeNameInfo, actualTypeInfo, data, false))
            {
                ...
                {
                    WriteObjectInfo newObjectInfo = WriteObjectInfo.Serialize(obj, m_surrogates, m_context, serObjectInfoInit, m_formatterConverter, null, this);
        ...
        private void WriteString(NameInfo memberNameInfo, NameInfo typeNameInfo, Object stringObject)
        {
            ...
            {
                WriteObjectRef(memberNameInfo, typeNameInfo, stringId);
            }
        }
