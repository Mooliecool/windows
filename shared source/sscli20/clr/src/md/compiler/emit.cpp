...
ErrExit:
    ...
    return hr;
} // STDMETHODIMP RegMeta::DefineMethod()
...
ErrExit:
    ...
    return hr;
} // STDMETHODIMP RegMeta::DefineMethodImpl()
...
ErrExit:
    ...
    END_ENTRYPOINT_NOTHROW;
    return hr;
} // STDMETHODIMP RegMeta::SetMethodImplFlags()
...
ErrExit:
    ...
    END_ENTRYPOINT_NOTHROW;
    return hr;
} // STDMETHODIMP RegMeta::SetFieldRVA()
...
ErrExit:
    ...
    END_ENTRYPOINT_NOTHROW;
    return hr;
} // STDMETHODIMP RegMeta::DefineTypeRefByName()
    ...
    mdTypeRef   *ptr)                   // [OUT] Put TypeRef token here.
{
    ...
    RegMeta     *pAssemImportRM = NULL;
    IMetaModelCommon *pAssemImportCommon = NULL;
    RegMeta     *pImportRM = NULL;
    IMetaModelCommon *pImportCommon = NULL;
    ...
    pAssemImportRM = static_cast<RegMeta*>(pAssemImport);
    pAssemImportCommon = pAssemImportRM ? static_cast<IMetaModelCommon*>(&pAssemImportRM->m_pStgdb->m_MiniMd) : 0;
    pImportRM = static_cast<RegMeta*>(pImport2);
    pImportCommon = static_cast<IMetaModelCommon*>(&pImportRM->m_pStgdb->m_MiniMd);
...
ErrExit:
    ...
    END_ENTRYPOINT_NOTHROW;
    return hr;
} // STDMETHODIMP RegMeta::DefineImportType()
...
ErrExit:
    ...
    END_ENTRYPOINT_NOTHROW;
    return hr;
} // STDMETHODIMP RegMeta::DefineMemberRef()
...
ErrExit:
    ...
    return hr;
} // STDMETHODIMP RegMeta::DefineImportMember()
...
ErrExit:
    return hr;        
} // STDMETHODIMP RegMeta::_SetFieldOffset()
...
ErrExit:
    ...
    return hr;
} // STDMETHODIMP RegMeta::_SetFieldMarshal()
...
ErrExit:
    ...
    return hr;
} // STDMETHODIMP RegMeta::GetTokenFromSig()
...
ErrExit:
    ...
    END_ENTRYPOINT_NOTHROW;
    return hr;
} // STDMETHODIMP RegMeta::DefineModuleRef()
...
ErrExit:
    ...
    return hr;
} // STDMETHODIMP RegMeta::_DefineModuleRef()
...
ErrExit:
    ...
    END_ENTRYPOINT_NOTHROW;
    return hr;
} // STDMETHODIMP RegMeta::SetParent()
    ...
    LPCWSTR     szSymbolDataPath)       // [IN] URL for the symbols of this module.
{
    ...
    wcscpy_s(pSymbol->rcName, ilen, szSymbolDataPath);
...
//*****************************************************************************
STDMETHODIMP RegMeta::DeleteToken(            // Return code.
    ...
    case mdtGenericParam:
        {
            ...
            IfNullGo(pRecord = m_pStgdb->m_MiniMd.getGenericParam(RidFromToken(tkObj)));
    ...
    case mdtGenericParamConstraint:
        {
            ...
            IfNullGo(pRecord = m_pStgdb->m_MiniMd.getGenericParamConstraint(RidFromToken(tkObj)));
    ...
    if ((tkOwnerType == mdtTypeDef) || (tkOwnerType == mdtMethodDef))
    {
        ...
        if (CheckDups(MDDupGenericParam))
        {
            ...
            for (rid = ridStart; rid < ridEnd; rid++)
            {
                ...
                IfNullGo(pGenericParam = m_pStgdb->m_MiniMd.getGenericParam(iGenericParam));
        ...
        if(rid >= ridEnd)
        {
            IfNullGo(pGenericParam = m_pStgdb->m_MiniMd.AddGenericParamRecord(&iGenericParam));
...
ErrExit:
    ...
    return hr;
} // STDMETHODIMP RegMeta::DefineGenericParam()
        ...
        mdToken      rtkConstraints[])     // [IN] Array of type constraints (TypeDef,TypeRef,TypeSpec)
{
    ...
    if (TypeFromToken(gp) == mdtGenericParam)
    {
        ...
        IfNullGo(pGenericParam = m_pStgdb->m_MiniMd.getGenericParam(RidFromToken(gp)));
...
ErrExit:
    ...
    END_ENTRYPOINT_NOTHROW;
    return hr;
} // STDMETHODIMP RegMeta::SetGenericParamProps()
    ...
    if (pGenericParam != NULL)
    {
        ...
        if (rtkConstraints != NULL)
        {
            ...
            for (rid = ridStart; rid < ridEnd; rid++)
            {
                ...
                IfNullGo(pGPCRec = m_pStgdb->m_MiniMd.getGenericParamConstraint(ridGPC));
                IfFailGo(m_pStgdb->m_MiniMd.PutCol(TBL_GenericParamConstraint, 
            ...
            {
                IfNullGo(pGPCRec = m_pStgdb->m_MiniMd.AddGenericParamConstraintRecord(&ridGPC));
                IfFailGo(m_pStgdb->m_MiniMd.PutCol(TBL_GenericParamConstraint, 
                                                     GenericParamConstraintRec::COL_Owner,
...
ErrExit:
    return hr;
} // HRESULT RegMeta::_SetGenericParamProps()
    ...
    if (CheckDups(MDDupMethodSpec)) 
    {
        ...
        if (SUCCEEDED(hr))
        {
            if (IsENCOn()) //GENERICS: is this correct? Do we really want to support ENC of MethodSpecs?
                pRecord = m_pStgdb->m_MiniMd.getMethodSpec(RidFromToken(*pmi)); 
            else
            {
                hr = META_S_DUPLICATE;
                goto ErrExit;
...
ErrExit:
    ...
    END_ENTRYPOINT_NOTHROW;
    return hr;
} // STDAPI RegMeta::DefineMethodSpec()
...
ErrExit:
    ...
    END_ENTRYPOINT_NOTHROW;
    return hr;
} // STDMETHODIMP RegMeta::SetEventProps()
...
} // STDMETHODIMP RegMeta::ApplyEditAndContinue()
