...
public:
    ...
    HRESULT CreateProfiler( __in LPWSTR wszCLSID, __in LPWSTR wszProfileDLL );
...
private:
    ...
    struct t_MovedReferencesData
    {
        ...
        ULONG arrMemBlockSize[MAX_REFERENCES];
    ...
    t_MovedReferencesData *AllocateMovedReferencesData();
    void FreeMovedReferencesData(t_MovedReferencesData *pData);
    ...
    HRESULT RootReferences2(t_MovedReferencesData *pData);
...
public:
    ...
    HRESULT RootReference2(BYTE *objectId, COR_PRF_GC_ROOT_KIND rootKind, COR_PRF_GC_ROOT_FLAGS rootFlags, void *rootID, void *pHeapId);
...
private:
    ...
    {
    public:
        CHashTableImpl(ULONG iBuckets) : CHashTable(iBuckets) {}
...
public:
    HRESULT AllocByClass(ObjectID objId, TypeID th, void* pHeapId);
