...
DECLARE_INTERFACE_(IDebugAdvanced2, IUnknown)
{
    ...
    STDMETHOD(Request)(
        ...
        __out __out_opt PULONG OutSize
        ) PURE;
    ...
    STDMETHOD(GetSourceFileInformation)(
        ...
        __out __out_opt PULONG InfoSize
        ) PURE;
...
DECLARE_INTERFACE_(IDebugControl4, IUnknown)
{
    ...
    STDMETHOD(GetContextStackTrace)(
        ...
        OUT OPTIONAL /* size_is(FramesSize) */ PDEBUG_STACK_FRAME Frames,
        IN ULONG FramesSize,
    ...
    STDMETHOD(OutputContextStackTrace)(
        THIS_
        IN ULONG OutputControl,
        IN /* size_is(FramesSize) */ PDEBUG_STACK_FRAME Frames,
        IN ULONG FramesSize,
...
DECLARE_INTERFACE_(IDebugSymbols3, IUnknown)
{
    ...
    STDMETHOD(GetSymbolEntriesByOffset)(
        ...
        IN ULONG64 Offset,
        IN ULONG Flags,
        OUT OPTIONAL /* size_is(IdsCount) */ PDEBUG_MODULE_AND_ID Ids,
        OUT OPTIONAL /* size_is(IdsCount) */ PULONG64 Displacements,
        IN ULONG IdsCount,
    ...
    STDMETHOD(GetSymbolEntryOffsetRegions)(
        ...
        IN PDEBUG_MODULE_AND_ID Id,
        IN ULONG Flags,
        OUT OPTIONAL /* size_is(RegionsCount) */ PDEBUG_OFFSET_REGION Regions,
    ...
    STDMETHOD(GetSourceEntriesByOffset)(
        ...
        IN ULONG64 Offset,
        IN ULONG Flags,
        OUT OPTIONAL /* size_is(EntriesCount) */ PDEBUG_SYMBOL_SOURCE_ENTRY Entries,
...
typedef HRESULT (CALLBACK * PDEBUG_ENTENSION_KNOWNSTRUCT)(
    IN ULONG Flag, IN ULONG64 Address, IN PSTR StructName,
    OUT PSTR Buffer, IN OUT PULONG BufferSize);
...
#define CreateProcessT CreateProcessWide
#define CreateProcessAndAttachT CreateProcessAndAttachWide
#define WriteDumpFileT WriteDumpFileWide
...
#define CreateProcessT CreateProcess
#define CreateProcessAndAttachT CreateProcessAndAttach
#define WriteDumpFileT WriteDumpFile
