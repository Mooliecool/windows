...
__inline VOID
ReloadSymbols(
    __in __in_z __in_opt IN PSTR Arg OPTIONAL
    )
/*++
...
__inline VOID
GetSetSympath(
    __in __in_z __in_opt IN PSTR Arg,
    __out_ecount (Length) __out_opt OUT PSTR Result OPTIONAL,
    IN int Length
    )
/*++
