...
{
    _ASSERTE("Fatal Error Verifying GC Heap.");
...
#define EnterCriticalSection UnsafeEnterCriticalSection

#ifdef LeaveCriticalSection
#undef LeaveCriticalSection
#endif //ifdef LeaveCriticalSection
#define LeaveCriticalSection UnsafeLeaveCriticalSection
...
protected:
    ...
    static void user_thread_wait (CLREvent *event, BOOL no_mode_change);
    ...
    static
    heap_segment* find_heap_segment(size_t size);
    static
    heap_segment* strip_empty_segment();
    static
