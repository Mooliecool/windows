...
typedef DPTR(struct TableSegment) PTR_TableSegment;
 ...
 *
 */
typedef TableSegment * (CALLBACK *SEGMENTITERATOR)(HandleTable *pTable, TableSegment *pPrevSegment, CrstHolder *pCrstHolder);
...
struct HandleTable
{
    ...
    /*
     * number of handles currently in this table
     */
    DWORD dwCount;
...
typedef DPTR(HandleTable) PTR_HandleTable;
 ...
 *
 */
TableSegment * CALLBACK QuickSegmentIterator(HandleTable *pTable, TableSegment *pPrevSegment, CrstHolder *pCrstHolder = 0);
 ...
 *
 */
TableSegment * CALLBACK StandardSegmentIterator(HandleTable *pTable, TableSegment *pPrevSegment, CrstHolder *pCrstHolder = 0);
 ...
 *
 */
TableSegment * CALLBACK FullSegmentIterator(HandleTable *pTable, TableSegment *pPrevSegment, CrstHolder *pCrstHolder = 0);
