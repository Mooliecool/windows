...
public:
    ...
    BOOL IsAssemblyPresent(SharedSecurityDescriptor* ssd);
    void AddEntry(void *ptr);
#ifndef DACCESS_COMPILE
    void AddFrameEntry(AppDomain * pAppDomain, FRAMESECDESCREF fsdRef);
#endif
    void Destroy(void);
...
private:
        ...
        BOOL IsAssemblyPresent(ADID domainID, SharedSecurityDescriptor* pSsd);
...
public:
    ...
    DWORD ProcessFrame(AppDomain* pAppDomain, SharedSecurityDescriptor* pSsd, FRAMESECDESCREF* pFsdRef);
