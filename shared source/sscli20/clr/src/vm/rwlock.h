...
public:
...
#else
    void AssertWriterLockHeld()                  { LEAF_CONTRACT; }
    void AssertWriterLockNotHeld()               { LEAF_CONTRACT; }
    void AssertReaderLockHeld()                  { LEAF_CONTRACT; }
    void AssertReaderLockNotHeld()               { LEAF_CONTRACT; }
    void AssertReaderOrWriterLockHeld()          { LEAF_CONTRACT; }
    void AssertHeld()                            { LEAF_CONTRACT; }
    void AssertNotHeld()                         { LEAF_CONTRACT; }
#endif
    ...
    DWORD GetReaderContentionCount()             { LEAF_CONTRACT; return(_dwReaderContentionCount); }
    DWORD GetWriterEntryCount()                  { LEAF_CONTRACT; return(_dwWriterEntryCount); }
    DWORD GetWriterContentionCount()             { LEAF_CONTRACT; return(_dwWriterContentionCount); }
#endif
    // Static functions
    ...
    static DWORD GetSpinCount()                  { LEAF_CONTRACT; return(gdwDefaultSpinCount); }
...
private:
    ...
    // private new
    static void *operator new(size_t size, void *pv)   { LEAF_CONTRACT;  return(pv); }
