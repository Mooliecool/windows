...
//
inline WORD *       FillWord        (WORD       * pv, int cel, WORD     v) { while (cel-- > 0) *pv++ = v; return pv; }
inline DWORD *      FillDWORD       (DWORD      * pv, int cel, DWORD    v) { while (cel-- > 0) *pv++ = v; return pv; }
inline ULONG *      FillULONG       (ULONG      * pv, int cel, ULONG    v) { while (cel-- > 0) *pv++ = v; return pv; }
inline int *        FillInt         (int        * pv, int cel, int      v) { while (cel-- > 0) *pv++ = v; return pv; }
inline UINT *       FillUINT        (UINT       * pv, int cel, UINT     v) { while (cel-- > 0) *pv++ = v; return pv; }
inline UINT_PTR *   FillUINT_PTR    (UINT_PTR   * pv, int cel, UINT_PTR v) { while (cel-- > 0) *pv++ = v; return pv; }
