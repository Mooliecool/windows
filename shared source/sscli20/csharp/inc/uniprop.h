...
void    WINAPI  GetProps ( __in_ecount(cch) PCWSTR pchBuffer, int cch, BYTE * pProps);

int     WINAPI  LastNonWhiteChar  ( __in_ecount(cch) PCWSTR pch, int cch);
int     WINAPI  FirstNonWhiteChar ( __in_ecount(cch) PCWSTR pch, int cch);
BOOL    WINAPI  IsWhitespace   (WCHAR ch);
BOOL    WINAPI  IsTab          (WCHAR ch);
BOOL    WINAPI  IsBlank        (WCHAR ch);
BOOL    WINAPI  IsBlanks       ( __in_ecount(cch) PCWSTR pch, int cch);
