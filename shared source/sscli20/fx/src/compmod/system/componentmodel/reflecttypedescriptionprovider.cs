        ...
        private class ReflectedTypeData {
            ...
            internal EventDescriptorCollection GetEvents()
            {
                ...
                if (_events == null)
                {
                    ...
                    Hashtable eventHash = new Hashtable(16, BackCompatibleStringComparer.Default);
                    Type baseType = _type;
                    ...
                    do {
                        ...
                        foreach(EventDescriptor ed in eventArray) {
                            if (!eventHash.ContainsKey(ed.Name)) {
                                eventHash.Add(ed.Name, ed);
                            }    
                        }
                        baseType = baseType.BaseType;
                    }
                    ...
                    eventArray = new EventDescriptor[eventHash.Count];
                    eventHash.Values.CopyTo(eventArray, 0);
            ...
            internal PropertyDescriptorCollection GetProperties()
            {
                ...
                if (_properties == null)
                {
                    ...
                    Hashtable propertyHash = new Hashtable(10, BackCompatibleStringComparer.Default);
                    Type baseType = _type;
                    Type objType = typeof(object);
                    ...
                    do {
                        ...
                        foreach(PropertyDescriptor p in propertyArray) {
                            if (!propertyHash.ContainsKey(p.Name)) {
                                propertyHash.Add(p.Name, p);
                            }    
                        }
                        baseType = baseType.BaseType;
                    }
                    ...
                    propertyArray = new PropertyDescriptor[propertyHash.Count];
                    propertyHash.Values.CopyTo(propertyArray, 0);
