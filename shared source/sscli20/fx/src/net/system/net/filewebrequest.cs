...
namespace System.Net {
    ...
    public class FileWebRequest : WebRequest, ISerializable {
        ...
        private static ContextCallback s_WrappedGetRequestStreamCallback = new ContextCallback(WrappedGetRequestStreamCallback);
        private static ContextCallback s_WrappedResponseCallback = new ContextCallback(WrappedGetResponseCallback);
    ...
    // fields
        ...
        bool m_writePending;
        bool m_writing;
        private ContextAwareResult m_WriteAResult;
        private ContextAwareResult m_ReadAResult;
    ...
    // methods
        ...
        private static void GetRequestStreamCallback(object state)
        {
            ...
            try {
                ...
                if (context == null)
                    WrappedGetRequestStreamCallback(state);
                else
                    ExecutionContext.Run(context, s_WrappedGetRequestStreamCallback, state);
