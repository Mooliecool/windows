...
#pragma warning restore 618
        ...
        internal static SchemaInfo GetDtdSchemaInfo(XmlReader reader) {
            XmlWrappingReader wrappingReader = reader as XmlWrappingReader;
            if ( wrappingReader != null ) {
                return wrappingReader.DtdSchemaInfo;
            }
            else {
                XmlTextReaderImpl tri = GetXmlTextReaderImpl(reader);
                return tri != null ? tri.DtdSchemaInfo : null;
            }
        }
...
#pragma warning restore 618
        ...
        public static XmlReader Create(String inputUri, XmlReaderSettings settings, XmlParserContext inputContext) {
            ...
            XmlResolver tmpResolver = settings.GetXmlResolver();
            if (tmpResolver == null) {
                tmpResolver = new XmlUrlResolver();
            }
            ...
            try {
                // create reader
                return CreateReaderImpl(stream, settings, baseUri, baseUri.ToString(), inputContext, true);
            }
            catch {
                stream.Close();
                throw;
        ...
        public static XmlReader Create(Stream input) {
            ...
            return CreateReaderImpl(input, settings, (Uri)null, string.Empty, null, settings.CloseInput);
        }
        ...
        public static XmlReader Create(Stream input, XmlReaderSettings settings, String baseUri) {
            ...
            return CreateReaderImpl(input, settings, (Uri)null, (string)baseUri, null, settings.CloseInput);
        }
        ...
        public static XmlReader Create(Stream input, XmlReaderSettings settings, XmlParserContext inputContext) {
            ...
            return CreateReaderImpl(input, settings, (Uri)null, string.Empty, inputContext, settings.CloseInput);
        }

        // Creates an XmlReader according for parsing XML from the given TextReader.
        public static XmlReader Create(TextReader input) {
            return CreateReaderImpl(input, (XmlReaderSettings)null, string.Empty, (XmlParserContext)null);
        }
        ...
        public static XmlReader Create(TextReader input, XmlReaderSettings settings, String baseUri) {
            return CreateReaderImpl(input, settings, baseUri, (XmlParserContext)null);
        }
...
#pragma warning disable 618
                if (settings.ConformanceLevel != ConformanceLevel.Auto && settings.ConformanceLevel != XmlReader.GetV1ConformanceLevel(baseReader)) {
                    throw new InvalidOperationException(Res.GetString(Res.Xml_IncompatibleConformanceLevel, settings.ConformanceLevel.ToString()));
                }
                ...
                if (settings.IgnoreWhitespace) {
                    ...
                    XmlTextReader tr = baseReader as XmlTextReader;
                    if (tr != null) {
                        wh = tr.WhitespaceHandling;
                    }
                    else {
                        XmlValidatingReader vr = baseReader as XmlValidatingReader;
                        if (vr != null) {
                            wh = ((XmlTextReader)vr.Reader).WhitespaceHandling;
                        }
                    }
                ...
                if (settings.ProhibitDtd) {
                    ...
                    if (tr == null) {
                        XmlValidatingReader vr = baseReader as XmlValidatingReader;
                        if (vr != null) {
                            tr = (XmlTextReader)vr.Reader;
                        }
                    }
                    if (tr == null || !tr.ProhibitDtd) {
                        prohibitDtd = true;
                        needWrap = true;
                    }
                }
