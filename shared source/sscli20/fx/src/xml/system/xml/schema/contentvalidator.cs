...
namespace System.Xml.Schema {
    ...
    sealed class SequenceNode : InteriorNode {
        ...
        public override bool IsNullable {
            get { return (LeftChild.IsNullable && (RightChild.IsNullable || RightChild.IsRangeNode)) || (RightChild.IsRangeNode && ((LeafRangeNode)RightChild).Min == 0 ); }
        }
        ...
        public override void Dump(StringBuilder bb, SymbolsDictionary symbols, Positions positions) {
            ...
            bb.Append(", ");
            RightChild.Dump(bb, symbols, positions);
            bb.Append(")");
        }
#endif
    }
