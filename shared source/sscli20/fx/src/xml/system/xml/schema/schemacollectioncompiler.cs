            ...
            if (mainMemberTypes != null) {
                foreach(XmlQualifiedName memberName in mainMemberTypes) {
                    ...
                    if (unionMember != null) {
                        ...
                        throw new XmlSchemaException(Res.Sch_UndeclaredSimpleType, memberName.ToString(), simpleType);   
                    }
                }
            }
        ...
        private void CompileIdentityConstraint (XmlSchemaIdentityConstraint xi) { 
            ...
            try {
                ...
                if (xi is XmlSchemaKeyref) {
                    XmlSchemaIdentityConstraint ic = (XmlSchemaIdentityConstraint)this.schema.IdentityConstraints[((XmlSchemaKeyref)xi).Refer];
                    if (ic == null) {
