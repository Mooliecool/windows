    ...
    internal class GenerateHelper {
        ...
        private string GetFileName(string uriString) {
            ...
            if (uriString.Length != 0 &&
                ...
                lastFileName = uri.LocalPath;
            } else {
                lastFileName = uriString;
            }
        ...
        private void MarkSequencePoint(ISourceLineInfo sourceInfo) {
            ...
            string sourceFile = GetFileName(sourceInfo.Uri);
            ...
            if (XmlILTrace.IsEnabled) {
                if (sourceInfo.IsNoSource)
                    ...
                    this.writerDump.WriteLine("//[{0},{1} -- {2},{3}]", sourceInfo.StartLine, sourceInfo.StartPos, sourceInfo.EndLine, sourceInfo.EndPos);
                }
            }
        #endif
            ISymbolDocumentWriter symDoc = this.module.AddSourceDocument(sourceFile);
            this.ilgen.MarkSequencePoint(symDoc, sourceInfo.StartLine, sourceInfo.StartPos, sourceInfo.EndLine, sourceInfo.EndPos);
