...
namespace System.Xml.Xsl.IlGen {
    ...
    internal class StaticDataManager {
        ...
        /// </summary>
        public int DeclareEarlyBound(string namespaceUri, MethodInfo methInfo) {
            ConstructorInfo constrInfo;

            // Get the default constructor
            constrInfo = methInfo.DeclaringType.GetConstructor(new Type[] {});
            Debug.Assert(constrInfo != null, "The type that declares method " + methInfo.Name + " must have a public default constructor.");

            if (this.earlyInfo == null)
                this.earlyInfo = new UniqueList<EarlyBoundInfo>();

            return this.earlyInfo.Add(new EarlyBoundInfo(namespaceUri, constrInfo));
        }
