...
namespace System.Xml.Xsl.Runtime {
    ...
    internal enum NumberingSequence {
        ...
        Ganada,                     // 0xac00 -- Korea
        ArabicScript,               // 0x0623 -- BIDI AraAlpha for Arabic/Farsi/Urdu
        ...
        Zodiac1,                    // 0x7532 -- Taiwan/China (10 numbers)
        Zodiac2,                    // 0x5b50 -- Taiwan/China (12 numbers)
        Zodiac3,                    // 0x7532 -- Taiwan/China (Zodiac1 + Zodiac2)
        LastSpecial = Zodiac3,
    }
