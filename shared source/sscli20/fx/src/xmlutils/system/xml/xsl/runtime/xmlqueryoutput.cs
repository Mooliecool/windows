...
namespace System.Xml.Xsl.Runtime {
    ...
    public sealed class XmlQueryOutput : XmlWriter {
        ...
        private string piTarget, piText;            // Cache pi target and text
        private string commentText;                 // Cache comment text
        private string nmspPrefix, nmspText;        // Cache namespace prefix and text
