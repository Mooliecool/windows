...
namespace System.Xml.Xsl {
    ...
    internal static class XmlQueryTypeFactory {
        ...
        /// <param name="c">the cardainality multiplier</param>
        ...
        public static readonly XmlQueryType NodeDodS            = TF.PrimeProduct(ItemType.NodeDod, XmlQueryCardinality.ZeroOrMore);
        #endregion
