...
namespace System.Xml.Xsl.Xslt {
    ...
    internal partial class QilGenerator : IXPathEnvironment {
        ...
        QilNode IXPathEnvironment.ResolveVariable(string prefix, string name) {
            ...
            if (var.NodeType == QilNodeType.Parameter && var.XmlType.IsNode && var.XmlType.MaybeMany && !var.XmlType.IsDod) {
                var = f.TypeAssert(var, XmlQueryTypeFactory.NodeDodS);
            }
        ...
        private QilNode CompileMsNodeSet(QilNode n) {
            ...
            return f.XsltConvert(n, T.NodeDodS);
        }
