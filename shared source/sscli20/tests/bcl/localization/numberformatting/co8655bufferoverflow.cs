...
public class Co8655BufferOverflow
{
 ...
 public bool runTest()
   ...
   Object[] values = {
     ...
     (Decimal)(Decimal.MinValue+1), (Decimal)(Decimal.MinValue+Decimal.Parse("0.0000000000000000000000001", CultureInfo.InvariantCulture)),
     ...
     (Decimal)(Decimal.MaxValue-1), (Decimal)(Decimal.MaxValue-Decimal.Parse("0.0000000000000000000000001", CultureInfo.InvariantCulture)),
   ...
   try
     ...
     iCountTestcases=iCountTestcases+5;		
     iCountTestcases++;
     random = new Random();
     list = new ArrayList();
     list.Add("0");
     ...
     list.Add("{{");
     list.Add("}}");
     customLoopSize = random.Next(100, 200);
