...
public class Co8648SoapFormatter
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "Security - SoapFormatter";
	public static String s_strTFName        = "Co8648SoapFormatter.cs";
	...
	{
		bool bResult = false;
		Co8648SoapFormatter cbA = new Co8648SoapFormatter();
		try {
			bResult = cbA.runTest();
