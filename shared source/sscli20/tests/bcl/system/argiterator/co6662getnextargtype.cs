...
public class Co6662GetNextArgType
{
 static String strName = "System.ArgIterator";
 static String strTest = "Co6662GetNextArgType";
 ...
 private Boolean runTest( Boolean verbose )
   ...
   try
     {	
     ++iCountTestcases;   
     if ( verbose ) Console.WriteLine( "GetNextArgType on Enumerator with no Elements in it should throw InvalidOperationException" );	
     try {
     ...
     ++iCountTestcases;   	
     if ( verbose ) Console.WriteLine( "GetNextArgType on Enumerator after enumeration ended should result in InvalidOperationException" );	
     try	{		
 ...
 public static void Main( String[] args ) 
   ...
   Co6662GetNextArgType oReplaceTest = new Co6662GetNextArgType();
   Console.WriteLine( "Starting "+ strName +" ..." );                                               	
   Console.WriteLine( "USAGE:  Co6662GetNextArgType.exe OR Co6662GetNextArgType.exe verbose" );
