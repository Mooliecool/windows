...
public class Co3749GetValue_iii
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Array.GetValue(int, int, int)";
 public static String s_strTFName        = "Co3749GetValue_iii";
 public static String s_strTFAbbrev      = "Co3749";
   ...
   try
	 ...
	 for(int j=0; j <= iArr.GetUpperBound(1); j++)
	   ...
	   for(int k=0; k<= iArr.GetUpperBound(2); k++)
	     ...
	     iTempArr[2]=k;
	     ++iCountTestcases;
	     if(!iArr.GetValue(iTempArr).Equals(i*j*k))
	       {
	       ++iCountErrors;
	       Console.WriteLine( s_strTFAbbrev + "Err_763cs_" + i + "_" + j + "_" + k + ", i*j*k==" + iArr.GetValue(i,j,k));
	       }
	     }
	   }
	 }
	 ...
	 try
	   ...
	   if(hshArrayValue.ContainsKey(ClassTypes[ii].Name))
	     ...
	     try
	       {
	       objArr.GetValue(objArr.GetLowerBound(0)-1, objArr.GetLowerBound(1), objArr.GetLowerBound(2));
	       ++iCountErrors;
	     ...
	     try
	       {
	       objArr.GetValue(objArr.GetLowerBound(0), objArr.GetLowerBound(1)-1, objArr.GetLowerBound(2));
	       ++iCountErrors;
	       Console.WriteLine( s_strTFAbbrev + ", Err_763sr! Exception not thrown");
	       }
	     catch(IndexOutOfRangeException )
	     ...
	     try
	       {
	       objArr.GetValue(objArr.GetLowerBound(0), objArr.GetLowerBound(1), objArr.GetLowerBound(2)-1);
	       ++iCountErrors;
	       Console.WriteLine( s_strTFAbbrev + ", Err_763sr! Exception not thrown");
	       }
	     catch(IndexOutOfRangeException )
	 ...
	 {
	 ++iCountTestcases;
	 iArr.GetValue(iArr.GetLowerBound(0), iArr.GetLowerBound(1));
	 ++iCountErrors;
 ...
 public static void Main( String[] args )
   {
   bool bResult = false;	
   Co3749GetValue_iii oCbTest = new Co3749GetValue_iii();
   try
     {
