...
public class Co3753GetValue_iarr
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Array.CreateInstance(Type, int[])";
 public static String s_strTFName        = "Co3753GetValue_iarr";
 public static String s_strTFAbbrev      = "Co3753";
	 ...
	 try
	   ...
	   if(hshArrayValue.ContainsKey(ClassTypes[ii].Name))
	     ...
	     for(int jj = 0, x = 0, y=0, z = 0, dim1max = objArr.GetLength(0), dim2max = objArr.GetLength(1); jj < alst1.Count; jj++)
	       ...
	       objArr.SetValue(alst1[jj], iIndex2Arr);
	       z++;
	       if((z%dim1max==0))
		 {
		 z=0;
 ...
 public static void Main( String[] args )
   {
   bool bResult = false;	
   Co3753GetValue_iarr oCbTest = new Co3753GetValue_iarr();
   try
     {
