...
using System.IO; 
using System;
public class Co3765LastIndexOf_ooi
{
 public static readonly String s_strActiveBugNums = "";
 public static readonly String s_strDtTmVer       = "";
 public static readonly String s_strClassMethod   = "Array.LastIndexOf(Object[], Object, int StartIndex)";
 public static readonly String s_strTFName        = "Co3765LastIndexOf_ooi";
 public static readonly String s_strTFAbbrev      = "Co3765";
 ...
 public virtual bool runTest()
   ...
   try
	 ...
	 {
	 o1 = cArr[i];
	 iReturnValue = Array.LastIndexOf(oArrValues, o1, i);
	 if ( iReturnValue != i )
	   {
	   ++iCountErrors;
	 ...
	 oArrValues[i]=i16Arr[i];
       ...
       ++iCountTestcases;
       for(int i=i16Arr.Length-1; i >=0 ; i--)
	 {
	 o1 = i16Arr[i];
	 iReturnValue = Array.LastIndexOf(oArrValues, o1, i);
	 if ( iReturnValue != i )
	 ...
	 o1 = 16;
	 ++iCountTestcases;
	 iReturnValue = Array.LastIndexOf(null, o1, 0);
	 ++iCountErrors;
	 ...
	 o1 = 16;
	 ++iCountTestcases;
	 iReturnValue = Array.LastIndexOf(oArrValues, o1, -1);
	 ++iCountErrors;
	 ...
	 oArrValues[i]=i16Arr[i];
       ...
       iReturnValue = Array.LastIndexOf(oArrValues, null, 0);
       ++iCountTestcases;
       if ( iReturnValue != -1 )	
	 {
	 ++iCountErrors;
 ...
 public static void Main( String[] args )
   {
   bool bResult = false;	
   Co3765LastIndexOf_ooi oCbTest = new Co3765LastIndexOf_ooi();
   try
     {
