...
using System.IO; 
using System;
public class Co3767Reverse_o
{
 public static readonly String s_strActiveBugNums = "";
 public static readonly String s_strDtTmVer       = "";
 public static readonly String s_strClassMethod   = "Array.Reverse(Object[])";
 public static readonly String s_strTFName        = "Co3767Reverse_o";
 public static readonly String s_strTFAbbrev      = "Co3767";
 ...
 public virtual bool runTest()
   ...
   try
	 ...
	 oArrValues[i]=cArr[i];
       ...
       Array.Reverse(oArrValues);
       ++iCountTestcases;
       for(int i=0, j=cArr.Length-1; i < cArr.Length; i++, j--)
	 {
	 strLoc="765vp_" + i;
	 o1 = cArr[i];
	 if ( o1.Equals(oArrValues[j]) != true )
	   {
	   ++iCountErrors;
	   Console.WriteLine( s_strTFAbbrev + ", Err_320ye_" + i + ", oArrValues[i]=="+ oArrValues[i] );
	   }
	 }
	 ...
	 oArrValues[i]=i16Arr[i];
       ...
       Array.Reverse(oArrValues);
       ++iCountTestcases;
       for(int i=0, j=i16Arr.Length-1; i < oArrValues.Length; i++, j--)
	 {
	 strLoc="897dd_" + i;
	 o1 = i16Arr[i];
	 if ( o1.Equals(oArrValues[j]) != true )
 ...
 public static void Main( String[] args )
   {
   bool bResult = false;	
   Co3767Reverse_o oCbTest = new Co3767Reverse_o();
   try
     {
