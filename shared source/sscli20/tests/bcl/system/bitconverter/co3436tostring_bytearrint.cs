...
using System.Text;
using System;
public class Co3436ToString_ByteArrInt
{
 public virtual bool runTest()
   {
   Console.Error.WriteLine( "Co3436ToString_ByteArrInt  runTest started." );
   ...
   try
     ...
     do
       ...
       byArr3[ 1] = (byte)0x49;  
       byArr3[ 2] = (byte)0x4A;
       str3 = BitConverter.ToString( byArr3 ,1 );  
       ++iCountTestcases;
	 ...
	 try
	   {
	   ++iCountTestcases;
	   str3 = BitConverter.ToString( byArr3 ,random.Next(Int32.MinValue, 0) );  
	   ++iCountErrors;
	 ...
	 {
	 ++iCountTestcases;
	 str3 = BitConverter.ToString( byArr3 ,Int32.MinValue );  
	 ++iCountErrors;
	 Console.Error.WriteLine(  "POINTTOBREAK: Error E_211wl!  str3==" + str3  );
	 }
       catch ( ArgumentOutOfRangeException argexc )
	 ...
	 {
	 ++iCountTestcases;
	 str3 = BitConverter.ToString( byArr3 ,Int32.MaxValue );  
	 ++iCountErrors;
	 Console.Error.WriteLine(  "POINTTOBREAK: Error E_211wl!  str3==" + str3  );
	 }
       catch ( ArgumentOutOfRangeException argexc )
	 ...
	 Console.Error.WriteLine(  "POINTTOBREAK: Error E_212jc!  exc.ToString()==" + exc.ToString()  );
       ...
       byArr3[ 4] = (byte)0x45;
       byArr3[ 5] = (byte)0x46;
       str3 = BitConverter.ToString( byArr3 ,inStartOffset  );  
       ++iCountTestcases;
       if ( str3.Equals( str2 ) == false )
	 {
	 ++iCountErrors;
     ...
     {
     ++iCountErrors;
     Console.Error.WriteLine(  "POINTTOBREAK: Error E_343un! (Co3436ToString_ByteArrInt) exc_general==" + exc_general  );
     Console.Error.WriteLine(  "EXTENDEDINFO: (E_343un) strLoc==" + strLoc  );
     }
   if ( iCountErrors == 0 )
     {
     Console.Error.WriteLine( "paSs.   BitConverter\\Co3436ToString_ByteArrInt.cs   iCountTestcases==" + iCountTestcases );
     return true;
     }
   else
     {
     Console.Error.WriteLine( "FAiL!   BitConverter\\Co3436ToString_ByteArrInt.cs   iCountErrors==" + iCountErrors );
     return false;
     }
   }
 public static void Main( String[] args )
   ...
   bool bResult = false; 
   StringBuilder sblMsg = new StringBuilder( 99 );
   Co3436ToString_ByteArrInt cbA = new Co3436ToString_ByteArrInt();
   try
     {
     bResult = cbA.runTest();
     }
     ...
     {
     bResult = false;
     Console.Error.WriteLine(  "POINTTOBREAK:  FAiL!  Error E_999zzz! (Co3436ToString_ByteArrInt) Uncaught Exception caught in main(), exc_main==" + exc_main  );
     }
   if ( ! bResult )
     {
     Console.Error.WriteLine(  "Co3436ToString_ByteArrInt.cs   FAiL!"  );
     }
