...
using System;
using System.IO; 
public class Co5375ToUInt64_ubArr_i
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Bitconverter.ToUInt64(unsigned SByte[], int)"; 
 public static String s_strTFName        = "Co5375ToUInt64_ubArr_i.cs";
 public static String s_strTFAbbrev      = "Co5375";
