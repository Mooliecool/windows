...
public class Co5043Parse_int_nfi
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Byte.Parse(String s, int style, NumberFormatInfo nfi)";
 public static String s_strTFName        = "Co5043Parse_int_nfi.cs";
 public static String s_strTFAbbrev      = "Co5043";
 ...
 public Boolean runTest()
   ...
   do
     ...
     for (int i=0; i < bytTestValues.Length;i++)
       ...
       iCountTestcases++;
       strOut = bytTestValues[i].ToString( "", nfi1);
       byt1a = Byte.Parse(strOut, NumberStyles.Any, nfi1);
     ...
     for (int i=0; i < bytTestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = bytTestValues[i].ToString( "G", nfi1);
       byt1a = Byte.Parse(strOut, NumberStyles.Any, nfi1);
       if(byt1a != bytTestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < bytTestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = bytTestValues[i].ToString( "G5", nfi1);
       byt1a = Byte.Parse(strOut, NumberStyles.Any, nfi1);
       if(byt1a != bytTestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < bytTestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = bytTestValues[i].ToString( "C", nfi1);
       byt1a = Byte.Parse(strOut, NumberStyles.Any, nfi1);
       if(byt1a != bytTestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < bytTestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = bytTestValues[i].ToString( "C4", nfi1);
       byt1a = Byte.Parse(strOut, NumberStyles.Any, nfi1);
       if(byt1a != bytTestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < bytTestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = bytTestValues[i].ToString( "D", nfi1);
       byt1a = Byte.Parse(strOut, NumberStyles.Any, nfi1);
       if(byt1a != bytTestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < bytTestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = bytTestValues[i].ToString( "D4", nfi1);
       byt1a = Byte.Parse(strOut, NumberStyles.Any, nfi1);
       if(byt1a != bytTestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < bytTestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = bytTestValues[i].ToString( "E", nfi1);
       byt1a = Byte.Parse(strOut, NumberStyles.Any, nfi1);
       if(byt1a != bytTestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < bytTestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = bytTestValues[i].ToString( "e4", nfi1);
       byt1a = Byte.Parse(strOut, NumberStyles.Any, nfi1);
       if(byt1a != bytTestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < bytTestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = bytTestValues[i].ToString( "N", nfi1);
       byt1a = Byte.Parse(strOut, NumberStyles.Any, nfi1);
       if(byt1a != bytTestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < bytTestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = bytTestValues[i].ToString( "N4", nfi1);
       byt1a = Byte.Parse(strOut, NumberStyles.Any, nfi1);
       if(byt1a != bytTestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < bytTestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = bytTestValues[i].ToString( "F", nfi1);
       byt1a = Byte.Parse(strOut, NumberStyles.Any, nfi1);
       if(byt1a != bytTestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < bytTestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = bytTestValues[i].ToString( "F4", nfi1);
       byt1a = Byte.Parse(strOut, NumberStyles.Any, nfi1);
       if(byt1a != bytTestValues[i])
	 {
	 iCountErrors++;
 ...
 public static void Main(String[] args) 
   ...
   Co5043Parse_int_nfi cbA = new Co5043Parse_int_nfi();
   try {
   bResult = cbA.runTest();
