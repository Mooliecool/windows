...
public class Co5045Format_str_nfi
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Byte.ToString(Byte value, String format)";
 public static String s_strTFName        = "Co5045Format_str_nfi.cs";
 public static String s_strTFAbbrev      = "Co5045";
 ...
 public static void Main(String[] args) 
   ...
   Co5045Format_str_nfi cbA = new Co5045Format_str_nfi();
   try {
   bResult = cbA.runTest();
