...
public class Co5713IConvertible_Byte : IDescribeTestedMethods
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Iconvertible";
 public static String s_strTFName        = "Co5713IConvertible_Byte.cs";
 ...
 public Boolean TestToBoolean(Byte testSubject){
 strLoc = "Loc_498yv";
 Boolean b1 = false;
 Boolean b2 = false;
 Boolean pass = false;
 ...
 public Boolean TestToChar(Byte testSubject) {
 strLoc = "498vy3";
 Char b1 = '\0';
 Char b2 = '\0';
 Boolean pass = false;
 ...
 public Boolean TestToSByte(Byte testSubject) {
 strLoc = "r4987";
 SByte b1 = 0;
 SByte b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToByte(Byte testSubject) {
 strLoc = "099d8";
 Byte b1 = 0;
 Byte b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToInt16(Byte testSubject) {
 strLoc = "099d8";
 Int16 b1 = 0;
 Int16 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToUInt16(Byte testSubject) {
 strLoc = "099d8";
 UInt16 b1 = 0;
 UInt16 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToInt32(Byte testSubject) {
 strLoc = "099d8";
 Int32 b1 = 0;
 Int32 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToUInt32(Byte testSubject) {
 strLoc = "099d8";
 UInt32 b1 = 0;
 UInt32 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToInt64(Byte testSubject) {
 strLoc = "099d8";
 Int64 b1 = 0;
 Int64 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToUInt64(Byte testSubject) {
 strLoc = "099d8";
 UInt64 b1 = 0;
 UInt64 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToSingle(Byte testSubject) {
 strLoc = "099d8";
 Single b1 = 0;
 Single b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToDouble(Byte testSubject) {
 strLoc = "099d8";
 Double b1 = 0;
 Double b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToDecimal(Byte testSubject) {
 strLoc = "099d8";
 Decimal b1 = 0;
 Decimal b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToDateTime(Byte testSubject) {
 strLoc = "099d8";
 ...
 public Boolean TestToString(Byte testSubject) {
 strLoc = "099d8";
 String b1 = "";
 String b2 = "";
 Boolean pass = false;
 ...
 Object exc2 = null;
 try {
 b1 = ((IConvertible)testSubject).ToString(null);
 pass = true;
 excthrown = false;
 } catch (Exception exc) {
 exc1 = exc;
 ...
 public Boolean TestToType(Byte testSubject, Type typecode) {
 strLoc = "099d8";
 Object b1 = 0;
 Object b2 = 0;
 Boolean pass = false;
 ...
 public bool runTest()
   ...
   try
     ...
     Byte[] testSubjects = new Byte[]{Byte.MinValue, 10, 100, 200, unchecked((Byte)300), Byte.MaxValue};
     Type[] typecodes = { 
       typeof(Object),         
       typeof(DBNull),         
       typeof(Boolean),        
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5713IConvertible_Byte cbA = new Co5713IConvertible_Byte();
   try {
   bResult = cbA.runTest();
