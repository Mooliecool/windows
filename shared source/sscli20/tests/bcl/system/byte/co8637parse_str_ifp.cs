...
public class Co8637Parse_str_ifp
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Byte.Parse(String sNumberFormatInfo nfi)";
 public static String s_strTFName        = "Co8637Parse_str_ifp.cs";
 ...
 public Boolean runTest()
   ...
   strOut ="-2147483649";
   iCountTestcases++;
   strOut = bytTestValues[0].ToString( "C", nfi1);
   try {
   byt1a = Byte.Parse(strOut, nfi1);
   iCountErrors++;
   Console.WriteLine(s_strTFAbbrev+ "Err_382er! ,byt1a=="+byt1a);
 ...
 public static void Main(String[] args) 
   ...
   Co8637Parse_str_ifp cbA = new Co8637Parse_str_ifp();
   try {
   bResult = cbA.runTest();
