...
using System.IO;
public class Co8565MoveNext
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "CharEnumerator.MoveNext()";
 public static String s_strTFName        = "Co8565MoveNext.cs";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co8565MoveNext cbA = new Co8565MoveNext();
   try {
   bResult = cbA.runTest();
