...
public class Co3907FixedSize_IL
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "ArrayList.FixedSize(IList)";
    public static String s_strTFName        = "Co3907FixedSize_IL.cs";
    ...
    public bool runTest()
    {
        ...
        try 
        {
            do
            {
                ...
                ilst1[0] = strValue;
                iCountTestcases++;
                if(!strValue.Equals((String)ilst1[0])) 
                {
                    iCountErrors++;
    ...
    {
        bool bResult = false;
        Co3907FixedSize_IL cbA = new Co3907FixedSize_IL();
        try 
        {
            bResult = cbA.runTest();
        } 
