...
public class Co3928LastIndexOf_Oi
{
    public static String strName = "ArrayList.LastIndexOf_Oi";
    public static String strTest = "Co3928LastIndexOf_Oi";
    ...
    public virtual bool runTest()
    {
        ...
        do
        {
            ...
            try
            {
                arrList.LastIndexOf( "Batman", -1000);
    ...
    {
        bool bResult = false;	
        Co3928LastIndexOf_Oi oCbTest = new Co3928LastIndexOf_Oi();
        try
        {
