...
public class Co3930IndexOf_Oi
{
    public static String strName = "ArrayList.IndexOf";
    public static String strTest = "Co3930IndexOf_Oi";
    ...
    public virtual bool runTest()
    {
        ...
        do
        {
            ...
            try
            {
                while ( ( ndx = arrList.IndexOf( "Batman", ++ndx) ) != -1 )
                {
    ...
    {
        bool bResult = false;	
        Co3930IndexOf_Oi oCbTest = new Co3930IndexOf_Oi();
        try
        {
