...
public class Co3971get_IsReadOnly
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "BitArray.readOnly";
    public static String s_strTFName        = "Co3971get_IsReadOnly.cs";
    ...
    {
        bool bResult = false;
        Co3971get_IsReadOnly cbA = new Co3971get_IsReadOnly();
        try 
        {
            bResult = cbA.runTest();
        } 
