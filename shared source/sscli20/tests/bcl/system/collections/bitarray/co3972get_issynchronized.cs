...
public class Co3972get_IsSynchronized
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "BitArray.IsSynchronized";
    public static String s_strTFName        = "Co3972get_IsSynchronized.cs";
    ...
    {
        bool bResult = false;
        Co3972get_IsSynchronized cbA = new Co3972get_IsSynchronized();
        try 
        {
            bResult = cbA.runTest();
        } 
