...
public class Co3916get_IsReadOnly
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "SortedList.ReadOnly(SortedList)";
    public static String s_strTFName        = "Co3916get_IsReadOnly.cs";
    ...
    {
        bool bResult = false;
        Co3916get_IsReadOnly cbA = new Co3916get_IsReadOnly();
        try 
        {
            bResult = cbA.runTest();
        } 
