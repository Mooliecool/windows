...
public class Co3925get_IsSynchronized
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "SortedList.Synchronized(SortedList)";
    public static String s_strTFName        = "Co3925get_IsSynchronized.cs";
    ...
    {
        bool bResult = false;
        Co3925get_IsSynchronized cbA = new Co3925get_IsSynchronized();
        try 
        {
            bResult = cbA.runTest();
        } 
