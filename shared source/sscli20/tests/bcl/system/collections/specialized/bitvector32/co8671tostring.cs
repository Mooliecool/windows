...
public class Co8671ToString
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "BitVector32.ToString()";
    public static String s_strTFName        = "Co8671ToString.cs";
    ...
    {
        bool bResult = false;
        Co8671ToString cbA = new Co8671ToString();
        try 
        {
            bResult = cbA.runTest();
        } 
