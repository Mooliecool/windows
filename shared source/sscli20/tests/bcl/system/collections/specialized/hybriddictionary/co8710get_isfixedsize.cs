...
public class Co8710get_IsFixedSize
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "HybridDictionary.IsFixedSize";
    public static String s_strTFName        = "Co8710get_IsFixedSize.cs";
    ...
    public virtual bool runTest()
    {
        ...
        try
        {
            ...
            Console.WriteLine("2. IsFixedSize for short filled dictionary");
            strLoc = "Loc_002oo"; 
            iCountTestcases++;
            hd.Clear();
            ...
            Console.WriteLine("3. IsFixedSize for long filled dictionary");
            strLoc = "Loc_003oo"; 
            iCountTestcases++;
            hd.Clear();
    ...
    {
        bool bResult = false;
        Co8710get_IsFixedSize cbA = new Co8710get_IsFixedSize();
        try 
        {
            bResult = cbA.runTest();
        } 
