...
public class Co8712get_IsSynchronized
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "HybridDictionary.IsSynchronized";
    public static String s_strTFName        = "Co8712get_IsSynchronized.cs";
    ...
    public virtual bool runTest()
    {
        ...
        try
        {
            ...
            Console.WriteLine("2. IsSynchronized for short filled dictionary");
            strLoc = "Loc_002oo"; 
            iCountTestcases++;
            hd.Clear();
            ...
            Console.WriteLine("3. IsSynchronized for long filled dictionary");
            strLoc = "Loc_003oo"; 
            iCountTestcases++;
            hd.Clear();
    ...
    {
        bool bResult = false;
        Co8712get_IsSynchronized cbA = new Co8712get_IsSynchronized();
        try 
        {
            bResult = cbA.runTest();
        } 
