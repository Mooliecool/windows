...
public class Co8715get_SyncRoot
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "HybridDictionary.SyncRoot get";
    public static String s_strTFName        = "Co8715get_SyncRoot.cs";
    ...
    {
        bool bResult = false;
        Co8715get_SyncRoot cbA = new Co8715get_SyncRoot();
        try 
        {
            bResult = cbA.runTest();
        } 
