...
using GenStrings;
public class Co8685Clear
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "ListDictionary.Clear()";
    public static String s_strTFName        = "Co8685Clear.cs";
    ...
    {
        bool bResult = false;
        Co8685Clear cbA = new Co8685Clear();
        try 
        {
            bResult = cbA.runTest();
        } 
