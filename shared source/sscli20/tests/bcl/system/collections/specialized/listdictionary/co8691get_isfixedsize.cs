...
public class Co8691get_IsFixedSize
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "ListDictionary.IsFixedSize";
    public static String s_strTFName        = "Co8691get_IsFixedSize.cs";
    ...
    {
        bool bResult = false;
        Co8691get_IsFixedSize cbA = new Co8691get_IsFixedSize();
        try 
        {
            bResult = cbA.runTest();
        } 
