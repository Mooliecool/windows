...
public class Co8692get_IsReadOnly
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "ListDictionary.IsReadOnly";
    public static String s_strTFName        = "Co8692get_IsReadOnly.cs";
    ...
    public virtual bool runTest()
    {
        ...
        try
        {
            ...
            Console.WriteLine("2. IsReadOnly for filled dictionary");
            strLoc = "Loc_002oo"; 
            iCountTestcases++;
            ld.Clear();
            cnt = values.Length;
    ...
    {
        bool bResult = false;
        Co8692get_IsReadOnly cbA = new Co8692get_IsReadOnly();
        try 
        {
            bResult = cbA.runTest();
        } 
