...
using GenStrings;
public class Co8730HasKeys
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "NameValueCollection.HasKeys()";
    public static String s_strTFName        = "Co8730HasKeys.cs";
    ...
    {
        bool bResult = false;
        Co8730HasKeys cbA = new Co8730HasKeys();
        try 
        {
            bResult = cbA.runTest();
        } 
