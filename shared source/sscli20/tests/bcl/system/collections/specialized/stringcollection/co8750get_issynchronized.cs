...
public class Co8750get_IsSynchronized
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "StringCollection.IsSynchronized";
    public static String s_strTFName        = "Co8750get_IsSynchronized.cs";
    ...
    {
        bool bResult = false;
        Co8750get_IsSynchronized cbA = new Co8750get_IsSynchronized();
        try 
        {
            bResult = cbA.runTest();
        } 
