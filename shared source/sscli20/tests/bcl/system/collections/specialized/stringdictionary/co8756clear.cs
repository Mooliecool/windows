...
using GenStrings;
public class Co8756Clear
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "StringDictionary.Clear()";
    public static String s_strTFName        = "Co8756Clear.cs";
    ...
    public virtual bool runTest()
    {
        ...
        try
        {
            ...
            {
                iCountErrors++;
                Console.WriteLine("Err_0001_, count is {0} instead of {1} after default ctor", sd.Count, 0);
            }
            ...
            {
                iCountErrors++;
                Console.WriteLine("Err_0001, count is {0} instead of {1} after Clear()", sd.Count, 0);
            }
    ...
    {
        bool bResult = false;
        Co8756Clear cbA = new Co8756Clear();
        try 
        {
            bResult = cbA.runTest();
        } 
