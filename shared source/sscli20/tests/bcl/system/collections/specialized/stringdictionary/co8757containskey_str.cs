...
using GenStrings;
public class Co8757ContainsKey_str
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "StringDictionary.ContainsKey(string)";
    public static String s_strTFName        = "Co8757ContainsKey_str.cs";
    ...
    {
        bool bResult = false;
        Co8757ContainsKey_str cbA = new Co8757ContainsKey_str();
        try 
        {
            bResult = cbA.runTest();
        } 
