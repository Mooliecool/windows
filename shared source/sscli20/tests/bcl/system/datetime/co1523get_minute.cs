...
using System.Text;
using System;
public class Co1523get_Minute
{
 public static readonly String s_strActiveBugNums = "";
 public static readonly String s_strDtTmVer       = "";
 public static readonly String s_strClassMethod   = "DateTime.GetMinute()";
 public static readonly String s_strTFName        = "Co1523get_Minute.cs";
 public static readonly String s_strTFAbbrev      = "Co1523";
 ...
 public static void Main( String[] args )
   ...
   bool bResult = false; 
   StringBuilder sblMsg = new StringBuilder( 99 );
   Co1523get_Minute cbA = new Co1523get_Minute();
   try
     {
     bResult = cbA.runTest();
     }
