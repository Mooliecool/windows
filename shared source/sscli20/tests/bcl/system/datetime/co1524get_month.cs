...
using System.Text;
using System;
public class Co1524get_Month
{
 public static readonly String s_strActiveBugNums = "";
 public static readonly String s_strDtTmVer       = "";
 public static readonly String s_strClassMethod   = "DateTime.GetMonth()";
 public static readonly String s_strTFName        = "Co1524get_Month.cs";
 public static readonly String s_strTFAbbrev      = "Co1524";
 ...
 public static void Main( String[] args )
   ...
   bool bResult = false; 
   StringBuilder sblMsg = new StringBuilder( 99 );
   Co1524get_Month cbA = new Co1524get_Month();
   try
     {
     bResult = cbA.runTest();
     }
