...
using System.Text;
using System;
public class Co1526get_Year
{
 public static readonly String s_strActiveBugNums = "";
 public static readonly String s_strDtTmVer       = "";
 public static readonly String s_strClassMethod   = "DateTime.GetYear()";
 public static readonly String s_strTFName        = "Co1526get_Year.cs";
 public static readonly String s_strTFAbbrev      = "Co1526";
 ...
 public static void Main( String[] args )
   ...
   bool bResult = false; 
   StringBuilder sblMsg = new StringBuilder( 99 );
   Co1526get_Year cbA = new Co1526get_Year();
   try
     {
     bResult = cbA.runTest();
     }
