...
using System.Text;
using System;
public class Co1527get_Millisecond
{
 public static readonly String s_strActiveBugNums = "";
 public static readonly String s_strDtTmVer       = "";
 public static readonly String s_strClassMethod   = "DateTime.GetMillisecond()";
 public static readonly String s_strTFName        = "Co1527get_Millisecond.cs";
 public static readonly String s_strTFAbbrev      = "Co1527";
 ...
 public static void Main( String[] args )
   ...
   bool bResult = false; 
   StringBuilder sblMsg = new StringBuilder( 99 );
   Co1527get_Millisecond cbA = new Co1527get_Millisecond();
   try
     {
     bResult = cbA.runTest();
     }
