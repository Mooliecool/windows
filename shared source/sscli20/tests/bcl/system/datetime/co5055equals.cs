...
using System.IO;
using System;
public class Co5055Equals
{
 public static readonly String s_strActiveBugNums = "";
 public static readonly String s_strDtTmVer       = "";
 public static readonly String s_strClassMethod   = "DateTime.Equals(Object obj)";
 public static readonly String s_strTFName        = "Co5055Equals.cs";
 public static readonly String s_strTFAbbrev      = "Co5055";
 ...
 public virtual Boolean runTest()
   ...
   do
     {
     strLoc = "Loc_199qi";
     dt1 = new DateTime(2015,3,23,5,23,34);
     iCountTestcases++;
     if(dt1.Equals(null))
       {
       iCountErrors++;
       Console.WriteLine( s_strTFAbbrev+ "Err_129qi! , result=="+dt1.Equals(null));
       }
     strLoc = "Loc_825uw";
     inYear = 800;
     inMonth = 2;
 ...
 public static void Main(String[] args)
   ...
   Co5055Equals cbA = new Co5055Equals();
   try {
   bResult = cbA.runTest();
