...
public class Co7061ctor_iiiiiii_Calendar
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "DateTime (Int32,Int32,Int32,Int32,Int32,Int32,Int32,Calendar)"; 
 public static String s_strTFName        = "Co7061ctor_iiiiiii_Calendar.cs";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7061ctor_iiiiiii_Calendar cbA = new Co7061ctor_iiiiiii_Calendar();
   try {
   bResult = cbA.runTest();
