...
public class Co7020ToUInt32
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "DBNull.ToUInt32"; 
 public static String s_strTFName        = "Co7020ToUInt32.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     try
       {
       i32Ret = ((IConvertible)DBNull.Value).ToUInt32(null);
       ++iCountErrors;	
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7020ToUInt32 cbA = new Co7020ToUInt32();
   try {
   bResult = cbA.runTest();
