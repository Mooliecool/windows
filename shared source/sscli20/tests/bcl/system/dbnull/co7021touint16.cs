...
public class Co7021ToUInt16
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "DBNull.ToUInt16"; 
 public static String s_strTFName        = "Co7021ToUInt16.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     try
       {
       i16Ret = ((IConvertible)DBNull.Value).ToUInt16(null);
       ++iCountErrors;	
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7021ToUInt16 cbA = new Co7021ToUInt16();
   try {
   bResult = cbA.runTest();
