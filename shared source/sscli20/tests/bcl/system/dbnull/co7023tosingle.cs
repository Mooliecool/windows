...
public class Co7023ToSingle
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "DBNull.ToSingle"; 
 public static String s_strTFName        = "Co7023ToSingle.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     try
       {
       ReturnValue = ((IConvertible)DBNull.Value).ToSingle(null);
       ++iCountErrors;	
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7023ToSingle cbA = new Co7023ToSingle();
   try {
   bResult = cbA.runTest();
