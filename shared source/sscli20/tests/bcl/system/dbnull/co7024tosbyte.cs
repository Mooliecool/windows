...
public class Co7024ToSByte
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "DBNull.ToSByte"; 
 public static String s_strTFName        = "Co7024ToSByte.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     try
       {
       ReturnValue = ((IConvertible)DBNull.Value).ToSByte(null);
       ++iCountErrors;	
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7024ToSByte cbA = new Co7024ToSByte();
   try {
   bResult = cbA.runTest();
