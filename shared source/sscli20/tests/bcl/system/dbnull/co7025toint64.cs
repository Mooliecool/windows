...
public class Co7025ToInt64
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "DBNull.ToInt64"; 
 public static String s_strTFName        = "Co7025ToInt64.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     try
       {
       ReturnValue = ((IConvertible)DBNull.Value).ToInt64(null);
       ++iCountErrors;	
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7025ToInt64 cbA = new Co7025ToInt64();
   try {
   bResult = cbA.runTest();
