...
public class Co7027ToInt16
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "DBNull.ToInt16"; 
 public static String s_strTFName        = "Co7027ToInt16.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     try
       {
       ReturnValue = ((IConvertible)DBNull.Value).ToInt16(null);
       ++iCountErrors;	
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7027ToInt16 cbA = new Co7027ToInt16();
   try {
   bResult = cbA.runTest();
