...
public class Co7028ToDouble
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "DBNull.ToDouble"; 
 public static String s_strTFName        = "Co7028ToDouble.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     try
       {
       ReturnValue = ((IConvertible)DBNull.Value).ToDouble(null);
       ++iCountErrors;	
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7028ToDouble cbA = new Co7028ToDouble();
   try {
   bResult = cbA.runTest();
