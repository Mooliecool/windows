...
public class Co7029ToDecimal
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "DBNull.ToDecimal"; 
 public static String s_strTFName        = "Co7029ToDecimal.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     try
       {
       ReturnValue = ((IConvertible)DBNull.Value).ToDecimal(null);
       ++iCountErrors;	
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7029ToDecimal cbA = new Co7029ToDecimal();
   try {
   bResult = cbA.runTest();
