...
public class Co7030ToDateTime
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "DBNull.ToDateTime"; 
 public static String s_strTFName        = "Co7030ToDateTime.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     try
       {
       ReturnValue = ((IConvertible)DBNull.Value).ToDateTime(null);
       ++iCountErrors;	
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7030ToDateTime cbA = new Co7030ToDateTime();
   try {
   bResult = cbA.runTest();
