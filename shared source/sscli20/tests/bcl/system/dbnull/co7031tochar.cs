...
public class Co7031ToChar
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "DBNull.ToChar"; 
 public static String s_strTFName        = "Co7031ToChar.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     try
       {
       ReturnValue = ((IConvertible)DBNull.Value).ToChar(null);
       ++iCountErrors;	
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7031ToChar cbA = new Co7031ToChar();
   try {
   bResult = cbA.runTest();
