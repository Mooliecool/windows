...
public class Co7032ToByte
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "DBNull.ToByte"; 
 public static String s_strTFName        = "Co7032ToByte.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     try
       {
       ReturnValue = ((IConvertible)DBNull.Value).ToByte(null);
       ++iCountErrors;	
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7032ToByte cbA = new Co7032ToByte();
   try {
   bResult = cbA.runTest();
