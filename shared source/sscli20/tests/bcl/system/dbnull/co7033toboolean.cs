...
public class Co7033ToBoolean
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "DBNull.ToBoolean"; 
 public static String s_strTFName        = "Co7033ToBoolean.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     try
       {
       ReturnValue = ((IConvertible)DBNull.Value).ToBoolean(null);
       ++iCountErrors;	
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7033ToBoolean cbA = new Co7033ToBoolean();
   try {
   bResult = cbA.runTest();
