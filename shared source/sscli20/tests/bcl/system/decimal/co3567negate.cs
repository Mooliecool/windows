...
public class Co3567Negate
{
 static String strName = "Decimal.Negate";
 static String strTest = "Co3567Negate.cs";
 ...
 public Boolean runTest()
   ...
   try
	 ...
	 {
	 dcml1 = Decimal.Negate(dcmlValues[aa]);
	 ++iCountTestcases;
 ...
 public static void Main( String[] args ) 
   ...
   Co3567Negate oCbTest = new Co3567Negate();
   try
     {
