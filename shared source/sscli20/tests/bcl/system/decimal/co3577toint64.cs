...
public class Co3577ToInteger8
{
 static String strName = "Decimal.ToInteger8";
 static String strTest = "Co3577ToInteger8.cs";
 ...
 public Boolean runTest()
   ...
   Decimal[] dcmlSecondValues = {new Decimal(1234.567895969984), new Decimal(Int64.MaxValue), 
				 new Decimal(Int64.MinValue), new Decimal(Int32.MaxValue),
				 new Decimal(Int32.MinValue),
				 new Decimal(Int16.MaxValue), new Decimal(Int16.MinValue),
				 Decimal.Parse("0.999999999999999999999999", CultureInfo.InvariantCulture)};
   Int64[] in8SecondValues = {1234, Int64.MaxValue, 
			      Int64.MinValue, Int32.MaxValue,
			      Int32.MinValue,
   ...
   try
	 ...
	 {
	 in8a = Decimal.ToInt64(dcmlFirstValues[aa]);
	 ++iCountTestcases;
	 ...
	 {
	 in8a = Decimal.ToInt64(dcmlSecondValues[aa]);
	 ++iCountTestcases;
	 ...
	 try
	   {
	   ++iCountTestcases;
	   in8a = Decimal.ToInt64(dcmlExceptions[aa]);
	   ++iCountErrors;
 ...
 public static void Main( String[] args ) 
   ...
   Co3577ToInteger8 oCbTest = new Co3577ToInteger8();
   try
     {
