...
using System.IO;
using System;
public class Co3684ToString_Str
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Decimal.ToToString(String)";
 public static String s_strTFName        = "Co3684ToString_Str.cs";
 public static String s_strTFAbbrev      = "Co3684";
 ...
 public Boolean runTest()
   ...
   try
	 ...
	 {
	 str1 = dcmlValues[aa].ToString((IFormatProvider)null);
	 ++iCountTestcases;
	 ...
	 try
	   {
	   ++iCountTestcases;
	   str1 = dcmlExceptions[aa].ToString((IFormatProvider)null);
	   ++iCountErrors;
 ...
 public static void Main( String[] args ) 
   ...
   Co3684ToString_Str oCbTest = new Co3684ToString_Str();
   try
     {
