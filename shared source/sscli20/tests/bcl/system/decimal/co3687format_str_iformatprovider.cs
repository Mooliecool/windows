...
public class Co3687Format_str_IFormatProvider
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Decimal.ToString(String format, IFormatProvider format)";
 public static String s_strTFName        = "Co3687Format_str_IFormatProvider.cs";
 public static String s_strTFAbbrev      = "Co3687";
 ...
 public static void Main(String[] args) 
   ...
   Co3687Format_str_IFormatProvider cbA = new Co3687Format_str_IFormatProvider();
   try {
   bResult = cbA.runTest();
