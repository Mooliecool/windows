...
public class Co3689Parse_int_nfi
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Decimal.Parse(String format, int style, NFI nfi)";
 public static String s_strTFName        = "Co3689Parse_int_nfi.cs";
 public static String s_strTFAbbrev      = "Co3689";
 ...
 public Boolean runTest()
   ...
   do
     ...
     for (int i=0; i < dcmExpValues.Length;i++)
       {
       strLoc = strBaseLoc + i;
       dcml1 = Decimal.Parse(strGFormat1Values[i], NumberStyles.Any, nfi1);
       iCountTestcases++;
     ...
     for (int i=0; i < dcmExpValues.Length;i++)
       ...
       dcml1 = Decimal.Parse(strGFormat2Values[i], NumberStyles.Any, nfi1);
       iCountTestcases++;
     ...
     for (int i=0; i < dcmExpValues.Length;i++)
       {
       strLoc = strBaseLoc + i;
       dcml1 = Decimal.Parse(strCFormat1Values[i], NumberStyles.Any, nfi1);
       iCountTestcases++;
     ...
     for (int i=0; i < dcmExpValues.Length;i++)
       {
       strLoc = strBaseLoc + i;
       dcml1 = Decimal.Parse(strCFormat2Values[i], NumberStyles.Any, nfi1);
       iCountTestcases++;
     ...
     for (int i=0; i < dcmExpValues.Length;i++)
       {
       strLoc = strBaseLoc + i;
       dcml1 = Decimal.Parse(strEFormat1Values[i], NumberStyles.Any, nfi1);
       iCountTestcases++;
     ...
     for (int i=0; i < dcmExpValues.Length;i++)
       {
       strLoc = strBaseLoc + i;
       dcml1 = Decimal.Parse(strEFormat2alues[i], NumberStyles.Any, nfi1);
       iCountTestcases++;
     ...
     for (int i=0; i < dcmExpValues.Length;i++)
       {
       strLoc = strBaseLoc + i;
       dcml1 = Decimal.Parse(strNFormat1Values[i], NumberStyles.Any, nfi1);
       iCountTestcases++;
     ...
     for (int i=0; i < dcmExpValues.Length;i++)
       {
       strLoc = strBaseLoc + i;
       dcml1 = Decimal.Parse(strNFormat2Values[i], NumberStyles.Any, nfi1);
       iCountTestcases++;
     ...
     for (int i=0; i < dcmExpValues.Length;i++)
       {
       strLoc = strBaseLoc + i;
       dcml1 = Decimal.Parse(strFFormat1Values[i], NumberStyles.Any, nfi1);
       iCountTestcases++;
       if(dcml1 != dcmNFormat1ExpValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < dcmExpValues.Length;i++)
       {
       strLoc = strBaseLoc + i.ToString();
       dcml1 = Decimal.Parse(strFFormat2Values[i], NumberStyles.Any, nfi1);
       iCountTestcases++;
       if(dcml1 != dcmNFormat2ExpValues[i])
	 {
	 iCountErrors++;
 ...
 public static void Main(String[] args) 
   ...
   Co3689Parse_int_nfi cbA = new Co3689Parse_int_nfi();
   try {
   bResult = cbA.runTest();
