...
public class Co5717IConvertible_Double : IDescribeTestedMethods
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Iconvertible";
 public static String s_strTFName        = "Co5717IConvertible_Double.cs";
 ...
 public Boolean TestToBoolean(Double testSubject){
 strLoc = "Loc_498yv";
 Boolean b1 = false;
 Boolean b2 = false;
 Boolean pass = false;
 ...
 public Boolean TestToChar(Double testSubject) {
 strLoc = "498vy3";
 Char b1 = '\0';
 Char b2 = '\0';
 Boolean pass = false;
 ...
 public Boolean TestToSByte(Double testSubject) {
 strLoc = "r4987";
 SByte b1 = 0;
 SByte b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToByte(Double testSubject) {
 strLoc = "398f9";
 Byte b1 = 0;
 Byte b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToInt16(Double testSubject) {
 strLoc = "38f7c";
 Int16 b1 = 0;
 Int16 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToUInt16(Double testSubject) {
 strLoc = "298ss";
 UInt16 b1 = 0;
 UInt16 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToInt32(Double testSubject) {
 strLoc = "129s8";
 Int32 b1 = 0;
 Int32 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToUInt32(Double testSubject) {
 strLoc = "10299";
 UInt32 b1 = 0;
 UInt32 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToInt64(Double testSubject) {
 strLoc = "398f8";
 Int64 b1 = 0;
 Int64 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToUInt64(Double testSubject) {
 strLoc = "2908s";
 UInt64 b1 = 0;
 UInt64 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToSingle(Double testSubject) {
 strLoc = "200s9";
 Single b1 = 0;
 Single b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToDouble(Double testSubject) {
 strLoc = "20949";
 Double b1 = 0;
 Double b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToDecimal(Double testSubject) {
 strLoc = "2099x";
 Decimal b1 = 0;
 Decimal b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToDateTime(Double testSubject) {
 strLoc = "39848";
 ...
 public Boolean TestToString(Double testSubject) {
 strLoc = "3498d";
 String b1 = "";
 String b2 = "";
 Boolean pass = false;
 ...
 public Boolean TestToType(Double testSubject, Type typecode) {
 strLoc = "29848";
 Object b1 = 0;
 Object b2 = 0;
 Boolean pass = false;
 ...
 public bool runTest()
   ...
   try
     ...
     Double[] testSubjects = new Double[]{
       Double.MinValue,
       Double.MaxValue,
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5717IConvertible_Double cbA = new Co5717IConvertible_Double();
   try {
   bResult = cbA.runTest();
