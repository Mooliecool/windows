...
using System;
using System.IO; 
public class Co5325get_ExitCode
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Environment.SetExitCode(int)";
 public static String s_strTFName        = "Co5325get_ExitCode.cs";
 public static String s_strTFAbbrev      = "Co5325";
 ...
 public static void Main(String[] args) 
   ...
   Co5325get_ExitCode cbA = new Co5325get_ExitCode();
   try {
   bResult = cbA.runTest();
