...
public class Co5521set_CurrentDirectory_dir
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Directory.SetCurrentDirectory(Directory)";
 public static String s_strTFName        = "Co5521set_CurrentDirectory_dir.cs";
 public static String s_strTFAbbrev      = "Co5521";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5521set_CurrentDirectory_dir cbA = new Co5521set_CurrentDirectory_dir();
   try {
   bResult = cbA.runTest();
