...
using System;
using System.IO; 
public class Co5321Ctor_bytArr
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Guid.Box()";
 public static String s_strTFName        = "Co5321Ctor_bytArr.cs";
 public static String s_strTFAbbrev      = "Co5321";
 ...
 public static void Main(String[] args) 
   ...
   Co5321Ctor_bytArr cbA = new Co5321Ctor_bytArr();
   try {
   bResult = cbA.runTest();
