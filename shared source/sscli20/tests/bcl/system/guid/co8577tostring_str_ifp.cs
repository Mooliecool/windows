...
public class Co8577ToString_str_ifp
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Guid.ToString(String format, IFormatProvider provider)";
 public static String s_strTFName        = "Co8577ToString_str_ifp.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     retValue = gd1.ToString(format, info);
     ...
     try{
     retValue = gd1.ToString(exp, info);
     iCountErrors++;
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co8577ToString_str_ifp cbA = new Co8577ToString_str_ifp();
   try {
   bResult = cbA.runTest();
