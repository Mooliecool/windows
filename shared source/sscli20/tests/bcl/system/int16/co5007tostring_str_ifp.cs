...
public class Co5007Format_str_nfi
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Integer2.ToString(Integer2 value, String format, NumberFormatInfo info)";
 public static String s_strTFName        = "Co5007Format_str_nfi.cs";
 public static String s_strTFAbbrev      = "Co5007";
 ...
 public Boolean runTest()
   ...
   do
     ...
     for (int i=0; i < in2TestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = in2TestValues[i].ToString( "x3", nfi1);
     ...
     strOut = "00045";
     iCountTestcases++;
     if(!strOut.Equals(in2a.ToString( "0000#", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_279eo! ,strOut=="+in2a.ToString( "0000#", nfi1));
       }
     strLoc = "Loc_129nq";
     in2a = (Int16)29145;
     strOut = "29,145";
     iCountTestcases++;
     if(!strOut.Equals(in2a.ToString( "#,#.", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_931ee! ,strOut=="+in2a.ToString( "#,#.", nfi1));
       }
     strLoc = "Loc_145hw";
     in2a = (Int16)(34);
     strOut = "test 34 test";
     iCountTestcases++;
     if(!strOut.Equals(in2a.ToString( "test #### test", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_871wj! ,strOut=="+in2a.ToString( "test #### test", nfi1));
       }
     strLoc = "Loc_328au";
     in2a = (Int16)3034;
     strOut = "30.3E+002";
     iCountTestcases++;
     if(!strOut.Equals(in2a.ToString( "##.#E+000",nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_892wo! ,strOut=="+in2a.ToString( "##.#E+000",nfi1));
       }
     strLoc = "Loc_378nq";
     in2a = (Int16)1234;
     strOut = "ABC#1234";
     iCountTestcases++;
     if(!strOut.Equals(in2a.ToString( "'ABC#'##",nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_128qx! ,strOut=="+in2a.ToString( "'ABC#'##",nfi1));
       }
     strLoc = "Loc_400ne";
     in2a = (Int16)(1234);
     strOut = "01234";
     iCountTestcases++;
     if(!strOut.Equals(in2a.ToString( "00000;00;00",nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_539tw! ,strOut=="+in2a.ToString( "00000;000000;00",nfi1));
       }
     strLoc = "Loc_412he";
     in2a = (Int16)(-123);
     strOut = "^000123";
     iCountTestcases++;
     if(!strOut.Equals(in2a.ToString( "00;^000000;00",nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_739em! ,strOut=="+in2a.ToString( "00;^000000;00", nfi1));
       }
     strLoc = "Loc_415ue";
     in2a = (Int16)0;
     strOut = "000";
     iCountTestcases++;
     if(!strOut.Equals(in2a.ToString( "00;00;000",nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_638kl! ,strOut=="+in2a.ToString( "00;00;000", nfi1));
       }
     } while (false);
 ...
 public static void Main(String[] args) 
   ...
   Co5007Format_str_nfi cbA = new Co5007Format_str_nfi();
   try {
   bResult = cbA.runTest();
