...
public class Co5016Parse_int
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Integer2.Parse(String s, int style)";
 public static String s_strTFName        = "Co5016Parse_int.cs";
 public static String s_strTFAbbrev      = "Co5016";
 ...
 public Boolean runTest()
   ...
   do
     ...
     for (int i=0; i < in2TestValues.Length;i++)
       ...
       iCountTestcases++;
       strOut = in2TestValues[i].ToString( "");
       in2a = Int16.Parse(strOut, NumberStyles.Any);
     ...
     for (int i=0; i < in2TestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = in2TestValues[i].ToString( "G");
       in2a = Int16.Parse(strOut, NumberStyles.Any);
       if(in2a != in2TestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < in2TestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = in2TestValues[i].ToString( "G5");
       in2a = Int16.Parse(strOut, NumberStyles.Any);
       if(in2a != in2TestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < in2TestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = in2TestValues[i].ToString( "C");
       in2a = Int16.Parse(strOut, NumberStyles.Any);
       if(in2a != in2TestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < in2TestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = in2TestValues[i].ToString( "C4");
       in2a = Int16.Parse(strOut, NumberStyles.Any);
       if(in2a != in2TestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < in2TestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = in2TestValues[i].ToString( "D");
       in2a = Int16.Parse(strOut, NumberStyles.Any);
       if(in2a != in2TestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < in2TestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = in2TestValues[i].ToString( "D4");
       in2a = Int16.Parse(strOut, NumberStyles.Any);
       if(in2a != in2TestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < in2TestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = in2TestValues[i].ToString( "E");
       in2a = Int16.Parse(strOut, NumberStyles.Any);
       if(in2a != in2TestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < in2TestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = in2TestValues[i].ToString( "e4");
       in2a = Int16.Parse(strOut, NumberStyles.Any);
       if(in2a != in2TestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < in2TestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = in2TestValues[i].ToString( "N");
       in2a = Int16.Parse(strOut, NumberStyles.Any);
       if(in2a != in2TestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < in2TestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = in2TestValues[i].ToString( "N4");
       in2a = Int16.Parse(strOut, NumberStyles.Any);
       if(in2a != in2TestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < in2TestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = in2TestValues[i].ToString( "F");
       in2a = Int16.Parse(strOut, NumberStyles.Any);
       if(in2a != in2TestValues[i])
	 {
	 iCountErrors++;
     ...
     for (int i=0; i < in2TestValues.Length;i++)
       ...
       strLoc = strBaseLoc + i.ToString();
       iCountTestcases++;
       strOut = in2TestValues[i].ToString( "F4");
       in2a = Int16.Parse(strOut, NumberStyles.Any);
       if(in2a != in2TestValues[i])
	 {
	 iCountErrors++;
 ...
 public static void Main(String[] args) 
   ...
   Co5016Parse_int cbA = new Co5016Parse_int();
   try {
   bResult = cbA.runTest();
