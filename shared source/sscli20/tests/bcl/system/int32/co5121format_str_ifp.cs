...
public class Co5121Format_str_ifp
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Integer4.ToString(Integer4 value, String format, NumberFormatInfo info)";
 public static String s_strTFName        = "Co5121Format_str_ifp.cs";
 public static String s_strTFAbbrev      = "Co5121";
 ...
 public Boolean runTest()
   ...
   do
	 ...
	 {
	 iCountErrors++;
	 Console.WriteLine(s_strTFAbbrev+ "Err_837qo! , i=="+i+" strOut=="+strOut + ", returned==" + strResultXFormat2[i] + ", Value==" + in4TestValues[i]);
	 }
       }
 ...
 public static void Main(String[] args) 
   ...
   Co5121Format_str_ifp cbA = new Co5121Format_str_ifp();
   try {
   bResult = cbA.runTest();
