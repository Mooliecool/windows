...
public class Co8581Parse_str_ifp
{
 ...
 public Boolean runTest()
   ...
   strOut ="-2147483649";
   iCountTestcases++;
   strOut = in4TestValues[0].ToString( "C", nfi1);
   try {
   in4a = Int32.Parse(strOut, nfi1);
   iCountErrors++;
   Console.WriteLine(s_strTFAbbrev+ "Err_382er! ,in4a=="+in4a);
   ...
   in4a = Int32.Parse("~123", nfi1);
   iCountTestcases++;
   if(in4a != 123)
     {
     iCountErrors++;
     Console.WriteLine("Err_93475sdg! in4a=="+in4a);
     }
 ...
 public static void Main(String[] args) 
   ...
   Co8581Parse_str_ifp cbA = new Co8581Parse_str_ifp();
   try {
   bResult = cbA.runTest();
