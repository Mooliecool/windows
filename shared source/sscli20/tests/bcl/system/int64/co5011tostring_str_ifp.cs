...
public class Co5011Format_str_nfi
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Integer8.ToString(Integer8 value, String format, NumberFormatInfo info)";
 public static String s_strTFName        = "Co5011Format_str_nfi.cs";
 public static String s_strTFAbbrev      = "Co5011";
 ...
 public Boolean runTest()
   ...
   do
     ...
     strOut = "^humbug: 50";
     iCountTestcases++;
     if(!strOut.Equals(in8a.ToString( "'humbug:' ###", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_125jw! ,strOut=="+in8a.ToString( "'humbug:' ###", nfi1));
       }
     strLoc = "Loc_250ej";
     in8a = (Int64)45;
     strOut = "00045";
     iCountTestcases++;
     if(!strOut.Equals(in8a.ToString( "0000#", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_279eo! ,strOut=="+in8a.ToString( "0000#", nfi1));
       }
     strLoc = "Loc_129nq";
     in8a = (Int64)29145;
     strOut = "29,145";
     iCountTestcases++;
     if(!strOut.Equals(in8a.ToString( "#,#.", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_931ee! ,strOut=="+in8a.ToString( "#,#.", nfi1));
       }
     strLoc = "Loc_145hw";
     in8a = (Int64)(34);
     strOut = "test 34 test";
     iCountTestcases++;
     if(!strOut.Equals(in8a.ToString( "test #### test", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_871wj! ,strOut=="+in8a.ToString( "test #### test", nfi1));
       }
     strLoc = "Loc_328au";
     in8a = (Int64)3034;
     strOut = "30.3E+002";
     iCountTestcases++;
     if(!strOut.Equals(in8a.ToString( "##.#E+000",nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_892wo! ,strOut=="+in8a.ToString( "##.#E+000",nfi1));
       }
     strLoc = "Loc_378nq";
     in8a = (Int64)1234;
     strOut = "ABC#1234";
     iCountTestcases++;
     if(!strOut.Equals(in8a.ToString( "'ABC#'##",nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_128qx! ,strOut=="+in8a.ToString( "'ABC#'##",nfi1));
       }
     strLoc = "Loc_400ne";
     in8a = (Int64)(1234);
     strOut = "01234";
     iCountTestcases++;
     if(!strOut.Equals(in8a.ToString( "00000;00;00",nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_539tw! ,strOut=="+in8a.ToString( "00000;000000;00",nfi1));
       }
     strLoc = "Loc_412he";
     in8a = (Int64)(-123);
     strOut = "^000123";
     iCountTestcases++;
     if(!strOut.Equals(in8a.ToString( "00;^000000;00",nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_739em! ,strOut=="+in8a.ToString( "00;^000000;00", nfi1));
       }
     strLoc = "Loc_415ue";
     in8a = (Int64)0;
     strOut = "000";
     iCountTestcases++;
     if(!strOut.Equals(in8a.ToString( "00;00;000",nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_638kl! ,strOut=="+in8a.ToString( "00;00;000", nfi1));
       }
     } while (false);
 ...
 public static void Main(String[] args) 
   ...
   Co5011Format_str_nfi cbA = new Co5011Format_str_nfi();
   try {
   bResult = cbA.runTest();
