...
public class Co8582ToString_ifp
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Int64.ToString(IFormatProvider info)";
 public static String s_strTFName        = "Co8582ToString_ifp.cs";
 ...
 public static void Main(String[] args) 
   ...
   Co8582ToString_ifp cbA = new Co8582ToString_ifp();
   try {
   bResult = cbA.runTest();
