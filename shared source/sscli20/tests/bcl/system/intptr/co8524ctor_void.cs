...
using System;
using System.IO;
public class Co8524ctor_void
{
 public static readonly String s_strActiveBugNums = "";
 public static readonly String s_strDtTmVer       = "";
 public static readonly String s_strClassMethod   = "IntPtr.ctor(void *)";
 public static readonly String s_strTFName        = "Co8524ctor_void.cs";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co8524ctor_void cbA = new Co8524ctor_void();
   try {
   bResult = cbA.runTest();
