...
using System;
using System.IO;
public class Co8527GetHashCode
{
 public static readonly String s_strActiveBugNums = "";
 public static readonly String s_strDtTmVer       = "";
 public static readonly String s_strClassMethod   = "IntPtr.GetHashCode()";
 public static readonly String s_strTFName        = "Co8527GetHashCode.cs";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co8527GetHashCode cbA = new Co8527GetHashCode();
   try {
   bResult = cbA.runTest();
