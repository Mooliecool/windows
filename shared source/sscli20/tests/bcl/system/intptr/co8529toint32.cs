...
using System;
using System.IO;
public class Co8529ToInt32
{
 public static readonly String s_strActiveBugNums = "";
 public static readonly String s_strDtTmVer       = "";
 public static readonly String s_strClassMethod   = "IntPtr.ToInt32()";
 public static readonly String s_strTFName        = "Co8529ToInt32.cs";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co8529ToInt32 cbA = new Co8529ToInt32();
   try {
   bResult = cbA.runTest();
