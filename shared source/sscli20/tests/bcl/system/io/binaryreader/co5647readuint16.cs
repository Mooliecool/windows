...
using System.Net;
public class Co5647ReadUInt16
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "BinaryWriter.Write(Uint16)";
    public static String s_strTFName        = "Co5647ReadUInt16.cs";
    public static String s_strTFAbbrev      = "Co5647";
    ...
    private static UInt16[] ui16Arr = new UInt16[] {
                                                       UInt16.MinValue
                                                       ,UInt16.MaxValue
                                                       ,0
                                                       ,100
        ...
        try
        {
            ...
            try 
            {
                ...
                for(ii = 0 ; ii < ui16Arr.Length ;ii++) 
                {
                    ...
                    {
                        iCountErrors++;
                        printerr( "Error_298hg_"+ii+"! Expected=="+ui16Arr[ii]+" , got=="+ui16a);
                    }
                }
                iCountTestcases++;
                try 
                {
                    ...
                    iCountErrors++;
                    printerr( "Error_2389! Expected exception not thrown, ui16a=="+ui16a);
                } 
            ...
            try 
            {
                ...
                for(ii = 0 ; ii < ui16Arr.Length ;ii++) 
                {
                    ...
                    {
                        iCountErrors++;
                        printerr( "Error_48yf4_"+ii+"! Expected=="+ui16Arr[ii]+" , got=="+ui16a);
                    }
                }
                iCountTestcases++;
                try 
                {
                    ui16a = dr2.ReadUInt16();
                    iCountErrors++;
                    printerr( "Error_2d847! Expected exception not thrown, ui16a=="+ui16a);
                } 
                catch (EndOfStreamException) 
                {
                } 
            ...
            Thread tcpListenerThread = new Thread(new ThreadStart(Co5647ReadUInt16.StartListeningTcp));
    ...
    public static void StartListeningTcp() 
    {
        ...
        try 
        {
            ...
            UInt16 iTemp ;
            for(int i = 0 ; i < ui16Arr.Length ; i++) 
            {
                iTemp = br.ReadUInt16();
                if(iTemp != ui16Arr[i]) 
                {
                    iCountErrors++;
                    Console.WriteLine( "Error_5453c_"+i+"! Expected=="+ui16Arr[i]+", got=="+iTemp);
                }
            }
    ...
    {
        bool bResult = false;
        Co5647ReadUInt16 cbA = new Co5647ReadUInt16();
        try 
        {
            bResult = cbA.runTest();
        } 
