...
using System.Net;
public class Co5648ReadUInt32
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "BinaryReader.ReadUInt32()";
    public static String s_strTFName        = "Co5648ReadUInt32.cs";
    public static String s_strTFAbbrev      = "Co5648";
    ...
    private static UInt32[] ui32Arr = new UInt32[] {
                                                       UInt32.MinValue
                                                       ,UInt32.MaxValue
                                                       ,0
                                                       ,100
    ...
    public static void StartListeningTcp() 
    {
        ...
        try 
        {
            ...
            UInt32 iTemp ;
            for(int i = 0 ; i < ui32Arr.Length ; i++) 
            {
                iTemp = br.ReadUInt32();
                if(iTemp != ui32Arr[i]) 
                {
                    iCountErrors++;
                    Console.WriteLine( "Error_5453c_"+i+"! Expected=="+ui32Arr[i]+", got=="+iTemp);
                }
            }
