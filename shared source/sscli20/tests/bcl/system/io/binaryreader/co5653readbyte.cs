...
using System.Net;
public class Co5653ReadByte
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "BinaryWriter.Write(Byte)";
    public static String s_strTFName        = "Co5653ReadByte.cs";
    public static String s_strTFAbbrev      = "Co5653";
    ...
    private static Byte[] bytArr = new Byte[0];
    public bool runTest()
    {
        ...
        try
        {
            ...
            Thread tcpListenerThread = new Thread(new ThreadStart(Co5653ReadByte.StartListeningTcp));
    ...
    public static void StartListeningTcp() 
    {
        ...
        try 
        {
            ...
            for(int i = 0 ; i < bytArr.Length ; i++) 
            {
                ...
                {
                    iCountErrors++;
                    Console.WriteLine( "Error_0000_"+i+"! Expected=="+bytArr[i]+", got=="+iTemp);
                }
            }
    ...
    {
        bool bResult = false;
        Co5653ReadByte cbA = new Co5653ReadByte();
        try 
        {
            bResult = cbA.runTest();
        } 
