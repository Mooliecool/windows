...
public class Co5544Write_ui16
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "BinaryWriter.Write(Uint16)";
	public static String s_strTFName        = "Co5544Write_ui16.cs";
	public static String s_strTFAbbrev      = "Co5544";
	...
	{
		bool bResult = false;
		Co5544Write_ui16 cbA = new Co5544Write_ui16();
		try {
			bResult = cbA.runTest();
