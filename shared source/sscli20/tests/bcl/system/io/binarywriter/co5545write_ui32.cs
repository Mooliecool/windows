...
public class Co5545Write_ui32
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "BinaryWriter.Write(UInt32)";
	public static String s_strTFName        = "Co5545Write_ui32.cs";
	public static String s_strTFAbbrev      = "Co5545";
	...
	{
		bool bResult = false;
		Co5545Write_ui32 cbA = new Co5545Write_ui32();
		try {
			bResult = cbA.runTest();
