...
using System.Text;
public class Co5549Write_str
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "BinaryWriter.Write(String)";
	public static String s_strTFName        = "Co5549Write_str.cs";
	public static String s_strTFAbbrev      = "Co5549";
	...
	{
		bool bResult = false;
		Co5549Write_str cbA = new Co5549Write_str();
		try {
			bResult = cbA.runTest();
