...
public class Co5552Write_bArr
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "BinaryWriter.Write(Byte[])";
	public static String s_strTFName        = "Co5552Write_bArr.cs";
		...
		try
		{
			...
			try {
				...
				for(ii = 0 ; ii < bytArr.Length ;ii++) {
					iCountTestcases++;
					if(!(byt2 = dr2.ReadByte()).Equals(bytArr[ii])) {
						iCountErrors++;
	...
	{
		bool bResult = false;
		Co5552Write_bArr cbA = new Co5552Write_bArr();
		try {
			bResult = cbA.runTest();
