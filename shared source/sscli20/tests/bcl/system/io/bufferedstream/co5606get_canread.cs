...
using System.Net;
public class Co5606get_CanRead
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "BufferedStream.Flush()";
    public static String s_strTFName        = "Co5606get_CanRead.cs";
    public static String s_strTFAbbrev      = "Co5606";
    ...
    public static void Teleport(string address) 
    {
        ...
        {
            iCountErrors++;
            Console.WriteLine( "Error_434234! CanRead returned false");
        } 
    }
    public static void Main(String[] args)
    {
        bool bResult = false;
        Co5606get_CanRead cbA = new Co5606get_CanRead();
        try 
        {
            bResult = cbA.runTest();
        } 
