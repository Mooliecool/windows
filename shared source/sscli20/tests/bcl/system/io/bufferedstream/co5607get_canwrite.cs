...
using System.Net;
public class Co5607get_CanWrite
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "BufferedStream.Flush()";
    public static String s_strTFName        = "Co5607get_CanWrite.cs";
    public static String s_strTFAbbrev      = "Co5607";
    ...
    public bool runTest()
    {
        ...
        try
        {
            ...
            FileStream fs2;
            if(File.Exists("Co5607Test.tmp"))
                File.Delete("Co5607Test.tmp");
            strLoc = "Loc_02u9c";
            ...
            {
                iCountErrors++;
                printerr( "Error_1099c! CanWrite returned true for closed stream");
            } 
            strLoc = "Loc_20987";
            memstr2 = new MemoryStream();
            bs2 = new BufferedStream(memstr2);
            ...
            strLoc = "Loc_029uc";
            fs2 = new FileStream("Co5607Test.tmp", FileMode.Create, FileAccess.Write);
            ...
            bs2.Close();
            strLoc = "Loc_091uc";
            fs2 = new FileStream("Co5607Test.tmp", FileMode.Open, FileAccess.ReadWrite);
            bs2 = new BufferedStream(fs2);
            iCountTestcases++;
            if(!bs2.CanWrite) 
            {
            ...
            fs2.Close();
            strLoc = "Loc_09u9v";
            fs2 = new FileStream("Co5607Test.tmp", FileMode.Open, FileAccess.Read);
            bs2 = new BufferedStream(fs2);
            iCountTestcases++;
            if(bs2.CanWrite) 
            {
            ...
            Thread tcpListenerThread = new Thread(new ThreadStart(Co5607get_CanWrite.StartListeningTcp));
    ...
    public static void Teleport(string address) 
    {
        ...
        {
            iCountErrors++;
            Console.WriteLine( "Error_434234! CanWrite returned false");
        } 
    }
    public static void Main(String[] args)
    {
        bool bResult = false;
        Co5607get_CanWrite cbA = new Co5607get_CanWrite();
        try 
        {
            bResult = cbA.runTest();
        } 
