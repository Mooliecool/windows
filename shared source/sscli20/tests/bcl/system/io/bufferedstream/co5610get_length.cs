...
using System.Net;
public class Co5610get_Length
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "BufferedStream.Flush()";
    public static String s_strTFName        = "Co5610get_Length.cs";
    public static String s_strTFAbbrev      = "Co5610";
    ...
    public bool runTest()
    {
        ...
        try
        {
            ...
            Thread tcpListenerThread = new Thread(new ThreadStart(Co5610get_Length.StartListeningTcp));
    ...
    {
        bool bResult = false;
        Co5610get_Length cbA = new Co5610get_Length();
        try 
        {
            bResult = cbA.runTest();
        } 
