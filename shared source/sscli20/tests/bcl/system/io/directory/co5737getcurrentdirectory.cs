...
public class Co5737GetCurrentDirectory
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "Directory.GetCurrentDirectory()";
	public static String s_strTFName        = "Co5737GetCurrentDirectory.cs";
	public static String s_strTFAbbrev      = "Co5737";
	...
	{
		bool bResult = false;
		Co5737GetCurrentDirectory cbA = new Co5737GetCurrentDirectory();
		try {
			bResult = cbA.runTest();
