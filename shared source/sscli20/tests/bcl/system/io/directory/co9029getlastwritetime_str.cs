...
public class Co9029GetLastWriteTime_str
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "Directory.GetLastWriteTime()";
	public static String s_strTFName        = "Co9029GetLastWriteTime_str.cs";
	...
	{
		bool bResult = false;
		Co9029GetLastWriteTime_str cbA = new Co9029GetLastWriteTime_str();
		try {
			bResult = cbA.runTest();
