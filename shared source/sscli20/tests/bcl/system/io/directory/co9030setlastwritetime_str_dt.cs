...
public class Co9030SetLastWriteTime_str_dt
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "Directory.SetLastWriteTime()";
	public static String s_strTFName        = "Co9030SetLastWriteTime_str_dt.cs";
	...
	{
		bool bResult = false;
		Co9030SetLastWriteTime_str_dt cbA = new Co9030SetLastWriteTime_str_dt();
		try {
			bResult = cbA.runTest();
