...
public class Co5520get_Attributes
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "Directory.Attributes";
	public static String s_strTFName        = "Co5520get_Attributes.cs";
	public static String s_strTFAbbrev      = "Co5520";
	...
	{
		bool bResult = false;
		Co5520get_Attributes cbA = new Co5520get_Attributes();
		try {
			bResult = cbA.runTest();
