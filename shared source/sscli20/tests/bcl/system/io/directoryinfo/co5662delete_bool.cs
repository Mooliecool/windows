...
public class Co5662Delete_bool
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "Directory.Delete(Boolean)";
	public static String s_strTFName        = "Co5662Delete_bool.cs";
		...
		try
		{
...
#if !PLATFORM_UNIX
            // Unix allows files that are currently open to be
            // deleted.
			strLoc = "Loc_ty7gy";
			...
			try {
				...
				printerr( "Error_ty7b7! Expected exception not thrown");
                    ...
                    iCountErrors++ ;
				    printerr( "Unexpected exception occured, iexc=="+iexc.Message);
			} catch (Exception exc) {
				iCountErrors++;
...
#endif
#if !PLATFORM_UNIX
            // Unix allows read-only directories to be deleted.
			strLoc = "Loc_928yg";
	...
	{
		bool bResult = false;
		Co5662Delete_bool cbA = new Co5662Delete_bool();
		try {
			bResult = cbA.runTest();
