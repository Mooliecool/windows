...
public class Co5748get_LastAccessTime
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "Directory.LastAccessTime";
	public static String s_strTFName        = "Co5748get_LastAccessTime.cs";
	...
	{
		bool bResult = false;
		Co5748get_LastAccessTime cbA = new Co5748get_LastAccessTime();
		try {
			bResult = cbA.runTest();
