...
public class Co5749get_LastWriteTime
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "Directory.LastWriteTime";
	public static String s_strTFName        = "Co5749get_LastWriteTime.cs";
	...
	{
		bool bResult = false;
		Co5749get_LastWriteTime cbA = new Co5749get_LastWriteTime();
		try {
			bResult = cbA.runTest();
