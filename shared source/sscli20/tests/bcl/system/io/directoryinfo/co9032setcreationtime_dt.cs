...
public class Co9032set_CreationTime_dt
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "DirectoryInfo.CreationTime";
	public static String s_strTFName        = "Co9032set_CreationTime_dt.cs";
	...
	{
		bool bResult = false;
		Co9032set_CreationTime_dt cbA = new Co9032set_CreationTime_dt();
		try {
			bResult = cbA.runTest();
