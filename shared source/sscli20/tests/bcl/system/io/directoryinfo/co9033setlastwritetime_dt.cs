...
public class Co9033set_LastWriteTime_dt
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "DirectoryInfo.LastWriteTime";
	public static String s_strTFName        = "Co9033set_LastWriteTime_dt.cs";
	...
	public bool runTest()
	{
		...
		{   		
			...
			try {
				...
				if((dir2.LastWriteTime - dt).Minutes > 0) {
					iCountErrors++;
			...
			try {
				dir2.LastWriteTime =  new DateTime(2001,332,20,50,50,50) ;
                                ...
                                printinfo("Expected exception occured :: " + aoore.Message );
                        } catch (Exception exc) {
				iCountErrors++;
	...
	{
		bool bResult = false;
		Co9033set_LastWriteTime_dt cbA = new Co9033set_LastWriteTime_dt();
		try {
			bResult = cbA.runTest();
