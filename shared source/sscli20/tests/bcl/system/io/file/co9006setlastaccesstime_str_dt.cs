...
public class Co9006SetLastAccessTime_str_dt
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "File.GetLastAccessTime()";
	public static String s_strTFName        = "Co9006SetLastAccessTime_str_dt.cs";
	...
	{
		bool bResult = false;
		Co9006SetLastAccessTime_str_dt cbA = new Co9006SetLastAccessTime_str_dt();
		try {
			bResult = cbA.runTest();
