...
public class Co5711MoveTo_str
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "File.MoveTo(String)";
    public static String s_strTFName        = "Co5711MoveTo_str.cs";
    ...
    public bool runTest()
    {
        ...
        try
        {
            ...
            iCountTestcases++;
            if(!fil2.Name.Equals("TestTest.tmp")) 
            {
                iCountErrors++;
                printerr( "Error_2488g! Incorrect name=="+fil2.Name);
            }
            if(!File.Exists(fil2.Name)) 
            {
                iCountErrors++;
    ...
    {
        bool bResult = false;
        Co5711MoveTo_str cbA = new Co5711MoveTo_str();
        try 
        {
            bResult = cbA.runTest();
        } 
