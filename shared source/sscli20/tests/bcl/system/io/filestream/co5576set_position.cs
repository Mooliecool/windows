...
public class Co5576set_Position
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "File.set_Position";
    public static String s_strTFName        = "Co5576set_Position.cs";
    public static String s_strTFAbbrev      = "Co5576";
    ...
    {
        bool bResult = false;
        Co5576set_Position cbA = new Co5576set_Position();
        try 
        {
            bResult = cbA.runTest();
        } 
