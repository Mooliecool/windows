...
public class Co5716Read_bArr_i_i
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "FileStream.Read(Byte[], Int, Int";
    public static String s_strTFName        = "Co5716Read_bArr_i_i.cs";
    ...
    public bool runTest()
    {
        ...
        try
        {
            ...
            for(int iLoop = 0 ; iLoop < iArrInvalidValues.Length ; iLoop++)
            {
                ...
                try 
                {
                    fs2.Read(new Byte[]{1}, iArrInvalidValues[iLoop], 0);
                    iCountErrors++;
            ...
            for(int iLoop = 0 ; iLoop < iArrInvalidValues.Length ; iLoop++)
            {
                ...
                try 
                {
                    fs2.Read(new Byte[]{1}, 0, iArrInvalidValues[iLoop]);
                    iCountErrors++;
            ...
            for(int iLoop = 0 ; iLoop < iArrLargeValues.Length ; iLoop++)
            {
                ...
                try 
                {
                    fs2.Read(new Byte[]{1}, iArrLargeValues[iLoop], 0);
                    iCountErrors++;
            ...
            for(int iLoop = 0 ; iLoop < iArrLargeValues.Length ; iLoop++)
            {
                ...
                try 
                {
                    fs2.Read(new Byte[]{1}, 0, iArrLargeValues[iLoop]);
                    iCountErrors++;
            ...
            for(int iLoop = 0 ; iLoop < iArrValidValues.Length ; iLoop++)
            {
                ...
                fs2.Read(bReadArr, 0, iArrValidValues[iLoop]);
                if(fs2.Length != iArrValidValues[iLoop]) 
                {
                    iCountErrors++;
                    printerr( "Error_958yv! Incorrect count=="+count);
    ...
    {
        bool bResult = false;
        Co5716Read_bArr_i_i cbA = new Co5716Read_bArr_i_i();
        try 
        {
            bResult = cbA.runTest();
        } 
