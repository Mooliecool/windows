...
public class Co5721ReadByte
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "FileStream.ReadByte";
    public static String s_strTFName        = "Co5721ReadByte.cs";
    ...
    public bool runTest()
    {
        ...
        try
        {
            ...
            fs2.Write(bytArr, 0, bytArr.Length);		   
            fs2.Flush();
            fs2.Close();
            strLoc = "Loc_987hg";
            ...
            {
                iCountErrors++;
                printerr( "Error_2389! Expected exception not thrown, i32=="+i32);
            } 
            fs2.Close();
            if(File.Exists(filName))
                File.Delete(filName);
    ...
    {
        bool bResult = false;
        Co5721ReadByte cbA = new Co5721ReadByte();
        try 
        {
            bResult = cbA.runTest();
        } 
