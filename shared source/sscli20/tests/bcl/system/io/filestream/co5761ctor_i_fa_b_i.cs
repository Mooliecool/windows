...
public class Co5761ctor_i_fa_b_i
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "FileStream(Int32, FileAccess,Boolean, Boolean)";
    public static String s_strTFName        = "Co5761ctor_i_fa_b_i.cs";
    public static String s_strTFAbbrev      = "Co5761";
    ...
    {
        bool bResult = false;
        Co5761ctor_i_fa_b_i cbA = new Co5761ctor_i_fa_b_i();
        try 
        {
            bResult = cbA.runTest();
        } 
