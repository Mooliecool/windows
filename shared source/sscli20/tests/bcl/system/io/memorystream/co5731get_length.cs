...
public class Co5731get_Length
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "MemoryStream.get_Length";
    public static String s_strTFName        = "Co5731get_Length.cs";
    public static String s_strTFAbbrev      = "Co5731";
    ...
    {
        bool bResult = false;
        Co5731get_Length cbA = new Co5731get_Length();
        try 
        {
            bResult = cbA.runTest();
        } 
