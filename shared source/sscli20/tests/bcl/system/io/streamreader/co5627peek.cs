...
using System.Net;
public class Co5627Peek
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "StreamReader.Peek()";
    public static String s_strTFName        = "Co5627Peek.cs";
    ...
    public bool runTest()
    {
        ...
        try
        {
            ...
            {
                iCountErrors++;
                printerr( "Error_987yg! Incorrect character");
            }
            sr2.Close();
            iCountTestcases++;
            m_PortSetEvent.Reset();
            Thread tcpListenerThread = new Thread(new ThreadStart(Co5627Peek.StartListeningTcp));
    ...
    public static void StartListeningTcp() 
    {
        ...
        try 
        {
            ...
            try 
            {
                ...
                for(int i = 0 ; i < chArr.Length ; i++) 
                {
                    if((tmp = sr.Peek()) != (Int32)chArr[i]) 
                    {
                        iCountErrors++;
                        Console.WriteLine( "Error_4239!_"+i+"! Expected=="+(Int32)chArr[i]+", got=="+tmp);
                    }
                    sr.Read();
                }		
            } 
