...
public class Co9304ctor_str_b
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "StreamReader(String, boolean)";
	public static String s_strTFName        = "Co9304ctor_str_b.cs";
	...
	public bool runTest()
	{
		...
		try
		{
			...
			iCountTestcases++;
			try {
				sr2 = new StreamReader((String)null, false);
				iCountErrors++;
			...
			iCountTestcases++;
			try {
				sr2 = new StreamReader(Environment.CurrentDirectory, false);
				iCountErrors++;
			...
			iCountTestcases++;
			try {
				sr2 = new StreamReader("HHHHHHHHHHHHHHHHHHHHHHHHH", true);
				iCountErrors++;
			...
			sw2.Close();
			sr2 = new StreamReader(filName, false);
			iCountTestcases++;
			str2 = sr2.ReadToEnd();
			...
			sw2.Write("Hello\u00FFWorld");
			sw2.Close();
			sr2 = new StreamReader(filName, true);
			iCountTestcases++;
			str2 = sr2.ReadToEnd();
			if(!str2.Equals("Hello\u00FFWorld")) {
				iCountTestcases++;
	...
	{
		bool bResult = false;
		Co9304ctor_str_b cbA = new Co9304ctor_str_b();
		try {
			bResult = cbA.runTest();
