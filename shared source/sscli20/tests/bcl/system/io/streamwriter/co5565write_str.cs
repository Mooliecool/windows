...
using System.Net;
public class Co5565Write_str
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "StreamWriter.Write(String)";
    public static String s_strTFName        = "Co5565Write_str.cs";
    public static String s_strTFAbbrev      = "Co5565";
    ...
    public bool runTest()
    {
        ...
        try 
        {
            ...
            {
                iCountErrors++;
                printerr( "Error_24g88! Incorrect length on memory stream");
            }
        } 
        catch (Exception exc) 
        {
            iCountErrors++;
            printerr( "ERror_298xs! Unexpected exception thrown, exc=="+exc.ToString());
        }
        try 
        {
        ...
        Thread tcpListenerThread = new Thread(new ThreadStart(Co5565Write_str.StartListeningTcp));
    ...
    {
        bool bResult = false;
        Co5565Write_str cbA = new Co5565Write_str();
        try 
        {
            bResult = cbA.runTest();
        } 
