...
public class Co5592get_AutoFlush
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "StreamWriter.AutoFlush";
	public static String s_strTFName        = "Co5592get_AutoFlush.cs";
	public static String s_strTFAbbrev      = "Co5592";
	...
	{
		bool bResult = false;
		Co5592get_AutoFlush cbA = new Co5592get_AutoFlush();
		try {
			bResult = cbA.runTest();
