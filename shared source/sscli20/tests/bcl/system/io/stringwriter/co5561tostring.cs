...
using System.Text;
public class Co5561ToString
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "StringWriter.ToString()";
	public static String s_strTFName        = "Co5561ToString.cs";
	...
	public bool runTest()
	{
		...
		try {
			...
			iCountTestcases++;
			if(!sw.ToString().Equals(sb.ToString())) {
				iCountErrors++;
		...
		try {
			...
			iCountTestcases++;
			if(!sw.ToString().Equals(String.Empty)) {
				iCountErrors++;
	...
	{
		bool bResult = false;
		Co5561ToString cbA = new Co5561ToString();
		try {
			bResult = cbA.runTest();
