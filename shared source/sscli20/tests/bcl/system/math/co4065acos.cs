...
using System.Text;
using System;
public class Co4065Acos
{
 public virtual bool runTest()
   {
   Console.Out.WriteLine( "Co4065Acos.cs  runTest() started." );
   ...
   do
     ...
     try
       ...
       dubValue = ( 0 );
       dubEquation = Math.Acos( dubValue );
   ...
   if ( iCountErrors == 0 )
     {
     Console.Error.Write( "Math\\Co4065Acos.cs: paSs.  iCountTestcases==" );
     Console.Error.WriteLine( iCountTestcases );
     return true;
     }
   else
     {
     Console.Error.Write( "Co4065Acos.cs iCountErrors==" );
     Console.Error.WriteLine( iCountErrors );
     Console.Error.WriteLine(  "Co4065Acos.cs   FAiL !"  );
     return false;
     }
   }
 public static void Main( String[] args )
   ...
   try
     ...
     {
     bResult = false;
     Console.Error.WriteLine(  "Co4065Acos.cs"  );
