...
using System.IO;
using System;
public class Co4648Min_Byte
{
 static String strTest = "Co4648Min_Byte";
 ...
 public Boolean runTest()
   ...
   retVal = Math.Min (inpVal, inpVal2);
   strLoc = "Loc_1_101.2";
   iCountTestcases++;
   if (retVal != expVal) {
   iCountErrors++;
 ...
 public static void Main (String[] args) 
   ...
   Co4648Min_Byte cbA = new Co4648Min_Byte ();
   try {
   bResult = cbA.runTest();
   }
