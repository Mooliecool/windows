...
using System;
using System.IO;
public class Co5397Max_UInt64
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Math.Max(UInt64,UInt64)";
 public static String s_strTFName        = "Co5397Max_UInt64.cs";
 public static String s_strTFAbbrev      = "Co5397";
 ...
 public bool runTest()
   ...
   try
     ...
     if(i64ret != UInt64.MaxValue)
       {
       iCountErrors++;
       printerr("Error_2908x! expected=="+UInt64.MaxValue.ToString()+" , value=="+i64ret.ToString());
       }
     strLoc = "Loc_6745x";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5397Max_UInt64 cbA = new Co5397Max_UInt64();
   try {
   bResult = cbA.runTest();
