...
using System;
using System.IO;
public class Co5400Min_UInt16
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Math.Min(UInt16,UInt16)";
 public static String s_strTFName        = "Co5400Min_UInt16.cs";
 public static String s_strTFAbbrev      = "Co5400";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5400Min_UInt16 cbA = new Co5400Min_UInt16();
   try {
   bResult = cbA.runTest();
