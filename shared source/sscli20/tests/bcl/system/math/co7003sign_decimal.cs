...
public class Co7003Sign_Decimal
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Math.Sign(Decimal)"; 
 public static String s_strTFName        = "Co7003Sign_Decimal.cs";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7003Sign_Decimal cbA = new Co7003Sign_Decimal();
   try {
   bResult = cbA.runTest();
