...
public class Co7005Cosh_Double
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Math.Cosh(Double)"; 
 public static String s_strTFName        = "Co7005Cosh_Double.cs";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7005Cosh_Double cbA = new Co7005Cosh_Double();
   try {
   bResult = cbA.runTest();
