...
public class Co7007Tanh_Double
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Math.Tanh(Double)"; 
 public static String s_strTFName        = "Co7007Tanh_Double.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     for (da = -10; da <= 10; da = da + 0.01)
       {
       iCountTestcases++;
       dactual = (Math.Exp (da) - Math.Exp (-1 * da))/(Math.Exp (da) + Math.Exp (da * -1));
       dret = Math.Tanh (da);
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7007Tanh_Double cbA = new Co7007Tanh_Double();
   try {
   bResult = cbA.runTest();
