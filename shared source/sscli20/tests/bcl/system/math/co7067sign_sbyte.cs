...
public class Co7067Sign_SByte
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Math.Sign(SByte)"; 
 public static String s_strTFName        = "Co7067Sign_SByte.cs";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7067Sign_SByte cbA = new Co7067Sign_SByte();
   try {
   bResult = cbA.runTest();
