...
using System.IO;
public class Co8630get_Name
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "SerializationEntry.Name";
	public static String s_strTFName        = "Co8630get_Name.cs";
	...
	{
		bool bResult = false;
		Co8630get_Name cbA = new Co8630get_Name();
		try {
			bResult = cbA.runTest();
