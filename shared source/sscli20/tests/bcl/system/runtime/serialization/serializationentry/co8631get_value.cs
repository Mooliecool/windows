...
using System.IO;
public class Co8631get_Value
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "SerializationEntry.Value";
	public static String s_strTFName        = "Co8631get_Value.cs";
	...
	{
		bool bResult = false;
		Co8631get_Value cbA = new Co8631get_Value();
		try {
			bResult = cbA.runTest();
