...
public class Co5248ctor_SCS_obj
{
	public static readonly String s_strActiveBugNums = "";
	public static readonly String s_strDtTmVer       = "";
	public static readonly String s_strClassMethod   = "StreamingContext(StreamingContextSates state, Object obj)";
	public static readonly String s_strTFName        = "Co5248ctor_SCS_obj.cs";
	public static readonly String s_strTFAbbrev      = "Co5248";
	...
	{
		bool bResult = false;
		Co5248ctor_SCS_obj cbA = new Co5248ctor_SCS_obj();
		try {
			bResult = cbA.runTest();
