...
public class Co5249get_State
{
	public static readonly String s_strActiveBugNums = "";
	public static readonly String s_strDtTmVer       = "";
	public static readonly String s_strClassMethod   = "StreamingContext()";
	public static readonly String s_strTFName        = "Co5249get_State.cs";
	public static readonly String s_strTFAbbrev      = "Co5249";
	...
	{
		bool bResult = false;
		Co5249get_State cbA = new Co5249get_State();
		try {
			bResult = cbA.runTest();
