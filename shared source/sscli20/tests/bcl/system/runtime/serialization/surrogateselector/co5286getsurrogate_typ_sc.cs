...
public class Co5286GetSurrogate_typ_sc
{
	public static String s_strActiveBugNums = "";
	public static String s_strDtTmVer       = "";
	public static String s_strClassMethod   = "SurrogateSelector.AddSurrogate(SurrogateInfo surrogates[])";
	public static String s_strTFName        = "Co5286GetSurrogate_typ_sc.cs";
	public static String s_strTFAbbrev      = "Cb5285";
	...
	{
		bool bResult = false;
		Co5286GetSurrogate_typ_sc cbA = new Co5286GetSurrogate_typ_sc();
		try {
			bResult = cbA.runTest();
