...
public class Co3664Parse_int_nfi
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "SignedByte.Parse(String s, int style, NumberFormatInfo info)";
 public static String s_strTFName        = "Co3664Parse_int_nfi.cs";
 public static String s_strTFAbbrev      = "Co3664";
 ...
 public static void Main(String[] args) 
   ...
   Co3664Parse_int_nfi cbA = new Co3664Parse_int_nfi();
   try {
   bResult = cbA.runTest();
