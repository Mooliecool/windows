...
public class Co3665Format_str_IFormatProvider
{
 ...
 public static String s_strTFName        = "Co3665Format_str_IFormatProvider.cs";
 public static String s_strTFAbbrev      = "Cb3662";
 ...
 public Boolean runTest()
   ...
   do
     ...
     if(!str1.Equals(byt1a.ToString( "'humbug:' ###", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_125rt! ,format=="+byt1a.ToString( "'humbug:' ###", nfi1));
       }
     strLoc = "Loc_250ej";
     byt1a = 45;
     str1 = "00045";
     ...
     if(!str1.Equals(byt1a.ToString( "0000#", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_279eo! ,format=="+byt1a.ToString( "0000#", nfi1));
       }
     strLoc = "Loc_140jj";
     byt1a = 23;
     str1 = "%2300";
     ...
     if(!str1.Equals(byt1a.ToString( "%#", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_182nq! ,format=="+byt1a.ToString( "%#", nfi1));
       }
     strLoc = "Loc_145hw";
     byt1a = 34;
     str1 = "test 34 test";
     ...
     if(!str1.Equals(byt1a.ToString("test #### test", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_871wj! ,format=="+byt1a.ToString("test #### test", nfi1));
       }
     strLoc = "Loc_328au";
     byt1a = 33;
     str1 = "33E+000";
     ...
     if(!str1.Equals(byt1a.ToString( "##.#E+000", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_892wo! ,format=="+byt1a.ToString( "##.#E+000", nfi1));
       }
     strLoc = "Loc_329er";
     byt1a = 33;
     str1 = "33e+000";
     ...
     if(!str1.Equals(byt1a.ToString("##.#e+000", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_293nw! ,format==" + byt1a.ToString("##.#e+000", nfi1));
       }
     strLoc = "Loc_347yu";
     byt1a = 123;
     str1 = "12\\3";
     ...
     if(!str1.Equals(byt1a.ToString("##\\\\#", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_087he! ,format=="+byt1a.ToString("##\\\\#", nfi1));
       }
     strLoc = "Loc_378nq";
     byt1a = 123;
     str1 = "ABC#123";
     ...
     if(!str1.Equals(byt1a.ToString("'ABC#'##", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_128qx! ,strOut==" + byt1a.ToString("'ABC#'##", nfi1));
       }
     strLoc = "Loc_400ne";
     byt1a = (123);
     str1 = "00123";
     ...
     if(!str1.Equals(byt1a.ToString("00000;00;00", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_539tw! ,strOut==" + byt1a.ToString("00000;00;00", nfi1));
       }
     strLoc = "Loc_415ue";
     byt1a = 0;
     str1 = "000";
     ...
     if(!str1.Equals(byt1a.ToString("00;00;000", nfi1)))
       {
       iCountErrors++;
       Console.WriteLine(s_strTFAbbrev+ "Err_638kl! ,strOut==" + byt1a.ToString("00;00;000", nfi1));
       }
     } while (false);
 ...
 public static void Main(String[] args) 
   ...
   Co3665Format_str_IFormatProvider cbA = new Co3665Format_str_IFormatProvider();
   try {
   bResult = cbA.runTest();
