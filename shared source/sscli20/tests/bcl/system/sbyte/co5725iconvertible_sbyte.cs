...
public class Co5725IConvertible_SByte : IDescribeTestedMethods
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Iconvertible";
 public static String s_strTFName        = "Co5725IConvertible_SByte.cs";
 ...
 public Boolean TestToBoolean(SByte testSubject){
 strLoc = "Loc_498yv";
 Boolean b1 = false;
 Boolean b2 = false;
 Boolean pass = false;
 ...
 public Boolean TestToChar(SByte testSubject) {
 strLoc = "498vy3";
 Char b1 = '\0';
 Char b2 = '\0';
 Boolean pass = false;
 ...
 public Boolean TestToSByte(SByte testSubject) {
 strLoc = "r4987";
 SByte b1 = 0;
 SByte b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToByte(SByte testSubject) {
 strLoc = "398f9";
 Byte b1 = 0;
 Byte b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToInt16(SByte testSubject) {
 strLoc = "38f7c";
 Int16 b1 = 0;
 Int16 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToUInt16(SByte testSubject) {
 strLoc = "298ss";
 UInt16 b1 = 0;
 UInt16 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToInt32(SByte testSubject) {
 strLoc = "129s8";
 Int32 b1 = 0;
 Int32 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToUInt32(SByte testSubject) {
 strLoc = "10299";
 UInt32 b1 = 0;
 UInt32 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToInt64(SByte testSubject) {
 strLoc = "398f8";
 Int64 b1 = 0;
 Int64 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToUInt64(SByte testSubject) {
 strLoc = "2908s";
 UInt64 b1 = 0;
 UInt64 b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToSingle(SByte testSubject) {
 strLoc = "200s9";
 Single b1 = 0;
 Single b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToDouble(SByte testSubject) {
 strLoc = "20949";
 Double b1 = 0;
 Double b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToDecimal(SByte testSubject) {
 strLoc = "2099x";
 Decimal b1 = 0;
 Decimal b2 = 0;
 Boolean pass = false;
 ...
 public Boolean TestToDateTime(SByte testSubject) {
 strLoc = "39848";
 ...
 public Boolean TestToType(SByte testSubject, Type typecode) {
 strLoc = "29848";
 Object b1 = 0;
 Object b2 = 0;
 Boolean pass = false;
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5725IConvertible_SByte cbA = new Co5725IConvertible_SByte();
   try {
   bResult = cbA.runTest();
