...
using GenStrings;
public class Co3418IndexOfAny_CharArrInt
{
 static String strName = "String.IndexOfAny";
 static String strTest = "Co3418IndexOfAny_CharArrInt.";
 ...
 public Boolean runTest()
   ...
   try
     ...
     try
       {
       iResult = str1.IndexOfAny( chArr1 , iArrInvalidValues[iLoop] );
       iCountErrors++;
     ...
     try
       {
       iResult = intlString.IndexOfAny( chArr1 , iArrLargeValues[iLoop] );
       iCountErrors++;
     ...
     try
       {                            
       iResult = intlString.IndexOfAny( chArr1 , iArrValidValues[iLoop] );
       if ( iResult == -1 ){
       iCountErrors++;
     ...
     if(myIntlString.IndexOfAny(myCharArr) == -1) {     
       myIntlString = String.Concat(myIntlString, "!@@!");
       if(myIntlString.IndexOfAny(myCharArr) < 9) {
       Console.WriteLine( "Error_ABCD!!! - myIntlString.IndexOfAny(myCharArr) = [{0}]", myIntlString.IndexOfAny(myCharArr) );
       ++iCountErrors;
       }
     }
     ...
     ++iCountTestcases;
     if ( str1.IndexOfAny(chArr1, 6) != 14 )
       {
       ++iCountErrors;
       strInfo = strTest + " error: ";
     ...
     ++iCountTestcases;
     if ( str1.IndexOfAny(chArr1, 15) != -1 )
       {
       ++iCountErrors;
       strInfo = strTest + " error: ";
     ...
     chArr1[4]='D';
     ++iCountTestcases;
     if ( str1.IndexOfAny(chArr1, 0) != 0 )
       {
       ++iCountErrors;
       strInfo = strTest + " error: ";
       strInfo += "FAiL. E_203wo" ;
       Console.WriteLine( strTest+ strInfo );
       }
     chArr1[4]='Z'; 
     chArr1[4]='D';
     ++iCountTestcases;
     if ( str1.IndexOfAny(chArr1, 1) != 5 )
       {
       ++iCountErrors;
       strInfo = strTest + " error: ";
     ...
     chArr1[3] = '\0';
     ++iCountTestcases;
     if ( str1.IndexOfAny(chArr1, 14) != 14 )
       {
       ++iCountErrors;
       strInfo = strTest + " error: ";
 ...
 public static void Main( String[] args ) 
   ...
   Co3418IndexOfAny_CharArrInt oCbTest = new Co3418IndexOfAny_CharArrInt();
   try
     {
