...
public class co4829ctor_string_string_string
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "String(string, string, string)";
 public static String s_strTFName        = "co4829ctor_string_string_string";
 ...
 public bool runTest()
   ...
   try
     ...
     strLoc = "Loc_498hv";
     iCountTestcases++;
     str = String.Concat (str1, str2, str3);
     ...
     iCountTestcases++;
     try {
     str = String.Concat (null, str2, str3);
     if(!str.Equals (String.Empty))
       {
       iCountErrors++;
     ...
     iCountTestcases++;
     try {
     str = String.Concat (str1, null, str3);
     if(!str.Equals (String.Empty))
       {
       iCountErrors++;
     ...
     iCountTestcases++;
     try {
     str = String.Concat (str1, str2, null);
     if(!str.Equals (String.Empty))
       {
       iCountErrors++;
     ...
     iCountTestcases++;
     try {
     str = String.Concat (null, null, null);
     if(str != String.Empty) 
       {
       iCountErrors++;
       printerr( "Error_687ch.4! incorrect string returned for null argument=="+ str + "!");
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   co4829ctor_string_string_string cbA = new co4829ctor_string_string_string();
   try {
   bResult = cbA.runTest();
