...
using System.IO; 
using System;
public class Co5101Format_str_4objs
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "String.Format(String format, Object[] args)";
 public static String s_strTFName        = "Co5101Format_str_4objs"; 
 public static String s_strTFAbbrev      = "Co5101";
 ...
 public Boolean runTest()
   ...
   do
     {
     Console.WriteLine( "[] Verifying ArgumentException when passing in null for format string." );
     strLoc = "Loc_100aa";
     iCountTestcases++;
     try {
     ...
     Console.WriteLine( "[] Passing in null for object array." );
     strLoc = "Loc_100bb";
     strFormat = ""; 
     iCountTestcases++;
     try {
     ...
     Console.WriteLine( "[] Testing Byte, Sbyte, Integer2, Integer4 Formatting, Format(String, Object[]) " );
     ...
     Console.WriteLine( "[] Testing Decimal Format." );
     ...
     Console.WriteLine( "[]  Testing Engineering Format." );
     ...
     Console.WriteLine( "[] Testing Fixed Point Format." );
     ...
     Console.WriteLine( "[] Testing General Format." );
     ...
     Console.WriteLine( "[] Testing Number Format." );
     ...
     Console.WriteLine( "[]  Testing Hexidecimal Format." );
     ...
     Console.WriteLine( "[] Testing Integer8, Single, Double Formatting Format(String, Object[])." );
     Console.WriteLine( "[] Testing Currency Format." );
 ...
 public static void Main(String[] args) 
   ...
   Co5101Format_str_4objs cbA = new Co5101Format_str_4objs();
   try {
   bResult = cbA.runTest();
