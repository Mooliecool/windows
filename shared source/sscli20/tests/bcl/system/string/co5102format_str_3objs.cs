...
using System.IO; 
using System;
public class Co5102Format_str_3objs
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "String.Format(String format, Object[] objs)";
 public static String s_strTFName        = "Co5102Format_str_3objs";
 public static String s_strTFAbbrev      = "Co5102";
 ...
 public Boolean runTest()
   ...
   do
	 ...
	 {
	 iCountErrors++;
	 Console.WriteLine( s_strTFAbbrev+ "Err_2837s (ii="+ ii.ToString() +")! , strResult=="+strResult+" strExpected=="+strExpectedResult);
	 }
       }
	 ...
	 {
	 iCountErrors++;
	 Console.WriteLine( s_strTFAbbrev+ "Err_374aa (ii="+ ii.ToString() +")! , strResult=="+strResult+" strExpected=="+strExpectedResult);
	 }
       }
	 ...
	 {
	 iCountErrors++;
	 Console.WriteLine( s_strTFAbbrev+ "Err_27sii (ii="+ ii.ToString() +")! , strResult=="+strResult+" strExpected=="+strExpectedResult);
	 }
       }
	 ...
	 {
	 iCountErrors++;
	 Console.WriteLine( s_strTFAbbrev+ "Err_11173 (ii="+ ii.ToString() +")! , strResult=="+strResult+" strExpected=="+strExpectedResult);
	 }
       }
	 ...
	 {
	 iCountErrors++;
	 Console.WriteLine( s_strTFAbbrev+ "Err_287dy (ii="+ ii.ToString() +")! , strResult=="+strResult+" strExpected=="+strExpectedResult);
	 }
       }
     } while (false);
 ...
 public static void Main(String[] args) 
   ...
   Co5102Format_str_3objs cbA = new Co5102Format_str_3objs();
   try {
   bResult = cbA.runTest();
