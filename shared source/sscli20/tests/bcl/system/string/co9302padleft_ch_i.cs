...
public class Test{
 ...
 try
   {
   strNewString = strNewString.PadLeft(iArrInvalidValues[iLoop], 'c');
   iCountErrors++;                        
 ...
 try
   {
   strNewString = strNewString.PadLeft(iArrLargeValues[iLoop], 'c');
 ...
 try
   {                            
   strNewString = strNewString.PadLeft(iArrValidValues[iLoop], 'c');
