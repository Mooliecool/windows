...
public class Test{
 ...
 try
   {
   strNewString = strNewString.PadRight(iArrInvalidValues[iLoop]);
   iCountErrors++;                        
 ...
 try
   {
   strNewString = strNewString.PadRight(iArrLargeValues[iLoop]);
 ...
 try
   {                            
   strNewString = strNewString.PadRight(iArrValidValues[iLoop]);
