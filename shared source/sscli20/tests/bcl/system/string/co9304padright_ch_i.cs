...
public class Test{
 ...
 try
   {
   strNewString = strNewString.PadRight(iArrInvalidValues[iLoop], 'c');
   iCountErrors++;                        
 ...
 try
   {
   strNewString = strNewString.PadRight(iArrLargeValues[iLoop], 'c');
 ...
 try
   {                            
   strNewString = strNewString.PadRight(iArrValidValues[iLoop], 'c');
