...
using System;
using System.IO;
public class Co2912Compare
{
 public static String strName = "TimeSpan.Compare";
 public static String strTest = "Co2912Compare";
 ...
 public static void Main( String[] args )
   {
   bool bResult = false;	
   Co2912Compare oCbTest = new Co2912Compare();
   try
     {
