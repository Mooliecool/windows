...
using System;
using System.IO;
public class Co2916get_Days
{
 public static String strName = "TimeSpan.Days";
 public static String strTest = "Co2916get_Days";
 ...
 public virtual bool runTest()
   ...
   do
     {
     ++iCountTestcases;
     Console.Error.WriteLine( "[]  Construct TimeSpan object using 4.5 days" );
     try
       {
       double dblDays = 4.50;
       iDays = 4;
     ...
     ++iCountTestcases;
     Console.Error.WriteLine( "[]  Construct TimeSpan object using negative 4.5 days" );
     try
       {
       double dblDays = -4.50;
       iDays = -4;
     ...
     try
       {
       double dblDays = Double.MaxValue;
       ts = TimeSpan.FromDays( dblDays );
 ...
 public static void Main( String[] args )
   {
   bool bResult = false;	
   Co2916get_Days oCbTest = new Co2916get_Days();
   try
     {
