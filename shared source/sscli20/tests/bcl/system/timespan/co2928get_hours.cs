...
using System;
using System.IO;
public class Co2928get_Hours
{
 public static String strName = "TimeSpan.GetHours";
 public static String strTest = "Co2928get_Hours";
 ...
 public static void Main( String[] args )
   {
   bool bResult = false;	
   Co2928get_Hours oCbTest = new Co2928get_Hours();
   try
     {
