...
using System;
using System.IO;
public class Co2930Milliseconds
{
 public static String strName = "TimeSpan.Milliseconds";
 public static String strTest = "Co2930Milliseconds";
 ...
 public virtual bool runTest()
   ...
   do
     {
     ++iCountTestcases;
     Console.Error.WriteLine( "[]  Construct TimeSpan object using 4.5 days in milliseconds" );
     try
       {
       double dblMilliseconds = 4.50 * 24.0 * 60.0 * 60.0 * 1000.0;
       iDays = 4;
       iHours = 12;
       iMinutes = 0;
       iSeconds = 0;
       ts = TimeSpan.FromMilliseconds( dblMilliseconds );
       if ( iDays != ts.Days )
	 {
     ...
     ++iCountTestcases;
     Console.Error.WriteLine( "[]  Construct TimeSpan object using negative 4.5 days in milliseconds." );
     try
       {
       double dblMilliseconds = -4.50 * 24.0 * 60.0 * 60.0 * 1000.0;
       iDays = -4;
     ...
     try
       {
       double dblMilliseconds = Double.MaxValue;
       ts = TimeSpan.FromMilliseconds( dblMilliseconds );
 ...
 public static void Main( String[] args )
   {
   bool bResult = false;	
   Co2930Milliseconds oCbTest = new Co2930Milliseconds();
   try
     {
