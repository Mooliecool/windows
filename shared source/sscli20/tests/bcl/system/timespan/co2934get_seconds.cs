...
using System;
using System.IO;
public class Co2934get_Seconds
{
 public static String strName = "TimeSpan.GetSeconds";
 public static String strTest = "Co2934get_Seconds";
 ...
 public static void Main( String[] args )
   {
   bool bResult = false;	
   Co2934get_Seconds oCbTest = new Co2934get_Seconds();
   try
     {
