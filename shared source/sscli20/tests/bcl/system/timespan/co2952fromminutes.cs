...
using System;
using System.IO;
public class Co2952Minutes
{
 public static String strName = "TimeSpan.Minutes";
 public static String strTest = "Co2952Minutes";
 ...
 public virtual bool runTest()
   ...
   do
     {
     ++iCountTestcases;
     Console.Error.WriteLine( "[]  Construct TimeSpan object using 4.5 days in minutes" );
     try
       {
       double dblMinutes = 4.50*24.0*60.0;
       iDays = 4;
       iHours = 12;
       iMinutes = 0;
       iSeconds = 0;
       ts = TimeSpan.FromMinutes( dblMinutes );
       if ( iDays != ts.Days )
	 {
     ...
     ++iCountTestcases;
     Console.Error.WriteLine( "[]  Construct TimeSpan object using negative 4.5 days in minutes." );
     try
       {
       double dblMinutes = -4.50 * 24.0 * 60.0;
       iDays = -4;
     ...
     try
       {
       double dblMinutes = Double.MaxValue;
       ts = TimeSpan.FromMinutes( dblMinutes );
 ...
 public static void Main( String[] args )
   {
   bool bResult = false;	
   Co2952Minutes oCbTest = new Co2952Minutes();
   try
     {
