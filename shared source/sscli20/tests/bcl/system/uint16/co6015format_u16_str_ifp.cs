...
public class Co6015Format_u16_str_ifp
{
 ...
 public static String s_strComponentBeingTested
   = "UInt16.ToString( UInt16, String, IFormatProvider )";
 public static String s_strTFName        = "Co6015Format_u16_str_ifp.cs";
 public static String s_strTFAbbrev      = "Co6015";
 ...
 public Boolean runTest()
   ...
   try
     ...
     if ( primativeUShort[i].ToString( "C", nfi ).Equals( currencyResults[i] ) != true ) ErrorCode(primativeUShort[i].ToString( "C", nfi ));
     } catch( Exception e ) {
     iCountErrors++;
     ...
     if ( primativeUShort[i].ToString( "D", nfi ).Equals( decimalResults[i] ) != true ) ErrorCode(primativeUShort[i].ToString( "d", nfi ));
     } catch( Exception e ) {
     iCountErrors++;
     Console.WriteLine( "Testcase["+iCountTestcases+"]" );
     Console.WriteLine( "Exception:" + e );
     ...
     if ( primativeUShort[i].ToString( "E", nfi ).Equals( sciResults[i] ) != true ) ErrorCode(primativeUShort[i].ToString( "E", nfi ));
     } catch( Exception e ) {
     iCountErrors++;
     Console.WriteLine( "Testcase["+iCountTestcases+"]" );
     Console.WriteLine( "Exception:" + e );
     ...
     if ( primativeUShort[i].ToString( "f", nfi ).Equals( fixedResults[i] ) != true ) ErrorCode(primativeUShort[i].ToString( "F", nfi ));
     } catch( Exception e ) {
     iCountErrors++;
     Console.WriteLine( "Testcase["+iCountTestcases+"]" );
     Console.WriteLine( "Exception:" + e );
     ...
     if ( primativeUShort[i].ToString( "G", nfi ).Equals( generalResults[i] ) != true ) ErrorCode(primativeUShort[i].ToString( "g", nfi ));
     } catch( Exception e ) {
     iCountErrors++;
     Console.WriteLine( "Testcase["+iCountTestcases+"]" );
     Console.WriteLine( "Exception:" + e );
     ...
     if ( primativeUShort[i].ToString( "n", nfi ).Equals( numberResults[i] ) != true ) ErrorCode(primativeUShort[i].ToString( "n", nfi ));
     } catch( Exception e ) {
     iCountErrors++;
     Console.WriteLine( "Testcase["+iCountTestcases+"]" );
     Console.WriteLine( "Exception:" + e );
     ...
     if ( primativeUShort[i].ToString( "x", nfi ).Equals( hexResults[i] ) != true ) ErrorCode(primativeUShort[i].ToString( "X", nfi ));
     } catch( Exception e ) {
     iCountErrors++;
     Console.WriteLine( "Testcase["+iCountTestcases+"]" );
     Console.WriteLine( "Exception:" + e );
 ...
 public static void Main( String[] args ) 
   ...
   Co6015Format_u16_str_ifp cbX= new Co6015Format_u16_str_ifp();
   try
     {
     bResult = cbX.runTest();
     }
