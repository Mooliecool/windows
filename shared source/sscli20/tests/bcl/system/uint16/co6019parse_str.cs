...
public class Co6019Parse_str
{
 ...
 public static String s_strComponentBeingTested
   = "UInt16.Parse( String )";
 public static String s_strTFName        = "Co6019Parse_str.cs";
 public static String s_strTFAbbrev      = "Co6019";
 ...
 public Boolean runTest()
   ...
   try
     ...
     testUI = UInt16.Parse( testStr );
     if ( testUI != i ) {
     Console.WriteLine( "Fail! " + testUI + " != " + i );
     iCountErrors++;
     }
     iCountTestcases++;
     testUI = UInt16.Parse( testStr.PadLeft( i, ' ') );
     if ( testUI != i ) {
     Console.WriteLine( "Fail! (pad left)" + testUI + " != " + i );
     iCountErrors++;
     }
     iCountTestcases++;
     testUI = UInt16.Parse( testStr.PadRight( i, ' ') );
     if ( testUI != i ) {
     Console.WriteLine( "Fail! (pad right)" + testUI + " != " + i );
     iCountErrors++;
     }
     iCountTestcases++;
     testUI = UInt16.Parse( testStr.PadRight( i, ' ').PadLeft( i,' ' ) );
     if ( testUI != i ) {
 ...
 public static void Main( String[] args ) 
   ...
   Co6019Parse_str cbX = new Co6019Parse_str();
   try
     {
     bResult = cbX.runTest();
     }
