...
public class Co6020Parse_str_int
{
 ...
 public static String s_strComponentBeingTested
   = "UInt16.Parse( String, Int32 )";
 public static String s_strTFName        = "Co6020Parse_str_int.cs";
 public static String s_strTFAbbrev      = "Co6020";
 ...
 public Boolean runTest()
   ...
   try
     ...
     testUI = UInt16.Parse( testStr, NumberStyles.Any );
     if ( testUI != i ) {
     Console.WriteLine( "Fail! " + testUI + " != " + i );
     iCountErrors++;
     }
     iCountTestcases++;
     testUI = UInt16.Parse( testStr.PadLeft( i, ' '), NumberStyles.Any );
     if ( testUI != i ) {
     Console.WriteLine( "Fail! (pad left)" + testUI + " != " + i );
     iCountErrors++;
     }
     iCountTestcases++;
     testUI = UInt16.Parse( testStr.PadRight( i, ' '), NumberStyles.Any );
     if ( testUI != i ) {
     Console.WriteLine( "Fail! (pad right)" + testUI + " != " + i );
     iCountErrors++;
     }
     iCountTestcases++;
     testUI = UInt16.Parse( testStr.PadRight( i, ' ').PadLeft( i,' ' ), NumberStyles.Any );
     if ( testUI != i ) {
     ...
     testUI = UInt16.Parse( testStr, NumberStyles.AllowCurrencySymbol );
     iCountErrors++;
     ...
     try {
     iCountTestcases++;
     UInt16 UI = UInt16.Parse( null, NumberStyles.Any );
     iCountErrors++;
     Console.WriteLine( "Failed! No exception Thrown! String = '"+testStr+"'" );
     }
 ...
 public static void Main( String[] args ) 
   ...
   Co6020Parse_str_int cbX = new Co6020Parse_str_int();
   try
     {
     bResult = cbX.runTest();
     }
