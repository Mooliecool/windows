...
public class Co6022ToString
{
 ...
 public static readonly String s_strComponentBeingTested
   = "UInt16.ToString()";
 public static readonly String s_strTFName        = "Co6022ToString.cs";
 public static readonly String s_strTFAbbrev      = "Co6022";
 ...
 public virtual bool runTest()
   ...
   try
     ...
     iCountTestcases++;
     testUI = ((UInt16) x );
     if ( testUI.ToString().Equals(  x.ToString( "d")) != true ) iCountErrors++;
     }
     } catch ( Exception e ) {
 ...
 public static void Main( String[] args )
   ...
   bool bResult = false; 
   Co6022ToString cbX = new Co6022ToString();
   try
     {
     bResult = cbX.runTest();
     }
