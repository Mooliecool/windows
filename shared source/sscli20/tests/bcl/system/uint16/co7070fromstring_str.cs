...
public class Co7070FromString_Str
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "UInt16.Parse(String)"; 
 public static String s_strTFName        = "Co7070FromString_Str.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     iCountTestcases++;
     strTest = "3";
     ReturnValue = UInt16.Parse(strTest);
     if (ReturnValue != 3)
       {
       iCountErrors++;
     ...
     strLoc = "Loc_398vy";
     iCountTestcases++;
     strTest = UInt16.MaxValue.ToString();
     ReturnValue = UInt16.Parse(strTest);
     if (ReturnValue != UInt16.MaxValue)
       {
       iCountErrors++;
       printerr("Error_300aa SentIn==\"" + strTest + "\" Expected==65535, value==" + ReturnValue.ToString());
       }
     strLoc = "Loc_398vy";
     iCountTestcases++;
     try
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7070FromString_Str cbA = new Co7070FromString_Str();
   try {
   bResult = cbA.runTest();
