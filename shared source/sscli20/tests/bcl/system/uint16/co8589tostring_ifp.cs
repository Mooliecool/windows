...
public class Co8589ToString_ifp
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "UInt16.ToString(NumberFormatInfo info)";
 public static String s_strTFName        = "Co8589ToString_ifp.cs";
 ...
 public static void Main(String[] args) 
   ...
   Co8589ToString_ifp cbA = new Co8589ToString_ifp();
   try {
   bResult = cbA.runTest();
