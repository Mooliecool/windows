...
public class Co8590Parse_str_ifp
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "UInt16.Parse(NumberFormatInfo nfi)";
 public static String s_strTFName        = "Co8590Parse_str_ifp.cs";
 ...
 public static void Main(String[] args) 
   ...
   Co8590Parse_str_ifp cbA = new Co8590Parse_str_ifp();
   try {
   bResult = cbA.runTest();
