...
public class Co5722IConvertible_UInt32 : IDescribeTestedMethods
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Iconvertible";
 public static String s_strTFName        = "Co5722IConvertible_UInt32.cs";
 ...
 public MethodInfo[] GetTestedMethods()
   ...
   list.Add(typeTarget.GetMethod("GetTypeCode", new Type[]{}));
   mis = new MethodInfo[list.Count];		
   list.CopyTo(mis, 0);
   return mis;		
   }
 public Boolean TestToBoolean(UInt32 testSubject)
   {
   strLoc = "Loc_498yv";
   Boolean b1 = false;
   Boolean b2 = false;
 ...
 public Boolean TestToChar(UInt32 testSubject) 
   {
   strLoc = "498vy3";
   Char b1 = '\0';
   Char b2 = '\0';
 ...
 public Boolean TestToSByte(UInt32 testSubject) 
   {
   strLoc = "r4987";
   SByte b1 = 0;
   SByte b2 = 0;
 ...
 public Boolean TestToByte(UInt32 testSubject) 
   {
   strLoc = "398f9";
   Byte b1 = 0;
   Byte b2 = 0;
 ...
 public Boolean TestToInt16(UInt32 testSubject) 
   {
   strLoc = "38f7c";
   Int16 b1 = 0;
   Int16 b2 = 0;
 ...
 public Boolean TestToUInt16(UInt32 testSubject) 
   {
   strLoc = "298ss";
   UInt16 b1 = 0;
   UInt16 b2 = 0;
 ...
 public Boolean TestToInt32(UInt32 testSubject) 
   {
   strLoc = "129s8";
   Int32 b1 = 0;
   Int32 b2 = 0;
 ...
 public Boolean TestToUInt32(UInt32 testSubject) 
   {
   strLoc = "10299";
   UInt32 b1 = 0;
   UInt32 b2 = 0;
 ...
 public Boolean TestToInt64(UInt32 testSubject) 
   {
   strLoc = "398f8";
   Int64 b1 = 0;
   Int64 b2 = 0;
 ...
 public Boolean TestToUInt64(UInt32 testSubject) 
   {
   strLoc = "2908s";
   UInt64 b1 = 0;
   UInt64 b2 = 0;
 ...
 public Boolean TestToSingle(UInt32 testSubject) 
   {
   strLoc = "200s9";
   Single b1 = 0;
   Single b2 = 0;
 ...
 public Boolean TestToDouble(UInt32 testSubject) 
   {
   strLoc = "20949";
   Double b1 = 0;
   Double b2 = 0;
 ...
 public Boolean TestToDecimal(UInt32 testSubject) 
   {
   strLoc = "2099x";
   Decimal b1 = 0;
   Decimal b2 = 0;
 ...
 public Boolean TestToDateTime(UInt32 testSubject) 
   {
   strLoc = "39848";
 ...
 public Boolean TestToString(UInt32 testSubject) 
   {
   strLoc = "3498d";
   String b1 = "";
   String b2 = "";
 ...
 public Boolean TestToType(UInt32 testSubject, Type typecode) 
   {
   strLoc = "29848";
   Object b1 = 0;
   Object b2 = 0;
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5722IConvertible_UInt32 cbA = new Co5722IConvertible_UInt32();
   try 
     {
     bResult = cbA.runTest();
     } 
