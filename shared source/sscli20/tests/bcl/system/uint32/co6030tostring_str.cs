...
public class Co6030Format_u32_str
{
 ...
 public static String s_strComponentBeingTested
   = "UInt32.ToString( UInt32, String )";
 public static String s_strTFName        = "Co6030Format_u32_str.cs";
 public static String s_strTFAbbrev      = "Co6030";
 ...
 public Boolean runTest()
   ...
   try
     ...
     String strPrimitiveCurrency = primativeUInt[i].ToString( "C") ;
     strPrimitiveCurrency = strPrimitiveCurrency.Replace("$" , new String( new char[]{(char)164} ) );
     if ( strPrimitiveCurrency.Equals( currencyResults[i] ) != true ) ErrorCode(primativeUInt[i].ToString( "C"));
     } catch( Exception e ) {
     iCountErrors++;
     ...
     if ( primativeUInt[i].ToString( "D").Equals( decimalResults[i] ) != true ) ErrorCode(primativeUInt[i].ToString( "d"));
     } catch( Exception e ) {
     iCountErrors++;
     Console.WriteLine( "Testcase["+iCountTestcases+"]" );
     Console.WriteLine( "Exception:" + e );
     ...
     if ( primativeUInt[i].ToString( "E").Equals( sciResults[i] ) != true ) ErrorCode(primativeUInt[i].ToString( "E"));
     } catch( Exception e ) {
     iCountErrors++;
     Console.WriteLine( "Testcase["+iCountTestcases+"]" );
     Console.WriteLine( "Exception:" + e );
     ...
     if ( primativeUInt[i].ToString( "f").Equals( fixedResults[i] ) != true ) ErrorCode(primativeUInt[i].ToString( "F"));
     } catch( Exception e ) {
     iCountErrors++;
     Console.WriteLine( "Testcase["+iCountTestcases+"]" );
     Console.WriteLine( "Exception:" + e );
     ...
     if ( primativeUInt[i].ToString( "G").Equals( generalResults[i] ) != true ) ErrorCode(primativeUInt[i].ToString( "g"));
     } catch( Exception e ) {
     iCountErrors++;
     Console.WriteLine( "Testcase["+iCountTestcases+"]" );
     Console.WriteLine( "Exception:" + e );
     ...
     if ( primativeUInt[i].ToString( "n").Equals( numberResults[i] ) != true ) ErrorCode(primativeUInt[i].ToString( "n"));
     } catch( Exception e ) {
     iCountErrors++;
     Console.WriteLine( "Testcase["+iCountTestcases+"]" );
     Console.WriteLine( "Exception:" + e );
     ...
     if ( primativeUInt[i].ToString( "x").Equals( hexResults[i] ) != true ) ErrorCode(primativeUInt[i].ToString( "X"));
     } catch( Exception e ) {
     iCountErrors++;
     Console.WriteLine( "Testcase["+iCountTestcases+"]" );
     Console.WriteLine( "Exception:" + e );
 ...
 public static void Main( String[] args ) 
   ...
   Co6030Format_u32_str cbX= new Co6030Format_u32_str();
   try
     {
     bResult = cbX.runTest();
     }
