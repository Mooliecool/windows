...
public class Co6034Parse_str_int
{
 ...
 public static String s_strComponentBeingTested
   = "UInt32.Parse( String, Int32 )";
 public static String s_strTFName        = "Co6034Parse_str_int.cs";
 public static String s_strTFAbbrev      = "Co6034";
 ...
 public static void Main( String[] args ) 
   ...
   Co6034Parse_str_int cbX = new Co6034Parse_str_int();
   try
     {
     bResult = cbX.runTest();
     }
