...
public class Co6036ToString
{
 ...
 public static String s_strComponentBeingTested
   = "UInt32.ToString()";
 public static String s_strTFName        = "Co6036ToString.cs";
 public static String s_strTFAbbrev      = "Co6036";
 ...
 public static void Main( String[] args ) 
   ...
   Co6036ToString cbX = new Co6036ToString();
   try
     {
     bResult = cbX.runTest();
     }
