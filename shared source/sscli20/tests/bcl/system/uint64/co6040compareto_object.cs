...
using System.IO;
using System;
public class Co6040CompareTo_Object
{
 ...
 public static String s_strTFName        = "Co6040CompareTo_Object.cs";
 public static String s_strTFAbbrev      = "Co6040";
 ...
 public Boolean runTest()
   ...
   try
     ...
     m_strLoc = "Starting testcase #" + iCountTestcases;
     m_strLoc = m_strLoc + "Compare to primitive UInt64";
     if ( testUIntOne.CompareTo( primitiveULong ) != 0 ) ErrorCode();
     }
     catch( Exception e ) {
     iCountErrors++;
     Console.WriteLine( "Testcase["+iCountTestcases+"] -- Wrong Exception!" );
 ...
 public static void Main( String[] args ) 
   ...
   Co6040CompareTo_Object cbX= new Co6040CompareTo_Object();
   try
     {
     bResult = cbX.runTest();
     }
