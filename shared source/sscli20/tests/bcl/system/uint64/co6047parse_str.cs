...
public class Co6047Parse_str
{
 ...
 public static String s_strComponentBeingTested
   = "UInt64.Parse( String )";
 public static String s_strTFName        = "Co6047Parse_str.cs";
 public static String s_strTFAbbrev      = "Co6047";
 ...
 public Boolean runTest()
   ...
   try
     ...
     iCountTestcases++;
     m_strLoc = "LocXX08." + i;
     testUI = UInt64.Parse( testStr.PadLeft( 1000, ' ') );
     if ( testUI != i ) {
     ...
     iCountTestcases++;
     m_strLoc = "LocXX07";
     testUI = UInt64.Parse( testStr.PadRight( 1000, ' ') );
     if ( testUI != i ) {
     ...
     iCountTestcases++;
     m_strLoc = "LocXX06";
     testUI = UInt64.Parse( testStr.PadRight( 1000, ' ').PadLeft( 1000,' ' ) );
     if ( testUI != i ) {
 ...
 public static void Main( String[] args ) 
   ...
   Co6047Parse_str cbX = new Co6047Parse_str();
   try
     {
     bResult = cbX.runTest();
     }
