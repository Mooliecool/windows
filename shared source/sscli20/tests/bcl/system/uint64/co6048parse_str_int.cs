...
public class Co6048Parse_str_int
{
 ...
 public static String s_strComponentBeingTested
   = "UInt64.Parse( String, Int32 )";
 public static String s_strTFName        = "Co6048Parse_str_int.cs";
 public static String s_strTFAbbrev      = "Co6048";
 ...
 public Boolean runTest()
   ...
   try
     ...
     testUI = UInt64.Parse( testStr, NumberStyles.Any );
     if ( testUI != i ) {
     Console.WriteLine( "Fail! " + testUI + " != " + i );
     iCountErrors++;
     }
     iCountTestcases++;
     testUI = UInt64.Parse( testStr.PadLeft( 1000, ' '), NumberStyles.Any );
     if ( testUI != i ) {
     Console.WriteLine( "Fail! (pad left)" + testUI + " != " + i );
     iCountErrors++;
     }
     iCountTestcases++;
     testUI = UInt64.Parse( testStr.PadRight( 1000, ' '), NumberStyles.Any );
     if ( testUI != i ) {
     Console.WriteLine( "Fail! (pad right)" + testUI + " != " + i );
     iCountErrors++;
     }
     iCountTestcases++;
     testUI = UInt64.Parse( testStr.PadRight( 1000, ' ').PadLeft( 1000,' ' ), NumberStyles.Any );
     if ( testUI != i ) {
     ...
     testUI = UInt64.Parse( testStr, NumberStyles.AllowCurrencySymbol );
     iCountErrors++;
     ...
     try {
     iCountTestcases++;
     UInt64 UI = UInt64.Parse( null, NumberStyles.Any );
     iCountErrors++;
     Console.WriteLine( "Failed! No exception Thrown! String = '"+testStr+"'" );
     }
 ...
 public static void Main( String[] args ) 
   ...
   Co6048Parse_str_int cbX = new Co6048Parse_str_int();
   try
     {
     bResult = cbX.runTest();
     }
