...
public class Co6050ToString
{
 ...
 public static String s_strComponentBeingTested
   = "UInt64.ToString()";
 public static String s_strTFName        = "Co6050ToString.cs";
 public static String s_strTFAbbrev      = "Co6050";
 ...
 public static void Main( String[] args ) 
   ...
   Co6050ToString cbX = new Co6050ToString();
   try
     {
     bResult = cbX.runTest();
     }
