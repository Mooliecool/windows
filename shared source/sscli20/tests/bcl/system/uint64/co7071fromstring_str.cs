...
public class Co7071FromString_Str
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "UInt64.Parse(String)"; 
 public static String s_strTFName        = "Co7071FromString_Str.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     iCountTestcases++;
     strTest = "3";
     ReturnValue = UInt64.Parse(strTest);
     if (ReturnValue != 3)
       {
       iCountErrors++;
     ...
     strLoc = "Loc_398vy";
     iCountTestcases++;
     strTest = UInt64.MaxValue.ToString();
     ReturnValue = UInt64.Parse(strTest);
     if (ReturnValue != UInt64.MaxValue)
       {
       iCountErrors++;
       printerr("Error_300aa SentIn==\"" + strTest + "\" Expected==184467440737095521615, value==" + ReturnValue.ToString());
       }
     strLoc = "Loc_398vy";
     iCountTestcases++;
     try
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7071FromString_Str cbA = new Co7071FromString_Str();
   try {
   bResult = cbA.runTest();
