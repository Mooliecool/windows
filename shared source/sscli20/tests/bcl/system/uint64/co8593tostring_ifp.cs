...
public class Co8593ToString_ifp
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "UInt64.ToString(NumberFormatInfo info)";
 public static String s_strTFName        = "Co8593ToString_ifp.cs";
 ...
 public static void Main(String[] args) 
   ...
   Co8593ToString_ifp cbA = new Co8593ToString_ifp();
   try {
   bResult = cbA.runTest();
