...
public class Co8594Parse_str_ifp
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "UInt64.Parse(NumberFormatInfo nfi)";
 public static String s_strTFName        = "Co8594Parse_str_ifp.cs";
 ...
 public Boolean runTest()
   ...
   for (int i=0; i < in2TestValues.Length;i++)
     ...
     strLoc = strBaseLoc + i.ToString();
     iCountTestcases++;
     strOut = in2TestValues[i].ToString( "G20", nfi1);
     in2a = UInt64.Parse(strOut, nfi1);
     if(in2a != in2TestValues[i])
       {
       iCountErrors++;
 ...
 public static void Main(String[] args) 
   ...
   Co8594Parse_str_ifp cbA = new Co8594Parse_str_ifp();
   try {
   bResult = cbA.runTest();
