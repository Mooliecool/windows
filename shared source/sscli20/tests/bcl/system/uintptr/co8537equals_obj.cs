...
using System;
using System.IO;
public class Co8537Equals_obj
{
 public static readonly String s_strActiveBugNums = "";
 public static readonly String s_strDtTmVer       = "";
 public static readonly String s_strClassMethod   = "UIntPtr.Equals(Object)";
 public static readonly String s_strTFName        = "Co8537Equals_obj.cs";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co8537Equals_obj cbA = new Co8537Equals_obj();
   try {
   bResult = cbA.runTest();
