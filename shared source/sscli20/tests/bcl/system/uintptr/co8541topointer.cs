...
using System;
using System.IO;
public class Co8541ToPointer
{
 public static readonly String s_strActiveBugNums = "";
 public static readonly String s_strDtTmVer       = "";
 public static readonly String s_strClassMethod   = "UIntPtr.ToPointer()";
 public static readonly String s_strTFName        = "Co8541ToPointer.cs";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co8541ToPointer cbA = new Co8541ToPointer();
   try {
   bResult = cbA.runTest();
