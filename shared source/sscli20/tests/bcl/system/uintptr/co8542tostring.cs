...
using System;
using System.IO;
public class Co8542ToString
{
 public static readonly String s_strActiveBugNums = "";
 public static readonly String s_strDtTmVer       = "";
 public static readonly String s_strClassMethod   = "UIntPtr.ToString()";
 public static readonly String s_strTFName        = "Co8542ToString.cs";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co8542ToString cbA = new Co8542ToString();
   try {
   bResult = cbA.runTest();
