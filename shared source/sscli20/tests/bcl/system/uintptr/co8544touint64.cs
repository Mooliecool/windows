...
using System;
using System.IO;
public class Co8544ToUInt64
{
 public static readonly String s_strActiveBugNums = "";
 public static readonly String s_strDtTmVer       = "";
 public static readonly String s_strClassMethod   = "UIntPtr.ToUInt64()";
 public static readonly String s_strTFName        = "Co8544ToUInt64.cs";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co8544ToUInt64 cbA = new Co8544ToUInt64();
   try {
   bResult = cbA.runTest();
