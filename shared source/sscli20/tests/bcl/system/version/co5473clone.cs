...
public class Co5473Clone
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Version.Clone()";
 public static String s_strTFName        = "Co5473Clone.cs";
 public static String s_strTFAbbrev      = "Co5473";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5473Clone cbA = new Co5473Clone();
   try {
   bResult = cbA.runTest();
