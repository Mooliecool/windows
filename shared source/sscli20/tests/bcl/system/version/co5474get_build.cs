...
public class Co5474get_Build
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Version.Build";
 public static String s_strTFName        = "Co5474get_Build.cs";
 public static String s_strTFAbbrev      = "Co5474";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5474get_Build cbA = new Co5474get_Build();
   try {
   bResult = cbA.runTest();
