...
public class Co5475set_Build
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Version.Build";
 public static String s_strTFName        = "Co5475set_Build.cs";
 public static String s_strTFAbbrev      = "Co5475";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5475set_Build cbA = new Co5475set_Build();
   try {
   bResult = cbA.runTest();
