...
public class Co5476get_Major
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Version.Major";
 public static String s_strTFName        = "Co5476get_Major.cs";
 public static String s_strTFAbbrev      = "Co5476";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5476get_Major cbA = new Co5476get_Major();
   try {
   bResult = cbA.runTest();
