...
public class Co5477set_Major
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Version.Major";
 public static String s_strTFName        = "Co5477set_Major.cs";
 public static String s_strTFAbbrev      = "Co5477";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5477set_Major cbA = new Co5477set_Major();
   try {
   bResult = cbA.runTest();
