...
public class Co5478get_Minor
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Version.Minor";
 public static String s_strTFName        = "Co5478get_Minor.cs";
 public static String s_strTFAbbrev      = "Co5478";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5478get_Minor cbA = new Co5478get_Minor();
   try {
   bResult = cbA.runTest();
