...
public class Co5480get_Revision
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Version.Minor";
 public static String s_strTFName        = "Co5480get_Revision.cs";
 public static String s_strTFAbbrev      = "Co5480";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5480get_Revision cbA = new Co5480get_Revision();
   try {
   bResult = cbA.runTest();
