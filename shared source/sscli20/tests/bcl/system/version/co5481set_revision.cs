...
public class Co5481set_Revision
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Version.Revision";
 public static String s_strTFName        = "Co5481set_Revision.cs";
 public static String s_strTFAbbrev      = "Co5481";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co5481set_Revision cbA = new Co5481set_Revision();
   try {
   bResult = cbA.runTest();
