...
public class Co7038ctor_ii
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Version(Int32,Int32)"; 
 public static String s_strTFName        = "Co7038ctor_ii.cs";
 ...
 public bool runTest()
   ...
   try
     ...
     strLoc = "Loc_400vy";
     iCountTestcases++;
     Version vTest = new Version (Int32.MaxValue, 2);
     ...
     try
       {
       Version vTest2 = new Version (Int32.MinValue, 2);
       ++iCountErrors;	
     ...
     try
       {
       Version vTest3 = new Version (Int32.MaxValue, -1);
       ++iCountErrors;	
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7038ctor_ii cbA = new Co7038ctor_ii();
   try {
   bResult = cbA.runTest();
