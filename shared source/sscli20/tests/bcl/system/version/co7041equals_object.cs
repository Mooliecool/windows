...
public class Co7041Equals_Object
{
 public static String s_strActiveBugNums = "";
 public static String s_strDtTmVer       = "";
 public static String s_strClassMethod   = "Version.Equals(Object)"; 
 public static String s_strTFName        = "Co7041Equals_Object.cs";
 ...
 public static void Main(String[] args)
   {
   bool bResult = false;
   Co7041Equals_Object cbA = new Co7041Equals_Object();
   try {
   bResult = cbA.runTest();
