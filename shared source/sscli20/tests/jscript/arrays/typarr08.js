...
/* -------------------------------------------------------------------------
 ...
 ---------------------------------------------------------------------------
  ...
  Scenarios:
			...
			6.  var a : char[] = new char[x];

			7.  var a : char[,] = new char[x,y];

			8.  var a : char[,,] = new char[x,y,z];

			9.  var a : char[,,,] = new char[w,x,y,z];
...
function typarr08() {
    ...
    apInitTest("typarr08: Typed Arrays -- char"); 
	...
	apInitScenario("2.  var a : char[][]");
		var a2 : char[][] = [[1,2,3],[4,5,6],[7,8,9]];
	...
	apInitScenario("4.  var a : char[][] = [x][y]");
		var x4 : char = 2;
		var y4 : char = 3;
		var a4 : char[][] = [[x4],[y4]];
	...
	apInitScenario("5.  var a : char[][][] = [x][y][z]");
		var x5 : char = 2;
		var y5 : char = 3;
		var z5 : char = 4;
		var a5 : char[][][] = [[[x5],[y5],[z5]]];
	...
	apInitScenario("6.  var a : char[] = new char[x]");
		var a6 : char[] = new char[4];
		a6[0] = 1;
		a6[1] = 2;
		a6[2] = 3;
		a6[3] = 4;
	...
	apInitScenario("7.  var a : char[,] = new char[x,y]");
		var a7 : char[,] = new char[1,4];
		a7[0,0] = 1;
		a7[0,1] = 2;
		a7[0,2] = 3;
		a7[0,3] = 4;
	...
	apInitScenario("8.  var a : char[,,] = new char[x,y,z]");
		var a8 : char[,,] = new char[1,1,4];
		a8[0,0,0] = 1;
		a8[0,0,1] = 2;
		a8[0,0,2] = 3;
		a8[0,0,3] = 4;
	...
	apInitScenario("9.  var a : char[,,,] = new char[w,x,y,z]");
		var a9 : char[,,,] = new char[1,1,1,4];
		a9[0,0,0,0] = 1;
		a9[0,0,0,1] = 2;
		a9[0,0,0,2] = 3;
		a9[0,0,0,3] = 4;
