...
/* -------------------------------------------------------------------------
 ...
 ---------------------------------------------------------------------------
  ...
  Scenarios:	1. decodeURI with more than 1 set of 'escaped' character
 ...
 ---------------------------------------------------------------------------
	...
	[00]	20-Oct-2000	    Angelach: Scenario 15 from deURI001
 -------------------------------------------------------------------------*/
...
function deuri004 ()
  {
    ...
    //----------------------------------------------------------------------
     apInitScenario( "Scenario 1: decodeURI with more than 1 set of 'escaped' character");

     Str2 = decodeURI ("%14%5C%0E%1D%25") ;	// in the range of [0, 127]
     Str1 = String.fromCharCode(0x14, 0x5C, 0x0E, 0x1D, 0x25) ;
     Verify ( Str1, Str2, "decodeURI.1.1" ) ;
     Str3 = encodeURI (Str2) ;
     Verify ( "%14%5C%0E%1D%25", Str3, "encodeURI.1.1" ) ;
     ...
     Str3 = encodeURI (Str2) ;
     Verify ( "%04%04%04%04%04%04%04%04%04%04%04%04%04%04%04%04%04%04", Str3, "encodeURI.1.2" ) ;
     ...
     Verify ( Str1, Str2, "decodeURI.1.3" ) ;
     Str3 = encodeURI (Str2) ;
     Verify ( Str4, Str3, "encodeURI.1.3" ) ;
     ...
     for ( iTmp = 2047 ; iTmp > 127 ; iTmp -= 16 )
	  ...
	  Str2 = decodeURI (Str4) ;
	  Verify ( Str1, Str2, "decodeURI.1.4."+iTmp ) ;
	  Str3 = encodeURI (Str2) ;
	  Verify ( Str4, Str3, "encodeURI.1.4."+iTmp ) ;
       }
     ...
     for ( iTmp = 55295 ; iTmp > 2047 ; iTmp -= 418 )
	  ...
	  Str2 = decodeURI (Str4) ;
	  Verify ( Str1, Str2, "decodeURI.1.5."+iTmp ) ;
	  Str3 = encodeURI (Str2) ;
	  Verify ( Str4, Str3, "encodeURI.1.5."+iTmp ) ;
       }
     ...
     for ( iTmp = 56319 ; iTmp > 55295 ; iTmp -= 16 )
	  ...
	  Str2 = decodeURI (Str4) ;
	  Verify ( Str1, Str2, "decodeURI.1.6."+iTmp ) ;
	  Str3 = encodeURI (Str2) ;
	  Verify ( Str4, Str3, "encodeURI.1.6."+iTmp ) ;
     ...
     for ( iTmp = 65535 ; iTmp > 57343 ; iTmp -= 32 )
	  ...
	  Str2 = decodeURI (Str4) ;
	  Verify ( Str1, Str2, "decodeURI.1.7."+iTmp ) ;
	  Str3 = encodeURI (Str2) ;
	  Verify ( Str4, Str3, "encodeURI.1.7."+iTmp ) ;
       }
	 ...
	 Str2 = decodeURI (Str4) ;
	 Verify ( Str1, Str2, "decodeURI.1.8." + iTmp ) ;
	 Str3 = encodeURI (Str2) ;
	 Verify ( Str4, Str3, "encodeURI.1.8." + iTmp) ;
       }
