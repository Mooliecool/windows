...
/* -------------------------------------------------------------------------
 ...
 ---------------------------------------------------------------------------
  ...
  Scenarios:	1.  decodeURI with different types of characters
 ...
 ---------------------------------------------------------------------------
	...
	[00]	20-Oct-2000	    Angelach: Scenario 16 from deURI001
 -------------------------------------------------------------------------*/
...
function deuri005 ()
  {
    ...
    //----------------------------------------------------------------------
     apInitScenario( "Scenario 1: decodeURI with different types of characters");
     ...
     Str4 = Str4 + getEncoding(8291)+getEncoding(11644)+getEncoding(11)+getEncoding(50000) ;
     Verify ( Str4, Str3, "encodeURI.1.1") ;
     ...
     Str3 = encodeURI (Str2) ;
     Verify ( Str4, Str3, "encodeURI.1.2") ;
	...
	Str4 = Str4 + "%" + hex(iTmp) ;
     ...
     Str1 = Str1 +"ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz~" ;
     Str3 = encodeURI (Str2) ;
     Verify ( Str1, Str3, "decodeURI.1.5." + iTmp) ;
	 ...
	 Str3 = encodeURI (Str2) ;
	 Verify ( Str4, Str3, "decodeURI.1.5." + iTmp) ;
       }
