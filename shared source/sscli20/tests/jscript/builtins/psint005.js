...
function psint005() {
 @if(@_fast)
    var i, ich, iDec, cbNum, sRnd, ExpNum;
 @end
    apInitTest("psInt005 ");
    ...
    verify("max pos: "+INT_MAX," "+INT_MAX,INT_MAX, null);
    ...
    verify("min neg < n < max neg: "+INT_MIN," "+INT_MIN,INT_MIN, null);

    verify("min neg < n < max neg: -1234567890","-1234567890",-1234567890, null);
    verify("min neg: -2147483648"," "+INT_MIN,INT_MIN, null);
    ...
    verify("min pos < n < max pos: 463069357","463069357",463069357, null);
    verify("min pos < n < max pos: 1234567890","1234567890",1234567890, null);
    verify("max pos: 2147483647"," "+INT_MAX,INT_MAX, null);
    ...
    verify("min neg < n < max neg: -1234567890","-1234567890",-1234567890, null);
    verify("min neg: -2147483647"," "+INT_MIN,INT_MIN, null);
