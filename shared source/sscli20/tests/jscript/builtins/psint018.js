...
function psint018() {
 @if(@_fast)
    var i, ich, iDec, cbNum, num, sNum, nRnd, sRnd, ExpNum, c;
 @end
    apInitTest("psInt018 ");
    ...
    verify("max pos: 2147483647",17777777777,2147483647, null);
    ...
    verify("min neg: -2147483648",-20000000000,-2147483648, null);
    ...
    for (i=0; i<10; i++)
    {
        ...
        sRnd = sNum+genRndStr(40,0x01|0x02|0x10|0x20);
    ...
    {
        sNum = Math.floor(Math.random()*2147483647);
        sRnd = genRndStr(40,0x01|0x02|0x10|0x20)+sNum;
