...
function psint019() {
 ...
 @end
    ...
    sExp =  2;
    sAct = parseInt(2.2250738585072014e-308,10);
    ...
    sCat = "max pos";
    sExp = 1;
    sAct = parseInt(1.7976931348623158e308,10);
    ...
    sExp = Number.NaN;
    sAct = parseInt(1.797693134862315807e309,10);
    ...
    sCat = "max neg";
    sExp = -2;
    sAct = parseInt(-2.225073858507202e-308,10);
    ...
    sCat = "min neg";
    sExp =  -1;
    sAct = parseInt(-1.797693134862315807e308,10);
    ...
    sCat = "max neg";
    sExp = -2;
    sAct = parseInt("-2.2250738585072012595e-308",10);
    ...
    sExp = 205979647;
    sAct = parseInt("205979647}Sa}OZ^U*WAV.\'x:CNZc\"cc!&<D\"\"REYKy] #tz},|QuMK<Htg\"	=y~zdA[?CyLW%?rS]pp&CjB(W\:K>Nou\D(n\'e&hw Z>[(bk",10);
    ...
    sExp = 1490812927;
    sAct = parseInt("1490812927SrMPZe#YB*oVS\nV*F^NbRF}kk[MO$UO`:LgXR\tFL sMz.&YwAG[:&M.z+TtoJNx@%jbjv,ycY%m*AxW<Qq\"z]ENR&m,yh?S\'m=Pe",10);
    ...
    sExp = 1703804927;
    sAct = parseInt("1703804927ÉŸç‹âæ.ÀÉŒ—Š–®ÔÉóˆÈ±ÌÜíØÒ ¬.‘²ä.Šã€þìÈ±„¢‘Ÿ.Èïð·—¡íì›†ú‘¸ìõàù×®ðÊó…ÓÕÐµ.ÜêÒÀåÂì©¶Ê¯æ¤õÀ·Æ.•¤Ä",10);
    ...
    sExp = 429981695;
    sAct = parseInt("429981695.ê÷ÈÞ.úý¡Ý¨Â˜÷Ý¿á..† ÄÙ‡¾¶Š.Ñ¿Òú.œ½ÈÞ•ž†ˆ…Ù¬¥³ ã’.é†œ.˜èª€ý«.äþüÕ.¢.®É®þÝí…îÓºã.©Ô÷Ó¼±þó¹ò¿¶·—.íô.",10);
    ...
    sExp = 585695231;
    sAct = parseInt("585695231‹á.ÚŽÕò°žÎ®£áŠîüŽ.é..ýË‹Ôñ‚¢«.ãä.Õó ÊøþÒÊ‚.†©“ŽÚ§¬¦§..Ä«âí¬..Ù«.§—³Žäí‹åÀÁÕ´™À‹Û.µëù©¿Ÿ.¶Å„“Óˆ",10);
    ...
    sExp = Number.NaN;
    sAct = parseInt("}Sa}OZ^U*WAV.\'x:CNZc\"cc!&<D\"\"REYKy] #tz},|QuMK<Htg\"	=y~zdA[?CyLW%?rS]pp&CjB(W\:K>Nou\D(n\'e&hw Z>[(bk205979647",10);
    ...
    sExp = Number.NaN;
    sAct = parseInt("SrMPZe#YB*oVS\nV*F^NbRF}kk[MO$UO`:LgXR\tFL sMz.&YwAG[:&M.z+TtoJNx@%jbjv,ycY%m*AxW<Qq\"z]ENR&m,yh?S\'m=Pe1490812927",10);
    ...
    sExp = Number.NaN;
    sAct = parseInt(".¬·È.ûÛ¡º¥..Ê.åßõ¨Ä.¸ãŸÈ.ý»Ãïò‚.°½.ºÇôÉ¸Í¥ª..Ô.†•Ç.ª—ù¼ÜðšÝðÏþ†–Ï.‡îùí.Ä.¢.‹ñ¹.œï¿.¾..ŽÃä®.Ö¸ëð›.2049966079",10);
    ...
    sExp = Number.NaN;
    sAct = parseInt(".§ÎÐóüœãý™Ü¤..„.å†…üœá•.ù¡„ÚŽ..Á¼Üèð.ÉÑÅ¥¿–‚¹È.ßÉžˆ« ‘ª.Çã¹ó².Á.€ó®Ç½¦ËÛðüŽ¡íû..ðÅÏ‡Å”¬š ².¾Ç²908066815",10);
    ...
    sExp = Number.NaN;
    sAct = parseInt("º”ÀÒ.‡à™²ñ...îÏ» œ˜Çò’¿ß”Ææò¡ê..´›ÎŠ.­´§ÛŒÊ.Õ.›¹´™ù¢õ.’ñ‡ÓÃ”í.ùö©.èÅœø§Ö´ù‰‚Æ.¯ç.Òº.€¦è…“Ø‚‚½×Ÿ„2028077055",10);
