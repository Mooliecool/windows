...
function verify(sCat, ob, bugNum) {
    ...
    var sAct = typeof parseInt(ob);

    if (sAct != "number")
        apLogFailInfo( m_scen+(sCat.length?"--"+sCat:"")+" failed", "number", sAct, bugNum);
}
...
function psint101() {
 @if(@_fast)
    var i, ich, iDec, num, sNum, cbNum, nRnd, sRnd, ExpNum;
 @end
    apInitTest("psInt101 ");
    ...
    verify("min pos: +1",+1, null);
    verify("min pos < n < max pos: 42",42, null);
    verify("min pos < n < max pos: 148",148, null);
    verify("min pos < n < max pos: 1446",1446, null);
    verify("min pos < n < max pos: 64688",64688, null);
    verify("min pos < n < max pos: 983474",983474, null);
    verify("min pos < n < max pos: 8983524",8983524, null);
    verify("min pos < n < max pos: 25288939",25288939, null);
    verify("min pos < n < max pos: 463069357",463069357, null);
    verify("min pos < n < max pos: 1234567890",1234567890, null);
    verify("max pos: 2147483647",2147483647, null);

    verify("max neg: -1",-1, null);
    verify("min neg < n < max neg: -21",-21, null);
    verify("min neg < n < max neg: -609",-609, null);
    verify("min neg < n < max neg: -6759",-6759, null);
    verify("min neg < n < max neg: -89429",-89429, null);
    verify("min neg < n < max neg: -401449",-401449, null);
    verify("min neg < n < max neg: -7909313",-7909313, null);
    verify("min neg < n < max neg: -47008400",-47008400, null);
    verify("min neg < n < max neg: -404860839",-404860839, null);

    verify("min neg < n < max neg: -1234567890",-1234567890, null);
    verify("min neg: -2147483648",-2147483648, null);

    verify("pos zero",0, null);
    verify("neg zero",-0, null);
    ...
    verify("min pos: 2.2250738585072014e-308",2.2250738585072014e-308, null);
        ...
        for (cbNum=1; cbNum<=15; cbNum++)
        {
            ...
            for (iDec=0; iDec<=cbNum+1; iDec++) // decimal places
            {
                ...
                if (num > 2147483647)
                    ...
                    ExpNum = iDec > 0 ? sNum.substring(0,iDec+1) : 0;

                verify("min pos < n < max pos: "+sNum,num, null);
            }
        }


    verify("max pos",1.7976931348623158e308, null);
    verify("max pos",1.7976931348623158e+308, null);
    verify("> max pos float (1.#INF)",1.797693134862315807e309, null);

    verify("max neg",-2.2250738585072012595e-308, null);
        ...
        for (cbNum=1; cbNum<=15; cbNum++)
        {
            for (iDec=0; iDec<=cbNum+1; iDec++)
            {
                ...
                if (num < -2147483648)
                    ...
                    ExpNum = iDec != 0 ? sNum.substring(0,iDec+2) : 0;

                verify("min pos < n < max pos: "+sNum,num, null);
            }
        }

    verify("min neg",-1.797693134862315807e308, null);
    verify("< min neg float (-1.#INF)",-1.797693134862315807e309, null);
    ...
    verify("min pos: 0x1",0x1, null);
    verify("min pos < n < max pos: 0xC",0xC, null);
    verify("min pos < n < max pos: 0x14",0x14, null);
    verify("min pos < n < max pos: 0x562",0x562, null);
    verify("min pos < n < max pos: 0x9a40",0x9a40, null);
    verify("min pos < n < max pos: 0xD4Bb9",0xD4Bb9, null);
    verify("min pos < n < max pos: 0x17020a",0x17020a, null);
    verify("min pos < n < max pos: 0x269aaf0",0x269aaf0, null);
    verify("min pos < n < max pos: 0xA7a864cf",0xA7a864cf, null);
    verify("max pos: 0xffffffff",0xffffffff, null);

    verify("max neg: -0x1",-0x1, null);
    verify("min neg < n < max neg: -0x2",-0x2, null);
    verify("min neg < n < max neg: -0xfC",-0xfC, null);
    verify("min neg < n < max neg: -0xC07",-0xC07, null);
    verify("min neg < n < max neg: -0x54e6",-0x54e6, null);
    verify("min neg < n < max neg: -0x41061",-0x41061, null);
    verify("min neg < n < max neg: -0xb15870",-0xb15870, null);
    verify("min neg < n < max neg: -0xf6BfE57",-0xf6BfE57, null);
    verify("min neg < n < max neg: -0xA347599c",-0xA347599c, null);
    verify("min neg: -0xffffffff",-0xffffffff, null);

    verify("pos zero",0x0, null);
    verify("neg zero",-0x0, null);
    ...
    verify("min pos",01, null);
    verify("min pos < n < max pos: 02",02, null);
    verify("min pos < n < max pos: 072",072, null);
    verify("min pos < n < max pos: 0461",0461, null);
    verify("min pos < n < max pos: 06706",06706, null);
    verify("min pos < n < max pos: 050661",050661, null);
    verify("min pos < n < max pos: 0302611",0302611, null);
    verify("min pos < n < max pos: 02303116",02303116, null);
    verify("min pos < n < max pos: 042152134",042152134, null);
    verify("min pos < n < max pos: 0324413222",0324413222, null);
    verify("min pos < n < max pos: 05766757103",05766757103, null);
    verify("min pos < n < max pos: 021013604067",021013604067, null);
    verify("max pos: 037777777777",037777777777, null);

    verify("max neg: -01",-01, null);
    verify("min neg < n < max neg: -07",-07, null);
    verify("min neg < n < max neg: -021",-021, null);
    verify("min neg < n < max neg: -0332",-0332, null);
    verify("min neg < n < max neg: -07777",-07777, null);
    verify("min neg < n < max neg: -044221",-044221, null);
    verify("min neg < n < max neg: -0201615",-0201615, null);
    verify("min neg < n < max neg: -04506536",-04506536, null);
    verify("min neg < n < max neg: -015257715",-015257715, null);
    verify("min neg < n < max neg: -0521544023",-0521544023, null);
    verify("min neg < n < max neg: -02330412042",-02330412042, null);
    verify("min neg < n < max neg: -035164014173",-035164014173, null);
    verify("min neg: -037777777777",-037777777777, null);

    verify("pos zero",00, null);
    verify("neg zero",-00, null);
    ...
    verify("min neg < n < max neg: -1234567890","-1234567890", null);
    verify("min neg: -2147483647","-2147483648", null);
    ...
    // float lengths for ns's between the min pos and the max pos floats
        ...
        for (cbNum=1; cbNum<=15; cbNum++)
        {
            for (iDec=0; iDec<=cbNum+1; iDec++) 
            {
                ...
                verify("min pos < n < max pos: "+sNum,sNum, null);
            }
        }
    ...
    verify("single space"," ", null);
    verify("multiple spaces","                                                                   ", null);
    verify("as false","false", null);
    verify("as single word","foo", null);
    verify("as single word, leading space"," foo", null);
    verify("as single word, trailing space","foo ", null);
    verify("as multiple word","foo bar", null);
    verify("as multiple word, leading space"," foo bar", null);
    verify("as multiple word, trailing space","foo bar ", null);
    verify("zls","", null);
    ...
    for (i=0; i<10; i++)
    {
        ...
        sRnd = sNum+genRndStr(100,0x7F^0x04);
        verify(sRnd,sRnd,null);
    }
    ...
    {
        sNum = Math.floor(Math.random()*2147483647);
        sRnd = sNum+genRndStr(100,0x100|0x200);
        verify(sRnd,sRnd,null);
    }
    ...
    {
        sNum = Math.floor(Math.random()*2147483647);
        sRnd = genRndStr(100,0x7F^0x04)+sNum;
        verify(sRnd,sRnd,null);
    }
    ...
    {
        sNum = Math.floor(Math.random()*2147483647);
        sRnd = genRndStr(100,0x100|0x200)+sNum;
        verify(sRnd,sRnd,null);
    }
    ...
    verify("new Array()",new Array(), null);
    verify("new Boolean()",new Boolean(), null);
    verify("new Date()",new Date(), null);
    verify("new Number()",new Number(), null);
    verify("new Object()",new Object(), null);
    ...
    verify("new obFoo()",new obFoo(), null);
    ...
    //----------------------------------------------------------------------------
    apInitScenario("22. Bug 178 - high precisions arithmetic");
    
    // really big
    var exp = ;
    var res = parseInt("",16)
    verify(exp, res,null);

    // really small
    exp = -;
    res = parseInt("-",16)
    verify(exp, res,null);
