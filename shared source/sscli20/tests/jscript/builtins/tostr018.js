...
function verify(scen, ob, type, bugNum) {
    ...
    if (type == 1)
        ...
        sExp = (ob+"").substring(1,ob.length-1);
    else
...
@end
    ...
    verify("literal, string--single space","' '", 2, null);
    verify("literal, string--multiple spaces","'                                                                   '", 2, null);
    verify("literal, string--as false","'false'",2, null);
    verify("literal, string--ns 0","'0'", 2, null);
    verify("literal, string--ns > 0","'1234567890'", 2, null);
    verify("literal, string--ns > 0, leading space","' 1234567890'", 2, null);
    verify("literal, string--ns > 0, trailing space","'1234567890 '", 2, null);
    verify("literal, string--ns < 0","'-1234567890'", 2, null);
    verify("literal, string--as single word","'obFoo'", 2, null);
    verify("literal, string--as single word, leading space","' foo'", 2, null);
    verify("literal, string--as single word, trailing space","'foo '", 2, null);
    verify("literal, string--as multiple word","'foo bar'", 2, null);
    verify("literal, string--as multiple word, leading space","' foo bar'", 2, null);
    verify("literal, string--as multiple word, trailing space","'foo bar '", 2, null);
    verify("literal, string--zls","''", 2, null);


    //----------------------------------------------------------------------------
    apInitScenario("9. constants");

    verify("constants",true, 1, null);
    verify("constants",false, 1, null);
