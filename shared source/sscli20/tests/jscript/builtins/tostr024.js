...
@end
    ...
    verify("built-in, exec, instanciated--Boolean",new Boolean(), 1, null);
    verify("built-in, exec, instanciated--Date",new Date(96,0,1), 0, null);
    verify("built-in, exec, instanciated--Number",new Number(), 1, null);
    verify("built-in, exec, instanciated--Object",new Object(), 0, null);
//    verify("built-in, exec, instanciated--String",new String(), 0, null); // cf vegas 3355
    ...
    verify("literal, string--single space","' '", 1, null);
    verify("literal, string--multiple spaces","'                                                                   '", 1, null);
    verify("literal, string--as false","'false'",1, null);
    verify("literal, string--ns 0","'0'", 1, null);
    verify("literal, string--ns > 0","'1234567890'", 1, null);
    verify("literal, string--ns > 0, leading space","' 1234567890'", 1, null);
    verify("literal, string--ns > 0, trailing space","'1234567890 '", 1, null);
    verify("literal, string--ns < 0","'-1234567890'", 1, null);
    verify("literal, string--as single word","'obFoo'", 1, null);
    verify("literal, string--as single word, leading space","' foo'", 1, null);
    verify("literal, string--as single word, trailing space","'foo '", 1, null);
    verify("literal, string--as multiple word","'foo bar'", 1, null);
    verify("literal, string--as multiple word, leading space","' foo bar'", 1, null);
    verify("literal, string--as multiple word, trailing space","'foo bar '", 1, null);
