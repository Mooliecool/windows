...
function unesc002() {
    ...
    sAct = unescape( "\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r" );
    ...
    //---------------Chars 0x20-0x7f------------------------------------------
        ...
        sAct = unescape( 'pppppppppppppppppppppppppppppppp' );

        if (sAct != sExp)
            apLogFailInfo( "repeated char lc alpha failed", sExp, sAct, "");

        sExp = 'jjjjjjjjjjjjjj';
        sAct = unescape( 'jjjjjjjjjjjjjj' );
        ...
        sAct = unescape( "11111111111111111111111111111111111" );

        if (sAct != sExp)
            apLogFailInfo( "repeated char num failed", sExp, sAct, "");

        sExp = "0000000000000000000000000000";
        sAct = unescape( "0000000000000000000000000000" );
        ...
        sAct = unescape( " !\"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~" );
        ...
        sAct = unescape( "0tjzL>E!(B#CJHg-;XwU^vI9nQ\'G`Wm&hDA i6k8c]=|YOKN)b3*:xd[,.~2?y/uS+MqlV\"pPR4TZ%7{o$f@e_F5<r1}as" );
    ...
    //---------------Chars 0x80-0xff-(Extended)-------------------------------
        ...
        sExp = "€‚ƒ„…†‡ˆ‰Š‹ŒŽ‘’“”•–—˜™š›œž ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ";
        sAct = unescape( "€‚ƒ„…†‡ˆ‰Š‹ŒŽ‘’“”•–—˜™š›œž ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ" );
        ...
        sExp = "¾ÑÒž•ïçƒ®±Ùè´þù¨¢«˜Çûöêßœ÷—›àÐæ”Üäü¥éÂ¼ÌŠì™È§²íâóŽã‡ÅºÀ½Øš–ýÊ’ÆÚË°îªòñµ¤‘Ä„“¦‰Ô‹ÁÓô†Õ€ÏúðÖ£ÃÞ¯ ˆÿ³¸Û»ëáÉ¡¶ø©ÍÎ…åŒ¿¹¬­õ×·‚Ý";

        sAct = unescape( "¾ÑÒž•ïçƒ®±Ùè´þù¨¢«˜Çûöêßœ÷—›àÐæ”Üäü¥éÂ¼ÌŠì™È§²íâóŽã‡ÅºÀ½Øš–ýÊ’ÆÚË°îªòñµ¤‘Ä„“¦‰Ô‹ÁÓô†Õ€ÏúðÖ£ÃÞ¯ ˆÿ³¸Û»ëáÉ¡¶ø©ÍÎ…åŒ¿¹¬­õ×·‚Ý" );
