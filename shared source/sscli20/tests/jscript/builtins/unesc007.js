...
function unesc007() {
    ...
    sClean = "\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r";
    sAct = unescape( sClean );
    ...
    //---------------Chars 0x20-0x7f------------------------------------------
        ...
        sClean = 'QQQQQQQQQQQQQQQQQQQQQQQQ';
        sAct = unescape( sClean );
        ...
        sClean = 'pppppppppppppppppppppppppppppppp';
        sAct = unescape( sClean );
        ...
        sClean = "11111111111111111111111111111111111";
        sAct = unescape( sClean );
        ...
        sClean = "0000000000000000000000000000";
        sAct = unescape( sClean );
        ...
        sClean = " !\"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
        sAct = unescape( sClean );
        ...
        sClean = "0tjzL>E!(B#CJHg-;XwU^vI9nQ\'G`Wm&hDA i6k8c]=|YOKN)b3*:xd[,.~2?y/uS+MqlV\"pPR4TZ%7{o$f@e_F5<r1}as";
        sAct = unescape( sClean );
	...
	sExp = "” ";
        ...
        sClean = "€‚ƒ„…†‡ˆ‰Š‹ŒŽ‘’“”•–—˜™š›œžŸ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ";
        sAct = unescape( sClean );
        ...
        sClean = "¾ÑÒž•ïçƒ®±Ùè´þù¨¢«˜ÇûöêßœŸ÷—›àÐæ”Üäü¥éÂ¼ÌŠì™È§²íâóŽã‡ÅºÀ½Øš–ýÊ’ÆÚË°îªòñµ¤‘Ä„“¦‰Ô‹ÁÓô†Õ€ÏúðÖ£ÃÞ¯ ˆÿ³¸Û»ëáÉ¡¶ø©ÍÎ…åŒ¿¹¬­õ×·‚Ý";
        sAct = unescape( sClean );
