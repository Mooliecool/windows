...
function unesc017() {
    ...
    sAct = unescape( retVar("\r\r%0D\r\r%0D%0D\r%0D%0D%0D%0D%0D\r%0D") );
    ...
    sExp = '\b\t\n\f\r';    
    sAct = unescape( retVar("%08\t%0A\f\r") );
    ...
    //---------------Chars 0x20-0x7f------------------------------------------
        ...
        sExp = "                  ";        
        sAct = unescape( retVar(" %20 %20%20%20%20%20  %20%20%20    %20") );
        ...
        sAct = unescape( retVar('QQ%51%51%51QQQQ%51%51%51QQQQQQQQQ%51%51%51') );

        if (sAct != sExp)
            apLogFailInfo( "repeated mixed escape char uc alpha failed", sExp, sAct, "");

        sExp = 'TTTTTTTTTTTTT';        
        sAct = unescape( retVar('TT%54TTT%54%54TTTTT') );
        ...
        sAct = unescape( retVar('%70%70pppppp%70pppppppppp%70%70%70%70%70%70%70%70%70p%70%70%70') );

        if (sAct != sExp)
            apLogFailInfo( "repeated mixed escape char lc alpha failed", sExp, sAct, "");

        sExp = 'zzzzzzzzzzzzzzzzzzzzzzzz';        
        sAct = unescape( retVar('zzz%7A%7Az%7A%7A%7A%7A%7A%7A%7Az%7A%7A%7A%7A%7A%7A%7A%7A%7Az') );
        ...
        sExp = '##########';        
        sAct = unescape( retVar('%23#%23%23%23%23%23%23%23%23') );

        if (sAct != sExp)
            apLogFailInfo( "repeated mixed escape char misc failed", sExp, sAct, "");

        sExp = '!!!!!!!!!!!!!!';        
        sAct = unescape( retVar('%21!!!!%21%21!!!%21!%21%21') );
        ...
        sExp = '@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@';        
        sAct = unescape( retVar('@@@@@@@%40%40@@@@@@@%40@@@@@@@@@@@@@@@@@%40%40@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@') );
        ...
        sAct = unescape( retVar("11111111%31%31%31%31%31%31%311111111111%31%3111111%31%31%31") );

        if (sAct != sExp)
            apLogFailInfo( "repeated mixed escape char num failed", sExp, sAct, "");

        sExp = "0000000000000000000000000000";        
        sAct = unescape( retVar("%30%30%30%30000%30%30%30%30%30%30%30%30%30%30%300%3000000%3000") );
        ...
        if(!g_OnDBCS)
	{
        	...
        	sAct = unescape( retVar('ç%E7ç%E7%E7%E7%E7çççç%E7%E7çç%E7%E7%E7') );
	}
	else
	{
	        sExp = 'çççççççççççççççççç';        
        	sAct = unescape( retVar('\u9257\u9257\u9257çççç\u9257çççç\u9257') );
	}
        if (sAct != sExp)
	...
	{
		sExp = 'ýýýýýý';        
         	sAct = unescape( retVar('ýýýý%FD%FD') );
	}
	else
	{
		sExp = 'ýýýýýý';        
         	sAct = unescape( retVar('ýýýý\uF8F1\uF8F1') );
	}
        if (sAct != sExp)
            apLogFailInfo( "repeated mixed escape char extended failed", sExp, sAct, "");
	...
	{
		sExp = '¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬';        
        	sAct = unescape( retVar('%AC%AC%AC%AC%AC%AC%AC%AC%AC¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬') );
	}
	else
	{
		sExp = '¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬';        
        	sAct = unescape( retVar('\uFF6C\uFF6C\uFF6C\uFF6C\uFF6C\uFF6C\uFF6C\uFF6C\uFF6C¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬') );
	}
        if (sAct != sExp)
            apLogFailInfo( "repeated mixed escape char extended failed", sExp, sAct, "");
	...
	{
	        sExp = '¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿';        
        	sAct = unescape( retVar('%BF%BF%BF%BF¿¿¿¿¿%BF%BF¿¿¿¿¿%BF%BF¿¿¿¿%BF%BF%BF¿') );
	}
	else
	{
	        sExp = '¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿';        
        	sAct = unescape( retVar('\uFF7F\uFF7F\uFF7F\uFF7F¿¿¿¿¿\uFF7F\uFF7F¿¿¿¿¿\uFF7F\uFF7F¿¿¿¿\uFF7F\uFF7F\uFF7F¿') );
	}
        if (sAct != sExp)
            apLogFailInfo( "repeated mixed escape char extended failed", sExp, sAct, "");
	...
	{
	        sExp = '«««';        
        	sAct = unescape( retVar('««%AB') );
	}
	else
	{
	        sExp = '«««';        
        	sAct = unescape( retVar('««\uFF6B') );
	}
        if (sAct != sExp)
            apLogFailInfo( "repeated mixed escape char extended failed", sExp, sAct, "");
