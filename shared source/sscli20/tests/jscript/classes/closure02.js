...
class c02{
  ...
  var o2:Object = {}
  var t2 = fun2(o2)
  if (o2.x()!= 2) apLogFailInfo("wrong result obtained", 2, o2.x(), "301086")
  ...
  apInitScenario("closure of function in function scope (field)")
  function fun17(invar){
    var val = 17
    t17 = function(){return val}
  }
  fun17()
  if (t17()!= 17) apLogFailInfo("wrong result obtained", 17, t17(), "")

  apInitScenario("closure of function using eval in function scope (field)")
  function fun18(invar){
    var val = 18
    eval("t18 = (function(){return val})", "unsafe")
  }
  fun18()
  if (t18()!= 18) apLogFailInfo("wrong result obtained", 18, t18(), "")

  @if (!@_fast) 
  apInitScenario("closure of function (defined in eval) in function scope(field)")
  eval(
  "function fun19(invar){			\n"+
  "  var val = 19				\n"+
  "  t19 =  function(){return val}	\n"+
  "}					\n", "unsafe")
  fun19()
  if (t19()!= 19) apLogFailInfo("wrong result obtained", 19, t19(), "")


  apInitScenario("closure (created in eval) of function in function scope(field)")
  function fun20(invar){
    var val = 20
    t20 = function(){return val}
  }
  eval("fun20()")
  if (t20()!= 20) apLogFailInfo("wrong result obtained", 20, t20(), "")
