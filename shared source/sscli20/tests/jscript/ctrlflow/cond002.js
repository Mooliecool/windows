...
function cond002() {
    ...
    // >0
        ...
        n = 0;    
        if ((1 ? ++n : --n) != 1) apLogFailInfo( "min pos int failed ", 1, n,"");
    
        n = 0;
        if ((1234567890 ? ++n : --n) != 1) apLogFailInfo( "min pos int < n < max pos int failed ", 1, n,"");

        n = 0;
        if ((2147483647 ? ++n : --n) != 1) apLogFailInfo( "max pos int failed ", 1, n,"");

    // <0

        n = 0;
        if ((-1 ? ++n : --n) != 1) apLogFailInfo( "max neg int failed ", 1, n,"");

        n = 0;
        if ((-1234567890 ? ++n : --n) != 1) apLogFailInfo( "min neg int < n < max neg int failed ", 1, n,"");

        n = 0;
        if ((-2147483647 ? ++n : --n) != 1) apLogFailInfo( "min neg int failed ", 1, n,"");

    // 0

        n = 0;
        if ((0 ? ++n : --n) != -1) apLogFailInfo( "zero int failed ", -1, n,"");
    ...
    // >0.0
        ...
        n = 0;    
        if ((2.225073858507202e-308 ? ++n : --n) != 1) apLogFailInfo( "min pos float failed ", 1, n,"");
    
        n = 0;
        if ((1.2345678e90 ? ++n : --n) != 1) apLogFailInfo( "min pos float < n < max pos float failed ", 1, n,"");

        n = 0;
        if ((1.797693134862315807e308 ? ++n : --n) != 1) apLogFailInfo( "max pos float failed ", 1, n,"");

        n = 0;
        if ((1.797693134862315807e309 ? ++n : --n) != 1) apLogFailInfo( "> max pos float (1.#INF) failed ", 1, n,"");

    // <0

        n = 0;
        if ((-2.225073858507202e-308 ? ++n : --n) != 1) apLogFailInfo( "max neg float failed ", 1, n,"");

        n = 0;
        if ((-1.2345678e90 ? ++n : --n) != 1) apLogFailInfo( "min neg float < n < max neg float failed ", 1, n,"");

        n = 0;
        if ((-1.797693134862315807e308 ? ++n : --n) != 1) apLogFailInfo( "min neg float failed ", 1, n,"");

        n = 0;
        if ((-1.797693134862315807e309 ? ++n : --n) != 1) apLogFailInfo( "< min neg float (-1.#INF) failed ", 1, n,"");

    // 0.0

        n = 0;
        if ((0.0 ? ++n : --n) != -1) apLogFailInfo( "zero float failed ", -1, n,"");
    ...
    // >0
        ...
        n = 0;    
        if ((0x1 ? ++n : --n) != 1) apLogFailInfo( "min pos int failed ", 1, n,"");
    
        n = 0;
        if ((0x2468ACE ? ++n : --n) != 1) apLogFailInfo( "min pos int < n < max pos int failed ", 1, n,"");

        n = 0;
        if ((0xFFFFFFFF ? ++n : --n) != 1) apLogFailInfo( "max pos int failed ", 1, n,"");

    // <0

        n = 0;
        if ((-0x1 ? ++n : --n) != 1) apLogFailInfo( "max neg int failed ", 1, n,"");

        n = 0;
        if ((-0x2468ACE ? ++n : --n) != 1) apLogFailInfo( "min neg int < n < max neg int failed ", 1, n,"");

        n = 0;
        if ((-0xFFFFFFFF ? ++n : --n) != 1) apLogFailInfo( "min neg int failed ", 1, n,"");

    // 0

        n = 0;
        if ((0x0 ? ++n : --n) != -1) apLogFailInfo( "zero int failed ", -1, n,"");
    ...
    // >0
        ...
        n = 0;    
        if ((01 ? ++n : --n) != 1) apLogFailInfo( "min pos int failed ", 1, n,"");
    
        n = 0;
        if ((01234567 ? ++n : --n) != 1) apLogFailInfo( "min pos int < n < max pos int failed ", 1, n,"");

        n = 0;
        if ((037777777777 ? ++n : --n) != 1) apLogFailInfo( "max pos int failed ", 1, n,"");

    // <0

        n = 0;
        if ((-01 ? ++n : --n) != 1) apLogFailInfo( "max neg int failed ", 1, n,"");

        n = 0;
        if ((-01234567 ? ++n : --n) != 1) apLogFailInfo( "min neg int < n < max neg int failed ", 1, n,"");

        n = 0;
        if ((-037777777777 ? ++n : --n) != 1) apLogFailInfo( "min neg int failed ", 1, n,"");

    // 0

        n = 0;
        if ((00 ? ++n : --n) != -1) apLogFailInfo( "zero int failed ", -1, n,"");
    ...
    apInitScenario("10. string");
        ...
        n = 0;
        if (("foo" ? ++n : --n) != 1) apLogFailInfo( "as single word failed ", 1, n,"");

        n = 0;
        if ((" foo" ? ++n : --n) != 1) apLogFailInfo( "as single word, leading space failed ", 1, n,"");

        n = 0;
        if (("foo " ? ++n : --n) != 1) apLogFailInfo( "as single word, trailing space failed ", 1, n,"");
    ...
    n = 0;
    if ((true ? ++n : --n) != 1) apLogFailInfo( "constants--true failed ", 1, n,"");
