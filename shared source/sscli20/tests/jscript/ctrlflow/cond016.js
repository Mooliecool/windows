...
function cond016() {
    ...
    // >0
        ...
        n = 0;    
        if ((!1 ? ++n : --n) != -1) apLogFailInfo( "min pos failed ", -1, n,"");
    
        n = 0;
        if ((!1234567890 ? ++n : --n) != -1) apLogFailInfo( "min pos < n < max pos failed ", -1, n,"");

        n = 0;
        if ((!2147483647 ? ++n : --n) != -1) apLogFailInfo( "max pos failed ", -1, n,"");

    // <0

        n = 0;
        if ((!-1 ? ++n : --n) != -1) apLogFailInfo( "max neg failed ", -1, n,"");

        n = 0;
        if ((!-1234567890 ? ++n : --n) != -1) apLogFailInfo( "min neg < n < max neg failed ", -1, n,"");

        n = 0;
        if ((!-2147483647 ? ++n : --n) != -1) apLogFailInfo( "min neg failed ", -1, n,"");

    // 0

        n = 0;
        if ((!0 ? ++n : --n) != 1) apLogFailInfo( "zero failed ", 1, n,"");
    ...
    // >0.0
        ...
        n = 0;    
        if ((!2.225073858507202e-308 ? ++n : --n) != -1) apLogFailInfo( "min pos failed ", -1, n,"");
    
        n = 0;
        if ((!1.2345678e90 ? ++n : --n) != -1) apLogFailInfo( "min pos float < n < max pos failed ", -1, n,"");

        n = 0;
        if ((!1.797693134862315807e308 ? ++n : --n) != -1) apLogFailInfo( "max pos failed ", -1, n,"");

        n = 0;
        if ((!1.797693134862315807e309 ? ++n : --n) != -1) apLogFailInfo( "> max pos (1.#INF) failed ", -1, n,"");

    // <0

        n = 0;
        if ((!-2.225073858507202e-308 ? ++n : --n) != -1) apLogFailInfo( "max neg failed ", -1, n,"");

        n = 0;
        if ((!-1.2345678e90 ? ++n : --n) != -1) apLogFailInfo( "min neg < n < max neg failed ", -1, n,"");

        n = 0;
        if ((!-1.797693134862315807e308 ? ++n : --n) != -1) apLogFailInfo( "min neg failed ", -1, n,"");

        n = 0;
        if ((!-1.797693134862315807e309 ? ++n : --n) != -1) apLogFailInfo( "< min neg (-1.#INF) failed ", -1, n,"");

    // 0.0

        n = 0;
        if ((!0.0 ? ++n : --n) != 1) apLogFailInfo( "zero failed ", 1, n,"");
    ...
    // >0
        ...
        n = 0;    
        if ((!0x1 ? ++n : --n) != -1) apLogFailInfo( "min pos failed ", -1, n,"");
    
        n = 0;
        if ((!0x2468ACE ? ++n : --n) != -1) apLogFailInfo( "min pos < n < max pos failed ", -1, n,"");

        n = 0;
        if ((!0xFFFFFFFF ? ++n : --n) != -1) apLogFailInfo( "max pos failed ", -1, n,"");

    // <0

        n = 0;
        if ((!-0x1 ? ++n : --n) != -1) apLogFailInfo( "max neg failed ", -1, n,"");

        n = 0;
        if ((!-0x2468ACE ? ++n : --n) != -1) apLogFailInfo( "min neg < n < max neg failed ", -1, n,"");

        n = 0;
        if ((!-0xFFFFFFFF ? ++n : --n) != -1) apLogFailInfo( "min neg failed ", -1, n,"");

    // 0

        n = 0;
        if ((!0x0 ? ++n : --n) != 1) apLogFailInfo( "zero failed ", 1, n,"");
    ...
    // >0
        ...
        n = 0;    
        if ((!01 ? ++n : --n) != -1) apLogFailInfo( "min pos failed ", -1, n,"");
    
        n = 0;
        if ((!01234567 ? ++n : --n) != -1) apLogFailInfo( "min pos < n < max pos failed ", -1, n,"");

        n = 0;
        if ((!037777777777 ? ++n : --n) != -1) apLogFailInfo( "max pos failed ", -1, n,"");

    // <0

        n = 0;
        if ((!-01 ? ++n : --n) != -1) apLogFailInfo( "max neg failed ", -1, n,"");

        n = 0;
        if ((!-01234567 ? ++n : --n) != -1) apLogFailInfo( "min neg < n < max neg failed ", -1, n,"");

        n = 0;
        if ((!-037777777777 ? ++n : --n) != -1) apLogFailInfo( "min neg failed ", -1, n,"");

    // 0

        n = 0;
        if ((!00 ? ++n : --n) != 1) apLogFailInfo( "zero failed ", 1, n,"");
    ...
    n = 0;
    if ((!null ? ++n : --n) != 1) apLogFailInfo( "null failed ", 1, n,"");
    ...
    n = 0;
    var obUndef;
    if ((!obUndef ? ++n : --n) != 1) apLogFailInfo( "null failed ", 1, n,"");
