...
{
    // expando properties are forbidden on the built-in objects, other than the Global object 
    @if(@_fast) 
...
@end       
    ...
    pOb.obMem.foo = pOb.obMem[1234567] = pOb.obMem["bar"] = pOb.obMem.bin = pOb.obMem[-1.23e45] = null;
    ...
    tActual = pOb.obMem.foo*pOb.obMem[1234567]*pOb.obMem["bar"]*pOb.obMem.bin*pOb.obMem[-1.23e45];
