...
@end       
    ...
    if (n != cMem) apLogFailInfo( "built-in, non-executable--Math failed",cMem,n,"");
    ...
    if (n != cMem) apLogFailInfo( "built-in, exec, not instantiated--Boolean failed", cMem, n,"");
    ...
    if (n != cMem) apLogFailInfo( "built-in, exec, not instantiated--Date failed", cMem, n,"");
    ...
    if (n != cMem) apLogFailInfo( "built-in, exec, not instantiated--Number failed", cMem, n,"");
    ...
    if (n != cMem) apLogFailInfo( "string--single space failed", cMem, n,"");
    ...
    if (n != cMem) apLogFailInfo( "string--multiple spaces failed", cMem, n,"");
    ...
    if (n != cMem) apLogFailInfo( "string--as single word failed", cMem, n,"");
    ...
    if (n != cMem) apLogFailInfo( "string--as single word, leading space failed", cMem, n,"");
    ...
    if (n != cMem) apLogFailInfo( "string--as single word, trailing space failed", cMem, n,"");
