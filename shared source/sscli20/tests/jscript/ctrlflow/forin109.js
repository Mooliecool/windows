...
@end      
   ...
   if (n != tMem) apLogFailInfo( "built-in, non-executable--Math failed",tMem,n,"");
   ...
   if (n != tMem) apLogFailInfo( "built-in, exec, not instantiated--Array failed", tMem, n,"");
