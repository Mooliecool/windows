...
@end       
    ...
    pOb.obMem.a=pOb.obMem.b=pOb.obMem.c=pOb.obMem.d=pOb.obMem.e=null;

    for (var i in pOb.obMem) {
        if (n % 2 && n < 6) pOb.obMem[++tMem] = null;
        pOb.obMem[i]=n;
		n++;
	}
	n--;
    ...
    var tActual = pOb.obMem.a*pOb.obMem.b*pOb.obMem.c*pOb.obMem.d*pOb.obMem.e*
        pOb.obMem[n-2]*pOb.obMem[n-1]*pOb.obMem[n];

    if (n != tMem || (tActual != tExpect)) apLogFailInfo( scen+"--"+nob+" failed ",tMem,n,"");
