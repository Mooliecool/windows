...
function boolean2types() {

 apInitTest("boolean2types"); 

//var empty : boolean = boolean(null);
var empty: boolean = null;

var mid0: boolean = "true";
var max0 :boolean = "1234567890";
var min0 : boolean = 0;
...
verify(sbyteTypedZero, zero, "sbyte0");
verify(sbyteTypedmid0, mid0, "sbyte0");
verify(sbyteTypedmax0, max0, "sbyte0");
verify(sbyteTypedmin0, min0, "sbyte0");
verify(sbyteObjZero, zero, "sbyte0");
verify(sbyteObjmid0, mid0, "sbyte0");
verify(sbyteObjmax0, max0, "sbyte0");
...
verify(byteTypedmid0, mid0, "byte0");
verify(byteTypedmax0, max0, "byte0");
verify(byteTypedmin0, min0, "byte0");
verify(byteObjZero, zero, "byte0");
verify(byteObjmid0, mid0, "byte0");
verify(byteObjmax0, max0, "byte0");
verify(byteObjmin0, min0, "byte0");
...
verify(shortTypedmid0, mid0, "short0");
verify(shortTypedmax0, max0, "short0");
verify(shortTypedmin0, min0, "short0");
verify(shortObjZero, zero, "short0");
verify(shortObjmid0, mid0, "short0");
verify(shortObjmax0, max0, "short0");
...
verify(ushortTypedmid0, mid0, "ushort0");
verify(ushortTypedmax0, max0, "ushort0");
verify(ushortTypedmin0, min0, "ushort0");
verify(ushortObjZero, zero, "ushort0");
verify(ushortObjmid0, mid0, "ushort0");
verify(ushortObjmax0, max0, "usuhort0");
verify(ushortObjmin0, min0, "usuhort0");
...
verify(ulongTypedmid0, mid0, "ulong0");
verify(ulongTypedmax0, max0, "ulong0");
verify(ulongObjZero, zero, "ulong0");
verify(ulongObjmid0, mid0, "ulong0");
