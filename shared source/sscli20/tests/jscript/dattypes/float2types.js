...
function float2types() {

 apInitTest("float2types"); 

//var empty : float = float(null);
var empty : float = null;

var mid0: float = 10.08 ;
var max0 :float = float.MaxValue;
var min0 : float = float.MinValue;
var zero : float = 0x0000000;
...
@if (@_fast)
verify(decimalTypedmid0, 10.0799999237061, "decimal0");
@else
...
@if (@_fast)
verify(decimalObjmid0, 10.0799999237061, "decimal0");
@else
