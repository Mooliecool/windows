...
function absh001() {
    ...
    // by design apLogFailInfo("bug: 277604", "", "", "");    
    ...
    verifyParams("sbyte: n = sbyte.min", sbyte.MinValue, 128)
    ...
    verifyParams("short: n = short.min", short.MinValue, 32768)
    ...
    verifyParams("int: n = int.min", int.MinValue, 2147483648)
    ...
    verifyParams("long: n = long.min", long.MinValue, 9223372036854775808)
    ...
    verifyParams("String: n = long.min", long.MinValue, 9223372036854775808)
