...
function sverify( ob, sExp, bugNum) { // soft verify - checks within a delta
    var delta = 4e-15;
...
function ceil002() {
    ...
    verify(5.56585846982525e-23, 1, null);
    verify(5.56585846982525e-24, 1, null);
    verify(5.56585846982525e-25, 1, null);
    verify(3.82611861733991e-105, 1, null);
    verify(3.82611861733991e-106, 1, null);
    verify(3.82611861733991e-107, 1, null);
    verify(7.55119898189387e-303, 1, null);
    verify(7.55119898189387e-304, 1, null);
    verify(7.55119898189387e-305, 1, null);
    verify(9.33079308870154e-304, 1, null);
    verify(9.33079308870154e-305, 1, null);
    verify(9.33079308870154e-306, 1, null);
...
@if (@_jscript_version>=7)
    sverify(7.00871941301623e15, 7008719413016230, null);
    sverify(7.00871941301623e16, 70087194130162300, null);
    sverify(7.00871941301623e17, 700871941301623040, null);
    sverify(1.44829343149756e16, 14482934314975600, null);
    sverify(1.44829343149756e17, 144829343149756000, null);
    sverify(1.44829343149756e18, 1448293431497560000, null);
    sverify(1.76150125345059e18, 1761501253450590000, null);
    sverify(1.76150125345059e19, 17615012534505900000, null);
    sverify(1.76150125345059e20, 1.7615012534505901e+020, null);
@else
...
@end
    ...
    verify(2.10767453808956e24, 2.10767453808956e+024, null);
    verify(2.10767453808956e25, 2.1076745380895599e+025, null);
    verify(2.10767453808956e26, 2.1076745380895601e+026, null);
    ...
    verify(4.43798139759837e304, 4.4379813975983703e+304, null);
    verify(4.43798139759837e305, 4.4379813975983703e+305, null);
    verify(4.43798139759837e306, 4.4379813975983698e+306, null);
    ...
    verify(-7.41928308312151e-23, 0, null);
    verify(-7.41928308312151e-24, 0, null);
    verify(-7.41928308312151e-25, 0, null);
    verify(-7.27813770416071e-105, 0, null);
    verify(-7.27813770416071e-106, 0, null);
    verify(-7.27813770416071e-107, 0, null);
    verify(-3.31023416390304e-304, 0, null);
    verify(-3.31023416390304e-305, 0, null);
    verify(-3.31023416390304e-306, 0, null);
...
@if (@_jscript_version>=7)
    sverify(-9.87601801405715e14, -987601801405715, null);
    sverify(-9.87601801405715e15, -9876018014057150, null);
    sverify(-9.87601801405715e16, -98760180140571500, null);
    sverify(-2.00941085362823e15, -2009410853628230, null);
    sverify(-2.00941085362823e16, -20094108536282300, null);
    sverify(-2.00941085362823e17, -200941085362823000, null);
    sverify(-6.75649868607965e16, -67564986860796496, null);
    sverify(-6.75649868607965e17, -675649868607965060, null);
    sverify(-6.75649868607965e18, -6756498686079649800, null);
    sverify(-7.43963320455925e17, -743963320455924990, null);
    sverify(-7.43963320455925e18, -7439633204559250400, null);
    sverify(-7.43963320455925e19, -74396332045592494000, null);
    sverify(-5.37604621849243e18, -5376046218492430300, null);
    sverify(-5.37604621849243e19, -53760462184924299000, null);
    sverify(-5.37604621849243e20, -5.3760462184924303e+020, null);
@else
