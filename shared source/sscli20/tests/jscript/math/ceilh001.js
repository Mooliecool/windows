...
function ceilh001() {
    ...
    type = boolean
    apInitScenario("ceil of a boolean");
    ...
    type = Single;
    apInitScenario("ceil of a Single");
    ...
    verifyParams("single: n = float.Epsilon", Single.Epsilon, 1)
    ...
    verifyParams("double: n = double.Epsilon", double.Epsilon, 1)
    ...
    type = decimal;
    apInitScenario("ceil of a decimal");
    ...
    type = ushort;
    apInitScenario("ceil of a ushort");
    ...
    type = ulong;
    apInitScenario("ceil of a ulong");
    ...
    type = sbyte;
    apInitScenario("ceil of a sbyte");
    ...
    type = short;
    apInitScenario("ceil of a short");
    ...
    type = String;
    apInitScenario("ceil of a String");
    ...
    type = Date;
    apInitScenario("ceil of a Date");
    verifyParams("Date: n = -int.max", -int.MaxValue, NaN)


    type = Array;
    apInitScenario("ceil of a Array");
