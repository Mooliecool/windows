...
function verify( ob, sExp, bugNum) {
    ...
    var sAct = Math.floor(eval(ob));// add var for sAct to pass /fast -qiongou
...
function floor006() {
    ...
    verify(8.0e-1, 0, null);
    verify(8.0e-2, 0, null);
    verify(6.40e-1, 0, null);
    ...
    verify(3.04950643692583e-23, 0, null);
    verify(3.04950643692583e-24, 0, null);
    verify(3.04950643692583e-25, 0, null);
    verify(3.01953106436364e-105, 0, null);
    verify(3.01953106436364e-106, 0, null);
    verify(3.01953106436364e-107, 0, null);
    verify(1.86940969214515e-304, 0, null);
    verify(1.86940969214515e-305, 0, null);
    verify(1.86940969214515e-306, 0, null);
    ...
    verify(-2.225073858507202e-308,-1, null);
    ...
    verify(-5.9e-2, -1, null);
    verify(-8.92e-1, -1, null);
    verify(-8.92e-2, -1, null);
    verify(-8.92e-3, -1, null);
    verify(-2.951e-2, -1, null);
    verify(-2.951e-3, -1, null);
    verify(-2.951e-4, -1, null);
    verify(-7.1573e-3, -1, null);
    verify(-7.1573e-4, -1, null);
    verify(-7.1573e-5, -1, null);
    verify(-7.83191e-4, -1, null);
    verify(-7.83191e-5, -1, null);
    verify(-7.83191e-6, -1, null);
    verify(-8.761734e-5, -1, null);
    verify(-8.761734e-6, -1, null);
    verify(-8.761734e-7, -1, null);
    verify(-5.6388918e-6, -1, null);
    verify(-5.6388918e-7, -1, null);
    verify(-5.6388918e-8, -1, null);
    verify(-5.51156439e-7, -1, null);
    verify(-5.51156439e-8, -1, null);
    verify(-5.51156439e-9, -1, null);
    verify(-3.640164456e-8, -1, null);
    verify(-3.640164456e-9, -1, null);
    verify(-3.640164456e-10, -1, null);
    verify(-1.4384034645e-9, -1, null);
    verify(-1.4384034645e-10, -1, null);
    verify(-1.4384034645e-11, -1, null);
    verify(-2.25583947958e-10, -1, null);
    verify(-2.25583947958e-11, -1, null);
    verify(-2.25583947958e-12, -1, null);
    verify(-2.011142560596e-11, -1, null);
    verify(-2.011142560596e-12, -1, null);
    verify(-2.011142560596e-13, -1, null);
    verify(-8.9001791229158e-12, -1, null);
    verify(-8.9001791229158e-13, -1, null);
    verify(-8.9001791229158e-14, -1, null);
    verify(-5.25024887140531e-13, -1, null);
    verify(-5.25024887140531e-14, -1, null);
    verify(-5.25024887140531e-15, -1, null);
    verify(-5.78935347372427e-14, -1, null);
    verify(-5.78935347372427e-15, -1, null);
    verify(-5.78935347372427e-16, -1, null);
    verify(-2.29358110607862e-15, -1, null);
    verify(-2.29358110607862e-16, -1, null);
    verify(-2.29358110607862e-17, -1, null);
    verify(-3.97922068769070e-16, -1, null);
    verify(-3.97922068769070e-17, -1, null);
    verify(-3.97922068769070e-18, -1, null);
    verify(-6.06392842726122e-17, -1, null);
    verify(-6.06392842726122e-18, -1, null);
    verify(-6.06392842726122e-19, -1, null);
    verify(-7.32488735425603e-18, -1, null);
    verify(-7.32488735425603e-19, -1, null);
    verify(-7.32488735425603e-20, -1, null);
    verify(-3.77369453157441e-19, -1, null);
    verify(-3.77369453157441e-20, -1, null);
    verify(-3.77369453157441e-21, -1, null);
    verify(-7.90712501118520e-20, -1, null);
    verify(-7.90712501118520e-21, -1, null);
    verify(-7.90712501118520e-22, -1, null);
    verify(-4.81083664920017e-21, -1, null);
    verify(-4.81083664920017e-22, -1, null);
    verify(-4.81083664920017e-23, -1, null);
    verify(-9.76622908870673e-22, -1, null);
    verify(-9.76622908870673e-23, -1, null);
    verify(-9.76622908870673e-24, -1, null);
    verify(-3.62879101444637e-23, -1, null);
    verify(-3.62879101444637e-24, -1, null);
    verify(-3.62879101444637e-25, -1, null);
    verify(-8.87038338701245e-105, -1, null);
    verify(-8.87038338701245e-106, -1, null);
    verify(-8.87038338701245e-107, -1, null);
    verify(-5.17044398729799e-304, -1, null);
    verify(-5.17044398729799e-305, -1, null);
    verify(-5.17044398729799e-306, -1, null);
    verify(-5.85334747871478e-305, -1, null);
    verify(-5.85334747871478e-306, -1, null);
    verify(-5.85334747871478e-307, -1, null);
    verify(-8.31942411940214e-306, -1, null);
    verify(-8.31942411940214e-307, -1, null);
    verify(-8.31942411940214e-308, -1, null);
    ...
    verify(-8.31682877219785e304, -8.3168287721978497e+304, null);
    verify(-8.31682877219785e305, -8.3168287721978497e+305, null);
    verify(-8.31682877219785e306, -8.3168287721978494e+306, null);
