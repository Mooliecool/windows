...
function roundh002() {
    ...
    type = char;
    apInitScenario("round of a char");
    ...
    type = Single;
    apInitScenario("round of a Single");
    ...
    verifyParams("single: n = -1.5", -1.5, -2)
    ...
    type = double;
    apInitScenario("round of a "+ type);
    ...
    verifyParams("double: n = -1.5", -1.5, -2)
    verifyParams("double: n = double.Epsilon", double.Epsilon, 0)
    verifyParams("double: n = 1.5", 1.5, 2)
    ...
    type = decimal;
    apInitScenario("round of a decimal");
    ...
    type = byte;
    apInitScenario("round of a byte");
    ...
    type = ushort;
    apInitScenario("round of a ushort");
    ...
    type = uint;
    apInitScenario("round of a uint");
    ...
    type = ulong;
    apInitScenario("round of a ulong");
    ...
    type = sbyte;
    apInitScenario("round of a sbyte");
    ...
    type = short;
    apInitScenario("round of a short");
    ...
    type = long;
    apInitScenario("round of a long");
    verifyParams("long: n = long.min", long.MinValue, long(-9223372036854775808), 0)
...
/*    type = String;
    //apInitScenario("round of a String");
    apWriteDebug("system calls on booleans bug 283081")
    ...
    type = Date;
    //apInitScenario("round of a Date");
    verifyParams("Date: n = -int.max", -int.MaxValue, NaN)


    type = Array;
    //apInitScenario("round of a Array");
    var arrvar:Array = new Array(1)
    arrvar[0] = -12.34
    verifyParams("Array: n = -12.34", arrvar, -12)
*/
