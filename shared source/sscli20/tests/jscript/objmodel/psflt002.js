...
/* Dependent on string.js helper file */

function verify(sCat, ob, sExp, bugNum) {
    if (bugNum == null) bugNum = "";

    var sAct = parseFloat(ob);
...
@end
    ...
    verify("min pos: 2.2250738585072014e-308" ,2.2250738585072014e-308, 2.2250738585072014e-308, 225);
    ...
    verify("max neg",-2.2250738585072012595e-308,-2.225073858507201259e-308, 16479);
