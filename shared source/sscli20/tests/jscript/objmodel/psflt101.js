...
@end
    ...
    verify("min neg: -2147483647",-2147483647, null);
    ...
    //////////////////////////////////////////////////////////////////////////////
    // Notes:
    // We differ from NS in the representation of floating point numbers.
    // Ex:  user types 3.1.  NS displays 3.1000000000000001 while we display 3.1
    // i.e., we display what the user types
    //////////////////////////////////////////////////////////////////////////////
    ...
    // float lengths for nums between the min pos and the max pos floats
        ...
        for (var cbNum=1; cbNum<=15; cbNum++)
        {
            // Create a unique NS for each possible decimal place
            for (var iDec=0; iDec<=cbNum+1; iDec++) // decimal places
            {
                sNum="";
                // Create the NS
                for (var ich=0; ich<cbNum; ich++)
                {
