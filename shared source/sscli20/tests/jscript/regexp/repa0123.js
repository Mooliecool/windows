...
apInitTest("repa0123");
	...
	ArrayEqual(sCat+strTest, objExp, strTest.replace(regPat, "a"));
   @if (!@_fast)
	   regVerify(sCat+strTest, new Array('a', 'bc'), strTest.replace(regPat, "a"));
   @end
	...
	ArrayEqual(sCat+strTest, objExp, strTest.replace(regPat, "a"));
@if (!@_fast)
	regVerify(sCat+strTest, new Array('abc', 'a', 'bc'), strTest.replace(regPat, "a"));
@end
	...
	ArrayEqual(sCat+strTest, objExp, strTest.replace(regPat, "a"));
   @if (!@_fast)
	   regVerify(sCat+strTest, new Array('a', 'b', 'c'), strTest.replace(regPat, "a"));
   @end
	...
	ArrayEqual(sCat+strTest, objExp, strTest.replace(regPat, "a"));
@if (!@_fast)
	regVerify(sCat+strTest, new Array('abc', 'a', 'b','c'), strTest.replace(regPat, "a"));
@end
