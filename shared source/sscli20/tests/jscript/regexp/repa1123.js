...
apInitTest("repa1123");
	...
	ArrayEqual(sCat+strTest, objExp, strTest.replace(regPat, "a"));
   @if (!@_fast)
	regVerify(sCat+strTest, new Array('2', '34'), strTest.replace(regPat, "a"));
   @end
	...
	ArrayEqual(sCat+strTest, objExp, strTest.replace(regPat, "a"));
   @if (!@_fast)
	regVerify(sCat+strTest, new Array('234', '2', '34'), strTest.replace(regPat, "a"));
   @end
	...
	ArrayEqual(sCat+strTest, objExp, strTest.replace(regPat, "a"));
@if (!@_fast)
	regVerify(sCat+strTest, new Array('2', '3', '4'), strTest.replace(regPat, "a"));
@end
	...
	ArrayEqual(sCat+strTest, objExp, strTest.replace(regPat, "a"));
   @if (!@_fast)
	regVerify(sCat+strTest, new Array('234', '2', '3','4'), strTest.replace(regPat, "a"));
   @end
