...
apInitTest("repa114");
	...
	m_scen = ('Test 17 numbers    /(\\w{1})(\\w{2})/');
	...
	m_scen = ('Test 19 numbers   tests /(\\w{1})(\\w{2})/ multiples');
	...
	m_scen = ('Test 21 numbers    /((\\w{1})(\\w{2}))/');
	...
	m_scen = ('Test 23 numbers   tests /((\\w{1})(\\w{2}))/ multiples');
	...
	m_scen = ('Test 25 numbers   /(\\w{1})(\\w{1})(\\w{1})/');
	...
	m_scen = ('Test 27 numbers   tests /(\\w{1})(\\w{1})(\\w{1})/ multiples');
	...
	m_scen = ('Test 29 numbers   /((\\w{1})(\\w{1})(\\w{1}))/');
	...
	m_scen = ('Test 31 numbers   tests /((\\w{1})(\\w{1})(\\w{1}))/ multiples');
	...
	objExp = '2347565098150175609815017562347560981501756098150175601234567891011121314151617181920_';
	strTest = '2347565098150175609815017562347560981501756098150175601234567891011121314151617181920_';
	verify(sCat+strTest, objExp, strTest.replace(regPat, "a"));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.replace(regPat, "a"));
	@end
