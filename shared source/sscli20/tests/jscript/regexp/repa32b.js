...
apInitTest("repa32b");
	...
	objExp = 'a \u0000\001A nmnoz \u0000\001A\000\u0000nmnoz\u00001def\u0000\001A\000\u0000'; 
	...
	objExp = 'a \u0000\001Anmnoz \u0000\001A\000\u0000nmnoz\u00001def\u0000\001A\000\u0000'; 
	...
	objExp = 'a \u0000\001Anmnoz \u0000\001Anmnoz\u00001def\u0000\001A\000\u0000'; 
	...
	m_scen = ('Test 33 Failure Lowercase /\u0000\001Anmnoz/');

	apInitScenario(m_scen);
	regPat = /\u0000\001Anmnoz1def/;
	...
	objExp = '              \u0000\001Anmnoz \u0000\001A nmnoz \u0000\001A\000\u0000nmnoz\u00001def\u0000\001A\000\u0000'; 
	strTest = '              \u0000\001Anmnoz \u0000\001A nmnoz \u0000\001A\000\u0000nmnoz\u00001def\u0000\001A\000\u0000'; 
	verify(sCat+strTest, objExp, strTest.replace(regPat, "a"));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.replace(regPat, "a"));
	...
	m_scen = ('Test 35 Failure Lowercase tests /\u0000\001Anmnoz/ multiples');

	objExp = '\u0000\001Anmnoz \u0000\001Anmnoz';
	strTest = '\u0000\001Anmnoz \u0000\001Anmnoz';
	verify(sCat+strTest, objExp, strTest.replace(regPat, "a"));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.replace(regPat, "a"));
	...
	objExp = '\u0000\001Anmnoz \u0000\001Anmnoz \u0000\001A\000\u0000nmnoz\u00001def\u0000\001A\000\u0000'; 
	strTest = '\u0000\001Anmnoz \u0000\001Anmnoz \u0000\001A\000\u0000nmnoz\u00001def\u0000\001A\000\u0000'; 
	verify(sCat+strTest, objExp, strTest.replace(regPat, "a"));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.replace(regPat, "a"));
	...
	objExp = '\u0000\001Anmnoz \u0000\001Anmnoz \u0000\001Anmnoz\u00001def\u0000\001A\000\u0000'; 
	strTest = '\u0000\001Anmnoz \u0000\001Anmnoz \u0000\001Anmnoz\u00001def\u0000\001A\000\u0000'; 
	verify(sCat+strTest, objExp, strTest.replace(regPat, "a"));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.replace(regPat, "a"));
