...
apInitTest("rxp_0123");
	...
	strTest = 'abc aBc';
	ArrayEqual(sCat+strTest, new Array('abc'), strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end
	...
	strTest = '     abc aBc';
	ArrayEqual(sCat+strTest, new Array('abc', 'abc'), strTest.match(regPat));
@if (!@_fast)
...
@end
	...
	strTest = '     abc aBc';
	ArrayEqual(sCat+strTest, new Array('abc', 'ab', 'c'), strTest.match(regPat));
@if (!@_fast)
	regVerify(sCat+strTest, new Array('ab', 'c'), strTest.match(regPat));
@end
	...
	strTest = '     abc aBc';
	ArrayEqual(sCat+strTest, new Array ('abc', 'abc', 'ab', 'c'), strTest.match(regPat));
@if (!@_fast)
	regVerify(sCat+strTest, new Array ('abc', 'ab', 'c'), strTest.match(regPat));
@end
	...
	m_scen = ('Test 17 MiXeD Case /(a)(bc)/i');
	...
	m_scen = ('Test 19 MiXeD Case tests /(a)(bc)/i multiples');
	...
	strTest = '     abc aBc';
	ArrayEqual(sCat+strTest, new Array('abc', 'a', 'bc'), strTest.match(regPat));
   @if (!@_fast)
	regVerify(sCat+strTest, new Array('a', 'bc'), strTest.match(regPat));
   @end
	...
	strTest = '     abc aBc';
	ArrayEqual(sCat+strTest, new Array('abc', 'abc', 'a', 'bc'), strTest.match(regPat));
@if (!@_fast)
	regVerify(sCat+strTest, new Array('abc', 'a', 'bc'), strTest.match(regPat));
@end
	...
	strTest = '     abc aBc';
	ArrayEqual(sCat+strTest, new Array('abc', 'a', 'b', 'c'), strTest.match(regPat));
@if (!@_fast)
	regVerify(sCat+strTest, new Array('a', 'b', 'c'), strTest.match(regPat));
@end
	...
	strTest = '     abc aBc';
	ArrayEqual(sCat+strTest, new Array('abc', 'abc', 'a', 'b','c'), strTest.match(regPat));
@if (!@_fast)
	regVerify(sCat+strTest, new Array('abc', 'a', 'b','c'), strTest.match(regPat));
@end
