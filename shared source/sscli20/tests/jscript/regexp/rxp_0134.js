...
apInitTest("rxp_0134");
	...
	m_scen = ('Test 1 Lowercase /abc/gi');

	sCat = "/abc/gi ";
	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat.compile("abc","gi");
	...
	m_scen = ('Test 3 Lowercase tests /abc/gi multiples');
	...
	m_scen = ('Test 5 Lowercase /(abc)/gi');

	sCat = "/(abc)/gi ";
	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("(abc)","gi");
	objExp = new Array('abc', 'abc');
	...
	m_scen = ('Test 7 Lowercase tests /(abc)/gi multiples');
	...
	m_scen = ('Test 9 Lowercase /(ab)(c)/gi');

	sCat = "/(ab)(c)/gi ";
	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("(ab)(c)","gi");
	...
	m_scen = ('Test 11 Lowercase tests /(ab)(c)/gi multiples');
	...
	m_scen = ('Test 13 Lowercase /((ab)(c))/gi');

	sCat = "/((ab)(c))/gi ";
	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat.compile("((ab)(c))","gi");
	...
	m_scen = ('Test 15 Lowercase tests //((ab)(c))/gi multiples');
	...
	m_scen = ('Test 17 Lowercase /(a)(bc)/gi');

	sCat = "/(a)(bc)/gi ";
	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("(a)(bc)","gi");
	...
	m_scen = ('Test 19 Lowercase tests /(a)(bc)/gi multiples');
	...
	m_scen = ('Test 21 Lowercase /((a)(bc))/gi');
	...
	m_scen = ('Test 23 Lowercase tests /((a)(bc))/gi multiples');
	...
	m_scen = ('Test 25 Lowercase /(a)(b)(c)/gi');

	sCat = "/(a)(b)(c)/gi ";
	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat.compile("(a)(b)(c)","gi");
	...
	m_scen = ('Test 27 Lowercase tests /(a)(b)(c)/gi multiples');
	...
	m_scen = ('Test 29 Lowercase /((a)(b)(c))/gi');

	sCat = "/((a)(b)(c))/gi ";
	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("((a)(b)(c))","gi");
	...
	m_scen = ('Test 31 Lowercase tests /((a)(b)(c))/gi multiples');
	...
	m_scen = ('Test 33 Failure Lowercase /aBcD/gi');

	sCat = "/aBcD/gi ";
	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("aBcD","gi");
	objExp = null;
	...
	m_scen = ('Test 35 Failure Lowercase tests /aBcD/gi multiples');
