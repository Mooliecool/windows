...
apInitTest("rxp_031");
	...
	m_scen = ('Test 17 Lowercase /(A)(bC)/g');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("(A)(bC)","g");
	...
	m_scen = ('Test 19 Lowercase tests /(A)(bC)/g multiples');
	...
	m_scen = ('Test 21 Lowercase /((A)(bC))/g');
	...
	m_scen = ('Test 23 Lowercase tests /((A)(bC))/g multiples');
	...
	m_scen = ('Test 25 Lowercase /(A)(b)(C)/g');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat.compile("(A)(b)(C)","g");
	...
	m_scen = ('Test 27 Lowercase tests /(A)(b)(C)/g multiples');
	...
	m_scen = ('Test 29 Lowercase /((A)(b)(C))/g');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("((A)(b)(C))","g");
	...
	m_scen = ('Test 31 Lowercase tests /((A)(b)(C))/g multiples');
	...
	m_scen = ('Test 33 Failure Lowercase /AZ/g');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("AZ","g");
	objExp = null;
	...
	m_scen = ('Test 35 Failure Lowercase tests /AbC/g multiples');
