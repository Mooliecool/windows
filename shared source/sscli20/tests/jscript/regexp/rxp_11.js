...
apInitTest("rxp_11");
	...
	m_scen = ('Test 3 numbers   tests /234/ multiples');
	...
	m_scen = ('Test 7 numbers   tests /(234)/ multiples');
	...
	m_scen = ('Test 9 numbers   /(23)(4)/');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("(23)(4)","");
	...
	m_scen = ('Test 11 numbers   tests /(23)(4)/ multiples');
	...
	m_scen = ('Test 15 numbers   tests //((ab)(c))/ multiples');
	...
	m_scen = ('Test 17 numbers   /(2)(34)/');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("(2)(34)","");
	...
	m_scen = ('Test 19 numbers   tests /(2)(34)/ multiples');
	...
	m_scen = ('Test 23 numbers   tests /((2)(34))/ multiples');
	...
	m_scen = ('Test 25 numbers   /(2)(3)(4)/');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat.compile("(2)(3)(4)","");
	...
	m_scen = ('Test 27 numbers   tests /(2)(3)(4)/ multiples');
	...
	m_scen = ('Test 29 numbers   /((2)(3)(4))/');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("((2)(3)(4))","");
	...
	m_scen = ('Test 31 numbers   tests /((2)(3)(4))/ multiples');
	...
	m_scen = ('Test 33 Failure Lowercase /2379/');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("2379","");
	objExp = null;
	...
	m_scen = ('Test 35 Failure Lowercase tests /234/ multiples');
