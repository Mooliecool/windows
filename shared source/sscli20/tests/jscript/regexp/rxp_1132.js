...
apInitTest("rxp_1132");
	...
	m_scen = ('Test 1 UpperCase /234/ig');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat.compile("234","ig");
	...
	m_scen = ('Test 3 UPPERCASE tests /234/ig multiples');
	...
	m_scen = ('Test 5 UPPERCASE /(234)/ig');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("(234)","ig");
	objExp = new Array('234', '234');
	...
	m_scen = ('Test 7 UPPERCASE tests /(234)/ig multiples');
	...
	m_scen = ('Test 9 UPPERCASE /(23)(4)/ig');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("(23)(4)","ig");
	...
	m_scen = ('Test 11 UPPERCASE tests /(23)(4)/ig multiples');
	...
	m_scen = ('Test 13 UPPERCASE /((23)(4))/ig');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat.compile("((23)(4))","ig");
	...
	m_scen = ('Test 15 UPPERCASE tests /((23)(4))/ig multiples');
	...
	m_scen = ('Test 17 UPPERCASE /(2)(34)/ig');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("(2)(34)","ig");
	...
	m_scen = ('Test 19 UPPERCASE tests /(2)(34)/ig multiples');
	...
	m_scen = ('Test 21 UPPERCASE /((2)(34))/ig');
	...
	m_scen = ('Test 23 UPPERCASE tests /((2)(34))/ig multiples');
	...
	m_scen = ('Test 25 UPPERCASE /(2)(3)(4)/ig');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat.compile("(2)(3)(4)","ig");
	...
	m_scen = ('Test 27 UPPERCASE tests /(2)(3)(4)/ig multiples');
	...
	m_scen = ('Test 29 UPPERCASE /((2)(3)(4))/ig');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("((2)(3)(4))","ig");
	...
	m_scen = ('Test 31 UPPERCASE tests /((2)(3)(4))/ig multiples');
	...
	m_scen = ('Test 33 Failure UPPERCASE /2347/ig');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("2347","ig");
	objExp = null;
	...
	m_scen = ('Test 35 Failure UPPERCASE tests /2347/ig multiples');
