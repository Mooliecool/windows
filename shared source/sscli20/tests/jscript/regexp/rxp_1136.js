...
apInitTest("rxp_1136");
	...
	m_scen = ('Test 1 MiXeD Case /234/gi');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat.compile("234","gi");
	...
	m_scen = ('Test 3 MiXeD Case tests /234/gi multiples');
	...
	m_scen = ('Test 5 MiXeD Case /(234)/gi');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("(234)","gi");
	objExp = new Array('234', '234');
	...
	m_scen = ('Test 7 MiXeD Case tests /(234)/gi multiples');
	...
	m_scen = ('Test 9 MiXeD Case /(23)(4)/gi');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("(23)(4)","gi");
	...
	m_scen = ('Test 11 MiXeD Case tests /(23)(4)/gi multiples');
	...
	m_scen = ('Test 13 MiXeD Case /((23)(4))/gi');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat.compile("((23)(4))","gi");
	...
	m_scen = ('Test 15 MiXeD Case tests //((ab)(c))/gi multiples');
	...
	m_scen = ('Test 17 MiXeD Case /(2)(34)/gi');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("(2)(34)","gi");
	...
	m_scen = ('Test 19 MiXeD Case tests /(2)(34)/gi multiples');
	...
	m_scen = ('Test 21 MiXeD Case /((2)(34))/gi');
	...
	m_scen = ('Test 23 MiXeD Case tests /((2)(34))/gi multiples');
	...
	m_scen = ('Test 25 MiXeD Case /(2)(3)(4)/gi');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat.compile("(2)(3)(4)","gi");
	...
	m_scen = ('Test 27 MiXeD Case tests /(2)(3)(4)/gi multiples');
	...
	m_scen = ('Test 29 MiXeD Case /((2)(3)(4))/gi');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("((2)(3)(4))","gi");
	...
	m_scen = ('Test 31 MiXeD Case tests /((2)(3)(4))/gi multiples');
	...
	m_scen = ('Test 33 Failure MiXeD Case /2347/gi');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("2347","gi");
	objExp = null;
	...
	m_scen = ('Test 35 Failure MiXeD Case tests /2347/gi multiples');
