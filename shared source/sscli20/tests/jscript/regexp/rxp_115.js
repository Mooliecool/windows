...
apInitTest("rxp_115");
	...
	m_scen = ('Test 1 numbers   /234|287828057025187/');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat.compile("234|287828057025187","");
	...
	m_scen = ('Test 5 numbers   /287828057025187|234/');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("287828057025187|234","");
	objExp = new Array('234');
	regExp = new Array();
	...
	m_scen = ('Test 9 numbers   /234|176/');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("234|176","");
	objExp = new Array('234');
	regExp = new Array();
