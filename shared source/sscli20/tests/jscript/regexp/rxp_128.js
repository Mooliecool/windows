...
apInitTest("rxp_128");
	...
	regPat = /a/ig;
	regPat.compile("\\d\\d\\d|\\D\\D\\D\\D\\D\\D\\D\\d\\D\\D\\D\\D\\D","");
	...
	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("\\D\\D\\D\\D\\D\\D\\D\\d\\D\\D\\D\\D\\D|\\d\\d\\d","");
	objExp = new Array('234');
	regExp = new Array();
	...
	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("\\d\\d\\d|\\d\\d\\d\\d","");
	objExp = new Array('234');
	regExp = new Array();
	...
	m_scen = ('Test 13 numbers   /\d\d\d\d|\d\d\d/');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat.compile("\\d\\d\\d\\d|\\d\\d\\d","");
	objExp = new Array('234');
	regExp = new Array();
	...
	m_scen = ('Test 17 numbers   /\d\d\d|\d\d\d/');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("\\d\\d\\d|\\d\\d\\d","");
	objExp = new Array('234');
	regExp = new Array();
	...
	m_scen = ('Test 21 Failure - Lowercase /\d\D\d\D\D\D\d\D|\d\d\D\d\D\D\D\D\D/');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("\\d\\D\\d\\D\\D\\D\\d\\D|\\d\\D\\d\\d\\d\\D\\d\\D\\D\\D\\D\\D","");
	objExp = null;
	regExp = new Array();
