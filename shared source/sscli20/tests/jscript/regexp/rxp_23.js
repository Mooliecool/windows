...
apInitTest("rxp_23");
	...
	m_scen = ('Test 19 nonalpha  tests /(\uC000)(\uC002)/ multiples');
	...
	m_scen = ('Test 23 nonalpha  tests /((\uC000)(\uC002))/ multiples');
	...
	m_scen = ('Test 27 nonalpha  tests /(\uC000)()(\uC002)/ multiples');
	...
	m_scen = ('Test 31 nonalpha  tests /((\uC000)()(\uC002))/ multiples');
	...
	m_scen = ('Test 33 Failure Lowercase /\uC000\uC002d/');

	apInitScenario(m_scen);
	regPat = /a/ig;
	regPat = new RegExp("\\uC000\\uC002d","");
	objExp = null;
	...
	m_scen = ('Test 35 Failure Lowercase tests /\uC000\uC002/ multiples');
