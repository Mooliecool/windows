...
apInitTest("spt_014");
	...
	m_scen = ('Test 3 Lowercase tests /\\w{3}/ multiples');
	...
	m_scen = ('Test 7 Lowercase tests /(\\w{3})/ multiples');
	...
	m_scen = ('Test 9 Lowercase /(\\w{2})(\\w{1})/');
	...
	m_scen = ('Test 11 Lowercase tests /(\\w{2})(\\w{1})/ multiples');
	...
	m_scen = ('Test 13 Lowercase  /((\\w{2})(\\w{1}))/');
	...
	m_scen = ('Test 15 Lowercase tests /((\\w{2})(\\w{1}))/ multiples');
