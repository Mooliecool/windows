...
apInitTest("srca0123");
	...
	ArrayEqual(sCat+strTest, objExp, strTest.search(regPat));
   @if (!@_fast)
	   regVerify(sCat+strTest, new Array('a', 'bc'), strTest.search(regPat));
   @end
	...
	ArrayEqual(sCat+strTest, objExp, strTest.search(regPat));
   @if (!@_fast)
	regVerify(sCat+strTest, new Array('abc', 'a', 'bc'), strTest.search(regPat));
   @end
	...
	ArrayEqual(sCat+strTest, objExp, strTest.search(regPat));
   @if (!@_fast)
   	regVerify(sCat+strTest, new Array('a', 'b', 'c'), strTest.search(regPat));
   @end
	...
	ArrayEqual(sCat+strTest, objExp, strTest.search(regPat));
   @if (!@_fast)
	regVerify(sCat+strTest, new Array('abc', 'a', 'b','c'), strTest.search(regPat));
   @end
