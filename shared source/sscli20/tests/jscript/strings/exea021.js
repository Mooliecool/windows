...
//This testcase uses the /ABC/g pattern as the bases for the pattern searching.
...
function exea021() 
{
	...
	m_scen = ('Test 21 UPPERCASE /((A)(BC))/g');
	sCat = "/((A)(BC))/g ";
	...
	m_scen = ('Test 23 UPPERCASE tests /((A)(BC))/g multiples');
	...
	m_scen = ('Test 25 UPPERCASE /(A)(B)(C)/g');
	...
	m_scen = ('Test 27 UPPERCASE tests /(A)(B)(C)/g multiples');
	...
	m_scen = ('Test 29 UPPERCASE /((A)(B)(C))/g');
	...
	m_scen = ('Test 31 UPPERCASE tests /((A)(B)(C))/g multiples');
	...
	m_scen = ('Test 33 Failure UPPERCASE /aBc/g');
	sCat = "/aBc/g ";
	apInitScenario(m_scen);
	regPat = /aBc/g;
	objExp = null;
...
//these tests verify that old values are kept
	...
	m_scen = ('Test 35 Failure UPPERCASE tests /aBc/g multiples');
