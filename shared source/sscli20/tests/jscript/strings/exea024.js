...
apInitTest("exea024");
	m_scen = ('Test 21 UPPERCASE  /((\\w{1})(\\w{2}))/');
	sCat = "/((\\w{1})(\\w{2}))/ ";
	...
	m_scen = ('Test 23 UPPERCASE tests /((\\w{1})(\\w{2}))/ multiples');
	strTest = 'ABC ABC';
	ArrayEqual(sCat+strTest, objExp, regPat.exec(strTest));
	@if (!@_fast)
		@if (!@_fast)
	...
	m_scen = ('Test 25 UPPERCASE /(\\w{1})(\\w{1})(\\w{1})/');
	sCat = "/(\\w{1})(\\w{1})(\\w{1})/ ";
	apInitScenario(m_scen);
	regPat = /(\w{1})(\w{1})(\w{1})/;
	...
	m_scen = ('Test 27 UPPERCASE tests /(\\w{1})(\\w{1})(\\w{1})/ multiples');
	strTest = 'ABC ABC';
	ArrayEqual(sCat+strTest, objExp, regPat.exec(strTest));
	@if (!@_fast)
		@if (!@_fast)
	...
	m_scen = ('Test 29 UPPERCASE /((\\w{1})(\\w{1})(\\w{1}))/');
	sCat = "/((\\w{1})(\\w{1})(\\w{1}))/ ";
	apInitScenario(m_scen);
	regPat = /((\w{1})(\w{1})(\w{1}))/;
	...
	m_scen = ('Test 31 UPPERCASE tests /((\\w{1})(\\w{1})(\\w{1}))/ multiples');
	strTest = 'ABC ABC';
	ArrayEqual(sCat+strTest, objExp, regPat.exec(strTest));
	@if (!@_fast)
		@if (!@_fast)
	...
	m_scen = ('Test 33 Failure UPPERCASE /\\w{27}/');
	sCat = "/\\w{27}/ ";
	apInitScenario(m_scen);
	regPat = /\w{27}/;
	objExp = null;
...
//this set of tests smakes sure that RegExp.$ keep original values
	...
	m_scen = ('Test 35 Failure UPPERCASE tests /\\w{27}/ multiples');
	strTest = 'ABC ABC';
	verify(sCat+strTest, objExp, regPat.exec(strTest));
	@if (!@_fast)
		@if (!@_fast)
	...
	m_scen = ('Test 37 Failure UPPERCASE /\\W/');
	sCat = "/\\W/ ";
	apInitScenario(m_scen);
	regPat = /\W/;
	objExp = null;
