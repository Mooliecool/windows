...
apInitTest("exea031");
	...
	m_scen = ('Test 21 MiXeD Case /((a)(Bc))/g');
	sCat = "/((a)(Bc))/g ";
	...
	m_scen = ('Test 23 MiXeD Case tests /((a)(Bc))/g multiples');
	strTest = 'aBc abc';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
	...
	m_scen = ('Test 25 MiXeD Case /(a)(B)(c)/g');
	sCat = "/(a)(B)(c)/g ";
	apInitScenario(m_scen);
	regPat = /(a)(B)(c)/g;
	...
	m_scen = ('Test 27 MiXeD Case tests /(a)(B)(c)/g multiples');
	strTest = 'aBc abc';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
	...
	m_scen = ('Test 29 MiXeD Case /((a)(B)(c))/g');
	sCat = "/((a)(B)(c))/g ";
	apInitScenario(m_scen);
	regPat = /((a)(B)(c))/g;
	...
	m_scen = ('Test 31 MiXeD Case tests /((a)(B)(c))/g multiples');
	strTest = 'aBc abc';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
	...
	m_scen = ('Test 33 Failure MiXeD Case /AbC/g');
	sCat = "/AbC/g ";
	apInitScenario(m_scen);
	regPat = /AbC/g;
	objExp = null;
//no new regExp due to spec of RegExp.$1-9
	...
	m_scen = ('Test 35 Failure MiXeD Case tests /AbC/g multiples');
	strTest = 'aBc abc';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	verify(sCat+strTest, objExp, result);
