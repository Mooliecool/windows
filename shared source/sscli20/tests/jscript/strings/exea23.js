...
apInitTest("Exea23");
	...
	m_scen = ('Test 17 MiXeD Case /()(\uC001)/');

	sCat = "/()(\uC001)/ ";
	apInitScenario(m_scen);
	regPat = /()(\uC001)/;
	objExp = new Array('\uC001', '','\uC001');
	var regExp = new Array('','\uC001');
	...
	m_scen = ('Test 19 MiXeD Case tests /()(\uC001)/ multiples');
	...
	m_scen = ('Test 21 MiXeD Case /(()(\uC001))/');

	
	sCat = "/(()(\uC001))/ ";
	apInitScenario(m_scen);
	regPat = /(()(\uC001))/;
	objExp = new Array('\uC001','\uC001','','\uC001');
	regExp = new Array('\uC001','','\uC001');
	...
	m_scen = ('Test 23 MiXeD Case tests /(()(\uC001))/ multiples');
	...
	m_scen = ('Test 27 MiXeD Case tests /()(\uC001)()/ multiples');
	...
	m_scen = ('Test 31 MiXeD Case tests /(()(\uC001)())/ multiples');
	...
	m_scen = ('Test 33 Failure MiXeD Case /\uC000\uC002/');
...
//these tests verify that old values are kept
	...
	m_scen = ('Test 35 Failure MiXeD Case tests /\uC000\uC002/ multiples');
