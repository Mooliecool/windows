...
apInitTest("Exea2387");
	...
	m_scen = ('Test 17 MiXed Case /\b[\uC000-\uC002-][\u0005-\uFFFF][\uC000-\uC501-\\]\b/');
...
strTest = '\u005f\uC000\uC002\u005F \u005f\uC000\uC002\u005F \uC000\uABCA\uC002\uC000\\\uC000\uABCA'; 
ArrayEqual(sCat+strTest, objExp, regPat.exec(strTest));
@if (!@_fast)
		regVerify(sCat+strTest, regExp, regPat.exec(strTest));
	@end
...
@if (!@_fast)
	...
	m_scen = ('Test 21 MiXed Case /\b[\uC000-\uC002-][\u0005-\uFFFF][\uC000-\uC501-\\]\B/');
...
@if (!@_fast)
	...
	m_scen = ('Test 25 MiXed Case /\B[\uC000-\uC002-][\u0005-\uFFFF][\uC000-\uC501-\\]\b/');
...
strTest = '\uC501\uC000\uC002_ \uC501\uC000\uC002_ \uC000\uABCA\uC002\uC000\\\uC000\uABCA'; 
ArrayEqual(sCat+strTest, objExp, regPat.exec(strTest));
@if (!@_fast)
		regVerify(sCat+strTest, regExp, regPat.exec(strTest));
	@end
...
@if (!@_fast)
	...
	m_scen = ('Test 29 MiXed Case /\B[\uC000-\uC002-][\u0005-\uFFFF][\uC000-\uC501-\\]\B/');
