...
apInitTest("exec0123");
	...
	strTest = 'abc aBc';
	ArrayEqual(sCat+strTest, new Array('abc'), regPat.exec(strTest));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, regPat.exec(strTest));
	@end
	...
	strTest = '     abc aBc';
	ArrayEqual(sCat+strTest, new Array('abc', 'abc'), regPat.exec(strTest));
    @if (!@_fast)
	regVerify(sCat+strTest, new Array('abc'), regPat.exec(strTest));
@end
	...
	strTest = '     abc aBc';
	ArrayEqual(sCat+strTest, new Array('abc', 'ab', 'c'), regPat.exec(strTest));
@if (!@_fast)
	regVerify(sCat+strTest, new Array('ab', 'c'), regPat.exec(strTest));
@end
	...
	strTest = '     abc aBc';
	ArrayEqual(sCat+strTest, new Array ('abc', 'abc', 'ab', 'c'), regPat.exec(strTest));
	@if (!@_fast)
             regVerify(sCat+strTest, new Array ('abc', 'ab', 'c'), regPat.exec(strTest));
       @end
	...
	strTest = '     abc aBc';
	ArrayEqual(sCat+strTest, new Array('abc', 'a', 'bc'), regPat.exec(strTest));
	@if (!@_fast)
              regVerify(sCat+strTest, new Array('a', 'bc'), regPat.exec(strTest));
       @end
