...
apInitTest("exec0132");
	m_scen = ('Test 1 UpperCase /abc/ig');
	sCat = "/abc/ig ";
	...
	m_scen = ('Test 3 UPPERCASE tests /abc/ig multiples');
	strTest = 'ABC ABC';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
	...
	m_scen = ('Test 5 UPPERCASE /(abc)/ig');
	sCat = "/(abc)/ig ";
	apInitScenario(m_scen);
	regPat = /(abc)/ig;
	...
	m_scen = ('Test 7 UPPERCASE tests /(abc)/ig multiples');
	strTest = 'ABC ABC';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
	...
	m_scen = ('Test 9 UPPERCASE /(ab)(c)/ig');
	sCat = "/(ab)(c)/ig ";
	apInitScenario(m_scen);
	regPat = /(ab)(c)/ig;
	...
	m_scen = ('Test 11 UPPERCASE tests /(ab)(c)/ig multiples');
	strTest = 'ABC ABC';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
	...
	m_scen = ('Test 13 UPPERCASE /((ab)(c))/ig');
	sCat = "/((ab)(c))/ig ";
	apInitScenario(m_scen);
	regPat = /((ab)(c))/ig;
	...
	m_scen = ('Test 15 UPPERCASE tests /((ab)(c))/ig multiples');
	strTest = 'ABC ABC';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
	...
	m_scen = ('Test 17 UPPERCASE /(a)(bc)/ig');
	sCat = "/(a)(bc)/ig ";
	apInitScenario(m_scen);
	regPat = /(a)(bc)/ig;
	...
	m_scen = ('Test 19 UPPERCASE tests /(a)(bc)/ig multiples');
	strTest = 'ABC ABC';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
