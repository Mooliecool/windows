...
apInitTest("exec0136");
	m_scen = ('Test 1 MiXeD Case /abc/gi');
	sCat = "/abc/gi ";
	...
	m_scen = ('Test 3 MiXeD Case tests /abc/gi multiples');
	strTest = 'aBc abc';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
	...
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, new Array('abc'), result);
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, result);
	@end
	...
	m_scen = ('Test 5 MiXeD Case /(abc)/gi');
	sCat = "/(abc)/gi ";
	apInitScenario(m_scen);
	regPat = /(abc)/gi;
	...
	m_scen = ('Test 7 MiXeD Case tests /(abc)/gi multiples');
	strTest = 'aBc abc';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
	...
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, new Array('abc', 'abc'), result);
	@if (!@_fast)
		regVerify(sCat+strTest, new Array('abc'), result);
	@end
	...
	m_scen = ('Test 9 MiXeD Case /(ab)(c)/gi');
	sCat = "/(ab)(c)/gi ";
	apInitScenario(m_scen);
	regPat = /(ab)(c)/gi;
	...
	m_scen = ('Test 11 MiXeD Case tests /(ab)(c)/gi multiples');
	strTest = 'aBc abc';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
	...
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, new Array('abc', 'ab', 'c'), result);
	@if (!@_fast)
		regVerify(sCat+strTest, new Array('ab', 'c'), result);
	@end
	...
	m_scen = ('Test 13 MiXeD Case /((ab)(c))/gi');
	sCat = "/((ab)(c))/gi ";
	apInitScenario(m_scen);
	regPat = /((ab)(c))/gi;
	...
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, new Array ('abc', 'abc', 'ab', 'c'), result);
	@if (!@_fast)
		regVerify(sCat+strTest, new Array ('abc', 'ab', 'c'), result);
	@end
	...
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, new Array('abc', 'a', 'bc'), result);
	@if (!@_fast)
		regVerify(sCat+strTest, new Array('a', 'bc'), result);
	@end
