...
apInitTest("exec031");
	m_scen = ('Test 1 MiXeD Case /aBc/g');
	sCat = "/aBc/g ";
	...
	m_scen = ('Test 3 MiXeD Case tests /aBc/g multiples');
	strTest = 'aBc abc';
	...
	m_scen = ('Test 5 MiXeD Case /(aBc)/g');
	sCat = "/(aBc)/g ";
	apInitScenario(m_scen);
	regPat = /(aBc)/g;
	...
	m_scen = ('Test 7 MiXeD Case tests /(aBc)/g multiples');
	strTest = 'aBc abc';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
	...
	m_scen = ('Test 9 MiXeD Case /(aB)(c)/g');
	sCat = "/(aB)(c)/g ";
	apInitScenario(m_scen);
	regPat = /(aB)(c)/g;
	...
	m_scen = ('Test 11 MiXeD Case tests /(aB)(c)/g multiples');
	strTest = 'aBc abc';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
	...
	m_scen = ('Test 13 MiXeD Case /((aB)(c))/g');
	sCat = "/((aB)(c))/g ";
	apInitScenario(m_scen);
	regPat = /((aB)(c))/g;
	...
	m_scen = ('Test 15 MiXeD Case tests //((aB)(c))/g multiples');
	strTest = 'aBc abc';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
	...
	m_scen = ('Test 17 MiXeD Case /(a)(Bc)/g');
	sCat = "/(a)(Bc)/g ";
	apInitScenario(m_scen);
	regPat = /(a)(Bc)/g;
	...
	m_scen = ('Test 19 MiXeD Case tests /(a)(Bc)/g multiples');
	strTest = 'aBc abc';
	regPat.lastIndex = 0;
	result = regPat.exec(strTest);
	ArrayEqual(sCat+strTest, objExp, result);
