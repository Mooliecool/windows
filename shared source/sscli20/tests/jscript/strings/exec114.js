...
@if (!@_fast)
	...
	m_scen = ('Test 3 numbers   tests /\\w{3}/ multiples');
...
@if (!@_fast)
	...
	m_scen = ('Test 7 numbers   tests /(\\w{3})/ multiples');
...
@if (!@_fast)
	...
	m_scen = ('Test 11 numbers   tests /(\\w{2})(\\w{1})/ multiples');
...
@if (!@_fast)
	...
	m_scen = ('Test 13 numbers    /((\\w{2})(\\w{1}))/');
...
@if (!@_fast)
	...
	m_scen = ('Test 15 numbers   tests /((\\w{2})(\\w{1}))/ multiples');
