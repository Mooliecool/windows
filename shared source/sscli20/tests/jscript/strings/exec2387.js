...
apInitTest("Exec2387");
	...
	m_scen = ('Test 1 MiXed Case /\b[\uC000-\uC002-][\u0005-\uFFFF][\uC000-\uC501-\\]/');
...
@if (!@_fast)
	...
	m_scen = ('Test 5 MiXed Case /[\uC000-\uC002-][\u0005-\uFFFF][\uC000-\uC501-\\]\b/');
...
@if (!@_fast)
	...
	m_scen = ('Test 9 MiXed Case /\B[\uC000-\uC002-][\u0005-\uFFFF][\uC000-\uC501-\\]/');
...
@if (!@_fast)
	...
	m_scen = ('Test 13 MiXed Case /\uC501[\uC000-\uC002-][\u0005-\uFFFF][\uC000-\uC501-\\]\B/');

sCat = "/\uC501[\uC000-\uC002-][\u0005-\uFFFF][\uC000-\uC501-\\]\B/ ";
	apInitScenario(m_scen);
regPat = /\uC501[\uC000-\uC002-][\u0005-\uFFFF][\uC000-\uC501-\\]\B/;
objExp = new Array('\uC501\uC000\uC002');
regExp = new Array();
