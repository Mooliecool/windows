...
function GetLang()
{
 ...
 function indxf03 () {
    ...
    IntegerVar1 = 3;
    Temp = VarString1.indexOf( "-1-",IntegerVar1);
    Expected = 7;
    if (Temp != Expected) {
	 apLogFailInfo("(START as INTEGER constant)", Expected, Temp, "");
    }
    ...
    DoubleVar1 = 7.7;
    Temp = VarString1.indexOf( "-1-",DoubleVar1);
    Expected = 7;
    if (Temp != Expected) {
	 apLogFailInfo("(START as single constant)", Expected, Temp, "");
    }

    DoubleVar2 = 2.00000099999;
    Temp = VarString1.indexOf("-1-",DoubleVar2);
    Expected = 7;
    if (Temp != Expected) {
	 apLogFailInfo("(START as DOUBLE constant)", Expected, Temp, "");
    }
    ...
    IntegerVar1 = 2;
    Temp = VarString1.indexOf( "-1-",IntegerVar1 + 1);
    Expected = 7;
    if (Temp != Expected) {
	 apLogFailInfo("(START as INTEGER constant)", Expected, Temp, "");
    }
    ...
    DoubleVar1 = 3.7;
    Temp = VarString1.indexOf( "-1-",DoubleVar1 * 2);
    Expected = 7;
    if (Temp != Expected) {
	 apLogFailInfo("(START as single constant)", Expected, Temp, "");
    }
    ...
    DoubleVar2 = 20;
    Temp = VarString1.indexOf("-1-",DoubleVar2 / 9);
    Expected = 7;
    if (Temp != Expected) {
	 apLogFailInfo("(START as DOUBLE constant)", Expected, Temp, "");
    }
