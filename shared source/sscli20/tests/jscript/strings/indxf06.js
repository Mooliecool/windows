...
function indxf06 () {
    ...
    apInitScenario("Scenario 1 - Use indexOf() in a recursive function");
    ...
    Temp = VarString1.indexOf( VarString2,function2(VarString2) );
    Expected = 3;
    if (Temp != Expected) {
    ...
    Temp = ("" + function3(VarString1, "EFG")).indexOf(VarString2)
    Expected = 4;
    if (Temp != Expected) {
    ...
    Temp = VarString1.indexOf(function3(VarString2, "F"));
    Expected = 4;
    if (Temp != Expected) {
