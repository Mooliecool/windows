...
function len0006() {
    ...
    apInitScenario(" 1: Verify that LEN accepts a string variable as an argument.");

    StringVar = bldStr(MaxString,"X");
    Result =	 StringVar.length;
    Expected = MaxString;
    if ( Result != Expected ) {
     apLogFailInfo("Length of string returned" + Result.toString() + " not" + Expected.toString() ,"","","");
    }
