...
apInitTest("mtc_1282");
	...
	m_scen = ('Test 1 numbers   /\d\d\d|\D\D\D\D\D\D\D\d\D\D\D\D\D/i');

	apInitScenario(m_scen);
	regPat = /\d\d\d|\D\D\D\D\D\D\D\d\D\D\D\D\D/i;
	...
	m_scen = ('Test 5 numbers   /\D\D\D\D\D\D\D\d\D\D\D\D\D|\d\d\d/i');
	...
	m_scen = ('Test 9 numbers   /\d\d\d|\d\d\d\d/i');

	apInitScenario(m_scen);
	regPat = /\d\d\d|\d\d\d\d/i;
	objExp = new Array('234');
	regExp = new Array();
	...
	m_scen = ('Test 13 numbers   /\d\d\d\d|\d\d\d/i');
	...
	m_scen = ('Test 17 numbers   /\d\d\d|\d\d\d/i');

	apInitScenario(m_scen);
	regPat = /\d\d\d|\d\d\d/i;
	objExp = new Array('234');
	regExp = new Array();
	...
	m_scen = ('Test 21 Failure - Lowercase /\d\D\d\D\D\D\d\D|\d\d\D\d\D\D\D\D\D/i');

	apInitScenario(m_scen);
	regPat = /\d\D\d\D\D\D\d\D|\d\D\d\d\d\D\d\D\D\D\D\D/i;
	objExp = null;
	regExp = new Array();
