...
apInitTest("mtc_1284");
	...
	m_scen = ('Test 1 numbers   /\d\d\d|\D\D\D\D\D\D\D\d\D\D\D\D\D/gi');

	sCat = "Pattern: exist | non-exist ";
	apInitScenario(m_scen);
	regPat = /\d\d\d|\D\D\D\D\D\D\D\d\D\D\D\D\D/gi;
	...
	objExp = new Array('234', '239', '242', '723');
	...
	objExp = new Array('234', '239', '242', '723', '923');	
	...
	objExp = new Array('234', '234', '239', '242', '723');	
	...
	objExp = new Array('234', '706', '885', '234', '706', '195', '792', '239', '242', '723', '925');	
	...
	m_scen = ('Test 5 numbers   /\D\D\D\D\D\D\D\d\D\D\D\D\D|\d\d\d/gi');
	...
	m_scen = ('Test 9 numbers   /\d\d\d|\d\d\d\d/gi');

	apInitScenario(m_scen);
	regPat = /\d\d\d|\d\d\d\d/gi;
	regExp = new Array();

	objExp = new Array('234', '176');
	strTest = '234  17622';
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	...
	objExp = new Array('234', '176', '239', '242', '723');
	...
	objExp = new Array('234', '706', '176', '239', '242', '723');
	...
	objExp = new Array('234', '176', '239', '242', '723', '923');
	...
	m_scen = ('Test 13 numbers   /\d\d\d\d|\d\d\d/gi');
	...
	objExp = new Array('234', '1762', '2392', '4272', '392');
 	strTest = '234 17627 23 4 23924272392'; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	...
	objExp = new Array('234', '706', '1762', '2392', '4272', '392');
	...
	objExp = new Array('234', '1762', '2392', '4272', '3923');
	...
	objExp = new Array('234','2392', '4272', '392');
	...
	objExp = new Array('234', '7063', '8857', '1762', '7195', '7920', '2392', '4272', '3925');
	...
	m_scen = ('Test 17 numbers   /\d\d\d|\d\d\d/gi');

	apInitScenario(m_scen);
	regPat = /\d\d\d|\d\d\d/gi;
	objExp = new Array('234');
	regExp = new Array();
	...
	objExp = new Array('234', '706', '885', '176', '271', '957', '920', '239', '242', '723', '925');
	...
	m_scen = ('Test 21 Failure - Lowercase /\d\D\d\D\D\D\d\D|\d\d\D\d\D\D\D\D\D/gi');

	apInitScenario(m_scen);
	regPat = /\d\D\d\D\D\D\d\D|\d\D\d\d\d\D\d\D\D\D\D\D/gi;
	objExp = null;
	regExp = new Array();
