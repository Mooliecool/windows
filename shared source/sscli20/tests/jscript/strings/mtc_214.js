...
apInitTest("mtc_214");
	...
	m_scen = ('Test 3 nonalpha  tests /\\w{3}/ multiples');
	...
	m_scen = ('Test 5 nonalpha  /(\\w{3})/');

	sCat = "/(\\w{3})/ ";
	apInitScenario(m_scen);
	regPat = /(\w{3})/;
	objExp = new Array('___', '___');
	regExp = new Array('___');
	...
	m_scen = ('Test 9 nonalpha  /(\\w{2})(\\w{1})/');

	sCat = " /(\\w{2})(\\w{1})/ ";
	apInitScenario(m_scen);
	regPat = /(\w{2})(\w{1})/;
	objExp = new Array('___','__','_');
	regExp = new Array('__','_');
	...
	m_scen = ('Test 11 nonalpha  tests /(\\w{2})(\\w{1})/ multiples');
	...
	m_scen = ('Test 13 nonalpha   /((\\w{2})(\\w{1}))/');

	sCat = " /((\\w{2})(\\w{1}))/ ";
	apInitScenario(m_scen);
	regPat =  /((\w{2})(\w{1}))/;
	objExp = new Array('___', '___','__','_');
	regExp = new Array('___','__','_');
	...
	m_scen = ('Test 15 nonalpha  tests /((\\w{2})(\\w{1}))/ multiples');
