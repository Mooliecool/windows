...
apInitTest("mtc_2287");
	...
	m_scen = ('Test 1 nonalpha  /\b[\uC000-\uC002][\uC000-\uFfFf][\uC000-\uD000]/');
	...
	strTest = '              d\uC000\uC001\uC002D d\uC000\uC001\uC002 \uC000\uC001\uABCA\uC000\uC000\uC002\uC000D\uC000\uC001\uABCA\uC000'; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end
	...
	strTest = '              d\uC000\uC001\uC002D d\uC000\uC001\uC002 \uC000\uC001\uABCA\uC000\uC002\uC000D\uC000\uC001\uABCA\uC000'; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end
	...
	m_scen = ('Test 5 nonalpha  /[\uC000-\uC002][\uC000-\uFfFf][\uC000-\uD000]\b/');
	...
	strTest = '              D\uC000\uC001\uC002d \uC000\uC001\uC002d \uC000\uC001\uABCA\uC000\uC000\uC002\uC000D\uC000\uC001\uABCA\uC000'; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end
	...
	strTest = '              D\uC000\uC001\uC002d \uC000\uC001\uC002d \uC000\uC001\uABCA\uC000\uC002\uC000D\uC000\uC001\uABCA\uC000'; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end
	...
	m_scen = ('Test 9 nonalpha  /\B[\uC000-\uC002][\uC000-\uFfFf][\uC000-\uD000]/');
	...
	m_scen = ('Test 13 nonalpha  /[\uC000-\uC002][\uC000-\uFfFf][\uC000-\uD000]\B/');
