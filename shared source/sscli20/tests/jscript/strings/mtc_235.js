...
apInitTest("mtc_235");
	...
	m_scen = ('Test 1 nonalpha  /\uC000\uC002|\uC000¤d \uC000¤\.\*d\.\uC000\*+¤d/');

	apInitScenario(m_scen);
	regPat = /\uC000\uC002|\uC000¤d \uC000¤\.\*d\.\uC000\*+¤d/;
	...
	strTest = '              d\uC000\uC002 \uC000 \uC002 \uC000\uABCA\uC000\uC002\uC000d\uC000\uABCA\uC000'; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end

	strTest = 'd\uC000\uC002 \uC000 \uC002 \uC000\uABCA\uC000\uC002\uC000d\uC000\uABCA\uC000 \uC002            '; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end
	...
	strTest = '           d\uC000\uC002, ¤\uC000\uC002 \uC000\uABCA\uC000\uC002\uC000d\uC000\uABCA\uC000d             '; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end

	strTest = '¤\uC000\uC002 \uC000\uC002 \uABCA\uC000\uC002\uC000d\uC000\uABCA\uC000'; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end

	strTest = '              ¤\uC000\uC002 \uC000\uC002 \uABCA\uC000\uABCA\uC000\uC002\uC000d\uC000\uABCA\uC000'; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end
	...
	strTest = '              ¤\uC000\uC002\uABCA \uC000\uC002\uC000 \uC000\uC002\uC000d\uC000\uABCA\uC000'; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end

	strTest = '\uABCA\uC000\uC002 ?\uC000\uC002 \uC000\uC002\uC000d\uC000\uABCA\uC000             '; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end

	strTest = '              \uC000\uC000\uC002d \uC000\uC000\uC000\uC002\uC000 \uC000\uC000\uC000\uC002\uC000d\uC000\uABCA\uC000'; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end

	strTest = '\r\uC000\uC002d {\uC000\uC000\uC002d¤ \uABCA~\uC000\uC002@\uC000\uC000d\uC000\uABCA\uC000             '; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end

	strTest = '           {	\uC000\uC002d d\r\uC000\uC002|} {*,}\uC000\uC002\uC000d\uC000\uABCA\uC000.}.             '; 
	ArrayEqual(sCat+strTest, objExp, strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end

	m_scen = ('Test 5 nonalpha  /\uC000¤d \uC000¤\.\*d\.\uC000\*+¤d|\uC000\uC002/');

	apInitScenario(m_scen);
	regPat = /\uC000¤d \uC000¤\.\*d\.\uC000\*+¤d|\uC000\uC002/;
	objExp = new Array('\uC000\uC002');
	regExp = new Array();
	...
	m_scen = ('Test 17 nonalpha  /\uC000\uC002|\uC000\uC002/');
	...
	m_scen = ('Test 21 Failure - Lowercase /\uC000\uC002|\uC000\uC002/');
