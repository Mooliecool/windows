...
apInitTest("mtca22");
	...
	m_scen = ('Test 19 nonalpha  tests /(\uC000)(\uC001\uC002)/ multiples');
	...
	m_scen = ('Test 21 nonalpha  /((\uC000)(\uC001\uC002))/');

	apInitScenario(m_scen);
	regPat = /((\uC000)(\uC001\uC002))/;
	objExp = new Array('\uC000\uC001\uC002','\uC000\uC001\uC002','\uC000','\uC001\uC002');
	regExp = new Array('\uC000\uC001\uC002','\uC000','\uC001\uC002');
	...
	m_scen = ('Test 23 nonalpha  tests /((\uC000)(\uC001\uC002))/ multiples');
	...
	m_scen = ('Test 25 nonalpha  /(\uC000)(\uC001)(\uC002)/');

	apInitScenario(m_scen);
	regPat = /(\uC000)(\uC001)(\uC002)/;
	objExp = new Array('\uC000\uC001\uC002','\uC000','\uC001','\uC002');
	regExp = new Array('\uC000', '\uC001', '\uC002');
	...
	m_scen = ('Test 27 nonalpha  tests /(\uC000)(\uC001)(\uC002)/ multiples');
	...
	m_scen = ('Test 29 nonalpha  /((\uC000)(\uC001)(\uC002))/');

	apInitScenario(m_scen);
	regPat = /((\uC000)(\uC001)(\uC002))/;
	objExp = new Array('\uC000\uC001\uC002','\uC000\uC001\uC002','\uC000','\uC001','\uC002');
	regExp = new Array('\uC000\uC001\uC002','\uC000','\uC001','\uC002');
	...
	m_scen = ('Test 31 nonalpha  tests /((\uC000)(\uC001)(\uC002))/ multiples');
	...
	m_scen = ('Test 33 Failure Lowercase /\uC000\uC001\uC002/');
	...
	m_scen = ('Test 35 Failure Lowercase tests /\uC000\uC001\uC002/ multiples');
