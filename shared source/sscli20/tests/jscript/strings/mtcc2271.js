...
apInitTest("mtcc2271");
	...
	objExp = new Array('\uC000\uC001\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002');
	...
	strTest = '\uC000\uC001\uC002\uC002';
	ArrayEqual(sCat+strTest, new Array('\uC000\uC001\uC002\uC002'), strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end
	...
	ArrayEqual(sCat+strTest, new Array('\uC000\uC001\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002\uC002'), strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end
	...
	strTest = '              D\uC000\uC001 \uC000\uC001 \uC002 \uC000\uC001\uABCA\uC000\uC002\uC000D\uC000\uC001\uABCA\uC000\uC001'; 
	ArrayEqual(sCat+strTest, new Array(strTemp), strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end

	strTest = 'D\uC000\uC001 \uC000\uC001 \uC002 \uC000\uC001\uABCA\uC000\uC002\uC000D\uC000\uC001\uABCA\uC000\uC001 \uC002            '; 
	ArrayEqual(sCat+strTest, new Array(strTemp), strTest.match(regPat));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, strTest.match(regPat));
	@end
