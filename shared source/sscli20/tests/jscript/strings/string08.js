...
@end
    ...
    apInitScenario("add numeric constant to string object");
    res = 1234 + myStr;
    ...
    apInitScenario("add numeric constant to date (coerced to string)");
    res = 1234 + ("" + myDate);
    ...
    apInitScenario("add numeric constant to date.toString()");
    ...
    apInitScenario("add numeric constant to function returning string");
    res = 1234 + FuncRetStr();
    ...
    apInitScenario("add numeric constant to null string");
    res = 1234 + "";
    expected = "1234";
    if (res != expected) {
        apLogFailInfo("wrong result",expected,res,"");
    ...
    apInitScenario("add numeric constant to string constant");
    res = 1234 + "Bernoulli";
    ...
    apInitScenario("add numeric constant to string expression");
    res = 1234 + ("abc" + "def");
    expected = "1234abcdef";
    if (res != expected) {
        apLogFailInfo("wrong result",expected,res,"");
    ...
    apInitScenario("add numeric constant to string variable");
    res = 1234 + strvar;
    ...
    apInitScenario("add numeric constant to string array element");
    res = 1234 + ary[3];
    ...
    apInitScenario("add numeric constant to user-defined object member");
    ...
    apInitScenario("add numeric constant to string.toString");
    ...
    apInitScenario("add numeric constant to Math.toString");
    ...
    apInitScenario("add numeric constant to eval string");
