...
function Scenarios ()
  {
     ...
     Verify ( "0.00", Str1, "toLocaleString.1.1" ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "15.00", Str1, "toLocaleString.1.2" ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "527.00", Str1, "toLocaleString.1.3" ) ;

     Str1 = (884).toLocaleString () ;
     Verify ( "884.00", Str1, "toLocaleString.1.4" ) ;

     Str1 = (numObj2 * 9).toLocaleString () ;
     Verify ( "135.00", Str1, "toLocaleString.1.5" ) ;

     numObj1 = 1000 ;			   
     numObj2 = 16572 ;
     numVar = 439918 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "1,000.00", Str1, "toLocaleString.1.6" ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "16,572.00", Str1, "toLocaleString.1.7" ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "439,918.00", Str1, "toLocaleString.1.8" ) ;

     Str1 = (28184).toLocaleString () ;
     Verify ( "28,184.00", Str1, "toLocaleString.1.9" ) ;

     Str1 = (numObj1 * 76).toLocaleString () ;
     Verify ( "76,000.00", Str1, "toLocaleString.1.10" ) ;

     numObj1 = 1000000 ;		   
     numObj2 = 17946562 ;
     numVar = 10000 * 10000 * 10000 * 10000 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "1,000,000.00", Str1, "toLocaleString.1.11" ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "17,946,562.00", Str1, "toLocaleString.1.12" ) ;

     Str1 = numVar.toLocaleString () ;
     if ( Str1 != "1E+16" && Str1 != "1e+16" )
       Verify ( "10,000,000,000,000,000.00", Str1, "toLocaleString.1.13" ) ;

     Str1 = (301982160).toLocaleString () ;
     Verify ( "301,982,160.00", Str1, "toLocaleString.1.14" ) ;

     Str1 = (numVar * 25).toLocaleString () ;
     if ( Str1 != "2.5E+17" && Str1 != "2.5e+17" )
       Verify ( "250,000,000,000,000,000.00", Str1, "toLocaleString.1.15" ) ;
     ...
     if ( Str1 != "2E+46" && Str1 != "2e+46" )
       Verify ( "20,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000.00",
	      Str1, "toLocaleString.1.16" ) ;

     Str1 = numObj2.toLocaleString () ;
     if ( Str1 != "3E+80" && Str1 != "3e+80" )
	Verify ( "300,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000.00",
	       Str1, "toLocaleString.1.17" ) ;
	 ...
	 for ( iTmp = 0 ; iTmp < 47 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ".00" ;
	 Verify ( Str2, Str1, "toLocaleString.1.18" ) ;
       }

     Str1 = (1e+60).toLocaleString () ;
     if ( Str1 != "1e+60" && Str1 != "1E+60" )
       Verify ( "1,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000.00",
	       Str1, "toLocaleString.1.19" ) ;
     ...
     if ( Str1 != "4E+142" && Str1 != "4e+142" )
	  ...
	  for ( iTmp = 0 ; iTmp < 47 ; iTmp++ )
	    Str2 = Str2 + ",000" ;
	  Str2 = Str2 + ".00" ;
	  Verify ( Str2, Str1, "toLocaleString.1.20" ) ;
       }
     ...
     numVar = -812 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "-83.00", Str1, "toLocaleString.2.1" ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "-1.00", Str1, "toLocaleString.2.2" ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "-812.00", Str1, "toLocaleString.2.3" ) ;

     Str1 = (-36).toLocaleString () ;
     Verify ( "-36.00", Str1, "toLocaleString.2.4" ) ;

     Str1 = (numVar - 50).toLocaleString () ;
     Verify ( "-862.00", Str1, "toLocaleString.2.5" ) ;

     numObj1 = -819934 ;		   
     numObj2 = -28561 ;
     numVar = -1100 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "-819,934.00", Str1, "toLocaleString.2.6" ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "-28,561.00", Str1, "toLocaleString.2.7" ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "-1,100.00", Str1, "toLocaleString.2.8" ) ;

     Str1 = (-6219).toLocaleString () ;
     Verify ( "-6,219.00", Str1, "toLocaleString.2.9" ) ;

     Str1 = (numObj1 + 25000).toLocaleString () ;
     Verify ( "-794,934.00", Str1, "toLocaleString.2.10" ) ;

     numObj1 = -1001000 ;		   
     numObj2 = -201664971 ;
     numVar = -40000 * 20000 * 30000 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "-1,001,000.00", Str1, "toLocaleString.2.11" ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "-201,664,971.00", Str1, "toLocaleString.2.12" ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "-24,000,000,000,000.00", Str1, "toLocaleString.2.13" ) ;

     Str1 = (-52073901433).toLocaleString () ;
     Verify ( "-52,073,901,433.00", Str1, "toLocaleString.2.14" ) ;

     Str1 = (numObj2 * 15).toLocaleString () ;
     Verify ( "-3,024,974,565.00", Str1, "toLocaleString.2.15" ) ;
     ...
     if ( Str1 != "-9E+145" && Str1 != "-9e+145" )
	  ...
	  for ( iTmp = 0 ; iTmp < 48 ; iTmp++ )
	    Str2 = Str2 + ",000" ;
	  Str2 = Str2 + ".00" ;
	  Verify ( Str2, Str1, "toLocaleString.2.16" ) ;
       }

     Str1 = numObj2.toLocaleString () ;
     if ( Str1 != "-6e+37" && Str1 != "-6E+37" )
	Verify ( "-60,000,000,000,000,000,000,000,000,000,000,000,000.00",
	       Str1, "toLocaleString.2.17" ) ;

     Str1 = numVar.toLocaleString () ;
     if ( Str1 != "-7E+75" && Str1 != "-7e+75" )
	Verify ( "-7,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000.00",
	       Str1, "toLocaleString.2.18" ) ;
	 ...
	 for ( iTmp = 0 ; iTmp < 46 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ".00" ;
	 Verify ( Str2, Str1, "toLocaleString.2.19" ) ;
       }

     Str1 = (numObj2 * 20).toLocaleString () ;
     if ( Str1 != "-1.2E+39" && Str1 != "-1.2e+39" )
       Verify ( "-1,200,000,000,000,000,000,000,000,000,000,000,000,000.00",
	       Str1, "toLocaleString.2.20" ) ;
     ...
     numVar = 39.5121 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "0.13", Str1, "toLocaleString.3.1" ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "211.26", Str1, "toLocaleString.3.2" ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "39.51", Str1, "toLocaleString.3.3" ) ;

     Str1 = (81.1).toLocaleString () ;
     Verify ( "81.10", Str1, "toLocaleString.3.4" ) ;

     Str1 = (numObj1 + 416).toLocaleString () ;
     Verify ( "416.13", Str1, "toLocaleString.3.5" ) ;

     numObj1 = 1993.4 ; 		   
     numObj2 = 47984.16644 ;
     numVar = 316647.834 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "1,993.40", Str1, "toLocaleString.3.6" ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "47,984.17", Str1, "toLocaleString.3.7" ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "316,647.83", Str1, "toLocaleString.3.8" ) ;

     Str1 = (66471.31).toLocaleString () ;
     Verify ( "66,471.31", Str1, "toLocaleString.3.9" ) ;

     Str1 = (numVar - 2503.734).toLocaleString () ;
     Verify ( "314,144.10", Str1, "toLocaleString.3.10" ) ;

     numObj1 = 9110441.8644137 ;	   
     numObj2 = 7860155312.1 ;
     numVar = 41358612.137 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "9,110,441.86", Str1, "toLocaleString.3.11" ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "7,860,155,312.10", Str1, "toLocaleString.3.12" ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "41,358,612.14", Str1, "toLocaleString.3.13" ) ;

     Str1 = (62464007831.3191).toLocaleString () ;
     Verify ( "62,464,007,831.32", Str1, "toLocaleString.3.14" ) ;

     Str1 = (153.14*153.14*153.14*153.14*153.14*153.14).toLocaleString () ;
     if ( Str1 !=  "12,898,281,664,351.60" )
	Verify ( "12,898,281,664,351.61", Str1, "toLocaleString.3.15" ) ;
	 ...
	 for ( iTmp = 0 ; iTmp < 33 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ".00" ;
	 Verify ( Str2, Str1, "toLocaleString.3.16" ) ;
       }
	 ...
	 for ( iTmp = 0 ; iTmp < 37 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ".00" ;
	 Verify ( Str2, Str1, "toLocaleString.3.17" ) ;
       }
	 ...
	 for ( iTmp = 0 ; iTmp < 40 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ".00" ;
	 Verify ( Str2, Str1, "toLocaleString.3.18" ) ;
       }
	 ...
	 for ( iTmp = 0 ; iTmp < 42 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ".00" ;
	 Verify ( Str2, Str1, "toLocaleString.3.19" ) ;
       }
...
if (SV < 5.6) {
	 ...
	 for ( iTmp = 0 ; iTmp < 44 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ".00" ;
	 Verify ( Str2, Str1, "toLocaleString.3.20" ) ;
       }

     Str1 = (4.01E-552).toLocaleString () ;
     Verify ( "0.00", Str1, "toLocaleString.3.21" ) ;
     ...
     numVar = -121.593 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "-6.14", Str1, "toLocaleString.4.1" ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "-73.17", Str1, "toLocaleString.4.2" ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "-121.59", Str1, "toLocaleString.4.3" ) ;

     Str1 = (-0.0093).toLocaleString () ;
     Verify ( "-0.01", Str1, "toLocaleString.4.4" ) ;

     Str1 = (numVar + 63.1724).toLocaleString () ;
     Verify ( "-58.42", Str1, "toLocaleString.4.5" ) ;

     numObj1 = -44991.7 ;		    
     numObj2 = -477148.0992 ;
     numVar = -8422.6 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "-44,991.70", Str1, "toLocaleString.4.6" ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "-477,148.10", Str1, "toLocaleString.4.7" ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "-8,422.60", Str1, "toLocaleString.4.8" ) ;

     Str1 = (-131746.22593).toLocaleString () ;
     Verify ( "-131,746.23", Str1, "toLocaleString.4.9" ) ;

     Str1 = (numVar + numObj2).toLocaleString () ;
     Verify ( "-485,570.70", Str1, "toLocaleString.4.10" ) ;

     numObj1 = -73144681440.11998 ;	    
     numObj2 = -102135510.617 ;
     numVar = -3121685.4 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "-73,144,681,440.12", Str1, "toLocaleString.4.11" ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "-102,135,510.62", Str1, "toLocaleString.4.12" ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "-3,121,685.40", Str1, "toLocaleString.4.13" ) ;

     Str1 = (-2910162464.007831).toLocaleString () ;
     Verify ( "-2,910,162,464.01", Str1, "toLocaleString.4.14" ) ;

     Str1 = (-332261943343.91394 - 72138491340.1348311).toLocaleString () ;
     Verify ( "-404,400,434,684.05", Str1, "toLocaleString.4.15" ) ;
	 ...
	 for ( iTmp = 0 ; iTmp < 48 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ".00" ;
	 Verify ( Str2, Str1, "toLocaleString.4.16" ) ;
       }
	 ...
	 for ( iTmp = 0 ; iTmp < 44 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ".00" ;
	 Verify ( Str2, Str1, "toLocaleString.4.17" ) ;
       }
	 ...
	 for ( iTmp = 0 ; iTmp < 41 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ".00" ;
	 Verify ( Str2, Str1, "toLocaleString.4.18" ) ;
       }
	 ...
	 for ( iTmp = 0 ; iTmp < 38 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ".00" ;
	 Verify ( Str2, Str1, "toLocaleString.4.19" ) ;
       }
	 ...
	 for ( iTmp = 0 ; iTmp < 32 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ".00" ;
	 Verify ( Str2, Str1, "toLocaleString.4.20" ) ;
       }

     Str1 = (-1.783E-408 * 100).toLocaleString () ;
     Verify ( "0.00", Str1, "toLocaleString.4.21" ) ;

    
     apInitScenario( "Scenario 5: toLocaleString on Number.NaN") ;

     Str1 = (Number.NaN).toLocaleString () ;
     Verify ( "NaN", Str1, "toLocaleString.5" ) ;

    
     apInitScenario( "Scenario 6: prototype to Array.toLocaleString") ;

     var numObj3 = new Number ();
     var numObj4 = new Number (-400);

@if (!@_fast)
     Str1 = "" ;
     Number.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = Number.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( arrErr, Str1, "toLocaleString.6.1" ) ;
@end

     Str1 = "" ;
     numObj3.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = numObj3.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( arrErr, Str1, "toLocaleString.6.2" ) ;

     Str1 = "" ;
     numObj4.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = numObj4.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( arrErr, Str1, "toLocaleString.6.3" ) ;

    
     apInitScenario( "Scenario 7: prototype to Date.toLocaleString") ;

@if (!@_fast)
     Str1 = "" ;
     Number.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = Number.toLocaleString () ;
       }
     ...
     Verify ( dateErr, Str1, "toLocaleString.7.1" ) ;
@end

     Str1 = "" ;
     numObj3.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = numObj3.toLocaleString () ;
       }
     ...
     Verify ( dateErr, Str1, "toLocaleString.7.2" ) ;

     Str1 = "" ;
     numObj4.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = numObj4.toLocaleString () ;
       }
     ...
     Verify ( dateErr, Str1, "toLocaleString.7.3" ) ;
  }
