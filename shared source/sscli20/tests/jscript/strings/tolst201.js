...
function tolst201 ()
  {
     ...
     if ( apSetIntlNumDefaults () )	   
	  ...
	  if ( apfSetIntlValue (keysdec, "^o^") == 0 )
	  ...
	  if ( apfSetIntlValue (keysdec, "dot") == 0 )
...
function Scenarios (sDec, iCase)
  {
     ...
     Verify ( "0"+sDec+"00", Str1, "toLocaleString.1.1."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "15"+sDec+"00", Str1, "toLocaleString.1.2."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "527"+sDec+"00", Str1, "toLocaleString.1.3."+iCase ) ;

     Str1 = (884).toLocaleString () ;
     Verify ( "884"+sDec+"00", Str1, "toLocaleString.1.4."+iCase ) ;

     Str1 = (numObj2 * 9).toLocaleString () ;
     Verify ( "135"+sDec+"00", Str1, "toLocaleString.1.5."+iCase ) ;

     numObj1 = 1000 ;			   
     numObj2 = 16572 ;
     numVar = 439918 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "1,000"+sDec+"00", Str1, "toLocaleString.1.6."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "16,572"+sDec+"00", Str1, "toLocaleString.1.7."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "439,918"+sDec+"00", Str1, "toLocaleString.1.8."+iCase ) ;

     Str1 = (28184).toLocaleString () ;
     Verify ( "28,184"+sDec+"00", Str1, "toLocaleString.1.9."+iCase ) ;

     Str1 = (numObj1 * 76).toLocaleString () ;
     Verify ( "76,000"+sDec+"00", Str1, "toLocaleString.1.10."+iCase ) ;

     numObj1 = 1000000 ;		   
     numObj2 = 17946562 ;
     numVar = 10000 * 10000 * 10000 * 10000 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "1,000,000"+sDec+"00", Str1, "toLocaleString.1.11."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "17,946,562"+sDec+"00", Str1, "toLocaleString.1.12."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     if ( Str1 != "1E+16" && Str1 != "1e+16" )
       Verify ( "10,000,000,000,000,000"+sDec+"00", Str1, "toLocaleString.1.13."+iCase ) ;

     Str1 = (301982160).toLocaleString () ;
     Verify ( "301,982,160"+sDec+"00", Str1, "toLocaleString.1.14."+iCase ) ;

     Str1 = (numVar * 25).toLocaleString () ;
     if ( Str1 != "2"+sDec+"5E+17" && Str1 != "2"+sDec+"5e+17" )
       Verify ( "250,000,000,000,000,000"+sDec+"00", Str1, "toLocaleString.1.15."+iCase ) ;
	...
	Verify ( "20,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000"+sDec+"00",
	      Str1, "toLocaleString.1.16."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     if ( Str1 != "3E+80" && Str1 != "3e+80" )
	 Verify ( "300,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000"+sDec+"00",
     ...
     if ( Str1 != "1e+60" && Str1 != "1E+60" )
       Verify ( "1,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000"+sDec+"00",
     ...
     numVar = -812 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "-83"+sDec+"00", Str1, "toLocaleString.2.1."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "-1"+sDec+"00", Str1, "toLocaleString.2.2."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "-812"+sDec+"00", Str1, "toLocaleString.2.3."+iCase ) ;

     Str1 = (-36).toLocaleString () ;
     Verify ( "-36"+sDec+"00", Str1, "toLocaleString.2.4."+iCase ) ;

     Str1 = (numVar - 50).toLocaleString () ;
     Verify ( "-862"+sDec+"00", Str1, "toLocaleString.2.5."+iCase ) ;

     numObj1 = -819934 ;		   
     numObj2 = -28561 ;
     numVar = -1100 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "-819,934"+sDec+"00", Str1, "toLocaleString.2.6."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "-28,561"+sDec+"00", Str1, "toLocaleString.2.7."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "-1,100"+sDec+"00", Str1, "toLocaleString.2.8."+iCase ) ;

     Str1 = (-6219).toLocaleString () ;
     Verify ( "-6,219"+sDec+"00", Str1, "toLocaleString.2.9."+iCase ) ;

     Str1 = (numObj1 + 25000).toLocaleString () ;
     Verify ( "-794,934"+sDec+"00", Str1, "toLocaleString.2.10."+iCase ) ;

     numObj1 = -1001000 ;		   
     numObj2 = -201664971 ;
     numVar = -40000 * 20000 * 30000 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "-1,001,000"+sDec+"00", Str1, "toLocaleString.2.11."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "-201,664,971"+sDec+"00", Str1, "toLocaleString.2.12."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "-24,000,000,000,000"+sDec+"00", Str1, "toLocaleString.2.13."+iCase ) ;

     Str1 = (-52073901433).toLocaleString () ;
     Verify ( "-52,073,901,433"+sDec+"00", Str1, "toLocaleString.2.14."+iCase ) ;

     Str1 = (numObj2 * 15).toLocaleString () ;
     Verify ( "-3,024,974,565"+sDec+"00", Str1, "toLocaleString.2.15."+iCase ) ;
     ...
     if ( Str1 != "-6e+37" && Str1 != "-6E+37" )
       Verify ( "-60,000,000,000,000,000,000,000,000,000,000,000,000"+sDec+"00",
	       Str1, "toLocaleString.2.17."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     if ( Str1 != "-7E+75" && Str1 != "-7e+75" )
	Verify ( "-7,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000"+sDec+"00",
     ...
     if ( Str1 != "-1"+sDec+"2E+39" && Str1 != "-1"+sDec+"2e+39" &&
	  Str1 != "-1"+sDec.substr(0,1)+"2E+39" && Str1 != "-1"+sDec.substr(0,1)+"2e+39" )
	Verify ( "-1,200,000,000,000,000,000,000,000,000,000,000,000,000"+sDec+"00",
     ...
     numVar = 39.5121 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "0"+sDec+"13", Str1, "toLocaleString.3.1."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "211"+sDec+"26", Str1, "toLocaleString.3.2."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "39"+sDec+"51", Str1, "toLocaleString.3.3."+iCase ) ;

     Str1 = (81.1).toLocaleString () ;
     Verify ( "81"+sDec+"10", Str1, "toLocaleString.3.4."+iCase ) ;

     Str1 = (numObj1 + 416).toLocaleString () ;
     Verify ( "416"+sDec+"13", Str1, "toLocaleString.3.5."+iCase ) ;

     numObj1 = 1993.4 ; 		   
     numObj2 = 47984.16644 ;
     numVar = 316647.834 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "1,993"+sDec+"40", Str1, "toLocaleString.3.6."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "47,984"+sDec+"17", Str1, "toLocaleString.3.7."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "316,647"+sDec+"83", Str1, "toLocaleString.3.8."+iCase ) ;

     Str1 = (66471.31).toLocaleString () ;
     Verify ( "66,471"+sDec+"31", Str1, "toLocaleString.3.9."+iCase ) ;

     Str1 = (numVar - 2503.734).toLocaleString () ;
     Verify ( "314,144"+sDec+"10", Str1, "toLocaleString.3.10."+iCase ) ;

     numObj1 = 9110441.8644137 ;	   
     numObj2 = 7860155312.1 ;
     numVar = 41358612.137 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "9,110,441"+sDec+"86", Str1, "toLocaleString.3.11."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "7,860,155,312"+sDec+"10", Str1, "toLocaleString.3.12."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "41,358,612"+sDec+"14", Str1, "toLocaleString.3.13."+iCase ) ;

     Str1 = (62464007831.3191).toLocaleString () ;
     Verify ( "62,464,007,831"+sDec+"32", Str1, "toLocaleString.3.14."+iCase ) ;

     Str1 = (153.14*153.14*153.14*153.14*153.14*153.14).toLocaleString () ;
     if ( Str1 !=  "12,898,281,664,351"+sDec+"60" )
       Verify ( "12,898,281,664,351"+sDec+"61", Str1, "toLocaleString.3.15."+iCase ) ;
     ...
     Str1 = numObj1.toLocaleString () ;
     Str2 = "1,980" ;			   
     if ( Str1 != "1"+sDec+"98E+102" && Str1 != "1"+sDec+"98e+102" &&
	  Str1 != "1"+sDec.substr(0,1)+"98E+102" && Str1 != "1"+sDec.substr(0,1)+"98e+102" )
       {
     ...
     Str1 = numObj2.toLocaleString () ;
     Str2 = "530" ;			   
     if ( Str1 != "5"+sDec+"3E+113" && Str1 != "5"+sDec+"3e+113" &&
	  Str1 != "5"+sDec.substr(0,1)+"3E+113" && Str1 != "5"+sDec.substr(0,1)+"3e+113" )
       {
     ...
     Str1 = numVar.toLocaleString () ;
     Str2 = "866,100" ;			   
     if ( Str1 != "8"+sDec+"661E+125" && Str1 != "8"+sDec+"661e+125" &&
	  Str1 != "8"+sDec.substr(0,1)+"661E+125" && Str1 != "8"+sDec.substr(0,1)+"661e+125" )
       {
     ...
     Str2 = "401,470" ;			   
     if ( Str1 != "4"+sDec+"0147E+131" && Str1 != "4"+sDec+"0147e+131" &&
	  Str1 != "4"+sDec.substr(0,1)+"0147E+131" && Str1 != "4"+sDec.substr(0,1)+"0147e+131" )
       {
...
if (SV < 5.6) {
     ...
     if ( Str1 != "2"+sDec+"655319E+149" && Str1 != "2"+sDec+"655319e+149" &&
	  Str1 != "2"+sDec.substr(0,1)+"655319E+149" && Str1 != "2"+sDec.substr(0,1)+"655319e+149" )
       {
     ...
     numVar = -121.593 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "-6"+sDec+"14", Str1, "toLocaleString.4.1."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "-73"+sDec+"17", Str1, "toLocaleString.4.2."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "-121"+sDec+"59", Str1, "toLocaleString.4.3."+iCase ) ;

     Str1 = (-0.0093).toLocaleString () ;
     Verify ( "-0"+sDec+"01", Str1, "toLocaleString.4.4."+iCase ) ;

     Str1 = (numVar + 63.1724).toLocaleString () ;
     Verify ( "-58"+sDec+"42", Str1, "toLocaleString.4.5."+iCase ) ;

     numObj1 = -44991.7 ;		    
     numObj2 = -477148.0992 ;
     numVar = -8422.6 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "-44,991"+sDec+"70", Str1, "toLocaleString.4.6."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "-477,148"+sDec+"10", Str1, "toLocaleString.4.7."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "-8,422"+sDec+"60", Str1, "toLocaleString.4.8."+iCase ) ;

     Str1 = (-131746.22593).toLocaleString () ;
     Verify ( "-131,746"+sDec+"23", Str1, "toLocaleString.4.9."+iCase ) ;

     Str1 = (numVar + numObj2).toLocaleString () ;
     Verify ( "-485,570"+sDec+"70", Str1, "toLocaleString.4.10."+iCase ) ;

     numObj1 = -73144681440.11998 ;	    
     numObj2 = -102135510.617 ;
     numVar = -3121685.4 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "-73,144,681,440"+sDec+"12", Str1, "toLocaleString.4.11."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "-102,135,510"+sDec+"62", Str1, "toLocaleString.4.12."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "-3,121,685"+sDec+"40", Str1, "toLocaleString.4.13."+iCase ) ;

     Str1 = (-2910162464.007831).toLocaleString () ;
     Verify ( "-2,910,162,464"+sDec+"01", Str1, "toLocaleString.4.14."+iCase ) ;

     Str1 = (-332261943343.91394 - 72138491340.1348311).toLocaleString () ;
     Verify ( "-404,400,434,684"+sDec+"05", Str1, "toLocaleString.4.15."+iCase ) ;
     ...
     Str1 = numObj1.toLocaleString () ;
     Str2 = "-617,784" ;		   
     if ( Str1 != "-6"+sDec+"17784E+149" && Str1 != "-6"+sDec+"17784e+149" &&
	  Str1 != "-6"+sDec.substr(0,1)+"17784E+149" && Str1 != "-6"+sDec.substr(0,1)+"17784e+149" )
       {
	 for ( iTmp = 0 ; iTmp < 48 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + sDec+"00" ;
     ...
     Str1 = numObj2.toLocaleString () ;
     Str2 = "-432,600" ;		   
     if ( Str1 != "-4"+sDec+"326E+137" && Str1 != "-4"+sDec+"326e+137" &&
	  Str1 != "-4"+sDec.substr(0,1)+"326E+137" && Str1 != "-4"+sDec.substr(0,1)+"326e+137" )
       {
	 for ( iTmp = 0 ; iTmp < 44 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + sDec+"00" ;
     ...
     Str1 = numVar.toLocaleString () ;
     Str2 = "-31" ;			   
     if ( Str1 != "-3"+sDec+"1E+124" && Str1 != "-3"+sDec+"1e+124" &&
	  Str1 != "-3"+sDec.substr(0,1)+"1E+124" && Str1 != "-3"+sDec.substr(0,1)+"1e+124" )
       {
     ...
     Str2 = "-90,073" ;			   
     if ( Str1 != "-9"+sDec+"0073E+118" && Str1 != "-9"+sDec+"0073e+118" &&
	  Str1 != "-9"+sDec.substr(0,1)+"0073E+118" && Str1 != "-9"+sDec.substr(0,1)+"0073e+118" )
       {
     ...
     Str2 = "-717,531,900" ;		   
     if ( Str1 != "-7"+sDec+"175319E+104" && Str1 != "-7"+sDec+"175319e+104" &&
	  Str1 != "-7"+sDec.substr(0,1)+"175319E+104" && Str1 != "-7"+sDec.substr(0,1)+"175319e+104" )
       {
