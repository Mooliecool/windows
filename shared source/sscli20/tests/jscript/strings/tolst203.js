...
function tolst203 ()
  {
     ...
     if ( apSetIntlNumDefaults () )	   
       {				   
	  if ( apfSetIntlValue (keysNegSign, "%") == 0 )
	  ...
	  if ( apfSetIntlValue (keysNegSign, "?n?") == 0 )
	  ...
	  if ( apfSetIntlValue (keysNegSign, "neg") == 0 )
...
function Scenarios (sNeg, iCase)
  {
     ...
     numVar = 439918 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "1,000.00", Str1, "toLocaleString.1.6."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "16,572.00", Str1, "toLocaleString.1.7."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "439,918.00", Str1, "toLocaleString.1.8."+iCase ) ;

     Str1 = (28184).toLocaleString () ;
     Verify ( "28,184.00", Str1, "toLocaleString.1.9."+iCase ) ;

     Str1 = (numObj1 * 76).toLocaleString () ;
     Verify ( "76,000.00", Str1, "toLocaleString.1.10."+iCase ) ;

     numObj1 = 1000000 ;		   
     numObj2 = 17946562 ;
     numVar = 10000 * 10000 * 10000 * 10000 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "1,000,000.00", Str1, "toLocaleString.1.11."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "17,946,562.00", Str1, "toLocaleString.1.12."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     if ( Str1 != "1E+16" && Str1 != "1e+16" )
	Verify ( "10,000,000,000,000,000.00", Str1, "toLocaleString.1.13."+iCase ) ;

     Str1 = (301982160).toLocaleString () ;
     Verify ( "301,982,160.00", Str1, "toLocaleString.1.14."+iCase ) ;

     Str1 = (numVar * 25).toLocaleString () ;
     if ( Str1 != "2.5E+17" && Str1 != "2.5e+17" )
       Verify ( "250,000,000,000,000,000.00", Str1, "toLocaleString.1.15."+iCase ) ;
	...
	Verify ( "1,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000.00",
     ...
     numVar = -812 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( sNeg+"83.00", Str1, "toLocaleString.2.1."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( sNeg+"1.00", Str1, "toLocaleString.2.2."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( sNeg+"812.00", Str1, "toLocaleString.2.3."+iCase ) ;

     Str1 = (-36).toLocaleString () ;
     Verify ( sNeg+"36.00", Str1, "toLocaleString.2.4."+iCase ) ;

     Str1 = (numVar - 50).toLocaleString () ;
     Verify ( sNeg+"862.00", Str1, "toLocaleString.2.5."+iCase ) ;

     numObj1 = -819934 ;		   
     numObj2 = -28561 ;
     numVar = -1100 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( sNeg+"819,934.00", Str1, "toLocaleString.2.6."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( sNeg+"28,561.00", Str1, "toLocaleString.2.7."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( sNeg+"1,100.00", Str1, "toLocaleString.2.8."+iCase ) ;

     Str1 = (-6219).toLocaleString () ;
     Verify ( sNeg+"6,219.00", Str1, "toLocaleString.2.9."+iCase ) ;

     Str1 = (numObj1 + 25000).toLocaleString () ;
     Verify ( sNeg+"794,934.00", Str1, "toLocaleString.2.10."+iCase ) ;

     numObj1 = -1001000 ;		   
     numObj2 = -201664971 ;
     numVar = -40000 * 20000 * 30000 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( sNeg+"1,001,000.00", Str1, "toLocaleString.2.11."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( sNeg+"201,664,971.00", Str1, "toLocaleString.2.12."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( sNeg+"24,000,000,000,000.00", Str1, "toLocaleString.2.13."+iCase ) ;

     Str1 = (-52073901433).toLocaleString () ;
     Verify ( sNeg+"52,073,901,433.00", Str1, "toLocaleString.2.14."+iCase ) ;

     Str1 = (numObj2 * 15).toLocaleString () ;
     Verify ( sNeg+"3,024,974,565.00", Str1, "toLocaleString.2.15."+iCase ) ;
     ...
     Str1 = numObj1.toLocaleString () ;
     Str2 = sNeg + "90" ;		   
     if ( Str1 != sNeg + "9E+145" && Str1 != sNeg + "9e+145" && 
	  Str1 != "-9E+145" && Str1 != "-9e+145" )		
       {
     ...
     Str1 = numObj2.toLocaleString () ;
     if ( Str1 != sNeg+"6e+37" && Str1 != sNeg+"6E+37" &&	
	  Str1 != "-6e+37" && Str1 != "-6E+37" )		
	Verify ( sNeg+"60,000,000,000,000,000,000,000,000,000,000,000,000.00",
	       Str1, "toLocaleString.2.17."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     if ( Str1 != sNeg+"7E+75" && Str1 != sNeg+"7e+75" &&
	  Str1 != "-7E+75" && Str1 != "-7e+75" )
	Verify ( sNeg+"7,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000.00",
	       Str1, "toLocaleString.2.18."+iCase ) ;

     Str1 = (-5e+138).toLocaleString () ;
     Str2 = sNeg + "5" ;		   
     if ( Str1 != sNeg+"5E+138" && Str1 != sNeg+"5e+138" &&
	  Str1 != "-5E+138" && Str1 != "-5e+138" )
       {
     ...
     if ( Str1 != sNeg+"1.2E+39" && Str1 != sNeg+"1.2e+39" &&
	  Str1 != "-1.2E+39" && Str1 != "-1.2e+39" )
	Verify ( sNeg+"1,200,000,000,000,000,000,000,000,000,000,000,000,000.00",
     ...
     numVar = 316647.834 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "1,993.40", Str1, "toLocaleString.3.6."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "47,984.17", Str1, "toLocaleString.3.7."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "316,647.83", Str1, "toLocaleString.3.8."+iCase ) ;

     Str1 = (66471.31).toLocaleString () ;
     Verify ( "66,471.31", Str1, "toLocaleString.3.9."+iCase ) ;

     Str1 = (numVar - 2503.734).toLocaleString () ;
     Verify ( "314,144.10", Str1, "toLocaleString.3.10."+iCase ) ;

     numObj1 = 9110441.8644137 ;	   
     numObj2 = 7860155312.1 ;
     numVar = 41358612.137 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( "9,110,441.86", Str1, "toLocaleString.3.11."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( "7,860,155,312.10", Str1, "toLocaleString.3.12."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( "41,358,612.14", Str1, "toLocaleString.3.13."+iCase ) ;

     Str1 = (62464007831.3191).toLocaleString () ;
     Verify ( "62,464,007,831.32", Str1, "toLocaleString.3.14."+iCase ) ;

     Str1 = (153.14*153.14*153.14*153.14*153.14*153.14).toLocaleString () ;
     if ( Str1 != "12,898,281,664,351.60" )
	Verify ( "12,898,281,664,351.61", Str1, "toLocaleString.3.15."+iCase ) ;
...
if (SV < 5.6) {
     ...
     numVar = -121.593 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( sNeg+"6.14", Str1, "toLocaleString.4.1."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( sNeg+"73.17", Str1, "toLocaleString.4.2."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( sNeg+"121.59", Str1, "toLocaleString.4.3."+iCase ) ;

     Str1 = (-0.0093).toLocaleString () ;
     Verify ( sNeg+"0.01", Str1, "toLocaleString.4.4."+iCase ) ;

     Str1 = (numVar + 63.1724).toLocaleString () ;
     Verify ( sNeg+"58.42", Str1, "toLocaleString.4.5."+iCase ) ;

     numObj1 = -44991.7 ;		    
     numObj2 = -477148.0992 ;
     numVar = -8422.6 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( sNeg+"44,991.70", Str1, "toLocaleString.4.6."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( sNeg+"477,148.10", Str1, "toLocaleString.4.7."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( sNeg+"8,422.60", Str1, "toLocaleString.4.8."+iCase ) ;

     Str1 = (-131746.22593).toLocaleString () ;
     Verify ( sNeg+"131,746.23", Str1, "toLocaleString.4.9."+iCase ) ;

     Str1 = (numVar + numObj2).toLocaleString () ;
     Verify ( sNeg+"485,570.70", Str1, "toLocaleString.4.10."+iCase ) ;

     numObj1 = -73144681440.11998 ;	    
     numObj2 = -102135510.617 ;
     numVar = -3121685.4 ;
     Str1 = numObj1.toLocaleString () ;
     Verify ( sNeg+"73,144,681,440.12", Str1, "toLocaleString.4.11."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Verify ( sNeg+"102,135,510.62", Str1, "toLocaleString.4.12."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Verify ( sNeg+"3,121,685.40", Str1, "toLocaleString.4.13."+iCase ) ;

     Str1 = (-2910162464.007831).toLocaleString () ;
     Verify ( sNeg+"2,910,162,464.01", Str1, "toLocaleString.4.14."+iCase ) ;

     Str1 = (-332261943343.91394 - 72138491340.1348311).toLocaleString () ;
     Verify ( sNeg+"404,400,434,684.05", Str1, "toLocaleString.4.15."+iCase ) ;
     ...
     Str1 = numObj1.toLocaleString () ;
     Str2 = sNeg + "617,784" ;		    
     if ( Str1 != sNeg + "6.17784E+149" && Str1 != sNeg + "6.17784e+149" &&
	  Str1 != "-6.17784E+149" && Str1 != "-6.17784e+149" )
       {
	 for ( iTmp = 0 ; iTmp < 48 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ".00" ;
     ...
     Str1 = numObj2.toLocaleString () ;
     Str2 = sNeg + "432,600" ;		    
     if ( Str1 != sNeg + "4.326E+137" && Str1 != sNeg + "4.326e+137" &&
	  Str1 != "-4.326E+137" && Str1 != "-4.326e+137" )
       {
	 for ( iTmp = 0 ; iTmp < 44 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ".00" ;
     ...
     Str1 = numVar.toLocaleString () ;
     Str2 = sNeg + "31" ;		    
     if ( Str1 != sNeg + "3.1E+124" && Str1 != sNeg + "3.1e+124" &&
	  Str1 != "-3.1E+124" && Str1 != "-3.1e+124" )
       {
     ...
     Str2 = sNeg + "90,073" ;		    
     if ( Str1 != sNeg + "9.0073E+118" && Str1 != sNeg + "9.0073e+118" &&
	  Str1 != "-9.0073E+118" && Str1 != "-9.0073e+118" )
       {
     ...
     Str2 = sNeg + "717,531,900" ;	    
     if ( Str1 != sNeg + "7.175319E+104" && Str1 != sNeg + "7.175319e+104" &&
	  Str1 != "-7.175319E+104" && Str1 != "-7.175319e+104" )
       {
