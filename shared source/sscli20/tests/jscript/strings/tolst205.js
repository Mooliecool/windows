...
function tolst205 ()
  {
     ...
     if ( apSetIntlNumDefaults () )	   
	  ...
	  for ( iTmp = 0 ; iTmp < 10 ; iTmp++ )
	    {				   
	      Str1 = iTmp.toString () ;    
	      if ( apfSetIntlValue (keyiDigits, Str1) == 0 )
...
function Scenarios (iCase)
  {
	...
	Verify ( "300,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,00"+Str2,
	 ...
	 for ( iTmp = 0 ; iTmp < 46 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ",00" + numToString (0, iCase, 1, "-", ".", 1) ;
	...
	Verify ( "1,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,00"+Str2,
     ...
     Str1 = numObj1.toLocaleString () ;
     Str2 = numToString (4, iCase, 1, "-", ".", 1) ;
     Verify ( "-819,93"+Str2, Str1, "toLocaleString.2.6."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Str2 = numToString (1, iCase, 1, "-", ".", 1) ;
     Verify ( "-28,56"+Str2, Str1, "toLocaleString.2.7."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Str2 = numToString (0, iCase, 1, "-", ".", 1) ;
     Verify ( "-1,10"+Str2, Str1, "toLocaleString.2.8."+iCase ) ;

     Str1 = (-6219).toLocaleString () ;
     Str2 = numToString (9, iCase, 1, "-", ".", 1) ;
     Verify ( "-6,21"+Str2, Str1, "toLocaleString.2.9."+iCase ) ;

     Str1 = (numObj1 + 25000).toLocaleString () ;
     Str2 = numToString (4, iCase, 1, "-", ".", 1) ;
     Verify ( "-794,93"+Str2, Str1, "toLocaleString.2.10."+iCase ) ;
     ...
     Str1 = numObj1.toLocaleString () ;
     Str2 = numToString (0, iCase, 1, "-", ".", 1) ;
     Verify ( "-1,001,00"+Str2, Str1, "toLocaleString.2.11."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Str2 = numToString (1, iCase, 1, "-", ".", 1) ;
     Verify ( "-201,664,97"+Str2, Str1, "toLocaleString.2.12."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Str2 = numToString (0, iCase, 1, "-", ".", 1) ;
     Verify ( "-24,000,000,000,00"+Str2, Str1, "toLocaleString.2.13."+iCase ) ;

     Str1 = (-52073901433).toLocaleString () ;
     Str2 = numToString (3, iCase, 1, "-", ".", 1) ;
     Verify ( "-52,073,901,43"+Str2, Str1, "toLocaleString.2.14."+iCase ) ;

     Str1 = (numObj2 * 15).toLocaleString () ;
     Str2 = numToString (5, iCase, 1, "-", ".", 1) ;
     Verify ( "-3,024,974,56"+Str2, Str1, "toLocaleString.2.15."+iCase ) ;
	...
	Verify ( "-60,000,000,000,000,000,000,000,000,000,000,000,00"+Str2,
	       Str1, "toLocaleString.2.17."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Str2 = numToString (0, iCase, 1, "-", ".", 1) ;
     if ( Str1 != "-7E+75" && Str1 != "-7e+75" )
	Verify ( "-7,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,00"+Str2,
	       Str1, "toLocaleString.2.18."+iCase ) ;
	...
	Verify ( "-1,200,000,000,000,000,000,000,000,000,000,000,000,00"+Str2,
	       Str1, "toLocaleString.2.20."+iCase ) ;
...
if (SV < 5.6) {
     ...
     numVar = -8422.6 ;
     Str1 = numObj1.toLocaleString () ;
     Str2 = numToString (1.7, iCase, 1, "-", ".", 1) ;
     Verify ( "-44,99"+Str2, Str1, "toLocaleString.4.6."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Str2 = numToString (8.0992, iCase, 1, "-", ".", 1) ;
     Verify ( "-477,14"+Str2, Str1, "toLocaleString.4.7."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Str2 = numToString (2.6, iCase, 1, "-", ".", 1) ;
     Verify ( "-8,42"+Str2, Str1, "toLocaleString.4.8."+iCase ) ;

     Str1 = (-131746.22593).toLocaleString () ;
     Str2 = numToString (6.22593, iCase, 1, "-", ".", 1) ;
     Verify ( "-131,74"+Str2, Str1, "toLocaleString.4.9."+iCase ) ;

     Str1 = (numVar + numObj2).toLocaleString () ;
     Str2 = numToString (0.6992, iCase, 1, "-", ".", 1) ;
     Verify ( "-485,57"+Str2, Str1, "toLocaleString.4.10."+iCase ) ;

     numObj1 = -73144681440.11998 ;	    
     numObj2 = -102135510.617 ;
     numVar = -3121685.4 ;
     Str1 = numObj1.toLocaleString () ;
     Str2 = numToString (0.11998, iCase, 1, "-", ".", 1) ;
     if ( Str1 != "-73,144,681,44"+Str2 )
       {
	  Str2 = numToString (0.12, iCase, 1, "-", ".", 1) ;
	  Verify ( "-73,144,681,44"+Str2, Str1, "toLocaleString.4.11."+iCase ) ;
       }

     Str1 = numObj2.toLocaleString () ;
     Str2 = numToString (0.617, iCase, 1, "-", ".", 1) ;
     Verify ( "-102,135,51"+Str2, Str1, "toLocaleString.4.12."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Str2 = numToString (5.4, iCase, 1, "-", ".", 1) ;
     Verify ( "-3,121,68"+Str2, Str1, "toLocaleString.4.13."+iCase ) ;

     Str1 = (-2910162464.007831).toLocaleString () ;
     Str2 = numToString (4.007831, iCase, 1, "-", ".", 1) ;
     if ( Str1 != "-2,910,162,46"+Str2 )
       {
	 Str2 = numToString (4.00783, iCase, 1, "-", ".", 1) ;
	 Verify ( "-2,910,162,46"+Str2, Str1, "toLocaleString.4.14."+iCase ) ;
       }

     Str1 = (-332261943343.91 - 72138491340.1).toLocaleString () ;
     Str2 = numToString (3.91 + 0.1, iCase, 1, "-", ".", 1) ;
     Verify ( "-404,400,434,68"+Str2, Str1, "toLocaleString.4.15."+iCase ) ;
