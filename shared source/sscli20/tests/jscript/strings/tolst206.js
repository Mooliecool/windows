...
function tolst206 ()
  {
     ...
     if ( apSetIntlNumDefaults () )	   
	  ...
	  for ( iTmp = 0 ; iTmp < 5 ; iTmp++ )
	    {
	      Str1 = iTmp.toString () ;     
	      if ( apfSetIntlValue (keyiNegNum, Str1) == 0 )
...
function Scenarios (iCase)
  {
     ...
     numVar = 439918 ;
     Str1 = numObj1.toLocaleString () ;
     Str2 = numToString ("0", 2, iCase, "-", ".", 1) ;
     Verify ( "1,00"+Str2, Str1, "toLocaleString.1.6."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Str2 = numToString ("2", 2, iCase, "-", ".", 1) ;
     Verify ( "16,57"+Str2, Str1, "toLocaleString.1.7."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Str2 = numToString (8, 2, iCase, "-", ".", 1) ;
     Verify ( "439,91"+Str2, Str1, "toLocaleString.1.8."+iCase ) ;

     Str1 = (28184).toLocaleString () ;
     Str2 = numToString (4, 2, iCase, "-", ".", 1) ;
     Verify ( "28,18"+Str2, Str1, "toLocaleString.1.9."+iCase ) ;

     Str1 = (numObj1 * 76).toLocaleString () ;
     Str2 = numToString (0, 2, iCase, "-", ".", 1) ;
     Verify ( "76,00"+Str2, Str1, "toLocaleString.1.10."+iCase ) ;
     ...
     Str1 = numObj1.toLocaleString () ;
     Str2 = numToString (0, 2, iCase, "-", ".", 1) ;
     Verify ( "1,000,00"+Str2, Str1, "toLocaleString.1.11."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Str2 = numToString (2, 2, iCase, "-", ".", 1) ;
     Verify ( "17,946,56"+Str2, Str1, "toLocaleString.1.12."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Str2 = numToString (0, 2, iCase, "-", ".", 1) ;
     if ( Str1 != "1E+16" && Str1 != "1e+16" )
       Verify ( "10,000,000,000,000,00"+Str2, Str1, "toLocaleString.1.13."+iCase ) ;

     Str1 = (301982160).toLocaleString () ;
     Str2 = numToString (0, 2, iCase, "-", ".", 1) ;
     if ( Str1 != "2.5E+17" && Str1 != "2.5e+17" )
       Verify ( "301,982,16"+Str2, Str1, "toLocaleString.1.14."+iCase ) ;

     Str1 = (numVar * 25).toLocaleString () ;
     Str2 = numToString (0, 2, iCase, "-", ".", 1) ;
     if ( Str1 != "2.5E+17" && Str1 != "2.5e+17" )
       Verify ( "250,000,000,000,000,00"+Str2, Str1, "toLocaleString.1.15."+iCase ) ;
     ...
     if ( Str1 != "2E+46" && Str1 != "2e+46" )
       Verify ( "20,000,000,000,000,000,000,000,000,000,000,000,000,000,000,00"+Str2,
	      Str1, "toLocaleString.1.16."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Str2 = numToString (0, 2, iCase, "-", ".", 1) ;
     if ( Str1 != "3E+80" && Str1 != "3e+80" )
	Verify ( "300,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,00"+Str2,
	       Str1, "toLocaleString.1.17."+iCase ) ;
     ...
     if ( Str1 != "4E+141" && Str1 != "4e+141" )
	  ...
	  for ( iTmp = 0 ; iTmp < 46 ; iTmp++ )
	    Str2 = Str2 + ",000" ;
	  Str2 = Str2 + ",00" + numToString (0, 2, iCase, "-", ".", 1) ;
     ...
     if ( Str1 != "1e+60" && Str1 != "1E+60" )
       Verify ( "1,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,00"+Str2,
	       Str1, "toLocaleString.1.19."+iCase ) ;
     ...
     Str1 = numObj2.toLocaleString () ;
     Str2 = "60,000,000,000,000,000,000,000,000,000,000,000,00"+numToString (0, 2, iCase, "-", ".", 1) ;
     Str2 = addNegSign(Str2, iCase, "-") ;
     if ( Str1 != "-6e+37" && Str1 != "-6E+37" )
       Verify ( Str2, Str1, "toLocaleString.2.17."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Str2 = "7,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,00"+numToString (0, 2, iCase, "-", ".", 1) ;
     Str2 = addNegSign(Str2, iCase, "-") ;
	...
	Verify ( Str2, Str1, "toLocaleString.2.18."+iCase ) ;
     ...
     Str2 = "1,200,000,000,000,000,000,000,000,000,000,000,000,00"+numToString (0, 2, iCase, "-", ".", 1) ;
     Str2 = addNegSign(Str2, iCase, "-") ;
	...
	Verify ( Str2, Str1, "toLocaleString.2.20."+iCase ) ;
     ...
     Str2 = numToString (81.1, 2, iCase, "-", ".", 1) ;
     Verify ( Str2, Str1, "toLocaleString.3.4."+iCase ) ;

     Str1 = (numObj1 + 416).toLocaleString () ;
     Str2 = numToString (numObj1 + 416, 2, iCase, "-", ".", 1) ;
     Verify ( Str2, Str1, "toLocaleString.3.5."+iCase ) ;

     numObj1 = 1993.4 ; 		   
     numObj2 = 47984.1664456823 ;
     numVar = 316647.834 ;
     Str1 = numObj1.toLocaleString () ;
     Str2 = numToString (3.4, 2, iCase, "-", ".", 1) ;
     Verify ( "1,99"+Str2, Str1, "toLocaleString.3.6."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Str2 = numToString (4.1664456823, 2, iCase, "-", ".", 1) ;
     Verify ( "47,98"+Str2, Str1, "toLocaleString.3.7."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Str2 = numToString (7.834, 2, iCase, "-", ".", 1) ;
     Verify ( "316,64"+Str2, Str1, "toLocaleString.3.8."+iCase ) ;

     Str1 = (66471.31).toLocaleString () ;
     Str2 = numToString (1.31, 2, iCase, "-", ".", 1) ;
     Verify ( "66,47"+Str2, Str1, "toLocaleString.3.9."+iCase ) ;

     Str1 = (numVar - 2503.734).toLocaleString () ;
     Str2 = numToString (4.1, 2, iCase, "-", ".", 1) ;
     Verify ( "314,14"+Str2, Str1, "toLocaleString.3.10."+iCase ) ;

     numObj1 = 9110441.86441375972 ;	     
     numObj2 = 7860155312.1 ;
     numVar = 41358612.13769 ;
     Str1 = numObj1.toLocaleString () ;
     Str2 = numToString (1.86441375972, 2, iCase, "-", ".", 1) ;
     Verify ( "9,110,44"+Str2, Str1, "toLocaleString.3.11."+iCase ) ;

     Str1 = numObj2.toLocaleString () ;
     Str2 = numToString (2.1, 2, iCase, "-", ".", 1) ;
     Verify ( "7,860,155,31"+Str2, Str1, "toLocaleString.3.12."+iCase ) ;

     Str1 = numVar.toLocaleString () ;
     Str2 = numToString (2.13769, 2, iCase, "-", ".", 1) ;
     Verify ( "41,358,61"+Str2, Str1, "toLocaleString.3.13."+iCase ) ;

     Str1 = (62464007831.3191).toLocaleString () ;
     Str2 = numToString (1.3191, 2, iCase, "-", ".", 1) ;
     Verify ( "62,464,007,83"+Str2, Str1, "toLocaleString.3.14."+iCase ) ;

     Str1 = (153.14*153.14*153.14*153.14*153.14*153.14).toLocaleString () ;
     Str2 = numToString (1.613, 2, iCase, "-", ".", 1) ;
     if ( Str1 != "12,898,281,664,35"+Str2 ) 
       {
	 Str2 = numToString (1.6, 2, iCase, "-", ".", 1) ;
	 Verify ( "12,898,281,664,35"+Str2, Str1, "toLocaleString.3.15."+iCase ) ;
       }
...
if (SV < 5.6) {
     Str2 = "265,531,900,000,000,000" ;		   
}
else {
     Str2 = "265,531,900,000,000,020" ;		   
}
	 ...
	 Str2 = Str2 + ",00" + numToString (0, 2, iCase, "-", ".", 1) ;
	 Str2 = addNegSign(Str2, iCase, "-") ;
	 Verify ( "-6.17784E+149", Str1, "toLocaleString.4.16."+iCase ) ;
       }
	 ...
	 Str2 = Str2 + ",00" + numToString (0, 2, iCase, "-", ".", 1) ;
	 Str2 = addNegSign(Str2, iCase, "-") ;
	 Verify ( "-4.326E+137", Str1, "toLocaleString.4.17."+iCase ) ;
       }
	 ...
	 Str2 = Str2 + ",00" + numToString (0, 2, iCase, "-", ".", 1) ;
	 Str2 = addNegSign(Str2, iCase, "-") ;
	 Verify ( "-3.1E+124", Str1, "toLocaleString.4.18."+iCase ) ;
       }
	 ...
	 Str2 = Str2 + ",00" + numToString (0, 2, iCase, "-", ".", 1) ;
	 Str2 = addNegSign(Str2, iCase, "-") ;
	 Verify ( "-9.0073E+118", Str1, "toLocaleString.4.19."+iCase ) ;
       }
     ...
     if ( Str1 != "-7.175319E+104" && Str1 != "-7.175319e+104" )
       {
	 for ( iTmp = 0 ; iTmp < 31 ; iTmp++ )
	   Str2 = Str2 + ",000" ;
	 Str2 = Str2 + ",00" + numToString (0, 2, iCase, "-", ".", 1) ;
	 Str2 = addNegSign(Str2, iCase, "-") ;
	 Verify ( "-7.175319E+104", Str1, "toLocaleString.4.20."+iCase ) ;
       }
