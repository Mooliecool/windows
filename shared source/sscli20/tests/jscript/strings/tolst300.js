...
function tolst300 ()
  {
     ...
     var boolObj1 = new Boolean () ;
     var boolObj2 = new Boolean (true) ;
     var boolObj3 = new Boolean (false) ;
     var boolVar1 = false ;
     var boolVar2 = true ;

    
     apInitScenario( "Scenario 1: toLocaleString from non-instantiated Boolean object") ;

     Str1 = Boolean.toString () ;
     Str2 = Boolean.toLocaleString () ;     
     Verify ( Str1, Str2, "toLocaleString.1.1","") ;

    
     apInitScenario( "Scenario 2: toLocaleString from instantiated Boolean object - explicit");

     Str1 = boolObj1.toString () ;
     Str2 = boolObj1.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.2.1" ) ;

     Str1 = boolObj2.toString () ;
     Str2 = boolObj2.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.2.2" ) ;

     Str1 = boolObj3.toString () ;
     Str2 = boolObj3.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.2.3" ) ;

    
     apInitScenario( "Scenario 3: toLocaleString from instantiated Boolean object - implicit");

     Str1 = boolVar1.toString () ;
     Str2 = boolVar1.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.3.1" ) ;

     Str1 = boolVar2.toString () ;
     Str2 = boolVar2.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.3.2" ) ;

     Str1 = true.toString () ;
     Str2 = true.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.3.3" ) ;

     Str1 = false.toString () ;
     Str2 = false.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.3.4" ) ;
...
@if (!@_fast)
     Str1 = "" ;			     
     Boolean.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = Boolean.toLocaleString () ;
       }
     catch ( err )
       {
...
@end
     ...
     Str1 = "" ;			     
     boolObj1.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = boolObj1.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
     ...
     Str1 = "" ;			     
     boolObj2.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = boolObj2.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
     ...
     Str1 = "" ;			     
     boolObj3.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = boolObj3.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( arrErr, Str1, "toLocaleString.4.4" ) ;

@if (!@_fast)
     Str1 = "" ;			     
     boolVar1.toLocaleString = Array.prototype.toLocaleString ;
     try				     
       {				     
	 Str1 = boolVar1.toLocaleString () ; 
       }				     
     catch ( err )			     
       {				     
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( boolVar1.toString(), Str1, "toLocaleString.4.5" ) ;

     Str1 = "" ;			     
     boolVar2.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = boolVar2.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( boolVar2.toString(), Str1, "toLocaleString.4.6" ) ;
@end
...
@if (!@_fast)
     Str1 = "" ;			     
     Boolean.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = Boolean.toLocaleString () ;
       }
...
@end
     ...
     Str1 = "" ;			     
     boolObj1.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = boolObj1.toLocaleString () ;
       }
     ...
     Str1 = "" ;			     
     boolObj2.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = boolObj2.toLocaleString () ;
       }
     ...
     Str1 = "" ;			     
     boolObj3.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = boolObj3.toLocaleString () ;
       }
     ...
     Verify ( dateErr, Str1, "toLocaleString.5.4" ) ;

@if (!@_fast)
     Str1 = "" ;			     
     boolVar1.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = boolVar1.toLocaleString () ;
       }
     ...
     Verify ( boolVar1.toString(), Str1, "toLocaleString.5.5" ) ;

     Str1 = "" ;			     
     boolVar2.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = boolVar2.toLocaleString () ;
       }
     ...
     Verify ( boolVar2.toString(), Str1, "toLocaleString.5.6" ) ;
@end
...
@if (!@_fast)
     Str1 = "" ;			     
     Boolean.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = Boolean.toLocaleString () ;
       }
...
@end
     ...
     Str1 = "" ;			     
     boolObj1.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = boolObj1.toLocaleString () ;
       }
     ...
     Str1 = "" ;			     
     boolObj2.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = boolObj2.toLocaleString () ;
       }
     ...
     Str1 = "" ;			     
     boolObj3.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = boolObj3.toLocaleString () ;
       }
     ...
     Verify ( numErr, Str1, "toLocaleString.6.4" ) ;

@if (!@_fast)
     Str1 = "" ;			     
     boolVar1.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = boolVar1.toLocaleString () ;
       }
     ...
     Verify ( boolVar1.toString(), Str1, "toLocaleString.6.5" ) ;

     Str1 = "" ;			     
     boolVar2.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = boolVar2.toLocaleString () ;
       }
     ...
     Verify ( boolVar2.toString(), Str1, "toLocaleString.6.6" ) ;
@end
...
@if (!@_fast)
     Str1 = "" ;			     
     Boolean.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = Boolean.toLocaleString () ;
       }
     ...
     Verify ( Boolean.toString(), Str1, "toLocaleString.7.1" ) ;
@end

     Str1 = "" ;			     
     boolObj1.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = boolObj1.toLocaleString () ;
       }
     ...
     Verify ( boolObj1.toString(), Str1, "toLocaleString.7.2" ) ;

     Str1 = "" ;			     
     boolObj2.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = boolObj2.toLocaleString () ;
       }
     ...
     Verify ( boolObj2.toString(), Str1, "toLocaleString.7.3" ) ;

     Str1 = "" ;			     
     boolObj3.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = boolObj3.toLocaleString () ;
       }
     ...
     Verify ( boolObj3.toString(), Str1, "toLocaleString.7.4" ) ;

@if (!@_fast)
     Str1 = "" ;			     
     boolVar1.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = boolVar1.toLocaleString () ;
       }
     ...
     Verify ( boolVar1.toString(), Str1, "toLocaleString.7.5" ) ;


     Str1 = "" ;			     
     boolVar2.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = boolVar2.toLocaleString () ;
       }
     ...
     Verify ( boolVar2.toString(), Str1, "toLocaleString.7.6" ) ;
@end
     ...
     Str2 = "fromToString" ;		     
     boolObj1.toString = function () { return Str2 ; } ;

     Str1 = boolObj1.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.8.1.1" ) ;  

     Str3 = "fromToLocaleString" ;	     
     boolObj1.toLocaleString = function () { return Str3 ; } ;
     ...
     Str2 = "boolTrue"			     
     boolObj2.toString = function () { return Str2 ; } ;

     Str1 = boolObj2.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.8.2.1" ) ;  

     Str3 = "True is the Value" ;	     
     boolObj2.toLocaleString = function () { return Str3 ; } ;
     ...
     Str2 = "String1" ; 		     
     boolObj3.toString = function () { return Str2 ; } ;

     Str1 = boolObj3.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.8.3.1" ) ;  

     Str3 = "String2" ; 		     
     boolObj3.toLocaleString = function () { return Str3 ; } ;
...
@if (!@_fast)
     Str2 = "/(d)/" ;			     
     boolVar1.toString = function () { return Str2 ; } ;

     Str1 = boolVar1.toLocaleString () ;      
     Verify ( "false", Str1, "toLocaleString.8.4.1" ) ;
					     
     Str3 = "/(*)/" ;			     
     boolVar1.toLocaleString = function () { return Str3 ; } ;

     Str1 = boolVar1.toLocaleString () ;
     Verify ( "false", Str1, "toLocaleString.8.4.2" ) ;

     Str2 = "This is ToString" ;	     
     boolVar2.toString = function () { return Str2 ; } ;

     Str1 = boolVar2.toLocaleString () ;      
     Verify ( "true", Str1, "toLocaleString.8.5.1" ) ;	

     Str3 = "This is toLocaleString" ;	     
     boolVar2.toLocaleString = function () { return Str3 ; } ;

     Str1 = boolVar2.toLocaleString () ;
     Verify ( "true", Str1, "toLocaleString.8.5.2" ) ;
@end
