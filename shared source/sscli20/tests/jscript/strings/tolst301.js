...
function tolst301 ()
  {
     ...
     apInitScenario( "Scenario 1: toLocaleString from non-instantiated Enumerator object") ;

     Str1 = Enumerator.toString () ;
     Str2 = Enumerator.toLocaleString () ;   
     Verify ( Str1, Str2, "toLocaleString.1.1" ) ;

    
     apInitScenario( "Scenario 2: toLocaleString from instantiated Enumerator object - explicit");

     eNumObj = new Enumerator () ;
     Str1 = eNumObj.toString () ;
     Str2 = eNumObj.toLocaleString () ;
...
@if (!@_fast)
     Str1 = "" ;			     
     Enumerator.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = Enumerator.toLocaleString () ;
       }
     catch ( err )
       {
     ...
     Str1 = "" ;			     
     eNumObj.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = eNumObj.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
...
@if (!@_fast)
     Str1 = "" ;			     
     Enumerator.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = Enumerator.toLocaleString () ;
       }
     ...
     Str1 = "" ;			     
     eNumObj.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = eNumObj.toLocaleString () ;
       }
...
@if (!@_fast)
     Str1 = "" ;			     
     Enumerator.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = Enumerator.toLocaleString () ;
       }
     ...
     Str1 = "" ;			     
     eNumObj.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = eNumObj.toLocaleString () ;
       }
...
@if (!@_fast)
     Str1 = "" ;			     
     Enumerator.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = Enumerator.toLocaleString () ;
       }
     ...
     Verify ( Enumerator.toString(), Str1, "toLocaleString.6.1" ) ;

     Str1 = "" ;			     
     eNumObj.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = eNumObj.toLocaleString () ;
       }
     ...
     Verify ( eNumObj.toString(), Str1, "toLocaleString.6.2" ) ;
@end
...
@if (!@_fast)
     Str2 = "fromToString" ;		     
     eNumObj.toString = function () { return Str2 ; } ;

     Str1 = eNumObj.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.7.1.1" ) ;  

     Str3 = "fromToLocaleString" ;	     
     eNumObj.toLocaleString = function () { return Str3 ; } ;
