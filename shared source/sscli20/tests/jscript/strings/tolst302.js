...
function tolst302 ()
  {
     ...
     apInitScenario( "Scenario 1: toLocaleString from non-instantiated Error object") ;

     Str1 = Error.toString () ;
     Str2 = Error.toLocaleString () ;	     
     Verify ( Str1, Str2, "toLocaleString.1.1" ) ;

    
     apInitScenario( "Scenario 2: toLocaleString from instantiated Error object - explicit");

     errObj = new Error () ;
     Str1 = errObj.toString () ;
     Str2 = errObj.toLocaleString () ;
...
@if (!@_fast)
     Str1 = "" ;			     
     Error.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = Error.toLocaleString () ;
       }
     catch ( err )
       {
...
@end
     ...
     Str1 = "" ;			     
     errObj.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = errObj.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
...
@if (!@_fast)
     Str1 = "" ;			     
     Error.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = Error.toLocaleString () ;
       }
...
@end
     ...
     Str1 = "" ;			     
     errObj.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = errObj.toLocaleString () ;
       }
...
@if (!@_fast)
     Str1 = "" ;			     
     Error.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = Error.toLocaleString () ;
       }
...
@end
     ...
     Str1 = "" ;			     
     errObj.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = errObj.toLocaleString () ;
       }
...
@if (!@_fast)
     Str1 = "" ;			     
     Error.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = Error.toLocaleString () ;
       }
     ...
     Verify ( Error.toString(), Str1, "toLocaleString.6.1" ) ;
@end

     Str1 = "" ;			     
     errObj.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = errObj.toLocaleString () ;
       }
     ...
     Verify ( errObj.toString(), Str1, "toLocaleString.6.2" ) ;

    
     apInitScenario( "Scenario 7: User-defined toString/toLocaleString");

     Str2 = "fromToString" ;		     
     errObj.toString = function () { return Str2 ; } ;

     Str1 = errObj.toLocaleString () ;	     
     Verify ( Str2, Str1, "toLocaleString.7.1.1" ) ;  

     Str3 = "fromToLocaleString" ;	     
     errObj.toLocaleString = function () { return Str3 ; } ;
