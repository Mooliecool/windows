...
function strFun1 ()
  {
     this.toString = function () { return "toString_of_strFun1" ; } ;
  }

function strFun2 ()
  {
     this.toString = function () { return "toString of strFun2" ; } ;
     this.toLocaleString = function () { return "toLocaleString of strFun2" ; } ;
  }
...
function tolst303 ()
  {
     ...
     var funcObj1 = new Function () ;
     var funcObj2 = new Verify ("a", "a", "c") ;
     var funcObj3 = new Function ("x", "y", "return(x+y)") ;
     var funcObj4 = new strFun1 () ;
     var funcObj5 = new strFun2 () ;

    
     apInitScenario( "Scenario 1: toLocaleString from non-instantiated Function object") ;

     Str1 = Function.toString () ;
     Str2 = Function.toLocaleString () ;     
     Verify ( Str1, Str2, "toLocaleString.1.1" ) ;

    
     apInitScenario( "Scenario 2: toLocaleString from instantiated Function object - explicit");

     Str1 = funcObj1.toString () ;
     Str2 = funcObj1.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.2.1" ) ;

     Str1 = funcObj2.toString () ;
     Str2 = funcObj2.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.2.2" ) ;

     Str1 = funcObj3.toString () ;
     Str2 = funcObj3.toLocaleString () ;
...
@if (!@_fast)
     Str1 = "" ;			     
     Function.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = Function.toLocaleString () ;
       }
     catch ( err )
       {
     ...
     Str1 = "" ;			     
     funcObj1.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = funcObj1.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
...
@end
     ...
     Str1 = "" ;			     
     funcObj2.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = funcObj2.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
...
@if (!@_fast)
     Str1 = "" ;			     
     funcObj3.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = funcObj3.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
...
@if (!@_fast)
     Str1 = "" ;			     
     Function.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = Function.toLocaleString () ;
       }
     ...
     Str1 = "" ;			     
     funcObj1.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = funcObj1.toLocaleString () ;
       }
...
@end
     ...
     Str1 = "" ;			     
     funcObj2.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = funcObj2.toLocaleString () ;
       }
...
@if (!@_fast)
     Str1 = "" ;			     
     funcObj3.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = funcObj3.toLocaleString () ;
       }
...
@if (!@_fast)
     Str1 = "" ;			     
     Function.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = Function.toLocaleString () ;
       }
     ...
     Str1 = "" ;			     
     funcObj1.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = funcObj1.toLocaleString () ;
       }
...
@end
     ...
     Str1 = "" ;			     
     funcObj2.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = funcObj2.toLocaleString () ;
       }
...
@if (!@_fast)
     Str1 = "" ;			     
     funcObj3.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = funcObj3.toLocaleString () ;
       }
...
@if (!@_fast)
     Str1 = "" ;			     
     Function.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = Function.toLocaleString () ;
       }
     ...
     Verify ( Function.toString(), Str1, "toLocaleString.6.1" ) ;

     Str1 = "" ;			     
     funcObj1.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = funcObj1.toLocaleString () ;
       }
     ...
     Verify ( funcObj1.toString(), Str1, "toLocaleString.6.2" ) ;
@end

     Str1 = "" ;			     
     funcObj2.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = funcObj2.toLocaleString () ;
       }
     ...
     Verify ( funcObj2.toString(), Str1, "toLocaleString.6.3" ) ;

     Str1 = "" ;			     
@if (!@_fast)
     funcObj3.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = funcObj3.toLocaleString () ;
       }
     ...
     Verify ( funcObj3.toString(), Str1, "toLocaleString.6.4" ) ;
@end

    
     apInitScenario( "Scenario 7: User-defined toString/toLocaleString within constructor");
					      
     Str1 = funcObj4.toLocaleString () ;      
     Verify ( "toString_of_strFun1", Str1, "toLocaleString.7.1" ) ;  
					      
     Str1 = funcObj5.toLocaleString () ;      
     Verify ( "toLocaleString of strFun2", Str1, "toLocaleString.7.2" ) ;  
     ...
     Str2 = "fromToString" ;		     
@if (!@_fast)
     funcObj1.toString = function () { return Str2 ; } ;

     Str1 = funcObj1.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.8.1.1" ) ;  

     Str3 = "fromToLocaleString" ;	     
     funcObj1.toLocaleString = function () { return Str3 ; } ;
...
@end
     ...
     Str2 = "boolTrue"			     
     funcObj2.toString = function () { return Str2 ; } ;

     Str1 = funcObj2.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.8.2.1" ) ;  

     Str3 = "True is the Value" ;	     
     funcObj2.toLocaleString = function () { return Str3 ; } ;
     ...
     Str2 = "String1" ; 		     
@if (!@_fast)
     funcObj3.toString = function () { return Str2 ; } ;

     Str1 = funcObj3.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.8.3.1" ) ;  

     Str3 = "String2" ; 		     
     funcObj3.toLocaleString = function () { return Str3 ; } ;

     Str1 = funcObj3.toLocaleString () ;
     Verify ( Str3, Str1, "toLocaleString.8.3.2" ) ;

     Str1 = funcObj3.toString () ;	      
     Verify ( Str2, Str1, "toString.8.3.2" ) ;	
@end

     Str2 = "/(d)/" ;			     
     funcObj4.toString = function () { return Str2 ; } ;

     Str1 = funcObj4.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.8.4.1" ) ;  

     Str3 = "/(*)/" ;			     
     funcObj4.toLocaleString = function () { return Str3 ; } ;

     Str1 = funcObj4.toLocaleString () ;
     Verify ( Str3, Str1, "toLocaleString.8.4.2" ) ;

     Str1 = funcObj4.toString () ;	      
     Verify ( Str2, Str1, "toString.8.4.2" ) ;	

     Str2 = "This is ToString" ;	     
     funcObj5.toString = function () { return Str2 ; } ;

     Str1 = funcObj5.toLocaleString () ;     
     Verify ( "toLocaleString of strFun2", Str1, "toLocaleString.8.5.1" ) ;
					     
     Str3 = "This is toLocaleString" ;	     
     funcObj5.toLocaleString = function () { return Str3 ; } ;

     Str1 = funcObj5.toLocaleString () ;
     Verify ( Str3, Str1, "toLocaleString.8.5.2" ) ;

     Str1 = funcObj5.toString () ;	      
     Verify ( Str2, Str1, "toString.8.5.2" ) ;	
