...
function tolst304 ()
  {
     ...
     var objObj1 = new Object () ;	     
     var objObj2 = new Object (true) ;	     
     var objObj3 = new Object (Verify) ;     
     var objObj4 = new Object ("/ddd+/") ;   
     var objObj5 = new Object ("NewObject") ;

    
     apInitScenario( "Scenario 1: toLocaleString from non-instantiated Object object") ;

     Str1 = Object.toString () ;
     Str2 = Object.toLocaleString () ;	     
     Verify ( Str1, Str2, "toLocaleString.1.1" ) ;

    
     apInitScenario( "Scenario 2: toLocaleString from instantiated Object object - explicit");

     Str1 = objObj1.toString () ;
     Str2 = objObj1.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.2.1" ) ;

     Str1 = objObj2.toString () ;
     Str2 = objObj2.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.2.2" ) ;

     Str1 = objObj3.toString () ;
     Str2 = objObj3.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.2.3" ) ;

     Str1 = objObj4.toString () ;
     Str2 = objObj4.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.2.4" ) ;

     Str1 = objObj5.toString () ;
     Str2 = objObj5.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.2.5" ) ;

    
     apInitScenario( "Scenario 3: toLocaleString based on Array.prototype.toLocaleString");

@if (!@_fast)
     Str1 = "" ;			     
     Object.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = Object.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( arrErr, Str1, "toLocaleString.3.1" ) ;
@end

     Str1 = "" ;			     
     objObj1.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj1.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( arrErr, Str1, "toLocaleString.3.2" ) ;

     Str1 = "" ;			     
     objObj2.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj2.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( arrErr, Str1, "toLocaleString.3.3" ) ;

     Str1 = "" ;			     
     objObj3.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj3.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( arrErr, Str1, "toLocaleString.3.4" ) ;

     Str1 = "" ;			     
     objObj4.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj4.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( arrErr, Str1, "toLocaleString.3.5" ) ;

     Str1 = "" ;			     
     objObj5.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj5.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( arrErr, Str1, "toLocaleString.3.6" ) ;

    
     apInitScenario( "Scenario 4: toLocaleString based on Date.prototype.toLocaleString");

@if (!@_fast)
     Str1 = "" ;			     
     Object.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = Object.toLocaleString () ;
       }
     ...
     Verify ( dateErr, Str1, "toLocaleString.4.1" ) ;
@end

     Str1 = "" ;			     
     objObj1.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj1.toLocaleString () ;
       }
     ...
     Verify ( dateErr, Str1, "toLocaleString.4.2" ) ;

     Str1 = "" ;			     
     objObj2.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj2.toLocaleString () ;
       }
     ...
     Verify ( dateErr, Str1, "toLocaleString.4.3" ) ;

     Str1 = "" ;			     
     objObj3.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj3.toLocaleString () ;
       }
     ...
     Verify ( dateErr, Str1, "toLocaleString.4.4" ) ;

     Str1 = "" ;			     
     objObj4.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj4.toLocaleString () ;
       }
     ...
     Verify ( dateErr, Str1, "toLocaleString.4.5" ) ;

     Str1 = "" ;			     
     objObj5.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj5.toLocaleString () ;
       }
     ...
     Verify ( dateErr, Str1, "toLocaleString.4.6" ) ;

    
     apInitScenario( "Scenario 5: toLocaleString based on Number.prototype.toLocaleString");

@if (!@_fast)
     Str1 = "" ;			     
     Object.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = Object.toLocaleString () ;
       }
     ...
     Verify ( numErr, Str1, "toLocaleString.5.1" ) ;
@end

     Str1 = "" ;			     
     objObj1.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj1.toLocaleString () ;
       }
     ...
     Verify ( numErr, Str1, "toLocaleString.5.2" ) ;

     Str1 = "" ;			     
     objObj2.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj2.toLocaleString () ;
       }
     ...
     Verify ( numErr, Str1, "toLocaleString.5.3" ) ;

     Str1 = "" ;			     
     objObj3.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj3.toLocaleString () ;
       }
     ...
     Verify ( numErr, Str1, "toLocaleString.5.4" ) ;

     Str1 = "" ;			     
     objObj4.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj4.toLocaleString () ;
       }
     ...
     Verify ( numErr, Str1, "toLocaleString.5.5" ) ;

     Str1 = "" ;			     
     objObj5.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj5.toLocaleString () ;
       }
     ...
     Verify ( numErr, Str1, "toLocaleString.5.6" ) ;

    
     apInitScenario( "Scenario 6: toLocaleString based on Object.prototype.toLocaleString");
...
@if (!@_fast)
     ...
     Verify ( Object.toString(), Str1, "toLocaleString.6.1" ) ;
@end

     Str1 = "" ;			     
     objObj1.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj1.toLocaleString () ;
       }
     ...
     Verify ( objObj1.toString(), Str1, "toLocaleString.6.2" ) ;

     Str1 = "" ;			     
     objObj2.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj2.toLocaleString () ;
       }
     ...
     Verify ( objObj2.toString(), Str1, "toLocaleString.6.3" ) ;

     Str1 = "" ;			     
     objObj3.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj3.toLocaleString () ;
       }
     ...
     Verify ( objObj3.toString(), Str1, "toLocaleString.6.4" ) ;

     Str1 = "" ;			     
     objObj4.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj4.toLocaleString () ;
       }
     ...
     Verify ( objObj4.toString(), Str1, "toLocaleString.6.5" ) ;

     Str1 = "" ;			     
     objObj5.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = objObj5.toLocaleString () ;
       }
     ...
     Verify ( objObj5.toString(), Str1, "toLocaleString.6.6" ) ;

    
     apInitScenario( "Scenario 7: User-defined toString/toLocaleString");

     Str2 = "fromToString" ;		     
     objObj1.toString = function () { return Str2 ; } ;

     Str1 = objObj1.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.7.1.1" ) ;  

     Str3 = "fromToLocaleString" ;	     
     objObj1.toLocaleString = function () { return Str3 ; } ;

     Str1 = objObj1.toLocaleString () ;
     Verify ( Str3, Str1, "toLocaleString.7.1.2" ) ;

     Str1 = objObj1.toString () ;	     
     Verify ( Str2, Str1, "toString.7.1.2" ) ;	

     Str2 = "boolTrue"			     
     objObj2.toString = function () { return Str2 ; } ;

     Str1 = objObj2.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.7.2.1" ) ;  

     Str3 = "True is the Value" ;	     
     objObj2.toLocaleString = function () { return Str3 ; } ;

     Str1 = objObj2.toLocaleString () ;
     Verify ( Str3, Str1, "toLocaleString.7.2.2" ) ;

     Str1 = objObj2.toString () ;	     
     Verify ( Str2, Str1, "toString.7.2.2" ) ;	

     Str2 = "String1" ; 		     
     objObj3.toString = function () { return Str2 ; } ;

     Str1 = objObj3.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.7.3.1" ) ;  

     Str3 = "String2" ; 		     
     objObj3.toLocaleString = function () { return Str3 ; } ;

     Str1 = objObj3.toLocaleString () ;
     Verify ( Str3, Str1, "toLocaleString.7.3.2" ) ;

     Str1 = objObj3.toString () ;	     
     Verify ( Str2, Str1, "toString.7.3.2" ) ;	

     Str2 = "/(d)/" ;			     
     objObj4.toString = function () { return Str2 ; } ;

     Str1 = objObj4.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.7.4.1" ) ;  

     Str3 = "/(*)/" ;			     
     objObj4.toLocaleString = function () { return Str3 ; } ;

     Str1 = objObj4.toLocaleString () ;
     Verify ( Str3, Str1, "toLocaleString.7.4.2" ) ;

     Str1 = objObj4.toString () ;	     
     Verify ( Str2, Str1, "toString.7.4.2" ) ;	

     Str2 = "This is ToString" ;	     
     objObj5.toString = function () { return Str2 ; } ;

     Str1 = objObj5.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.7.5.1" ) ;  

     Str3 = "This is toLocaleString" ;	     
     objObj5.toLocaleString = function () { return Str3 ; } ;

     Str1 = objObj5.toLocaleString () ;
     Verify ( Str3, Str1, "toLocaleString.7.5.2" ) ;

     Str1 = objObj5.toString () ;	     
     Verify ( Str2, Str1, "toString.7.5.2" ) ;	
