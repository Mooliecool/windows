...
function tolst306 ()
  {
     ...
     var strObj2 = new String ("") ;
     var strObj3 = new String ("To Locale") ;
     var strVar1 = "" ;
     var strVar2 = "A Test String" ;

    
     apInitScenario( "Scenario 1: toLocaleString from non-instantiated String object") ;

     Str1 = String.toString () ;
     Str2 = String.toLocaleString () ;	     
     Verify ( Str1, Str2, "toLocaleString.1.1" ) ;

    
     apInitScenario( "Scenario 2: toLocaleString from instantiated String object - explicit");

     Str1 = strObj1.toString () ;
     Str2 = strObj1.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.2.1" ) ;

     Str1 = strObj2.toString () ;
     Str2 = strObj2.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.2.2" ) ;

     Str1 = strObj3.toString () ;
     Str2 = strObj3.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.2.3" ) ;

    
     apInitScenario( "Scenario 3: toLocaleString from instantiated String object - implicit");

     Str1 = strVar1.toString () ;
     Str2 = strVar1.toLocaleString () ;
     Verify ( Str1, Str2, "toLocaleString.3.1" ) ;

     Str1 = strVar2.toString () ;
     Str2 = strVar2.toLocaleString () ;
     ...
     Str1 = "Not Empty".toString () ;
     Str2 = "Not Empty".toLocaleString () ;
...
@if (!@_fast)
     Str1 = "" ;			     
     String.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = String.toLocaleString () ;
       }
     catch ( err )
       {
...
@end
     ...
     Str1 = "" ;			     
     strObj1.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = strObj1.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
     ...
     Str1 = "" ;			     
     strObj2.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = strObj2.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
     ...
     Str1 = "" ;			     
     strObj3.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = strObj3.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
...
@if (!@_fast)
     Str1 = "" ;			     
     strVar1.toLocaleString = Array.prototype.toLocaleString ;
     try				     
       {				     
	 Str1 = strVar1.toLocaleString () ;  
       }				     
     catch ( err )			     
       {				     
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( strVar1.toString(), Str1, "toLocaleString.4.5" ) ;

     Str1 = "" ;			     
     strVar2.toLocaleString = Array.prototype.toLocaleString ;
     try				     
       {				     
	 Str1 = strVar2.toLocaleString () ;  
       }				     
     catch ( err )			     
       {				     
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( strVar2.toString(), Str1, "toLocaleString.4.6" ) ;
@end
...
@if (!@_fast)
     Str1 = "" ;			     
     String.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = String.toLocaleString () ;
       }
...
@end
     ...
     Str1 = "" ;			     
     strObj1.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = strObj1.toLocaleString () ;
       }
     ...
     Str1 = "" ;			     
     strObj2.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = strObj2.toLocaleString () ;
       }
     ...
     Str1 = "" ;			     
     strObj3.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = strObj3.toLocaleString () ;
       }
...
@if (!@_fast)
     Str1 = "" ;			     
     strVar1.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = strVar1.toLocaleString () ;
       }
     ...
     Verify ( strVar1.toString(), Str1, "toLocaleString.5.5" ) ;

     Str1 = "" ;			     
     strVar2.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = strVar2.toLocaleString () ;
       }
     ...
     Verify ( strVar2.toString(), Str1, "toLocaleString.5.6" ) ;
@end
...
@if (!@_fast)
     Str1 = "" ;			     
     String.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = String.toLocaleString () ;
       }
...
@end
     ...
     Str1 = "" ;			     
     strObj1.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = strObj1.toLocaleString () ;
       }
     ...
     Str1 = "" ;			     
     strObj2.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = strObj2.toLocaleString () ;
       }
     ...
     Str1 = "" ;			     
     strObj3.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = strObj3.toLocaleString () ;
       }
...
@if (!@_fast)
     Str1 = "" ;			     
     strVar1.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = strVar1.toLocaleString () ;
       }
     ...
     Verify ( strVar1.toString(), Str1, "toLocaleString.6.5" ) ;

     Str1 = "" ;			     
     strVar2.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = strVar2.toLocaleString () ;
       }
     ...
     Verify ( strVar2.toString(), Str1, "toLocaleString.6.6" ) ;
@end
...
@if (!@_fast)
     Str1 = "" ;			     
     String.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = String.toLocaleString () ;
       }
     ...
     Verify ( String.toString(), Str1, "toLocaleString.7.1" ) ;
@end

     Str1 = "" ;			     
     strObj1.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = strObj1.toLocaleString () ;
       }
     ...
     Verify ( strObj1.toString(), Str1, "toLocaleString.7.2" ) ;

     Str1 = "" ;			     
     strObj2.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = strObj2.toLocaleString () ;
       }
     ...
     Verify ( strObj2.toString(), Str1, "toLocaleString.7.3" ) ;

     Str1 = "" ;			     
     strObj3.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = strObj3.toLocaleString () ;
       }
     ...
     Verify ( strObj3.toString(), Str1, "toLocaleString.7.4" ) ;

@if (!@_fast)
     Str1 = "" ;			     
     strVar1.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = strVar1.toLocaleString () ;
       }
     ...
     Verify ( strVar1.toString(), Str1, "toLocaleString.7.5" ) ;

     Str1 = "" ;			     
     strVar2.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = strVar2.toLocaleString () ;
       }
     ...
     Verify ( strVar2.toString(), Str1, "toLocaleString.7.6" ) ;
@end
     ...
     Str2 = "fromToString" ;		     
     strObj1.toString = function () { return Str2 ; } ;

     Str1 = strObj1.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.8.1.1" ) ;  

     Str3 = "fromToLocaleString" ;	     
     strObj1.toLocaleString = function () { return Str3 ; } ;
     ...
     Str2 = "strTrue"			    
     strObj2.toString = function () { return Str2 ; } ;

     Str1 = strObj2.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.8.2.1" ) ;  

     Str3 = "True is the Value" ;	     
     strObj2.toLocaleString = function () { return Str3 ; } ;
     ...
     Str2 = "String1" ; 		     
     strObj3.toString = function () { return Str2 ; } ;

     Str1 = strObj3.toLocaleString () ;      
     Verify ( Str2, Str1, "toLocaleString.8.3.1" ) ;  

     Str3 = "String2" ; 		     
     strObj3.toLocaleString = function () { return Str3 ; } ;
...
@if (!@_fast)
     Str2 = "/(d)/" ;			     
     strVar1.toString = function () { return Str2 ; } ;

     Str1 = strVar1.toLocaleString () ;      
     Verify ( "", Str1, "toLocaleString.8.4.1" ) ;  
					     
     Str3 = "/(*)/" ;			     
     strVar1.toLocaleString = function () { return Str3 ; } ;

     Str1 = strVar1.toLocaleString () ;
     Verify ( "", Str1, "toLocaleString.8.4.2" ) ;

     Str2 = "This is ToString" ;	     
     strVar2.toString = function () { return Str2 ; } ;

     Str1 = strVar2.toLocaleString () ;      
     Verify ( "A Test String", Str1, "toLocaleString.8.5.1" ) ;  

     Str3 = "This is toLocaleString" ;	     
     strVar2.toLocaleString = function () { return Str3 ; } ;

     Str1 = strVar2.toLocaleString () ;
     Verify ( "A Test String", Str1, "toLocaleString.8.5.2" ) ;
@end
