...
function tolst307 ()
  {
     ...
     apInitScenario( "Scenario 1: toLocaleString from non-instantiated ScriptEngine object") ;

     Str1 = ScriptEngine.toString () ;
     Str2 = ScriptEngine.toLocaleString () ; 
     Verify ( Str1, Str2, "toLocaleString.1.1" ) ;

    
     apInitScenario( "Scenario 2: toLocaleString based on Array.prototype.toLocaleString");

@if (!@_fast)
     Str1 = "" ;			     
     ScriptEngine.toLocaleString = Array.prototype.toLocaleString ;
     try
       {
	 Str1 = ScriptEngine.toLocaleString () ;
       }
     catch ( err )
       {
	  Str1 = Str1 + err.number.toString(10) ;
       }
     Verify ( arrErr, Str1, "toLocaleString.2.1" ) ;
@end

    
     apInitScenario( "Scenario 3: toLocaleString based on Date.prototype.toLocaleString");

@if (!@_fast)
     Str1 = "" ;			     
     ScriptEngine.toLocaleString = Date.prototype.toLocaleString ;
     try
       {
	 Str1 = ScriptEngine.toLocaleString () ;
       }
     ...
     Verify ( dateErr, Str1, "toLocaleString.3.1" ) ;
@end

    
     apInitScenario( "Scenario 4: toLocaleString based on Number.prototype.toLocaleString");

@if (!@_fast)
     Str1 = "" ;			     
     ScriptEngine.toLocaleString = Number.prototype.toLocaleString ;
     try
       {
	 Str1 = ScriptEngine.toLocaleString () ;
       }
     ...
     Verify ( numErr, Str1, "toLocaleString.4.1" ) ;
@end

    
     apInitScenario( "Scenario 5: toLocaleString based on Object.prototype.toLocaleString");

@if (!@_fast)
     Str1 = "" ;			     
     ScriptEngine.toLocaleString = Object.prototype.toLocaleString ;
     try
       {
	 Str1 = ScriptEngine.toLocaleString () ;
       }
     ...
     Verify ( ScriptEngine.toString(), Str1, "toLocaleString.5.1" ) ;
@end
