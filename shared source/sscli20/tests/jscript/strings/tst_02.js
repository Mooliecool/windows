...
apInitTest("tst_02");
	...
	m_scen = ('Test 3 UPPERCASE tests /ABC/ multiples');
	...
	m_scen = ('Test 7 UPPERCASE tests /(ABC)/ multiples');
	...
	m_scen = ('Test 11 UPPERCASE tests /(AB)(C)/ multiples');
	...
	m_scen = ('Test 15 UPPERCASE tests /((AB)(C))/ multiples');
