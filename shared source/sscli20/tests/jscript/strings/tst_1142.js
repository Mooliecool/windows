...
apInitTest("tst_1142");
	...
	m_scen = ('Test 3 numbers   tests /\\w{3}/i multiples');
	...
	m_scen = ('Test 7 numbers   tests /(\\w{3})/i multiples');
	...
	m_scen = ('Test 9 numbers   /(\\w{2})(\\w{1})/i');
	...
	m_scen = ('Test 11 numbers   tests /(\\w{2})(\\w{1})/i multiples');
	...
	m_scen = ('Test 13 numbers    /((\\w{2})(\\w{1}))/i');
	...
	m_scen = ('Test 15 numbers   tests /((\\w{2})(\\w{1}))/i multiples');
	...
	m_scen = ('Test 17 numbers    /(\\w{1})(\\w{2})/i');
	...
	m_scen = ('Test 19 numbers   tests /(\\w{1})(\\w{2})/i multiples');
