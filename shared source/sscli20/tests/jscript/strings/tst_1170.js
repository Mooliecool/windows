...
apInitTest("tst_1170");
	...
	m_scen = ('Test 2 numbers   /234*/');   // comment
	...
	m_scen = ('Test 4 numbers   tests w/ multiples');
	...
	strTest = '              8234414 32342 234272342'; 
	ArrayEqual(sCat+strTest, objExp, regPat.test(strTest));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, regPat.test(strTest));
	@end
	...
	strTest = '              8234444444444444444444494 32342 234272342'; 
	ArrayEqual(sCat+strTest, objExp, regPat.test(strTest));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, regPat.test(strTest));
	@end
