...
apInitTest("tsta0123");
	...
	ArrayEqual(sCat+strTest, objExp, regPat.test(strTest));
@if (!@_fast)
	regVerify(sCat+strTest, new Array('a', 'bc'), regPat.test(strTest));
@end
	...
	ArrayEqual(sCat+strTest, objExp, regPat.test(strTest));
@if (!@_fast)
	regVerify(sCat+strTest, new Array('abc', 'a', 'bc'), regPat.test(strTest));
@end
	...
	ArrayEqual(sCat+strTest, objExp, regPat.test(strTest));
@if (!@_fast)
	regVerify(sCat+strTest, new Array('a', 'b', 'c'), regPat.test(strTest));
@end
	...
	ArrayEqual(sCat+strTest, objExp, regPat.test(strTest));
@if (!@_fast)
	regVerify(sCat+strTest, new Array('abc', 'a', 'b','c'), regPat.test(strTest));
@end
