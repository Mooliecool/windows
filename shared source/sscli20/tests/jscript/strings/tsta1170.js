...
apInitTest("tsta1170");
	...
	m_scen = ('Test 8 numbers   tests w/ multiples');
	...
	strTest = '              823484 32342 234272342'; 
	ArrayEqual(sCat+strTest, objExp, regPat.test(strTest));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, regPat.test(strTest));
	@end
	...
	strTest = '              8234494 32342 234272342'; 
	ArrayEqual(sCat+strTest, objExp, regPat.test(strTest));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, regPat.test(strTest));
	@end
	...
	strTest = '              8234444444444444444444484 32342 234272342'; 
	ArrayEqual(sCat+strTest, objExp, regPat.test(strTest));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, regPat.test(strTest));
	@end
	...
	m_scen = ('Test 12 numbers   tests w/ multiples');
	...
	strTest = '              82364 323842 234272342'; 
	ArrayEqual(sCat+strTest, objExp, regPat.test(strTest));
	@if (!@_fast)
		regVerify(sCat+strTest, regExp, regPat.test(strTest));
	@end
