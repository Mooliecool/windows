/*=============================================================
**
** Source: accept_neg_client.c
**
** Purpose: Negatively test the accept API. This is a client routine
**          which only helps testing the accept API. This client 
**          routine must be be started after the related server is 
**          started. This test case is for stream socket.
**
** 
