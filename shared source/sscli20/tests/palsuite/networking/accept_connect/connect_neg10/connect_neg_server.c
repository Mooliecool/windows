/*=============================================================
**
** Source: connect_neg_server.c
**
** Purpose: Negatively test the connect API. 
**          This is a server routine which is only used to help
**          running the client. This server routine
**          must be started before the related client is started.
**            
** 
...
int __cdecl main(int argc, char *argv[])
{
    ...
    {
        Trace("\nFailed to call select API to monitor the readable "
            "socket set!\n");
        err = closesocket(socketID);
        if(SOCKET_ERROR == err)
        {    
    ...
    {
        Trace("\nFailed to call accept API to accept an request!\n");
        err = closesocket(socketID);
        if(SOCKET_ERROR == err)
        {    
            Trace("\nFailed to call closesocket API!\n");
