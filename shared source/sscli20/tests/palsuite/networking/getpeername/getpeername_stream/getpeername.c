/*=============================================================
**
** Source: getpeername_stream.c
**
** Purpose: Positively test getpeername function to retrieve the 
**          name of the peer to which a stream socket is connected.
**
** 
...
int __cdecl main(int argc, char *argv[])
{
    ...
    {
        Trace("\nFailed to read server name, this is an empry host name!\n");
        err = WSACleanup();
        if(SOCKET_ERROR == err)
        {
            Trace("\nFailed to call WSACleanup API!\n");
    ...
    */
    ...
    {
        Trace("\nFailed to call getpeername to retrieve the peer host info, "
