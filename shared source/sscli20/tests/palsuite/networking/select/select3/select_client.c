...
**          with some waiting time. This is a client routine 
**          which must be started after the related server is
**          started.
**
** 
...
int __cdecl main(int argc, char *argv[])
{
    ...
    /*do not need to send data to sever side*/
    /*only check whether server side can find the readable socket*/
    err = closesocket(socketID);
    if(SOCKET_ERROR == err)
    {
        Trace("\nFailed to call closesocket API!\n");
