/*=============================================================
**
** Source: select_client.c
**
** Purpose: Positively test the select API for monitoring writable 
**          socket(s) with 0 waiting time. This is a client 
**          routine which must be started after the related client
**          is started. This test case only tests select to monitor
**          a writeable socket set, no data are really sent out. 
**
** 
...
int __cdecl main(int argc, char *argv[])
{
    ...
    /*add socket to writeable socket set*/
    FD_SET(socketID,&writeFds);
    /*mornitor the writeable socket set*/
    socketFds = select(0, NULL, &writeFds, NULL,0);
