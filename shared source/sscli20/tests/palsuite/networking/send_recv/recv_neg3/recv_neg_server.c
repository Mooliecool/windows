...
**            This test case is to test recv with an invalid 
**            socket descriptor.
**
** 
...
int __cdecl main(int argc, char *argv[])
{
    ...
    fd_set readFds;
    int socketFds;
    int InvalidSocketID = -1;/*set an invlid socket descriptor*/
    ...
    /*retrive data with invalid socket ID*/
    err = recv(InvalidSocketID,data,BUFFERSIZE,0);
