/*=============================================================
**
** Source: shutdown_neg_server.c
**
** Purpose: Negative test the shutdown API to disable the read of
**          a stream socket without calling WSAStartup.
...
int __cdecl main(int argc, char *argv[])
{
    ...
    if ( setsockopt(socketID, SOL_SOCKET, SO_REUSEADDR, (char*)&one, 
            sizeof(one)) == -1)
    {
