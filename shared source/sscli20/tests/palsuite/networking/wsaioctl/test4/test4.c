/*=============================================================================
**
** Source: test4.c (WSAIoctl)
**
** Purpose: Test to verify that WSAIoctl returns WSAEINVAL 
**          if it's called with an invalid command.
** 
...
int __cdecl main( int argc, char **argv ) 
{
    ...
    /* Call WSAIoctl with an invalid command */
    ...
    { 
        Trace( "ERROR: "
               ...
               "when it should have returned WSAEINVAL\n",
                GetLastError() );
