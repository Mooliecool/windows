/*=============================================================================
**
** Source: wsarecv14.c (WSASend, WSARecv)
**
** Purpose: This test tries the receive operation with a buffer smaller than
**          the one specified at the send operation. Operations are done with 
**          sent by client thread and the server receive operation should be 
**          divided in 2 parts, one wsarecv of 150 bytes(IO_PENDING) and a second 
