/*=============================================================================
**
** Source: wsarecv6_client.c (WSASend, WSARecv)
**
** Purpose: Start a client server connection. The server call 
**          WSARecv and return an WSA_IO_PENDING error because no 
...
INT __cdecl main(INT argc, CHAR **argv)
{
    ...
    */
    ...
    /* For test purpose, disconnect the socket */
