/*=============================================================================
**
** Source: wsarecv7_client.c (WSASend, WSARecv)
**
** Purpose: Server specifies an event to WSARecv and waits for that
**          event to be triggered when the client sends data.
**
