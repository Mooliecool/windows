/*=============================================================================
**
** Source: wsarecv7_server.c (WSASend, WSARecv)
**
** Purpose: Server specifies an event to WSARecv and wait for that
**          event to be triggered when the client send data
** 
    ...
    */
    ...
    if(err != SOCKET_ERROR)      
    {
        ...
        if(dwNbrOfByteSent!=255)
        {
            Trace("ERROR: "
                "WSARecv(...) "
                "returned %d and number of byte sent is not 255\n",
                err ); 
