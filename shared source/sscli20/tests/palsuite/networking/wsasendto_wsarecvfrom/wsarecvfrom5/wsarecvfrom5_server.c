/*=============================================================================
**
** Source: wsarecvfrom5_server.c (WSASendTo, WSARecvFrom)
**
** Purpose: Test to ensure that WSARecvFrom returns the WSA_IO_PENDING
**          when data is waiting to be received.
** 
