/*=============================================================================
**
** Source: wsasendto2_client.c (WSASendTo, WSARecvFrom)
**
** Purpose: Test to ensure that WSASendTo returns the WSAEACCES
**          when trying to broadcast a message without a proper
**          flag.
** 
