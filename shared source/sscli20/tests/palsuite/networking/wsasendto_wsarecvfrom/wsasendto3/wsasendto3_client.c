/*=============================================================================
**
** Source: wsasendto3_client.c (WSASendTo, WSARecvFrom)
**
** Purpose: Test to ensure that WSASendTo returns the WSAENOTSOCK
**          when a valid socket is not specified.
** 
...
INT __cdecl main(INT argc, CHAR **argv)
{
    ...
    */
    ...
    /* specify an empty buffer (dumb) instead of testSockets[0] */
    err=WSASendTo(
            (SOCKET)myBuffer[0], 
            wsaBuf,
            dwNbrOfBuf,
    ...
    else
    {
        ...
        */
        ...
        if( dwLastError != WSAENOTSOCK)
        {
        
            Trace("ERROR: "
                  "WSASendTo(...) sets LastError to %d expected WSAENOTSOCK\n",
                  dwLastError );
