/*=============================================================================
**
** Source: wsasendto4_client.c (WSASendTo, WSARecvFrom)
**
** Purpose: Test to ensure that WSASento returns the WSAEOPNOTSUPP
**          when we specify a MSG_OOB on a UDP socket.
** 
    ...
    else
    {
        ...
        */
        ...
        if( dwLastError != WSAEOPNOTSUPP)
        {
            ...
            Trace("ERROR: "
                  "WSASendTo(...) sets LastError to %d expected WSAEOPNOTSUPP\n",
                  dwLastError );
