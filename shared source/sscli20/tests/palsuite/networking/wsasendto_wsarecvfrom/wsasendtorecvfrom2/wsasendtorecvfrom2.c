/*=============================================================================
**
** Source: wsasendtorecvfrom2.c (WSASendTo, WSARecv)
**
** Purpose: This test sends and receives a buffer using wsasendto and 
**          wsasendrecv. The operations are TCP, Non-Blocking and Overlapped.
...
INT __cdecl main(INT argc, CHAR **argv)
{
    ...
    /* Variables needed for WSARecvFrom */
    WSABUF        wsaBuf;
    DWORD         dwNbrOfBuf  = 1;
   ...
   /* Initialize the WSABUF structure */
    ...
    /* reset the buffer used by WSARecvFrom */
    memset(myBuffer, 0, 255);
