/*=============================================================================
**
** Source: wsasendtorecvfrom5.c (WSASend, WSARecv)
**
...
**          are done in UDP, Non-blocking and Overlapped. A separate thread is 
    ...
    */
    ...
    {        
            ...
            */
            if(wsaOverlapped.InternalHigh==0)
            {
                Trace("Client Error: Unexpected failure: "
                    ...
                    "wsaOverlapped.Internal = %d at send number %d."
                    "\n",wsaOverlapped.Internal, i);
        ...
        else
        {
            ...
            /* test if it has sent the data.
               dwNbrOfByteSent should have been updated.
            */
            if(dwNbrOfByteSent==0)
            {
        ...
        /* Verify that the number of bytes sent are the number of bytes
