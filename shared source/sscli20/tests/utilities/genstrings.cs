...
public class IntlStrings
  ...
  Console.WriteLine("Random seed :: " + lSeed );                
  ...
  Console.WriteLine( "Locale ID... " + iCurrentLCID ); // We may need this to debug test cases.                
  ...
  Console.WriteLine("Resource loading failed... \r\nFollowing exception occured.... \r\n" + e.ToString()  );
  ...
  ResourceManager manager = new ResourceManager("genstrings", this.GetType().Module.Assembly);  //Load the resource file.
  ...
  if ( strCodePageInfo  == null )
    Console.WriteLine("Resource file is empty");

  Console.WriteLine("Resource loaded for .. " +  strLangName + RESOURCE_STRING_POSTFIX ); //Debug statement, we can remove later.
  }catch (FileNotFoundException e ){
  Console.WriteLine("Specified Resource file doesn't exist... " + e.ToString());
  return false ;
  }catch ( Exception e ){
  Console.WriteLine("Current LCID number.... " + iLCID );
  Console.WriteLine("Exception occured while loading the resources... Current Locale ID:{0} \r\n Following exception occured... \r\n " + e.ToString() );
  return false;
  }    
  return true ;     
  }
  ...
  Console.WriteLine("Unexpected exception while reading the token file... " + e.ToString() );
  } 
  ...
  Console.WriteLine("Unexpected exception occured in RetrieveSectionInfo method... " + e.ToString() );
  }
  return strText;
  }
  ...
  case DOUBLES:
    ...
    Console.WriteLine("Lead  ::" + lngLead.ToString("x"));
    Console.WriteLine("Trail ::" + lngTrail.ToString("x")) ;
    Console.WriteLine( Convert.ToChar(Int32.Parse(lngTrail.ToString("x") + lngTrail.ToString("x"))) );
