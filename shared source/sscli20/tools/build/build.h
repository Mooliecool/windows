...
typedef struct _TARGET_MACHINE_INFO {
    TMIDIR_t SourceSubDirMask;  // TMIDIR_I386
...
#define TMIDIR_I386     ((TMIDIR_t)0x00000001)
#define TMIDIR_AMD64    ((TMIDIR_t)0x00000002)
#define TMIDIR_IA64     ((TMIDIR_t)0x00000004)
#define TMIDIR_DYNAMIC  ((TMIDIR_t)0x00000008)
#define TMIDIR_PARENT   ((TMIDIR_t)0x00000080)  // or'd in with above bits
