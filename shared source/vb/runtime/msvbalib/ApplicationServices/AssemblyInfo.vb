...
Namespace Microsoft.VisualBasic.ApplicationServices
    ...
    Public Class AssemblyInfo
        ...
        Public ReadOnly Property Description() As String
            Get
                If m_Description Is Nothing Then
                    Dim Attribute As AssemblyDescriptionAttribute = _
        ...
        Public ReadOnly Property CompanyName() As String
            Get
                If m_CompanyName Is Nothing Then
                    Dim Attribute As AssemblyCompanyAttribute = _
        ...
        Public ReadOnly Property Title() As String
            Get
                If m_Title Is Nothing Then
                    Dim Attribute As AssemblyTitleAttribute = _
        ...
        Public ReadOnly Property Version() As System.Version
            Get
                ' CONSIDER: Version will not work in low-trust zone. VSWhidbey 192212.
                Return m_Assembly.GetName().Version
            End Get
        End Property

        ' NOTE: The properties below will not work in low-trust zone.
        ' .NET Framework will demand FileIOPermission.PathDiscovery.
        ...
        Private Function GetAttribute(ByVal AttributeType As Type) As Object
            ...
            ' NOTE (MSDN): inherit: This argument is ignored for objects of type Assembly
