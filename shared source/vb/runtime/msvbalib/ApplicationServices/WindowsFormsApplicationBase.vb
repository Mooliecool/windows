     ...
     Public Class WindowsFormsApplicationBase : Inherits ConsoleApplicationBase
        ...
        Public Sub New(ByVal authenticationMode As AuthenticationMode)
            ...
            If authenticationMode = authenticationMode.Windows Then
                Try
                    'Consider: twhitney - sadly, a call to: System.Security.SecurityManager.IsGranted(New SecurityPermission(SecurityPermissionFlag.ControlPrincipal))  
        ...
        Private Sub WriteUrlToMemoryMappedFile(ByVal URL As String)
            ...
            Using SecurityAttributes As New NativeTypes.SECURITY_ATTRIBUTES
                ...
                Try
                    ...
                    'SECURITY REVIEW: twhitney - I'm new to the security description string.  Make sure this is ok.
        ...
        Private Function GetApplicationInstanceID(ByVal Entry As Assembly) As String
            ...
            'machine, are separate.  So you can have session 1 running as TWhitney and have a global system object named "FOO" that won't conflict with
            'any other global system object named "FOO" whether it be in session 2 running as TWHITNEY or session n running as whoever.
