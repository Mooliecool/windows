...
'*
'* Purpose:
'*  Implements Conversion functions for Basic
'*
'*****************************************************************************/
    ...
    Public Module Conversion
        ...
        Public Function ErrorToString(ByVal ErrorNumber As Integer) As String
            If ErrorNumber >= MAX_ERR_NUMBER Then
                Throw New ArgumentException(GetResourceString(ResID.MaxErrNumber))
            End If
        ...
        Public Function Fix(ByVal Number As Object) As Object
            If Number Is Nothing Then
                Throw New ArgumentNullException(GetResourceString(ResID.Argument_InvalidNullValue1, "Number"))
            End If
            ...
            Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_NotNumericType2, "Number", Number.GetType().FullName)), vbErrors.TypeMismatch)
        End Function
...
RangeCheck:
            ...
            Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidValueType2, "Number", VBFriendlyName(Number)))
        End Function
...
RangeCheck:
        ...
        Public Function Str(ByVal Number As Object) As String
            ...
            If ValueInterface Is Nothing Then
                Throw New InvalidCastException(GetResourceString(ResID.ArgumentNotNumeric1, "Number"))
            End If
...
NextOctCharacter:
        ...
        'CONSIDER: (VSW#395733) Should this function be extended and versioned to handle ULONG values?
        ...
        Public Function Val(ByVal Expression As Object) As Double
            ...
            Else
                ...
                Catch ex As System.Threading.ThreadAbortException
                    Throw ex
                Catch
                    Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_InvalidValueType2, "Expression", VBFriendlyName(Expression))), vbErrors.OLENoPropOrMethod)
                End Try
        ...
        'CONSIDER: Move to VB6InputFile where it is used
