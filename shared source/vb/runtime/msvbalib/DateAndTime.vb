...
'*
'* Purpose:
'*  Implements date and time functions for Basic
'*
'*****************************************************************************/
    ...
    Public Module DateAndTime
        ...
        Public Property TimeString() As String
            ...
            Set(ByVal Value As String)
                ...
                Catch ex As System.Threading.ThreadAbortException
                    Throw ex
                Catch
                    Throw VbMakeException(New InvalidCastException(GetResourceString(ResID.InvalidCast_FromStringTo, Left(Value, 32), "Date")), vbErrors.IllegalFuncCall)
                End Try
        ...
        Public ReadOnly Property Timer() As Double
            Get
                ...
                Return (System.DateTime.Now.Ticks Mod System.TimeSpan.TicksPerDay) / _
        ...
        Public Function DateAdd(ByVal Interval As DateInterval, _
            ...
            Select Case Interval
                ...
                Case DateInterval.Day, _
                     DateInterval.DayOfYear, _
        ...
        Public Function DatePart(ByVal Interval As DateInterval, ByVal DateValue As DateTime, _
        ...
        Public Function DateAdd(ByVal Interval As String, _
            ...
            Catch ex As System.Threading.ThreadAbortException
                Throw ex
            Catch
                Throw New InvalidCastException(GetResourceString(ResID.Argument_InvalidDateValue1, "DateValue"))
            End Try
        ...
        Public Function DateDiff(ByVal Interval As String, _
            ...
            Catch ex As System.Threading.ThreadAbortException
                Throw ex
            Catch
                Throw New InvalidCastException(GetResourceString(ResID.Argument_InvalidDateValue1, "Date1"))
            End Try
            Try
                dt2 = CDate(Date2)
            Catch ex As StackOverflowException
            ...
            Catch ex As System.Threading.ThreadAbortException
                Throw ex
            Catch
                Throw New InvalidCastException(GetResourceString(ResID.Argument_InvalidDateValue1, "Date2"))
            End Try
        ...
        Public Function DatePart(ByVal Interval As String, ByVal DateValue As Object, _
            Optional ByVal DayOfWeek As FirstDayOfWeek = FirstDayOfWeek.Sunday, _
        ...
        Public Function DateSerial(ByVal [Year] As Integer, ByVal [Month] As Integer, ByVal [Day] As Integer) As DateTime
            ...
            Catch ex As System.Threading.ThreadAbortException
                Throw ex
            Catch
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "Year")), vbErrors.IllegalFuncCall)
            End Try
            ...
            Catch ex As System.Threading.ThreadAbortException
                Throw ex
            Catch
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "Month")), vbErrors.IllegalFuncCall)
            End Try
            ...
            Catch ex As System.Threading.ThreadAbortException
                Throw ex
            Catch
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "Day")), vbErrors.IllegalFuncCall)
            End Try
        ...
        Public Function Weekday(ByVal DateValue As DateTime, Optional ByVal DayOfWeek As FirstDayOfWeek = FirstDayOfWeek.Sunday) As Integer
            ...
            ElseIf (DayOfWeek < FirstDayOfWeek.Sunday) OrElse (DayOfWeek > FirstDayOfWeek.Saturday) Then
                Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "DayOfWeek"))
            End If
        ...
        Public Function MonthName(ByVal Month As Integer, Optional ByVal Abbreviate As Boolean = False) As String
            ...
            If Month < 1 OrElse Month > 13 Then
                Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "Month"))
            End If
        ...
        Public Function WeekdayName(ByVal Weekday As Integer, Optional ByVal Abbreviate As Boolean = False, Optional ByVal FirstDayOfWeekValue As FirstDayOfWeek = FirstDayOfWeek.System) As String
            'COM+ uses 0-6 while VB uses 1-7.
            'COM+ is not reacting to the FirstDayOfWeekSetting.  If that gets fixed later, can call Clone to get a Read/Write dtfi, then
            'set the FirstDayOfWeek property (offset by 1) and simplify the calculation to "WeekdayName = dtfi.GetDayName(Weekday-1)". 
            Dim dtfi As DateTimeFormatInfo
            Dim Result As String

            If (Weekday < 1) OrElse (Weekday > 7) Then
                Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "Weekday"))
            End If

            If (FirstDayOfWeekValue < 0) OrElse (FirstDayOfWeekValue > 7) Then
                Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "FirstDayOfWeekValue"))
            End If
