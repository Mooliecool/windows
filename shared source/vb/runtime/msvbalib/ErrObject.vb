...
'*
'* Purpose:
'*  This is the object returned when the ERR command is executed in VB.
'*  It's the globally defined error object for VB6 style error handling.
'*****************************************************************************/
...
Namespace Microsoft.VisualBasic
    ...
    Public NotInheritable Class ErrObject
        ...
        Private Function MapExceptionToNumber(ByVal e As Exception) As Integer
            ...
            ElseIf TypeOf e Is System.Runtime.InteropServices.InvalidOleVariantTypeException Then
        ...
        Friend Function MapErrorNumber(ByVal Number As Integer) As Integer
            If Number > 65535 Then
                ...
                ' CONSIDER: cambecc:  A more helpful error would be nice
                Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "Number"))
            End If
