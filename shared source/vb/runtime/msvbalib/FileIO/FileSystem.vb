    ...
    Public Class FileSystem
        ...
        Public Shared ReadOnly Property Drives() As ObjectModel.ReadOnlyCollection(Of System.IO.DriveInfo)
            Get
                ...
                ' CONSIDER: HuyN: Create a read-only collection from an array?
        ...
        Public Shared Function CombinePath(ByVal baseDirectory As String, ByVal relativePath As String) As String
            ...
            If baseDirectory = "" Then
                Throw ExUtils.GetArgumentNullException("baseDirectory", ResID.MyID.General_ArgumentEmptyOrNothing_Name, "baseDirectory")
            End If
        ...
        Public Shared Function FileExists(ByVal file As String) As Boolean
            If Not String.IsNullOrEmpty(file) AndAlso _
                (file.EndsWith(IO.Path.DirectorySeparatorChar, StringComparison.OrdinalIgnoreCase) Or _
        ...
        Public Shared Function FindInFiles(ByVal directory As String, _
        ...
        Public Shared Function FindInFiles(ByVal directory As String, ByVal containsText As String, ByVal ignoreCase As Boolean, _
            ...
            Dim NameMatchFiles As ObjectModel.ReadOnlyCollection(Of String) = FindFilesOrDirectories( _
        ...
        ''' <returns>A ReadOnlyCollection(Of String) containing the matched directories' paths.</returns>
        Public Shared Function GetDirectories(ByVal directory As String, ByVal searchType As SearchOption, _
        ...
        ''' ;GetDirectoryInfo
        ''' <summary>
        '''  Returns the information object about the specifed directory.
        ''' </summary>
        ...
        ''' <param name="wildcards">The wildcards for the file name, for example "*.bmp", "*.txt"</param>
        ''' <returns>A ReadOnlyCollection(Of String) containing the matched files' paths.</returns>
        Public Shared Function GetFiles(ByVal directory As String, ByVal searchType As SearchOption, _
            ByVal ParamArray wildcards() As String) As ObjectModel.ReadOnlyCollection(Of String)
        ...
        Public Shared Function GetParentPath(ByVal path As String) As String
            ...
            If IsRoot(path) Then
                Throw ExUtils.GetArgumentExceptionWithArgName("path", ResID.MyID.IO_GetParentPathIsRoot_Path, path)
            Else
                Return IO.Path.GetDirectoryName(path.TrimEnd( _
        ...
        ''' ;OpenTextFieldParser
        ''' <summary>
        ''' Return a StreamReader for reading the given file using UTF-8 as prefered encoding.
        ''' </summary>
        ...
        ''' ;OpenTextFileReader
        ''' <summary>
        ''' Return a StreamReader for reading the given file using the given encoding as prefered encoding.
        ''' </summary>
        ''' <param name="file">The file to open the StreamReader on.</param>
        ''' <param name="Encoding">The prefered encoding that will be used if the encoding of the file could not be detected.</param>
        ''' <returns>An instance of System.IO.StreamReader opened on the file (with FileShare.Read).</returns>
        ...
        ''' <returns>An instance of StreamWriter opened on the file (with FileShare.Read).</returns>
        Public Shared Function OpenTextFileWriter(ByVal file As String, ByVal append As Boolean, _
        ...
        Public Shared Sub CopyDirectory(ByVal sourceDirectoryName As String, ByVal destinationDirectoryName As String)
            CopyOrMoveDirectory(CopyOrMove.Copy, sourceDirectoryName, destinationDirectoryName, _
        ...
        Public Shared Sub CopyFile(ByVal sourceFileName As String, ByVal destinationFileName As String)
            CopyOrMoveFile(CopyOrMove.Copy, sourceFileName, destinationFileName, _
                False, UIOptionInternal.NoUI, UICancelOption.ThrowException)
        End Sub
        ...
        Public Shared Sub CreateDirectory(ByVal directory As String)
            ...
            If IO.File.Exists(directory) Then ' CONSIDER: HuyN: Pending on VSWhidbey 104049.
                Throw ExUtils.GetIOException(ResID.MyID.IO_FileExists_Path, directory)
            End If
        ...
        Public Shared Sub DeleteDirectory(ByVal directory As String, ByVal onDirectoryNotEmpty As DeleteDirectoryOption)
            DeleteDirectoryInternal(directory, onDirectoryNotEmpty, _
        ...
        Public Shared Sub DeleteDirectory(ByVal directory As String, ByVal showUI As UIOption, ByVal recycle As RecycleOption)
            DeleteDirectoryInternal(directory, DeleteDirectoryOption.DeleteAllContents, _
        ...
        <ResourceExposure(ResourceScope.Machine)> _
        <ResourceConsumption(ResourceScope.Machine)> _
        Public Shared Sub DeleteDirectory(ByVal directory As String, _
        ...
        <ResourceExposure(ResourceScope.Machine)> _
        <ResourceConsumption(ResourceScope.Machine)> _
        Public Shared Sub DeleteFile(ByVal file As String, ByVal showUI As UIOption, ByVal recycle As RecycleOption, _
        ...
        Public Shared Sub MoveDirectory(ByVal sourceDirectoryName As String, ByVal destinationDirectoryName As String)
            CopyOrMoveDirectory(CopyOrMove.Move, sourceDirectoryName, destinationDirectoryName, _
                False, UIOptionInternal.NoUI, UICancelOption.ThrowException)
        End Sub
        ...
        Public Shared Sub MoveFile(ByVal sourceFileName As String, ByVal destinationFileName As String)
            CopyOrMoveFile(CopyOrMove.Move, sourceFileName, destinationFileName, _
                False, UIOptionInternal.NoUI, UICancelOption.ThrowException)
        End Sub
        ...
        Public Shared Sub RenameDirectory(ByVal directory As String, ByVal newName As String)
            ...
            If IsRoot(directory) Then
                Throw ExUtils.GetIOException(ResID.MyID.IO_DirectoryIsRoot_Path, directory)
            End If
            ...
            If newName = "" Then
                Throw ExUtils.GetArgumentNullException( _
                    "newName", ResID.MyID.General_ArgumentEmptyOrNothing_Name, "newName")
            End If
            ...
            Debug.Assert(GetParentPath(FullNewPath).Equals(GetParentPath(directory), _
        ...
        Public Shared Sub RenameFile(ByVal file As String, ByVal newName As String)
            ...
            If Not IO.File.Exists(file) Then
                Throw ExUtils.GetFileNotFoundException(file, ResID.MyID.IO_FileNotFound_Path, file)
            End If
            ...
            Debug.Assert(GetParentPath(FullNewPath).Equals(GetParentPath(file), _
                StringComparison.OrdinalIgnoreCase), "Invalid FullNewPath!!!")
        ...
        Public Shared Sub WriteAllBytes(ByVal file As String, ByVal data() As Byte, ByVal append As Boolean)
            ...
            Try
                ...
                FileStream = New IO.FileStream(file, _
        ...
        ''' <exception cref="IO.StreamWriter">See StreamWriter constructor and Write: For other exceptions.</exception>
        Public Shared Sub WriteAllText(ByVal file As String, ByVal text As String, ByVal append As Boolean, _
        ...
        ''' <remarks>Keep this function since we might change the implementaion / behavior later.</remarks>
        ...
        Friend Shared Sub CheckFilePathTrailingSeparator(ByVal path As String, ByVal paramName As String)
            If path = "" Then ' Check for argument null - VSWhidbey 452078.
                Throw ExUtils.GetArgumentNullException(paramName)
            End If
            If path.EndsWith(IO.Path.DirectorySeparatorChar, StringComparison.Ordinal) Or _
                path.EndsWith(IO.Path.AltDirectorySeparatorChar, StringComparison.Ordinal) Then
                Throw ExUtils.GetArgumentExceptionWithArgName(paramName, ResID.MyID.IO_FilePathException)
            End If
        End Sub
        ...
        Private Shared Sub AddToStringCollection(ByVal StrCollection As ObjectModel.Collection(Of String), ByVal StrArray() As String)
            ' CONSIDER: HuyN: BCL to support adding an array of string directly into a generic string collection?
        ...
        <ResourceExposure(ResourceScope.Machine)> _
        <ResourceConsumption(ResourceScope.Machine)> _
        Private Shared Sub CopyOrMoveDirectory(ByVal operation As CopyOrMove, _
            ByVal sourceDirectoryName As String, ByVal destinationDirectoryName As String, _
            ...
            If Not IO.Directory.Exists(SourceDirectoryFullPath) Then
                Throw ExUtils.GetDirectoryNotFoundException(ResID.MyID.IO_DirectoryNotFound_Path, sourceDirectoryName)
            End If

            ' Throw if source directory is a root directory.
            If IsRoot(SourceDirectoryFullPath) Then
                Throw ExUtils.GetIOException(ResID.MyID.IO_DirectoryIsRoot_Path, sourceDirectoryName)
            End If

            ' Throw if there's a file at TargetDirectoryFullPath.
            If IO.File.Exists(TargetDirectoryFullPath) Then
                Throw ExUtils.GetIOException(ResID.MyID.IO_FileExists_Path, destinationDirectoryName)
            End If
            ...
            If TargetDirectoryFullPath.Equals(SourceDirectoryFullPath, StringComparison.OrdinalIgnoreCase) Then
                Throw ExUtils.GetIOException(ResID.MyID.IO_SourceEqualsTargetDirectory)
            End If
            ...
            If TargetDirectoryFullPath.Length > SourceDirectoryFullPath.Length AndAlso _
                TargetDirectoryFullPath.Substring(0, SourceDirectoryFullPath.Length).Equals( _
                ...
                If TargetDirectoryFullPath.Chars(SourceDirectoryFullPath.Length) = IO.Path.DirectorySeparatorChar Then
                    Throw ExUtils.GetInvalidOperationException(ResID.MyID.IO_CyclicOperation)
                End If
            End If
        ...
        <ResourceExposure(ResourceScope.Machine)> _
        <ResourceConsumption(ResourceScope.Machine)> _
        Private Shared Sub FxCopyOrMoveDirectory(ByVal operation As CopyOrMove, _
            ...
            If operation = CopyOrMove.Move And Not IO.Directory.Exists(targetDirectoryPath) And _
            ...
            If Exceptions.Count > 0 Then
                Dim IOException As New IO.IOException(GetResourceString(ResID.MyID.IO_CopyMoveRecursive))
        ...
        <ResourceExposure(ResourceScope.Machine)> _
        <ResourceConsumption(ResourceScope.Machine)> _
        Private Shared Sub CopyOrMoveDirectoryNode(ByVal Operation As CopyOrMove, _
            ...
            Catch ex As Exception
                If (TypeOf ex Is IO.IOException OrElse TypeOf ex Is UnauthorizedAccessException OrElse _
                    TypeOf ex Is IO.DirectoryNotFoundException OrElse TypeOf ex Is NotSupportedException OrElse _
            ...
            If Not IO.Directory.Exists(SourceDirectoryNode.TargetPath) Then
                Exceptions.Add(SourceDirectoryNode.TargetPath, ExUtils.GetDirectoryNotFoundException(ResID.MyID.IO_DirectoryNotFound_Path, SourceDirectoryNode.TargetPath))
                Exit Sub
            End If
            ...
            For Each SubFilePath As String In IO.Directory.GetFiles(SourceDirectoryNode.Path)
                Try
                    CopyOrMoveFile(Operation, SubFilePath, IO.Path.Combine(SourceDirectoryNode.TargetPath, IO.Path.GetFileName(SubFilePath)), _
                        Overwrite, UIOptionInternal.NoUI, UICancelOption.ThrowException)
                Catch ex As Exception
                    If (TypeOf ex Is IO.IOException OrElse TypeOf ex Is UnauthorizedAccessException OrElse _
        ...
        <ResourceExposure(ResourceScope.Machine)> _
        <ResourceConsumption(ResourceScope.Machine)> _
        Private Shared Sub CopyOrMoveFile(ByVal operation As CopyOrMove, _
            ByVal sourceFileName As String, ByVal destinationFileName As String, _
            ByVal overwrite As Boolean, ByVal showUI As UIOptionInternal, ByVal onUserCancel As UICancelOption _
        )
            Debug.Assert(System.Enum.IsDefined(GetType(CopyOrMove), operation), "Invalid Operation!!!")
            ...
            If Not IO.File.Exists(sourceFileFullPath) Then
                Throw ExUtils.GetFileNotFoundException(sourceFileName, ResID.MyID.IO_FileNotFound_Path, sourceFileName)
            End If

            ' Throw exception if TargetFilePath is an existing directory.
            If IO.Directory.Exists(destinationFileFullPath) Then
                Throw ExUtils.GetIOException(ResID.MyID.IO_DirectoryExists_Path, destinationFileName)
            End If
            ...
            ' Use Framework.
            If operation = CopyOrMove.Copy OrElse _
            ...
            Else ' MoveFile with support for overwrite flag.
                If overwrite Then ' User wants to overwrite destination.
                    ...
                    If Environment.OSVersion.Platform = PlatformID.Win32NT Then ' Platforms supporting MoveFileEx.
                        ...
                        Try
                            Dim succeed As Boolean = NativeMethods.MoveFileEx( _
        ...
        <ResourceExposure(ResourceScope.Machine)> _
        <ResourceConsumption(ResourceScope.Machine)> _
        Private Shared Sub DeleteDirectoryInternal(ByVal directory As String, ByVal onDirectoryNotEmpty As DeleteDirectoryOption, _
        ...
        <ResourceExposure(ResourceScope.Machine)> _
        <ResourceConsumption(ResourceScope.Machine)> _
        Private Shared Sub DeleteFileInternal(ByVal file As String, ByVal showUI As UIOptionInternal, ByVal recycle As RecycleOption, _
            ByVal onUserCancel As UICancelOption)
        ...
        Private Shared Sub DemandDirectoryPermission(ByVal fullDirectoryPath As String, ByVal access As FileIOPermissionAccess)
            Debug.Assert(NormalizePath(fullDirectoryPath).Equals(fullDirectoryPath, StringComparison.OrdinalIgnoreCase), _
            ...
            If Not (fullDirectoryPath.EndsWith(IO.Path.DirectorySeparatorChar, StringComparison.Ordinal) Or _
        ...
        Private Shared Sub EnsurePathNotExist(ByVal Path As String)
            If IO.File.Exists(Path) Then
                Throw ExUtils.GetIOException(ResID.MyID.IO_FileExists_Path, Path)
            End If

            If IO.Directory.Exists(Path) Then
                Throw ExUtils.GetIOException(ResID.MyID.IO_DirectoryExists_Path, Path)
            End If
        End Sub
        ...
        ''' <param name="Text">The text to searh for.</param>
        ...
        Private Shared Function FileContainsText(ByVal FilePath As String, ByVal Text As String, ByVal IgnoreCase As Boolean) _
            ...
            Catch ex As Exception
                ...
                ' We don't expect the following types of exceptions, so we'll rethrow it together with Yukon's exceptions.
                Debug.Assert(Not (TypeOf ex Is ArgumentException Or TypeOf ex Is ArgumentOutOfRangeException Or _
                    TypeOf ex Is ArgumentNullException Or TypeOf ex Is IO.DirectoryNotFoundException Or _
                    TypeOf ex Is IO.FileNotFoundException Or TypeOf ex Is ObjectDisposedException Or _
                    TypeOf ex Is RankException Or TypeOf ex Is ArrayTypeMismatchException Or _
                ...
                If TypeOf ex Is IO.IOException Or _
                    TypeOf ex Is NotSupportedException Or _
                    TypeOf ex Is SecurityException Or _
                    TypeOf ex Is UnauthorizedAccessException Then

                    Return False
                Else
                    ' Rethrow Yukon's exceptions, PathTooLong exception (linked directory) and others.
                    Throw
                End If
            Finally
        ...
        Private Shared Function FindFilesOrDirectories(ByVal FileOrDirectory As FileOrDirectory, ByVal directory As String, _
        ...
        Private Shared Sub FindFilesOrDirectories(ByVal FileOrDirectory As FileOrDirectory, ByVal directory As String, _
            ...
            If wildcards IsNot Nothing Then
                For Each wildcard As String In wildcards
                    ...
                    If wildcard.TrimEnd() = "" Then
                        Throw ExUtils.GetArgumentNullException("wildcards", ResID.MyID.IO_GetFiles_NullPattern)
                    End If
                Next
            End If
        ...
        Private Shared Function GetFullPathFromNewName(ByVal Path As String, _
            ...
            If NewName.IndexOfAny(m_SeparatorChars) >= 0 Then
                Throw ExUtils.GetArgumentExceptionWithArgName(ArgumentName, ResID.MyID.IO_ArgumentIsPath_Name_Path, ArgumentName, NewName)
            End If
        ...
        Private Shared Function GetLongPath(ByVal FullPath As String) As String
            ...
            Try
                ...
                ElseIf IO.Directory.Exists(FullPath) Then
                    Debug.Assert(DInfo.GetDirectories(IO.Path.GetFileName(FullPath)).Length = 1, _
            ...
            Catch ex As Exception
                ...
                If TypeOf ex Is ArgumentException OrElse _
                    TypeOf ex Is ArgumentNullException OrElse _
                    TypeOf ex Is IO.PathTooLongException OrElse _
                    TypeOf ex Is NotSupportedException OrElse _
                    TypeOf ex Is IO.DirectoryNotFoundException OrElse _
                    TypeOf ex Is SecurityException OrElse _
                    TypeOf ex Is UnauthorizedAccessException Then

                    Debug.Assert(Not (TypeOf ex Is ArgumentException OrElse _
                        TypeOf ex Is ArgumentNullException OrElse _
                        TypeOf ex Is IO.PathTooLongException OrElse _
        ...
        Private Shared Function IsOnSameDrive(ByVal Path1 As String, ByVal Path2 As String) As Boolean
            ...
            Return String.Compare(IO.Path.GetPathRoot(Path1), IO.Path.GetPathRoot(Path2), _
        ...
        Private Shared Function IsRoot(ByVal Path As String) As Boolean
            ...
            Return String.Compare(Path, IO.Path.GetPathRoot(Path), _
                    StringComparison.OrdinalIgnoreCase) = 0
        End Function
        ...
        <ResourceExposure(ResourceScope.Machine)> _
        <ResourceConsumption(ResourceScope.Machine)> _
        Private Shared Sub ShellCopyOrMove(ByVal Operation As CopyOrMove, ByVal TargetType As FileOrDirectory, _
        ...
        <ResourceExposure(ResourceScope.Machine)> _
        <ResourceConsumption(ResourceScope.Machine)> _
        Private Shared Sub ShellDelete(ByVal FullPath As String, _
        ...
        ''' </remarks>
        <SecurityCritical()> _
        <HostProtection(Resources:=HostProtectionResource.ExternalProcessMgmt, UI:=True)> _
        <ResourceExposure(ResourceScope.Machine)> _
        <ResourceConsumption(ResourceScope.Machine)> _
        Private Shared Sub ShellFileOperation(ByVal OperationType As SHFileOperationType, ByVal OperationFlags As ShFileOperationFlags, _
            ...
            ' Demand the neccessary permissions: UIPermission.
            ...
            Try
                ...
                NativeMethods.SHChangeNotify(SHChangeEventTypes.SHCNE_DISKEVENTS, _
        ...
        <SecurityCritical()> _
        Private Shared Function GetShellOperationInfo( _
            ByVal OperationType As SHFileOperationType, ByVal OperationFlags As ShFileOperationFlags, _
        ...
        Private Shared Function GetShellOperationInfo( _
            ...
            Catch ex As Exception
                If TypeOf (ex) Is SecurityException OrElse _
                    TypeOf (ex) Is InvalidOperationException OrElse _
...
#End If
        ...
        Private Shared Sub ThrowIfDevicePath(ByVal path As String)
            If path.StartsWith("\\.\", StringComparison.Ordinal) Then
                Throw ExceptionUtils.GetArgumentExceptionWithArgName("path", ResID.MyID.IO_DevicePath)
            End If
        End Sub
        ...
        Private Shared Sub ThrowWinIOError(ByVal errorCode As Integer)
            Select Case errorCode
                ...
                Case Else
                    ...
                    Throw New IO.IOException((New Win32Exception(errorCode)).Message, _
        ...
        Private Shared Sub VerifyDeleteDirectoryOption(ByVal argName As String, ByVal argValue As DeleteDirectoryOption)
            If argValue = FileIO.DeleteDirectoryOption.DeleteAllContents OrElse _
        ...
        Private Shared Sub VerifyRecycleOption(ByVal argName As String, ByVal argValue As RecycleOption)
            If argValue = RecycleOption.DeletePermanently OrElse _
        ...
        Private Shared Sub VerifySearchOption(ByVal argName As String, ByVal argValue As SearchOption)
            If argValue = SearchOption.SearchAllSubDirectories OrElse _
        ...
        Private Shared Sub VerifyUICancelOption(ByVal argName As String, ByVal argValue As UICancelOption)
            If argValue = UICancelOption.DoNothing OrElse _
        ...
        Private Const m_SHELL_OPERATION_FLAGS_BASE As ShFileOperationFlags = _
            ShFileOperationFlags.FOF_NO_CONNECTED_ELEMENTS Or _
        ...
        Private Const m_SHELL_OPERATION_FLAGS_HIDE_UI As ShFileOperationFlags = _
            ShFileOperationFlags.FOF_SILENT Or _
        ...
        Private Const m_MOVEFILEEX_FLAGS As Integer = CInt( _
            MoveFileExFlags.MOVEFILE_COPY_ALLOWED Or _
            MoveFileExFlags.MOVEFILE_REPLACE_EXISTING Or _
        ...
        Private Shared ReadOnly m_SeparatorChars() As Char = { _
        ...
        Private Class TextSearchHelper
            ...
            Friend Function IsTextFound(ByVal ByteBuffer() As Byte, ByVal Count As Integer) As Boolean
                ...
                Array.Copy(sourceArray:=m_PreviousCharBuffer, sourceIndex:=0, _
                ...
                Dim CharCount As Integer = m_Decoder.GetChars( _
                    bytes:=ByteBuffer, byteIndex:=ByteBufferStartIndex, byteCount:=Count, _
                ...
                If CharBuffer.Length > m_SearchText.Length Then
                    ...
                    End If
                    Array.Copy(sourceArray:=CharBuffer, sourceIndex:=(CharBuffer.Length - m_SearchText.Length), _
