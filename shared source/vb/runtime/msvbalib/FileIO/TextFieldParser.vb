    ...
    Public Class TextFieldParser
        ...
        Private Function SlideCursorToStartOfBuffer() As Integer
            ...
            If m_Position > 0 Then
                ...
                Array.Copy(m_Buffer, m_Position, TempArray, 0, ContentLength)

                ' Fill the rest of the buffer
                Dim CharsRead As Integer = m_Reader.Read(TempArray, ContentLength, BufferLength - ContentLength)
            ...
            While Index <= LineEndIndex
                ...
                If QuoteDelimited Then
                    ...
                    If EndHelper.MalformedLine Then
                        ...
                        Throw New MalformedLineException(GetResourceString(ResID.MyID.TextFieldParser_MalFormedDelimitedLine, CurrentLineNumber.ToString(CultureInfo.InvariantCulture)), CurrentLineNumber)
                    End If
                    ...
                    Else
                        ...
                        Do
                            ...
                            If Line.Length + NewLine.Length > m_MaxLineSize Then
                                m_ErrorLine = Line.TrimEnd(Chr(13), Chr(10))
                                m_ErrorLineNumber = CurrentLineNumber
                                Throw New MalformedLineException(GetResourceString(ResID.MyID.TextFieldParser_MaxLineSizeExceeded, CurrentLineNumber.ToString(CultureInfo.InvariantCulture)), CurrentLineNumber)
                            End If
        ...
        Private Sub ValidateFixedWidthLine(ByVal Line As StringInfo, ByVal LineNumber As Long)
            ...
            If Line.LengthInTextElements < m_LineLength Then
                ...
                Throw New MalformedLineException(GetResourceString(ResID.MyID.TextFieldParser_MalFormedFixedWidthLine, LineNumber.ToString(CultureInfo.InvariantCulture)), LineNumber)
            End If
        ...
        Private Sub ValidateFieldWidths()
            ...
            If m_FieldWidths Is Nothing Then
                Throw GetInvalidOperationException(ResID.MyID.TextFieldParser_FieldWidthsNothing)
            End If
        ...
        Private Sub ValidateFieldWidthsOnInput(ByVal Widths() As Integer)
            ...
            For i As Integer = 0 To Bound - 1
                If Widths(i) < 1 Then
                    Throw GetArgumentExceptionWithArgName("FieldWidths", ResID.MyID.TextFieldParser_FieldWidthsMustPositive, "FieldWidths")
                End If
            Next
        End Sub
        ...
        Private Sub ValidateAndEscapeDelimiters()
            If m_Delimiters Is Nothing Then
                Throw GetArgumentExceptionWithArgName("Delimiters", ResID.MyID.TextFieldParser_DelimitersNothing, "Delimiters")
            End If
                ...
                If m_Delimiters(i) IsNot Nothing Then
                    ...
                    If m_HasFieldsEnclosedInQuotes Then
                        If m_Delimiters(i).IndexOf(""""c) > -1 Then
                            Throw GetInvalidOperationException(ResID.MyID.TextFieldParser_IllegalDelimiter)
                        End If
                    End If
                        ...
                        If Token <> "" Then
                            If m_HasFieldsEnclosedInQuotes And m_TextFieldType = FieldType.Delimited Then
                                ...
                                If String.Compare(Token.Trim(), """", StringComparison.Ordinal) = 0 Then
                                    Throw GetInvalidOperationException(ResID.MyID.TextFieldParser_InvalidComment)
                                End If
                            End If
                        End If
                    Next
        ...
        Private Sub ValidateDelimiters(ByVal delimiterArray() As String)
            ...
            For Each delimiter As String In delimiterArray
                If delimiter = "" Then
                    Throw GetArgumentExceptionWithArgName("Delimiters", ResID.MyID.TextFieldParser_DelimiterNothing, "Delimiters")
                End If
                If delimiter.IndexOfAny(New Char() {Chr(13), Chr(10)}) > -1 Then
                    Throw GetArgumentExceptionWithArgName("Delimiters", ResID.MyID.TextFieldParser_EndCharsInDelimiter)
                End If
            Next
        End Sub
        ...
        Private Sub CheckCommentTokensForWhitespace(ByVal tokens() As String)
            ...
            For Each token As String In tokens
                If m_WhiteSpaceRegEx.IsMatch(token) Then
                    Throw GetArgumentExceptionWithArgName("CommentTokens", ResID.MyID.TextFieldParser_WhitespaceInToken)
                End If
            Next
        End Sub
