...
'*
'* Purpose:
'*  Implements file system functions for Basic
'*
'*****************************************************************************/
...
Namespace Microsoft.VisualBasic
    ...
    Public Module FileSystem
        ...
        Public Sub ChDir(ByVal Path As String)
            Debug.Assert(Not System.Reflection.Assembly.GetCallingAssembly() Is Utils.VBRuntimeAssembly, _
                "Methods in Microsoft.VisualBasic should not call FileSystem public method. VSWhidbey 476783.")

            Path = RTrim(Path) 'VB6 accepted things like "\   ", so need to trim the trailing spaces

            If (Path Is Nothing) OrElse (Path.Length = 0) Then
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_PathNullOrEmpty)), vbErrors.BadFileNameOrNumber)
            End If
            ...
            Catch ex As System.IO.FileNotFoundException
                Throw VbMakeException(New FileNotFoundException(GetResourceString(ResID.FileSystem_PathNotFound1, Path)), vbErrors.PathNotFound)
            End Try
        ...
        Public Sub ChDrive(ByVal Drive As Char)
            ...
            If (Drive < chLetterA) OrElse (Drive > chLetterZ) Then
                Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "Drive"))
            End If

            If Not UnsafeValidDrive(Drive) Then
                Throw VbMakeException(New IOException(GetResourceString(ResID.FileSystem_DriveNotFound1, CStr(Drive))), vbErrors.DevUnavailable)
            End If
        ...
        Public Function CurDir(ByVal Drive As Char) As String
            ...
            Drive = System.Char.ToUpper(Drive, CultureInfo.InvariantCulture)
            If (Drive < chLetterA OrElse Drive > chLetterZ) Then
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "Drive")), vbErrors.DevUnavailable)
            End If
        ...
        Public Function Dir(ByVal PathName As String, Optional ByVal Attributes As FileAttribute = FileAttribute.Normal) As String
            'VB's FileAttribute is different than the URT's System.IO.FileAttributes:
            '		            VB	  URT
            'Normal		         0	  128
            'ReadOnly		     1	    1
            'Hidden		         2	    2
        ...
        Public Sub FileCopy(ByVal Source As String, ByVal Destination As String)
            If (Source Is Nothing) OrElse (Source.Length = 0) Then
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_PathNullOrEmpty1, "Source")), vbErrors.BadFileNameOrNumber)
            End If

            If (Destination Is Nothing) OrElse (Destination.Length = 0) Then
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_PathNullOrEmpty1, "Destination")), vbErrors.BadFileNameOrNumber)
            End If

            '  Error if wildcard characters in name
            If PathContainsWildcards(Source) Then
                'CONSIDER: make wildcard exception text
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "Source")), vbErrors.BadFileNameOrNumber)
            End If

            If PathContainsWildcards(Destination) Then
                'CONSIDER: make wildcard exception text
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "Destination")), vbErrors.BadFileNameOrNumber)
            End If
            ...
            If CheckFileOpen(oAssemblyData, Destination, OpenModeTypes.Output) Then
                Throw VbMakeException(New IOException(GetResourceString(ResID.FileSystem_FileAlreadyOpen1, Destination)), vbErrors.FileAlreadyOpen)
            End If

            If CheckFileOpen(oAssemblyData, Source, OpenModeTypes.Input) Then
                Throw VbMakeException(New IOException(GetResourceString(ResID.FileSystem_FileAlreadyOpen1, Source)), vbErrors.FileAlreadyOpen)
            End If
            ...
            Catch ex As IOException
                ...
                'REVIEW: Catch ex As AccessException
                'REVIEW:     Throw VbMakeException(ex, vbErrors.PathFileAccess)
        ...
        Public Function FileDateTime(ByVal PathName As String) As DateTime
            ...
            If PathContainsWildcards(PathName) Then
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "PathName")), vbErrors.BadFileNameOrNumber)
            End If
            ...
            Throw New FileNotFoundException(GetResourceString(ResID.FileSystem_FileNotFound1, PathName))
        End Function
        ...
        Public Sub Kill(ByVal PathName As String)
                ...
                For i = 0 To files.GetUpperBound(0)
                    ...
                    If (file.Attributes And (FileAttribute.Hidden Or FileAttribute.System)) = 0 Then
                        ...
                        If CheckFileOpen(oAssemblyData, FileName, OpenModeTypes.Any) Then
                            Throw VbMakeException(New IOException(GetResourceString(ResID.FileSystem_FileAlreadyOpen1, FileName)), vbErrors.FileAlreadyOpen)
                        End If
            ...
            If DeleteCount = 0 Then
                Throw New IO.FileNotFoundException(GetResourceString(ResID.KILL_NoFilesFound1, PathName))
            End If
        End Sub
        ...
        Public Sub SetAttr(ByVal PathName As String, ByVal Attributes As FileAttribute)
            ...
            If ((Attributes Or &H27S) <> &H27S) Then
                Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "Attributes"))
            End If
        ...
        Private Sub ValidateAccess(ByVal Access As OpenAccess)
            If Access <> OpenAccess.Default AndAlso _
                Access <> OpenAccess.Read AndAlso _
                Access <> OpenAccess.ReadWrite AndAlso _
                Access <> OpenAccess.Write Then
                Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "Access"))
            End If
        End Sub
        ...
        Private Sub ValidateShare(ByVal Share As OpenShare)
            If Share <> OpenShare.Default AndAlso _
                Share <> OpenShare.Shared AndAlso _
                Share <> OpenShare.LockRead AndAlso _
                Share <> OpenShare.LockReadWrite AndAlso _
                Share <> OpenShare.LockWrite Then
                Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "Share"))
            End If
        End Sub
        ...
        Private Sub ValidateMode(ByVal Mode As OpenMode)
            If Mode <> OpenMode.Input AndAlso _
                Mode <> OpenMode.Output AndAlso _
                Mode <> OpenMode.Random AndAlso _
                Mode <> OpenMode.Append AndAlso _
                Mode <> OpenMode.Binary Then
                Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "Mode"))
            End If
        End Sub
        ...
        Private Sub ValidateGetPutRecordNumber(ByVal RecordNumber As Long)
            If RecordNumber < 1 AndAlso RecordNumber <> -1 Then
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "RecordNumber")), vbErrors.BadRecordNum)
            End If
        End Sub
...
#If 0 Then
    'This was intended to catch FileGet uses that should be FileGetObject uses, however, when this code is enabled it
    'causes problems with binding to structures, arrays of structures, and arrays of decimal.
    <ObsoleteAttribute("Use FileGetObject instead, or coerce an object to a more specific type")> _
    Public Sub FileGet(ByVal FileNumber As Object, ByRef Value As Object, Optional ByVal RecordNumber As Object = -1)
    End Sub
#End If
        ...
        <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)> _
        Public Sub FileGet(ByVal FileNumber As Integer, ByRef Value As System.Array, Optional ByVal RecordNumber As Long = -1, _
        ...
        <ObsoleteAttribute("This member has been deprecated. Please use FilePutObject to write Object types, or coerce FileNumber and RecordNumber to Integer for writing non-Object types. http://go.microsoft.com/fwlink/?linkid=14202")> _
        <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)> _
        Public Sub FilePut(ByVal FileNumber As Object, ByVal Value As Object, Optional ByVal RecordNumber As Object = -1)
            Throw New ArgumentException(GetResourceString(ResID.UseFilePutObject))
        End Sub
        ...
        <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)> _
        Public Sub FilePut(ByVal FileNumber As Integer, ByVal Value As System.Array, Optional ByVal RecordNumber As Long = -1, _
            Optional ByVal ArrayIsDynamic As Boolean = False, Optional ByVal StringIsFixedLength As Boolean = False)
        ...
        Public Function InputString(ByVal FileNumber As Integer, ByVal CharCount As Integer) As String
            Try
                ...
                If (CharCount < 0 OrElse CharCount > (&H7FFFFFFFI / 2)) Then
                    Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidValue1, "CharCount"))
                End If
        ...
        Public Sub Rename(ByVal OldPath As String, ByVal NewPath As String)
            ...
            'FILES CAN BE MOVED CROSS VOLUME - SO READ | WRITE (DELETE) permissions are required
            Call (New FileIOPermission( _
                    FileIOPermissionAccess.Read Or FileIOPermissionAccess.Write, OldPath)).Demand()
        ...
        Private Function GetStream(ByVal assem As System.Reflection.Assembly, ByVal FileNumber As Integer) As VB6File
            Return GetStream(assem, FileNumber, CType(OpenModeTypes.Input Or _
                                            OpenModeTypes.Output Or _
                                            OpenModeTypes.Random Or _
                                            OpenModeTypes.Append Or _
        ...
        Private Function OpenModeTypesFromOpenMode(ByVal om As OpenMode) As OpenModeTypes
            ...
            Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidValue), "om")
        End Function
        ...
        Friend Function VB6CheckPathname(ByVal oAssemblyData As AssemblyData, ByVal sPath As String, ByVal mode As OpenMode) As String
            ...
            If (sPath.IndexOf("?"c) <> -1 OrElse sPath.IndexOf("*"c) <> -1) Then
                Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidPathChars1, sPath))
            End If
        ...
        Private Sub vbIOOpenFile(ByVal assem As System.Reflection.Assembly, _
                                    ByVal FileNumber As Integer, _
                                    ByVal FileName As String, _
                                    ByVal Mode As OpenMode, _
                                    ByVal Access As OpenAccess, _
                                    ByVal Share As OpenShare, _
            ...
            Select Case Mode
                ...
                Case OpenMode.Input
                    If (Access <> OpenAccess.Read) AndAlso (Access <> OpenAccess.Default) Then
                        Throw New ArgumentException(GetResourceString(ResID.FileSystem_IllegalInputAccess))
                    End If
                ...
                Case OpenMode.Output
                    If (Access <> OpenAccess.Write) AndAlso (Access <> OpenAccess.Default) Then
                        Throw New ArgumentException(GetResourceString(ResID.FileSystem_IllegalOutputAccess))
                    End If
                ...
                Case OpenMode.Append
                    If (Access <> OpenAccess.Write) AndAlso (Access <> OpenAccess.ReadWrite) AndAlso (Access <> OpenAccess.Default) Then
                        Throw New ArgumentException(GetResourceString(ResID.FileSystem_IllegalAppendAccess))
                    End If
