    ...
    Public NotInheritable Class Conversions
        ...
        Public Shared Function ToBoolean(ByVal Value As String) As Boolean
            ...
            Catch e As FormatException
                Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromStringTo, Left(Value, 32), "Boolean"), e)
            End Try
        ...
        Public Shared Function ToBoolean(ByVal Value As Object) As Boolean
            ...
            Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromTo, VBFriendlyName(Value), "Boolean"))
        End Function
        ...
        Public Shared Function ToByte(ByVal Value As String) As Byte
            ...
            Catch e As FormatException
                Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromStringTo, Left(Value, 32), "Byte"), e)  'UNSIGNED: make these strings constants
            End Try
        ...
        Public Shared Function ToByte(ByVal Value As Object) As Byte
            ...
            If ValueInterface IsNot Nothing Then
                ...
                Select Case ValueTypeCode
                    ...
                    Case TypeCode.Boolean
                        'REVIEW (VSW 395741): Would a try/catch be better here than doing the TypeOf check?  When is the TypeOf check going to be False?
                        If TypeOf Value Is Boolean Then
            ...
            Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromTo, VBFriendlyName(Value), "Byte"))
        ...
        Public Shared Function ToSByte(ByVal Value As String) As SByte
            ...
            Catch e As FormatException
                Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromStringTo, Left(Value, 32), "SByte"), e)
            End Try
...
ThrowInvalidCast:
            Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromTo, VBFriendlyName(Value), "SByte"))
        ...
        Public Shared Function ToShort(ByVal Value As String) As Short
            ...
            Catch e As FormatException
                Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromStringTo, Left(Value, 32), "Short"), e)
            End Try
        ...
        Public Shared Function ToShort(ByVal Value As Object) As Short
            ...
            Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromTo, VBFriendlyName(Value), "Short"))
        ...
        Public Shared Function ToUShort(ByVal Value As String) As UShort
            ...
            Catch e As FormatException
                Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromStringTo, Left(Value, 32), "UShort"), e)
            End Try
        ...
        Public Shared Function ToUShort(ByVal Value As Object) As UShort
            ...
            Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromTo, VBFriendlyName(Value), "UShort"))
        End Function
        ...
        Public Shared Function ToUInteger(ByVal Value As String) As UInteger
            ...
            Catch e As FormatException
                Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromStringTo, Left(Value, 32), "UInteger"), e)
            End Try
        ...
        Public Shared Function ToUInteger(ByVal Value As Object) As UInteger
            ...
            Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromTo, VBFriendlyName(Value), "UInteger"))
        ...
        Public Shared Function ToLong(ByVal Value As String) As Long
            ...
            Catch e As FormatException
                Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromStringTo, Left(Value, 32), "Long"), e)
            End Try
        ...
        Public Shared Function ToLong(ByVal Value As Object) As Long
            ...
            Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromTo, VBFriendlyName(Value), "Long"))
        End Function
        ...
        Public Shared Function ToULong(ByVal Value As String) As ULong
            ...
            Catch e As FormatException
                Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromStringTo, Left(Value, 32), "ULong"), e)
            End Try
        ...
        Public Shared Function ToULong(ByVal Value As Object) As ULong
            ...
            Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromTo, VBFriendlyName(Value), "ULong"))
        End Function
...
MisMatch:
        ...
        Friend Shared Function ToSingle(ByVal Value As String, ByVal NumberFormat As NumberFormatInfo) As Single
            ...
            Try
                ...
                If (Result < System.Single.MinValue OrElse Result > System.Single.MaxValue) AndAlso _
            ...
            Catch e As FormatException
                Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromStringTo, Left(Value, 32), "Single"), e)
            End Try
        ...
        Friend Shared Function ToSingle(ByVal Value As Object, ByVal NumberFormat As NumberFormatInfo) As Single
            ...
            Throw New InvalidCastException(GetResourceString(ResID.InvalidCast_FromTo, VBFriendlyName(Value), "Single"))
        End Function
        ...
        Friend Shared Function ForceValueCopy(ByVal Expression As Object, ByVal TargetType As Type) As Object
            'CONSIDER: any way to get this faster?  It's called every time we pass a valuetype to a byref parameter.
        ...
        Friend Shared Function ChangeType(ByVal Expression As Object, ByVal TargetType As System.Type, ByVal Dynamic as Boolean) As Object
            If TargetType Is Nothing Then
                Throw New ArgumentException(GetResourceString(ResID.Argument_InvalidNullValue1, "TargetType"))
            End If
            ...
            If Expression Is Nothing Then
                If IsValueType(TargetType) Then
                    ...
                    Dim Permission As New System.Security.Permissions.ReflectionPermission( _
            ...
            Debug.Assert(ClassifyPredefinedConversion(TargetType, SourceType) = ConversionClass.None OrElse _
                         ClassifyPredefinedConversion(TargetType, SourceType) = ConversionClass.Narrowing, _
        ...
        <DebuggerHiddenAttribute()> <DebuggerStepThroughAttribute()> _
        Private Shared Function ObjectUserDefinedConversion( _
                ByVal Expression As Object, ByVal TargetType As Type) As Object

            Dim SourceType As Type = Expression.GetType
            If ClassifyPredefinedConversion(TargetType, SourceType) = ConversionClass.None AndAlso _
               ...
               Not (IsIntrinsicType(SourceType) AndAlso IsIntrinsicType(TargetType)) Then
                ...
                If OperatorMethod IsNot Nothing Then
                    Debug.Assert(Result = ConversionClass.Widening OrElse Result = ConversionClass.Narrowing, _
                    ...
                    Dim InvocationResult As Object = _
                        BaseReference.InvokeMethod( _
                            OperatorMethod, _
                            New Object() {Expression}, _
                            Nothing, _
...
#If DEBUG Then
                    If InvocationResult IsNot Nothing Then
                        ...
                        '[JonAneja] Dev10 639545 - disabling the assert below when we're converting to Nullable(Of T)
                        ...
                        If Not _
                           (TargetType.IsGenericType AndAlso _
                            Not TargetType.IsGenericTypeDefinition AndAlso _
                            TargetType.GetGenericTypeDefinition().Equals(GetType(Nullable(Of ))) AndAlso _
                            ...
                            Debug.Assert( _
                                PostConversion = ConversionClass.Narrowing OrElse _
                                PostConversion = ConversionClass.Identity OrElse _
                                PostConversion = ConversionClass.Widening, _
...
#End If
                ...
                ElseIf Result = ConversionClass.Ambiguous Then
                    Throw New InvalidCastException( _
                        GetResourceString( _
                            ResID.AmbiguousCast2, _
                            VBFriendlyName(SourceType), _
