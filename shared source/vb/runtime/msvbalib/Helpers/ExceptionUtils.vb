...
#If 0 Then 'craigv: Nobody is using this anymore (fxcop reported it)
        '''**************************************************************************
        ''' ;GetArgumentOutOfRangeException
        ''' <summary>
        ''' Return a new instance of ArgumentOutOfRangeException with the message from resource file.
        ''' </summary>
        ''' <param name="ArgumentName">The name of the argument (paramemter). Not localized.</param>
        ''' <param name="ArgumentValue">The value (not in the expected range) of the argument.</param>
        ''' <param name="ResourceID">The resource ID. Use CompilerServices.ResID.xxx</param>
        ''' <param name="PlaceHolders">Strings that will replace place holders in the resource string, if any.</param>
        ''' <returns>A new instance of ArgumentOutOfRangeException.</returns>
        Friend Shared Function GetArgumentOutOfRangeException(ByVal ArgumentName As String, ByVal ArgumentValue As Object, _
            ByVal ResourceID As String, ByVal ParamArray PlaceHolders() As String) As ArgumentOutOfRangeException

            Return New ArgumentOutOfRangeException(ArgumentName, ArgumentValue, GetResourceString(ResourceID, PlaceHolders))
        End Function
#End If
...
#If 0 Then 'twhitney: Nobody is using this anymore (fxcop reported it)
        '''**************************************************************************
...
#If 0 Then 'craigv: Nobody is using these anymore. Their use is discouraged
        '''**************************************************************************
        ''' ;GetUnexpectedException
        ''' <summary>
        ''' Return a new instance of System.Exception with message "An unexpected error has occurred.".
        ''' </summary>
        ''' <returns>A new instance of System.Exception.</returns>
        Friend Shared Function GetUnexpectedException() As System.Exception
            Return New System.Exception(GetResourceString(ResID.MyID.UnexpectedError))
        End Function

        '''**************************************************************************
        ''' ;GetUnexpectedException
        ''' <summary>
        ''' Return a new instance of System.Exception with the message from resource file.
        ''' </summary>
        ''' <param name="ResourceID">The resource ID. Use CompilerServices.ResID.xxx</param>
        ''' <param name="PlaceHolders">Strings that will replace place holders in the resource string, if any.</param>
        ''' <returns>A new instance of System.Exception.</returns>
        Friend Shared Function GetUnexpectedException(ByVal ResourceID As String, ByVal ParamArray PlaceHolders() As String) As Exception
            Return New System.Exception(GetResourceString(ResourceID, PlaceHolders))
        End Function
#End If
