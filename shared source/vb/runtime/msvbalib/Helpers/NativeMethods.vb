...
'*
'* Purpose: Here we define methods that call into native code but for which we
'* do NOT suppress unmanaged code permissions.  You need unmanaged code permissions
