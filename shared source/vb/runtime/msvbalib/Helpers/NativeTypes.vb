...
#If 0 Then
        <CriticalResourceReleaseMethod("CloseHandle", ZeroIsInvalid:=True)> _
        <SuppressUnmanagedCodeSecurity()> _
        Friend NotInheritable Class VBSafeHandle
            Inherits SafeHandle
...
#End If
        ...
        ''' </summary>
        ''' <remarks>
        ''' See ndp\fx\src\compmod\microsoft\win32\safenativemethod.cs.
        ...
        ''' of Strings - so that the marshalling layer won't release the memory.  This caused us problems in the shell() functions.  We would call GetStartupInfo()
        ...
        ''' See VSWhidbey 445195, 418202, 434146
        ''' </summary>
        ''' <remarks></remarks>
...
#If 0 Then
        <StructLayout(LayoutKind.Sequential)> Friend Structure _
            NUMPARSE
                Public cDig As Integer
                Public dwInFlags As Integer
                Public dwOutFlags As Integer
