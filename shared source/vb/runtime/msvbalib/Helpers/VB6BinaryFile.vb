...
#Region " BACKWARDS COMPATIBILITY "
    ...
    Friend Class VB6BinaryFile
        ...
        Protected Overrides Function InputStr() As String
            ...
            'twhitney: The deal here is that this functionality was moved from vb6randomfile.vb to fix VSWhidbey 32408.  The problem is, it introduced a breaking change.  The bug this fix
