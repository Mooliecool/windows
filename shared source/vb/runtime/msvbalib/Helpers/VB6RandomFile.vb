...
#Region " BACKWARDS COMPATIBILITY "
    ...
    Friend Class VB6RandomFile
        ...
        Friend Overrides Function EOF() As Boolean
            'COM+INTEG REVIEW: this may not be replacement equivalent
            'If Not m_file.DataAvailable Then   ' consider what is this supposed to be replaced with
        ...
        ' Get
        '======================================
        Friend Overrides Sub GetObject(ByRef Value As Object, Optional ByVal RecordNumber As Long = 0, _
            ...
            Else
                ...
                ElseIf vtype = VT.DBNull Then
                    Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_UnsupportedIOType1, "DBNull")), vbErrors.IllegalFuncCall)
                ElseIf vtype = VT.Empty Then
                    Value = Nothing
                ElseIf vtype = VT.Currency Then
                    Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_UnsupportedIOType1, "Currency")), vbErrors.IllegalFuncCall)
                Else
                    Throw VbMakeException(New ArgumentException(GetResourceString(ResId.Argument_UnsupportedIOType1, typ.FullName)), VbErrors.IllegalFuncCall)
                End If
            End If
        End Sub
        ...
        Friend Overloads Overrides Sub [Get](ByRef Value As System.Array, Optional ByVal RecordNumber As Long = 0, _
        ...
        Friend Overloads Overrides Sub [Get](ByRef Value As String, Optional ByVal RecordNumber As Long = 0, _
        ...
        Friend Overrides Sub PutObject(ByVal Value As Object, Optional ByVal RecordNumber As Long = 0, _
            Optional ByVal ContainedInVariant As Boolean = True)
            ...
            If typ Is Nothing Then
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_UnsupportedIOType1, "Empty")), vbErrors.IllegalFuncCall)
            ...
            If typ Is GetType(System.Reflection.Missing) Then
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_UnsupportedIOType1, "Missing")), vbErrors.IllegalFuncCall)
            ...
            ElseIf ContainedInVariant AndAlso typ.IsValueType Then
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_PutObjectOfValueType1, VBFriendlyName(typ, Value))), vbErrors.IllegalFuncCall)

            Else
                Throw VbMakeException(New ArgumentException(GetResourceString(ResID.Argument_UnsupportedIOType1, VBFriendlyName(typ, Value))), vbErrors.IllegalFuncCall)
            End If
        End Sub
        ...
        Friend Overloads Overrides Sub Put(ByVal Value As System.Array, Optional ByVal RecordNumber As Long = 0, _
            Optional ByVal ArrayIsDynamic As Boolean = False, Optional ByVal StringIsFixedLength As Boolean = False)
        ...
        Protected Sub ValidateWriteable()
            If (m_access <> OpenAccess.ReadWrite) AndAlso (m_access <> OpenAccess.Write) Then
                Throw VbMakeExceptionEx(vbErrors.PathFileAccess, GetResourceString(ResID.FileOpenedNoWrite))
            End If
        End Sub

        Protected Sub ValidateReadable()
            If (m_access <> OpenAccess.ReadWrite) AndAlso (m_access <> OpenAccess.Read) Then
                Throw VbMakeExceptionEx(vbErrors.PathFileAccess, GetResourceString(ResID.FileOpenedNoRead))
            End If
        End Sub
