...
'*
'* Purpose:
'*  Implements information functions for Basic
'*
'*****************************************************************************/
...
Namespace Microsoft.VisualBasic
    ...
    Public Module Information
        ...
        Private ReadOnly QBColorTable() As Integer = {&H0I, &H800000I, &H8000I, &H808000I, _
                                                        &H80I, &H800080I, &H8080I, _
                                                        &HC0C0C0I, &H808080I, &HFF0000I, _
                                                        &HFF00I, &HFFFF00I, &HFFI, _
...
CleanupTypeName:
        ...
        Friend Function VarTypeFromComType(ByVal typ As System.Type) As VariantType
            ...
            If (typ Is GetType(System.Reflection.Missing)) OrElse _
               (typ Is GetType(System.Exception)) OrElse _
