'*-----------------------------------------------------------------------
'* <copyright file="Interaction.vb" company="Microsoft">
'*     Copyright (c) Microsoft Corporation.  All rights reserved.
'* </copyright>
'*
'* Implements functions that interact with the OS, user, and registry:
'*      AppActivate
'*      Shell
'*      InputBox, MsgBox
'*      Command, Command$
...
'*      Beep
'*      CallByName
'*      Choose, Switch, IFF, Partition  
'*      SaveSetting, DeleteSetting, GetAllSettings, GetSetting
'*-----------------------------------------------------------------------
...
Namespace Microsoft.VisualBasic
    ...
    Public Module Interaction
        ...
        Public Sub AppActivate(ByVal Title As String)
            ...
            Const MAX_TITLE_LENGTH As Integer = 511 'CONSIDER: twhitney - this is bizarre.  Eventually might want to do the trick in c:\vs\ndp\Designer\CompMod\System\ComponentModel\Design\MultilineStringEditor.cs (search for getWindowText)
        ...
        Public Function InputBox(ByVal Prompt As String, Optional ByVal Title As String = "", Optional ByVal DefaultResponse As String = "", Optional ByVal XPos As Integer = -1, Optional ByVal YPos As Integer = -1) As String
            ...
            'CONSIDER cambecc:  use the threadpool for performance?
        ...
        Private Sub InsertSpaces(ByRef Buffer As String, ByVal Spaces As Long)
            Do While Spaces > 0 'consider: twhitney - use stringbuilder
                Buffer = Buffer & " "
                Spaces = Spaces - 1
            Loop
        End Sub
        ...
        Private Sub InsertNumber(ByRef Buffer As String, ByVal Num As Long, ByVal Spaces As Long)
            Dim Buffer1 As String 'consider: twhitney - use stringbuilder
        ...
        Public Function GetSetting(ByVal AppName As String, ByVal Section As String, ByVal Key As String, Optional ByVal [Default] As String = "") As String
            ...
            If o Is Nothing Then
                Return Nothing
            ElseIf TypeOf o Is String Then 'twhitney - odd that this is required to be a string when it isn't in GetAllSettings() above...
