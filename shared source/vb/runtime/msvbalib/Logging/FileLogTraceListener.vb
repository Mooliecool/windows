    ...
    Public Class FileLogTraceListener
        ...
        Public Property BaseFileName() As String
            ...
            Set(ByVal value As String)
                If value = "" Then
                    Throw GetArgumentNullException("value", ResID.MyID.ApplicationLogBaseNameNull)
                End If
        ...
        Public Property MaxFileSize() As Long
            ...
            Set(ByVal value As Long)
                ...
                If value < MIN_FILE_SIZE Then
                    Throw GetArgumentExceptionWithArgName("value", ResID.MyID.ApplicationLogNumberTooSmall, "MaxFileSize")
                End If
                m_MaxFileSize = value
        ...
        Public Property ReserveDiskSpace() As Long
            ...
            Set(ByVal value As Long)
                DemandWritePermission()
                If value < 0 Then
                    Throw GetArgumentExceptionWithArgName("value", ResID.MyID.ApplicationLog_NegativeNumber, "ReserveDiskSpace")
                End If
        ...
        Private Function GetStream() As ReferencedStream
            ...
            Throw GetInvalidOperationException(ResID.MyID.ApplicationLog_ExhaustedPossibleStreamNames, BaseStreamName)
        End Function
        ...
        Private Function DayChanged() As Boolean
            Return m_Day.AddDays(m_Days) <> Now.Date
        End Function
        ...
        Private Sub HandleDateChange()
            If Me.LogFileCreationSchedule = LogFileCreationScheduleOption.Daily Then
                If DayChanged() Then
                    ...
                    ' m_Days is used to properly handle race condition
                    ' integer assignment is atomic
                    m_Days = Now.Date.Subtract(m_Day).Days
        ...
        Private Function ResourcesAvailable(ByVal newEntrySize As Long) As Boolean
            ...
            If ListenerStream.FileSize + newEntrySize > Me.MaxFileSize Then
                If Me.DiskSpaceExhaustedBehavior = DiskSpaceExhaustedOption.ThrowException Then
                    Throw New InvalidOperationException(GetResourceString(ResID.MyID.ApplicationLog_FileExceedsMaximumSize))
                End If
                Return False
            End If
            ...
            If Me.GetFreeDiskSpace() - newEntrySize < Me.ReserveDiskSpace Then
                If Me.DiskSpaceExhaustedBehavior = DiskSpaceExhaustedOption.ThrowException Then
                    Throw New InvalidOperationException(GetResourceString(ResID.MyID.ApplicationLog_ReservedSpaceEncroached))
                End If
                Return False
            End If
        ...
        Private Function GetFreeDiskSpace() As Long
            ...
            Throw GetWin32Exception(ResID.MyID.ApplicationLog_FreeSpaceError)
        End Function
        ...
        '''**************************************************************************
        ''' ;ValidateLogFileLocationEnumValue
        ''' <summary>
        ...
        '''**************************************************************************
        ''' ;ValidateDiskSpaceExhaustedOptionEnumValue
        ''' <summary>
        ...
        '''**************************************************************************
        ''' ;ValidateLogFileCreationScheduleOptionEnumValue
        ''' <summary>
