...
Namespace Microsoft.VisualBasic.MyServices
    ...
    Public Class FileSystemProxy
        ...
        Public Function GetFiles(ByVal directory As String, ByVal searchType As SearchOption, _
        ...
        Public Function GetDirectories(ByVal directory As String, ByVal searchType As SearchOption, _
            ByVal ParamArray wildcards() As String) As ReadOnlyCollection(Of String)

            Return Microsoft.VisualBasic.FileIO.FileSystem.GetDirectories(directory, searchType, wildcards)
        End Function

        Public Function FindInFiles(ByVal directory As String, _
        ...
        Public Function FindInFiles(ByVal directory As String, ByVal containsText As String, ByVal ignoreCase As Boolean, _
        ...
        Public Sub WriteAllText(ByVal file As String, ByVal text As String, ByVal append As Boolean, _
        ...
        <ResourceExposure(ResourceScope.Machine)> _
        <ResourceConsumption(ResourceScope.Machine)> _
        Public Sub DeleteFile(ByVal file As String, ByVal showUI As UIOption, ByVal recycle As RecycleOption, _
        ...
        <ResourceExposure(ResourceScope.Machine)> _
        <ResourceConsumption(ResourceScope.Machine)> _
        Public Sub DeleteDirectory(ByVal directory As String, _
        ...
        Public Function OpenTextFileWriter(ByVal file As String, ByVal append As Boolean, _
