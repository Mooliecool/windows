//---------------------------------------------------------------------------
//
// <copyright file="TableParaClient.cs" company="Microsoft">
...
namespace MS.Internal.PtsHost
{
    ...
    internal sealed class TableParaClient : BaseParaClient
    {
        ...
        /// <SecurityNote>
        /// Critical, because:
        ///     a) calls Critical function QueryRowDetails.
        ///     b) calls Critical function PTS.FsTransformRectangle
        /// Safe - as this can't be used to pass arbitrary parameters to the Critical
        ///        function.  All In parameters passed in are generated by safe methods.
        /// </SecurityNote>
        ...
        /// <SecurityNote>
        /// Critical - as this calls Critical function ValidateRowVisualComplex and
        ...
        /// --------------------
        /// <SecurityNote>
        /// Critical - as this calls Critical functions QueryRowDetails.
        /// Safe - The arrayTableRowDesc parameter passed to other methods is generated securely in this function.
        /// </SecurityNote>
        [SecurityCritical, SecurityTreatAsSafe]
        ...
        /// <SecurityNote>
        /// Critical - as this calls Critical function QueryRowDetails.
        /// Safe - as this can't be used to pass arbitrary parameters to the Critical
        ///        function.  All In parameters passed in are generated by safe methods.
        /// </SecurityNote>
        [SecurityCritical, SecurityTreatAsSafe]
        ...
        /// </returns>
        /// <SecurityNote>
        /// Critical - as this uses PTS.FSTABLEROWDESCRIPTION, a structure with
        ///         overlapping fields (to match a union in PTS)
        /// Safe - returned information is safe to disclose.
        /// </SecurityNote>
        [SecurityCritical, SecurityTreatAsSafe]
        ...
        /// <SecurityNote>
        /// Critical - as this calls Critical function PTS.FsQueryTableObjRowDetails
        /// </SecurityNote>
        [SecurityCritical]
        ...
        /// <SecurityNote>
        /// Critical - as this calls Critical functions PTS.FsQueryTableObjDetails,
        ///            PTS.FsQueryTableObjTableProperDetails and PTS.FsQueryTableObjRowList.
        /// Safe - returned information is safe to disclose.
        /// </SecurityNote>
        [SecurityCritical, SecurityTreatAsSafe]
        ...
        /// <SecurityNote>
        /// Critical - as this calls Critical functions PTS.FsQueryTableObjRowDetails
        ///            and PTS.FsQueryTableObjCellList.
        /// </SecurityNote>
        [SecurityCritical]
        ...
        /// <SecurityNote>
        /// Critical - as this calls Critical function QueryRowDetails and passes
        ///            pfstablerow directly.
        /// </SecurityNote>
        [SecurityCritical]
        ...
        /// </remarks>
        /// <SecurityNote>
        /// Critical - as this calls Critical function QueryRowDetails and passes it
        ///            pfstablerow directly.
        /// </SecurityNote>
        [SecurityCritical]
        ...
        /// </remarks>
        /// <SecurityNote>
        /// Critical - as this uses unmanaged data structures with a union
        /// </SecurityNote>
        [SecurityCritical]
            ...
            for (int i = 0; i < _calculatedColumns.Length; ++i)
            {
                ...
                else
                {
                    ...
                    _calculatedColumns[i].DurWidth =
                        ...
                        // subtract proportionally to column.DurMaxWidth, to avoid divide-by-zero (Dev11 192577)
                        ?  fAbsWidthsHaveFlex
