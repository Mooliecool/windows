//---------------------------------------------------------------------------
//
// <copyright file="TextLineResult.cs" company="Microsoft">
...
namespace MS.Internal.Text
{
    ...
    internal sealed class TextLineResult : LineResult
    {
        ...
        internal TextLineResult(System.Windows.Controls.TextBlock owner, int dcp, int cch, Rect layoutBox, double baseline, int index)
        {
            _owner = owner;
            _dcp = dcp;
            _cch = cch;
