//------------------------------------------------------------------------------
// <copyright file="WebBrowser.cs" company="Microsoft">
...
//  02/22/08    [....]       Expose the WebBrowser control
...
namespace System.Windows.Controls
{
    ...
    public sealed class WebBrowser : ActiveXHost
    {
        ...
        private static void TurnOnFeatureControlKeys()
        {
            ...
            //                                      resistry. We have it set for PresentationHost (Dev10.586366).
            ...
            // We are trying to change this unfortunate trend. Dev10.749259.
        }
        ...
        private void DoNavigate(Uri source, ref object targetFrameName, ref object postData, ref object headers, bool ignoreEscaping = false)
        {
            ...
            // TFS Dev10 451846 - Calling Navigate and NavigateToStream subsequently causes internal state
            ...
            // Dev10 Work Item 674571 - Fix for inability to navigate to a URI containing invalid UTF-8 sequences
            ...
            // to get back the URI string to feed in to the WebOC in its original form. [....] has a similar
