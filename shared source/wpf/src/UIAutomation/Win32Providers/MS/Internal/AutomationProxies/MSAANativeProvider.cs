//---------------------------------------------------------------------------
//
// <copyright file="MsaaNativeProvider.cs" company="Microsoft">
...
//            }
        ...
        IRawElementProviderFragment IRawElementProviderFragmentRoot.GetFocus()
        {
            ...
            // Pre BRENDANM: I'm not sure how reliable get_accFocus is for 'progressive drilling' -
            // I think it might only work on the container parent of the item that has focus
            ...
            //
            // one lsat resort, however, may be for UIA or this to track focus events, since those
