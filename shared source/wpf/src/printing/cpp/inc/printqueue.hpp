...
namespace Printing
{
    ...
    public PrintSystemObject
    {
        ...
        /// <SecurityNote>
        ///    Critical - Sets critical printTicketManager field
        ///    Safe     - Set to safe value null
        /// <SecurityNote>
        ...
        //
        ///<SecurityNote>
        /// Critical     - Sets InPartialTrust property to initialize the SecurityCritical member.
        /// TreatAsSafe  - It sets InPartialTrust to false, which prevents making any elevations in PT
        ///</SecurityNote>
        [SecuritySafeCritical]
        PrintQueue(
            array<String^>^             propertyFilter
        ...
        ///<SecurityNote>
        /// Critical    - Returns critical PrintThunkHandlerBase to interact with printer device
        ///</SecurityNote>
        [SecurityCritical]
        ...
        ///<SecurityNote>
        /// Critical    - Calls native methods to determine if XPS spooling API's are available
        ...
        ///<SecurityNote>
        /// Critical    - Uses type from non-APTCA Reachframework.
        ...
        /// </param>
        ///<SecurityNote>
        /// Critical    - When running in PT, we need to evelate to determine the
        ///               supported capabilities
        /// PublicOK    - Reading the value is considered safe in PT.
        ///</SecurityNote>
        [SecurityCritical]
        PrintCapabilities^
        ...
        /// </summary>
        ///<SecurityNote>
        /// Critical    - Uses type from non-APTCA Reachframework (PrintCapabilities).
        /// PublicOK    - Types use is safe.
        ///</SecurityNote>
        [SecuritySafeCritical]
        PrintCapabilities^
        GetPrintCapabilities(
        ...
        /// </param>
        ///<SecurityNote>
        /// Critical    - Uses type from non-APTCA Reachframework (PrintTicket, PrintTicketManager).
        /// PublicOK    - Types use is safe.
        ///</SecurityNote>
        [SecuritySafeCritical]
        MemoryStream^
        ...
        /// </summary>
        ///<SecurityNote>
        /// Critical    - Uses type from non-APTCA Reachframework (PrintTicketManager).
        /// PublicOK    - Types use is safe.
        ///</SecurityNote>
        [SecuritySafeCritical]
        MemoryStream^
        ...
        ///<SecurityNote>
        /// Critical    - Uses types from non-APTCA reachframework.dll (ValidationResult, PrintTicket)
        /// PublicOK    - Types use is safe.
        ///</SecurityNote>
        [SecuritySafeCritical]
        ValidationResult
        ...
        /// <returns>Returns a ValidationResult.</returns>
        ///<SecurityNote>
        /// Critical     - Uses types from non-APTCA reachframework.dll (ValidationResult, PrintTicket, PrintTicketScope)
        /// PublicOK     - Types use is safe.
        ///</SecurityNote>
        [SecuritySafeCritical]
        ValidationResult
        ...
        {
            ///<SecurityNote>
            /// Critical    - Get needs to elevate to be able to convert the DEVMODE to a PrintTicket
            /// PublicOK    - Enabled only if the printQueue was created in PT, code path controlled by the Avalon Print Dialog
            ///</SecurityNote>
            [SecurityCritical]
            PrintTicket^ get();
        ...
        /// </value>
        ///<SecurityNote>
        /// Critical    - Calls GetIsXpsDevice which asserts to determine if the device is Xps enabled
        /// PublicOK    - Not critical in PT. Besides, a PT caller can never get a hold of a printQueue.
        ///</SecurityNote>
        property
        Boolean
        IsXpsDevice
        ...
        {
            ///<SecurityNote>
            /// Critical    - References type from non-APTCA reachframework.dll (PrintTicketManager)
            /// TreatAsSafe - Use of type is safe
            ///</SecurityNote>
            [SecuritySafeCritical]
            Int32 get();
        }
        ...
        {
            ///<SecurityNote>
            /// Critical    - When this property is set to True,
            ///               a PremiumPrintStream created for this printQueue asserts
            ///               DefaultPrinting to enable printing in Partial Trust. Access
            ///                  to this demands Default Printing Permissions
            ///</SecurityNote>
            [SecurityCritical]
            ...
            /// Critical    - When this property is set to True,
            ///               a PremiumPrintStream created for this printQueue asserts
            ///               DefaultPrinting to enable printing in Partial Trust
            /// PublicOK    - Reading the value is considered safe.
            ///</SecurityNote>
            [SecurityCritical]
            Boolean get();
        }
        ...
        ///<SecurityNote>
        /// Critical    - Uses type from non-APTCA Reachframework (PrintCommitAttributesException).
        /// PublicOK    - Types use is safe.
        ///</SecurityNote>
        [SecuritySafeCritical]
        virtual void
        ...
        ///<SecurityNote>
        /// Critical    - Calls Dispose on critical SafeHandles
        ///</SecurityNote>
        [SecurityCritical]
        virtual
        void
        ...
        {
            ///<SecurityNote>
            /// Critical    - Uses type from non-APTCA Reachframework (PrintTicket).
            /// PublicOK    - Types use is safe.
            ///</SecurityNote>
            [SecuritySafeCritical]
        ...
        ///<SecurityNote>
        /// Critical    -  Calls ShowDialog which is critical
        /// PublicOK   - A PrintQueue object cannot be created in Partial Trust, as the caller needs DefaultPrinting
        ///               This method is meant to be called in Partial Trust and it invokes Avalon UI dialog which will
        ///               create the PrintQueue object for it. The InPartialTrust property is set on the PrintQueue object
        ///               by this method to indicate that a PremiumPrintStream class created for it
        ///               can elevate permissions to enable printing in PT
        /// Remark......- Indirectly sets the InPartialTrust on a PrintQueue created by invoking the Avalon UI
        ///               When the property is set, a PremiumPrintStream class created for a printQueue asserts
        ///               DefaultPrinting to enable printing in Partial Trust
        ///</SecurityNote>
        [SecurityCritical]
        static
        ...
        ///<SecurityNote>
        /// Critical    - Asserts for DefaultPrinting to enable making the Xps DrvDocumentEvent driver notifications
        ///</SecurityNote>
        [SecurityCritical]
        Int32
        PrintQueue::
        ...
        ///<SecurityNote>
        /// Critical    - References type in non-APTCA reachframework.dll (PrintTicket)
        ///             - See primaryAttributeTypes static initializer
        ...
        ///<SecurityNote>
        /// Critical     - Uses non-APTCA reachframework.dll type (PrintTicket) to set the user print ticket and default print ticket to null
        /// TreatAsSafe  - Types are safe
        ///</SecurityNote>
        [SecuritySafeCritical]
        void
        ...
        ///<SecurityNote>
        /// Critical    - Asserts for DefaultPrinting to determine if the device is Xps enabled
        ///</SecurityNote>
        [SecurityCritical]
        Boolean
        GetIsXpsDevice(
        ...
        ///<SecurityNote>
        /// Critical    - Calls XpsDocumentEvent which is critical due the input buffer
        /// TreatAsSafe - The buffer passed to XpsDocumentEvent is being created in this method
        ///               based on XpsSerializationXpsDriverDocEventArgs which cannot be altered by PT caller.
        ///</SecurityNote>
        [SecuritySafeCritical]
        void
        PrintQueue::
        ...
        /// TreatAsSafe - The buffer passed to XpsDocumentEvent is being created in this method
        ///               based on XpsSerializationXpsDriverDocEventArgs which cannot be altered by PT caller.
        ///               The event can carry on a PrintTicket which is considered safe as
        ///               the XML data it contains is validated to be well formed. A PT caller could
        ///               change this data, however that is subject to PrintTicket parser validation.
        ///               Any custom data can only be generated by the print driver and not by the PT caller
        ///               and that is condsidered safe as it's being passed back to the same print driver.
        ///</SecurityNote>
        [SecuritySafeCritical]
        void
        ...
        ///<SecurityNote>
        /// Critical    - Asserts DefaultPrinting to be able to call IsXpsDocumentEventSupported on the printerThunkHandler
        /// TreatAsSafe - This is considered safe as the assert is done only if the PrintQueue
        ///               was created by the Avalon PrintDialog.
        ///</SecurityNote>
        [SecuritySafeCritical]
        Boolean
        ...
        ///<SecurityNote>
        /// Critical    - Calls GatherDataFromPrintDialog and returns print ticket and print queue.
        ///</SecurityNote>
        [SecurityCritical]
        static
        bool
        ...
        ///<SecurityNote>
        /// Critical  1 )Asserts for DefaultPrinting to get print ticket and from
        ///              print dialog.   Both are out paameters.
        ///           2 )Sets the InPartialTrust on a PrintQueue created by invoking the Avalon UI
        ///               When the property is set, a PremiumPrintStream class created for a printQueue asserts
        ///               DefaultPrinting to enable printing in Partial Trust
        ///</SecurityNote>
        [SecurityCritical]
        ...
        ///<SecurityNote>
        /// Critical    - Asserts for DefaultPrinting to get print capablities
        ///</SecurityNote>
        [SecurityCritical]
        static
        ...
        ///<SecurityNote>
        /// Critical    - When this value is set to True,
        ///               a PremiumPrintStream created for this printQueue asserts
        ///               DefaultPrinting to enable printing in Partial Trust
        ///</SecurityNote>
        [SecurityCritical]
