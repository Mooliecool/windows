...
*
*   2/20/2006 bnguyen
*       Rewrote ConvertToGpPath as CapacityStreamGeometryContext implementation to
*       improve performance when geometry is a StreamGeometry.
*
*   7/14/2004 t-bnguy
*       Also removed AddPolyCount; it was recognized that the polycount array
*       would be of size number of polygons at most.
*
*   7/13/2004 t-bnguy
*       Fixed mistaken assumption that some pointers were managed (and thus not
*       freed and causing memory leaks).
*
*   7/1/2004 t-bnguy
*       Ported from unmanaged code.
*
*/
...
private:
    ...
    /// <SecurityNote>
    /// Critical    : References method in non-APTCA reachframework.dll (GeometryHelper::ArcToBezier)
    /// TreatAsSafe : GeometryHelper::ArcToBezier is safe
    /// </SecurityNote>
