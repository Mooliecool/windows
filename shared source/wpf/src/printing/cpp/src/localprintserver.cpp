/*++
   ...
   Author:
        ...
        Adina Trufinescu (AdianTru) 1-May-2003

    Revision History:

        Khaled Sedky (khaledS) 1-July-2003
--*/
            ...
            try
            {
                ...
                if (property->Equals("DefaultPrintQueue"))
                {
                    ...
                    if(isPrinterConnection == true)
                    {
                        ...
                        //
                        PrintSystemUNCPath----er^ ----er = gcnew PrintSystemUNCPath----er(defaultPrinterName);
                        targetPrintServer   = gcnew PrintServer(----er->PrintServerName,
                                                                PrintServerType::Browsable);
                        defaultPrinterName  = ----er->PrintQueueName;
                    }
                    else
                    {
                        //
