...
GO
SET ANSI_NULLS ON 
GOif exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[Maintenance_CleanForumsRead]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
...
GO
SET ANSI_NULLS ON 
GOprint 'Populating table with sample data...'
