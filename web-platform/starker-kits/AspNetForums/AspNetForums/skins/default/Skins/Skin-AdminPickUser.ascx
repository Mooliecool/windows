...
<table class="tableBorder" cellSpacing="1" cellPadding="3" width="100%">
  <tr>
    <th class="tableHeaderText" align="left">
      &nbsp;Pick a user whose information you wish to edit
    </th>
  </tr>
  <tr>
    <td class="forumRow">
                ...
                <asp:Table Runat="server" ID="Table1" NAME="Table1">
                  <asp:TableRow Runat="server" ID="Tablerow1" NAME="Tablerow1">
                    ...
                    <asp:TableCell Runat="server" ID="Tablecell6" NAME="Tablecell2">
                      <asp:HyperLink runat="server" NavigateUrl='<%# Globals.UrlAdminEditUser + DataBinder.Eval(Container.DataItem, "Username") %>' CssClass="linkSmallBold" Text='<%# DataBinder.Eval(Container.DataItem, "Username") %>' />
                    </asp:TableCell>
                    <asp:TableCell Runat="server" ID="Tablecell7" NAME="Tablecell2">
                      <span class="normalTextSmall">
                        <%# ((DateTime) DataBinder.Eval(Container.DataItem, "DateCreated")).ToString(Globals.DateFormat) %>
                      </span>
                    </asp:TableCell>
                    <asp:TableCell Runat="server" ID="Tablecell8" NAME="Tablecell2">
                      <span class="normalTextSmall">
                        <%# ((DateTime) DataBinder.Eval(Container.DataItem, "LastActivity")).ToString(Globals.DateFormat) %>
                      </span>
                    </asp:TableCell>
                    <asp:TableCell Runat="server" ID="Tablecell9" NAME="Tablecell2">
                      <asp:HyperLink runat="server" NavigateUrl='<%# Globals.UrlSearchForPostsByUser + DataBinder.Eval(Container.DataItem, "Username") %>' CssClass="linkSmallBold" Text='<%# DataBinder.Eval(Container.DataItem, "TotalPosts") %>' ID="Hyperlink1" NAME="Hyperlink1"/>
                    </asp:TableCell>
                  </asp:TableRow>
                </asp:Table>
              </ItemTemplate>
