...
<table cellPadding="0" width="100%">
  ...
  <tr>
    <td align="center">
      <AspNetForums:AlphaPicker SelectedLetter="A" id="AlphaPicker" runat="server" />
    </td>
  ...
  <tr>
    <td vAlign="top" align="right" colspan="2">
      <AspNetForums:UserList UrlUserNameRedirect='<%# Globals.UrlAdminEditUser %>' width="100%" id="UserList" CssClass="tableBorder" CellPadding="3" CellSpacing="1" runat="server" />
