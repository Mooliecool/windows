  ...
  <tr>
    <td class="forumRow">
      <table cellpadding="3" cellspacing="1">
        <tr>
          <td colspan="3">
            <span class="normalTextSmall"> Select an email message template to edit.&nbsp;
            </span>
          </td>
        </tr>
        <tr>
          <td align="right" nowrap>
            <asp:DropDownList id="emailTemplateList" runat="server"></asp:DropDownList>
          </td>
          <td align="left">
          </td>
      ...
      <table cellpadding="3" cellspacing="1">
        <tr>
          ...
          <td align="left">
            <asp:TextBox id="Subject" runat="server" Columns="45"></asp:TextBox>
          </td>
          <td align="left" width="100%">
          </td>
        </tr>
